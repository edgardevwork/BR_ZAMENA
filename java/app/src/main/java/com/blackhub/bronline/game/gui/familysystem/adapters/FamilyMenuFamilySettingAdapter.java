...
public final class FamilyMenuFamilySettingAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        FamiliesMenuRankOrColorItemBinding familiesMenuRankOrColorItemBindingInflate = FamiliesMenuRankOrColorItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.checkNotNullExpressionValue(familiesMenuRankOrColorItemBindingInflate, "inflate(...)");
        return new ViewHolder(this, familiesMenuRankOrColorItemBindingInflate);
    }
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(@NotNull final FamilyRankOrColorData thisItem, @Nullable final Function3<? super FamilyRankOrColorData, ? super Integer, ? super Integer, Unit> onClickMenuFamilyList) throws Resources.NotFoundException {
            String str;
            ...
            if (statusType == 0) {
                ...
                familiesMenuRankOrColorItemBinding.renameRank.setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.adapters.FamilyMenuFamilySettingAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        FamilyMenuFamilySettingAdapter.ViewHolder.bind$lambda$11$lambda$1(onClickMenuFamilyList, thisItem, this, view);
                    }
                });
            ...
            if (statusType != 1) {
                ...
                familiesMenuRankOrColorItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.adapters.FamilyMenuFamilySettingAdapter$ViewHolder$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        FamilyMenuFamilySettingAdapter.ViewHolder.bind$lambda$11$lambda$10(onClickMenuFamilyList, thisItem, this, view);
                    }
                });
                return;
            }
            ...
            if (currentStatus != null) {
                int iIntValue = currentStatus.intValue();
                if (iIntValue == 0) {
            ...
            familiesMenuRankOrColorItemBinding.rankAccessSwitch.setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.adapters.FamilyMenuFamilySettingAdapter$ViewHolder$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    FamilyMenuFamilySettingAdapter.ViewHolder.bind$lambda$11$lambda$5(onClickMenuFamilyList, thisItem, this, view);
                }
            });
