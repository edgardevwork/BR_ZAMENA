...
public final class FamilyUpgradeChildItemAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        FamiliesUpgradeChildItemBinding familiesUpgradeChildItemBindingInflate = FamiliesUpgradeChildItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.checkNotNullExpressionValue(familiesUpgradeChildItemBindingInflate, "inflate(...)");
        return new ViewHolder(this, familiesUpgradeChildItemBindingInflate);
    }
