...
@DebugMetadata(m7119c = "com.blackhub.bronline.game.core.viewmodel.JNIActivityViewModel$requestJson$1$deferredTasks$25", m7120f = "JNIActivityViewModel.kt", m7121i = {}, m7122l = {501}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
...
public final class JNIActivityViewModel$requestJson$1$deferredTasks$25 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C36361 c36361 = new C36361(jNIActivityViewModel, null);
            C36372 c36372 = new C36372(this.this$0, null);
            ...
            this.label = 1;
            if (JNIActivityViewModel.fetchData$default(jNIActivityViewModel, c36361, c36372, function2, function0, i2, 0, 0, 0L, this, 224, null) == coroutine_suspended) {
    ...
    /* compiled from: JNIActivityViewModel.kt */
    @Metadata(m7104d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\u008a@"}, m7105d2 = {"<anonymous>", "Lretrofit2/Response;", "Lcom/blackhub/bronline/game/gui/craft/model/response/MarketDeliveryFiltersResponse;"}, m7106k = 3, m7107mv = {1, 9, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "com.blackhub.bronline.game.core.viewmodel.JNIActivityViewModel$requestJson$1$deferredTasks$25$1", m7120f = "JNIActivityViewModel.kt", m7121i = {}, m7122l = {502}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: com.blackhub.bronline.game.core.viewmodel.JNIActivityViewModel$requestJson$1$deferredTasks$25$1 */
    public static final class C36361 extends SuspendLambda implements Function1<Continuation<? super Response<MarketDeliveryFiltersResponse>>, Object> {
        public int label;
        public final /* synthetic */ JNIActivityViewModel this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36361(JNIActivityViewModel jNIActivityViewModel, Continuation<? super C36361> continuation) {
    ...
    /* compiled from: JNIActivityViewModel.kt */
    @Metadata(m7104d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\u008a@"}, m7105d2 = {"<anonymous>", "Lretrofit2/Response;", "Lcom/blackhub/bronline/game/gui/craft/model/response/MarketDeliveryFiltersResponse;"}, m7106k = 3, m7107mv = {1, 9, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "com.blackhub.bronline.game.core.viewmodel.JNIActivityViewModel$requestJson$1$deferredTasks$25$2", m7120f = "JNIActivityViewModel.kt", m7121i = {}, m7122l = {503}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: com.blackhub.bronline.game.core.viewmodel.JNIActivityViewModel$requestJson$1$deferredTasks$25$2 */
    public static final class C36372 extends SuspendLambda implements Function1<Continuation<? super Response<MarketDeliveryFiltersResponse>>, Object> {
        public int label;
        public final /* synthetic */ JNIActivityViewModel this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36372(JNIActivityViewModel jNIActivityViewModel, Continuation<? super C36372> continuation) {
            super(1, continuation);
            this.this$0 = jNIActivityViewModel;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C36372(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        @Nullable
        public final Object invoke(@Nullable Continuation<? super Response<MarketDeliveryFiltersResponse>> continuation) {
            return ((C36372) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
