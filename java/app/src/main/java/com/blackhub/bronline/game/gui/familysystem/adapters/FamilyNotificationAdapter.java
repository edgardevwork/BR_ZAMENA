...
public final class FamilyNotificationAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        FamiliesNotificationItemBinding familiesNotificationItemBindingInflate = FamiliesNotificationItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.checkNotNullExpressionValue(familiesNotificationItemBindingInflate, "inflate(...)");
        return new ViewHolder(this, familiesNotificationItemBindingInflate);
    }
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(@NotNull final FamilyNotificationData notification, @Nullable final Function1<? super FamilyNotificationData, Unit> clickNotification) {
            ...
            if (jNIActivity == null || (string = jNIActivity.getString(R.string.families_notifications_author, notification.getNotificationsAuthor())) == null) {
                string = "";
            }
            ...
            familiesNotificationItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.adapters.FamilyNotificationAdapter$ViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    FamilyNotificationAdapter.ViewHolder.bind$lambda$1$lambda$0(familiesNotificationItemBinding, clickNotification, notification, view);
                }
            });
        }
