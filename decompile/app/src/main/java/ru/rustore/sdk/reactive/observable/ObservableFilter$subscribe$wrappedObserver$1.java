...
public final class ObservableFilter$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public final /* synthetic */ ObservableFilter<T> this$0;
    ...
    public ObservableFilter$subscribe$wrappedObserver$1(ObservableObserver<T> observableObserver, ObservableFilter<T> observableFilter) {
    ...
    public void onNext(T item) {
        ...
        try {
            ...
            Boolean bool = (Boolean) observableFilter.predicate.invoke(item);
            bool.booleanValue();
        ...
        if (Result.m15706isSuccessimpl(objM15699constructorimpl)) {
            boolean zBooleanValue = ((Boolean) objM15699constructorimpl).booleanValue();
            if (!getDisposed() && zBooleanValue) {
