...
public final class ObservableDoOnDispose$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public final /* synthetic */ ObservableDoOnDispose<T> this$0;
    ...
    public ObservableDoOnDispose$subscribe$wrappedObserver$1(ObservableObserver<T> observableObserver, ObservableDoOnDispose<T> observableDoOnDispose) {
    ...
    public void dispose() {
        ...
        if (this.disposed.compareAndSet(false, true)) {
            ...
            try {
                ...
                observableDoOnDispose.onDispose.invoke();
            ...
            if (thM15702exceptionOrNullimpl != null) {
                ...
                onError(thM15702exceptionOrNullimpl);
            }
