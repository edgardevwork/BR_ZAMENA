...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    @NotNull
    BufferedSink write(@NotNull ByteString byteString, int i, int byteCount) throws IOException;
    ...
    @NotNull
    BufferedSink write(@NotNull byte[] source, int i, int byteCount) throws IOException;
    ...
    @NotNull
    BufferedSink writeString(@NotNull String str, int beginIndex, int endIndex, @NotNull Charset charset) throws IOException;
    ...
    @NotNull
    BufferedSink writeUtf8(@NotNull String str, int beginIndex, int endIndex) throws IOException;
