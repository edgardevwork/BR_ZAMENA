...
public final class SegmentedByteString {
    ...
    public static final long reverseBytes(long j) {
        return ((j & 255) << 56) | (((-72057594037927936L) & j) >>> 56) | ((ZipEightByteInteger.BYTE_6_MASK & j) >>> 40) | ((ZipEightByteInteger.BYTE_5_MASK & j) >>> 24) | ((ZipEightByteInteger.BYTE_4_MASK & j) >>> 8) | ((ZipEightByteInteger.BYTE_3_MASK & j) << 8) | ((16711680 & j) << 24) | ((65280 & j) << 40);
    }
    ...
    public static final String toHexString(byte b) {
        return StringsKt__StringsJVMKt.concatToString(new char[]{okio.internal.ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], okio.internal.ByteString.getHEX_DIGIT_CHARS()[b & Ascii.f786SI]});
    }
    ...
    public static final String toHexString(long j) {
        ...
        return StringsKt__StringsJVMKt.concatToString(cArr, i, 16);
    }
