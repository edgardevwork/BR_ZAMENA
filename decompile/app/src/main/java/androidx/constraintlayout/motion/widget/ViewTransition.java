...
public class ViewTransition {
    ...
    */
    ...
    public final void parseViewTransitionTags(Context context, XmlPullParser parser) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C2167R.styleable.ViewTransition);
        int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = typedArrayObtainStyledAttributes.getIndex(i);
            if (index == C2167R.styleable.ViewTransition_android_id) {
                this.mId = typedArrayObtainStyledAttributes.getResourceId(index, this.mId);
            } else if (index == C2167R.styleable.ViewTransition_motionTarget) {
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        int i3 = C2167R.id.view_transition;
        layout.updateState(i3, current);
        layout.setState(i3, -1, -1);
        MotionScene.Transition transition = new MotionScene.Transition(-1, layout.mScene, i3, fromId);
        ...
        layout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.ViewTransition$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.lambda$applyTransition$0(views);
            }
        });
    }

    public final /* synthetic */ void lambda$applyTransition$0(View[] viewArr) {
        if (this.mSetsTag != -1) {
    ...
    public final void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo14021clone().setViewId(id));
            }
