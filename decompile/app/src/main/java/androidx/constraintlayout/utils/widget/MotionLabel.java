...
public class MotionLabel extends View implements FloatLayout {
    ...
    public final void setupTexture() {
    ...
    public final void adjustTexture(float l, float t, float r, float b) {
    ...
    public final void setUpTheme(Context context, @Nullable AttributeSet attrs) {
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0092R.attr.colorPrimary, typedValue, true);
        TextPaint textPaint = this.mPaint;
    ...
    public final void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
    ...
    public void setTextSize(float size) {
        this.mTextSize = size;
        Log.v(TAG, Debug.getLoc() + GlideException.IndentedAppendable.INDENT + size + " / " + this.mBaseTextSize);
        TextPaint textPaint = this.mPaint;
