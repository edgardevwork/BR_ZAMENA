...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C21381.f215x6930e354[type2.ordinal()]) {
            case 1:
    ...
    public static /* synthetic */ class C21381 {

        /* renamed from: $SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type */
        public static final /* synthetic */ int[] f215x6930e354;
        ...
        static {
            ...
            try {
                f215x6930e354[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f215x6930e354[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f215x6930e354[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f215x6930e354[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f215x6930e354[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f215x6930e354[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f215x6930e354[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f215x6930e354[Type.NONE.ordinal()] = 9;
    ...
    public boolean isSideAnchor() {
        switch (C21381.f215x6930e354[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public final boolean isConnectionToMe(ConstraintWidget constraintWidget, HashSet<ConstraintWidget> hashSet) {
