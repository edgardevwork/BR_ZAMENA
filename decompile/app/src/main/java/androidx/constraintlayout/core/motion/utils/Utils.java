...
public class Utils {
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            String str3 = ".(" + stackTrace[i2].getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName();
            str2 = str2 + " ";
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTraceElement.getLineNumber() + ")" + JsonKt.defaultIndent.substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
