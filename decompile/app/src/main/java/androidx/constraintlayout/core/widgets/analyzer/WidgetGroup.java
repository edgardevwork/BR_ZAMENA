...
public class WidgetGroup {
    ...
    public String toString() {
        String str = getOrientationString() + " [" + this.f225id + "] <";
    ...
    public void moveTo(int i, WidgetGroup widgetGroup) {
        ...
        this.moveTo = widgetGroup.f225id;
    }
    ...
    public final int measureWrap(int i, ConstraintWidget constraintWidget) {
    ...
    public final int solverMeasure(LinearSystem linearSystem, ArrayList<ConstraintWidget> arrayList, int i) {
    ...
    public final boolean contains(ConstraintWidget constraintWidget) {
    ...
    public void cleanup(ArrayList<WidgetGroup> arrayList) {
        ...
        if (this.moveTo != -1 && size > 0) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (this.moveTo == widgetGroup.f225id) {
