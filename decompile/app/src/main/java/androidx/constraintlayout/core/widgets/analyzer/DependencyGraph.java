...
public class DependencyGraph {
    ...
    public final void displayGraph() {
        Iterator<WidgetRun> it = this.mRuns.iterator();
    ...
    public final String generateDisplayNode(DependencyNode dependencyNode, boolean z, String str) {
        StringBuilder sb = new StringBuilder(str);
        for (DependencyNode dependencyNode2 : dependencyNode.targets) {
            String str2 = (StringUtils.f9903LF + dependencyNode.name()) + " -> " + dependencyNode2.name();
            ...
            sb.append(str2 + StringUtils.f9903LF);
        }
        return sb.toString();
    }

    public final String nodeDefinition(WidgetRun widgetRun) {
    ...
    public final String generateChainDisplayGraph(ChainRun chainRun, String str) {
    ...
    public final boolean isCenteredConnection(DependencyNode dependencyNode, DependencyNode dependencyNode2) {
    ...
    public final String generateDisplayGraph(WidgetRun widgetRun, String str) {
        boolean z;
