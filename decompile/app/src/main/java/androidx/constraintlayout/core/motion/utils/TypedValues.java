...
public interface TypedValues {
    ...
    public interface OnSwipe {
        ...
        public static final String[] ON_TOUCH_UP_ENUM = {"autoComplete", "autoCompleteToStart", "autoCompleteToEnd", "stop", Easing.DECELERATE_NAME, "decelerateAndComplete", "neverCompleteToStart", "neverCompleteToEnd"};
        public static final String[] SPRING_BOUNDARY_ENUM = {Easing.OVERSHOOT_NAME, "bounceStart", "bounceEnd", "bounceBoth"};
