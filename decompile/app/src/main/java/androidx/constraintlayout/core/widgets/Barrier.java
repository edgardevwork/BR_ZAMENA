...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.resolved) {
            ...
            if (i6 == 0 || i6 == 1) {
                linearSystem.addEquality(this.mLeft.mSolverVariable, this.f216mX);
                linearSystem.addEquality(this.mRight.mSolverVariable, this.f216mX);
                return;
            } else {
                if (i6 == 2 || i6 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f217mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f217mY);
                    return;
                }
                return;
            }
