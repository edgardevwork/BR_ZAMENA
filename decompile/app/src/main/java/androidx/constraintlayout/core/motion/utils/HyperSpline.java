...
public class HyperSpline {
    ...
    public static class Cubic {
        ...
        /* renamed from: mA */
        public double f202mA;

        /* renamed from: mB */
        public double f203mB;

        /* renamed from: mC */
        public double f204mC;

        /* renamed from: mD */
        public double f205mD;
        ...
        public double eval(double d) {
            return (((((this.f205mD * d) + this.f204mC) * d) + this.f203mB) * d) + this.f202mA;
        }

        public double vel(double d) {
            return (((this.f205mD * 3.0d * d) + (this.f204mC * 2.0d)) * d) + this.f203mB;
        }
    }
}
