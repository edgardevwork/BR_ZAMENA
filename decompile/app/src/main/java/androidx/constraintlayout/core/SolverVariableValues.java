...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public final void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f191id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i3 = iArr2[i2];
        if (i3 == -1) {
            iArr2[i2] = i;
    ...
    public final void removeFromHashMap(SolverVariable solverVariable) {
        int[] iArr;
        int i;
        int i2 = solverVariable.f191id;
    ...
    public final void addVariable(int i, SolverVariable solverVariable, float f) {
        this.variables[i] = solverVariable.f191id;
        this.values[i] = f;
        this.previous[i] = -1;
        this.next[i] = -1;
    ...
    public final void insertVariable(int i, SolverVariable solverVariable, float f) {
