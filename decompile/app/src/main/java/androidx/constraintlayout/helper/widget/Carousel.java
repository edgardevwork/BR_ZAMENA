...
public class Carousel extends MotionHelper {
    ...
    public final void enableAllTransitions(boolean enable) {
    ...
    public final boolean enableTransition(int transitionID, boolean enable) {
    ...
    public final boolean updateViewVisibility(View view, int visibility) {
    ...
    public final boolean updateViewVisibility(int constraintSetId, View view, int visibility) {
    ...
    public final /* synthetic */ void lambda$updateItems$0() {
