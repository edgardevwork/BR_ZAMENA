...
public class ConstraintSet {
    ...
    public static final int ANIMATE_CIRCLE_ANGLE_TO = 82;
    ...
    public static final int BASELINE_MARGIN = 93;
    public static final int BASELINE_TO_BASELINE = 1;
    public static final int BASELINE_TO_BOTTOM = 92;
    public static final int BASELINE_TO_TOP = 91;
    ...
    public static final int GONE_BASELINE_MARGIN = 94;
    ...
    public static final int GUIDELINE_USE_RTL = 99;
    ...
    public static final String KEY_PERCENT_PARENT = "parent";
    public static final String KEY_RATIO = "ratio";
    public static final String KEY_WEIGHT = "weight";
    public static final int LAYOUT_CONSTRAINT_HEIGHT = 96;
    public static final int LAYOUT_CONSTRAINT_WIDTH = 95;
    ...
    public static final int LAYOUT_WRAP_BEHAVIOR = 97;
    ...
    public static final int MOTION_TARGET = 98;
    ...
    public static final int QUANTIZE_MOTION_INTERPOLATOR = 86;
    public static final int QUANTIZE_MOTION_INTERPOLATOR_ID = 89;
    public static final int QUANTIZE_MOTION_INTERPOLATOR_STR = 90;
    public static final int QUANTIZE_MOTION_INTERPOLATOR_TYPE = 88;
    public static final int QUANTIZE_MOTION_PHASE = 85;
    public static final int QUANTIZE_MOTION_STEPS = 84;
    ...
    public static final int TRANSFORM_PIVOT_TARGET = 83;
    ...
    public static final int UNUSED = 87;
    ...
    static {
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        mapToConstant.append(C2167R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C2167R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C2167R.styleable.Constraint_guidelineUseRtl, 99);
        mapToConstant.append(C2167R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C2167R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C2167R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHeight, 96);
        mapToConstant.append(C2167R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C2167R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C2167R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C2167R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C2167R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C2167R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C2167R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C2167R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C2167R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C2167R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C2167R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C2167R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C2167R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C2167R.styleable.Constraint_animateRelativeTo, 64);
        mapToConstant.append(C2167R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C2167R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C2167R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C2167R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C2167R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C2167R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C2167R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        mapToConstant.append(C2167R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C2167R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C2167R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C2167R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C2167R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C2167R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C2167R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C2167R.styleable.Constraint_layout_constrainedHeight, 81);
        mapToConstant.append(C2167R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C2167R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C2167R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C2167R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C2167R.styleable.Constraint_quantizeMotionInterpolator, 86);
        SparseIntArray sparseIntArray = overrideMapToConstant;
        int i = C2167R.styleable.ConstraintOverride_layout_editor_absoluteY;
        sparseIntArray.append(i, 6);
        overrideMapToConstant.append(i, 7);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_motionTarget, 98);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C2167R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    */
    public static void parseDimensionConstraints(Object data, TypedArray a2, int attr, int orientation) {
        ...
        if (value != null) {
            ...
            if (iIndexOf > 0 && iIndexOf < length - 1) {
                ...
                if (strSubstring.equalsIgnoreCase(ExifInterface.LONGITUDE_WEST)) {
                    i = 0;
                } else if (strSubstring.equalsIgnoreCase(DurationFormatUtils.f9908H)) {
                    i = 1;
                }
                i2 = iIndexOf + 1;
            }
    ...
    public static class Layout {
        ...
        public static final int BARRIER_DIRECTION = 72;
        public static final int BARRIER_MARGIN = 73;
        public static final int BASELINE_MARGIN = 80;
        public static final int BASELINE_TO_BASELINE = 1;
        public static final int BASELINE_TO_BOTTOM = 78;
        public static final int BASELINE_TO_TOP = 77;
        public static final int BOTTOM_MARGIN = 2;
        public static final int BOTTOM_TO_BOTTOM = 3;
        public static final int BOTTOM_TO_TOP = 4;
        public static final int CHAIN_USE_RTL = 71;
        ...
        public static final int CIRCLE_ANGLE = 63;
        public static final int CIRCLE_RADIUS = 62;
        public static final int CONSTRAINED_HEIGHT = 88;
        public static final int CONSTRAINED_WIDTH = 87;
        public static final int CONSTRAINT_REFERENCED_IDS = 74;
        public static final int CONSTRAINT_TAG = 89;
        public static final int DIMENSION_RATIO = 5;
        public static final int EDITOR_ABSOLUTE_X = 6;
        public static final int EDITOR_ABSOLUTE_Y = 7;
        public static final int END_MARGIN = 8;
        public static final int END_TO_END = 9;
        public static final int END_TO_START = 10;
        public static final int GONE_BASELINE_MARGIN = 79;
        public static final int GONE_BOTTOM_MARGIN = 11;
        public static final int GONE_END_MARGIN = 12;
        public static final int GONE_LEFT_MARGIN = 13;
        public static final int GONE_RIGHT_MARGIN = 14;
        ...
        public static final int GUIDE_END = 18;
        public static final int GUIDE_PERCENT = 19;
        public static final int GUIDE_USE_RTL = 90;
        public static final int HEIGHT_DEFAULT = 82;
        public static final int HEIGHT_MAX = 83;
        public static final int HEIGHT_MIN = 85;
        public static final int HEIGHT_PERCENT = 70;
        public static final int HORIZONTAL_BIAS = 20;
        public static final int HORIZONTAL_STYLE = 39;
        public static final int HORIZONTAL_WEIGHT = 37;
        public static final int LAYOUT_CONSTRAINT_HEIGHT = 42;
        public static final int LAYOUT_CONSTRAINT_WIDTH = 41;
        public static final int LAYOUT_HEIGHT = 21;
        public static final int LAYOUT_WIDTH = 22;
        public static final int LAYOUT_WRAP_BEHAVIOR = 76;
        ...
        public static final int UNUSED = 91;
        ...
        public static final int WIDTH_DEFAULT = 81;
        public static final int WIDTH_MAX = 84;
        public static final int WIDTH_MIN = 86;
        public static final int WIDTH_PERCENT = 69;
        ...
        static {
            ...
            sparseIntArray.append(C2167R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C2167R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C2167R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C2167R.styleable.Layout_guidelineUseRtl, 90);
            mapToConstant.append(C2167R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C2167R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintLeft_creator, 91);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintTop_creator, 91);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintRight_creator, 91);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintBottom_creator, 91);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintBaseline_creator, 91);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C2167R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C2167R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C2167R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C2167R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C2167R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C2167R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C2167R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C2167R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C2167R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C2167R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C2167R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        public static final int TRANSFORM_PIVOT_TARGET = 12;
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C2167R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C2167R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C2167R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C2167R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C2167R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C2167R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C2167R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C2167R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C2167R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C2167R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C2167R.styleable.Transform_android_elevation, 11);
            mapToConstant.append(C2167R.styleable.Transform_transformPivotTarget, 12);
        }

        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C2167R.styleable.Transform);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C2167R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C2167R.styleable.PropertySet_android_alpha) {
                    this.alpha = typedArrayObtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C2167R.styleable.PropertySet_android_visibility) {
                    this.visibility = typedArrayObtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C2167R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = typedArrayObtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C2167R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        public static final int ANIMATE_CIRCLE_ANGLE_TO = 6;
        ...
        public static final int MOTION_STAGGER = 7;
        public static final int PATH_MOTION_ARC = 2;
        public static final int QUANTIZE_MOTION_INTERPOLATOR = 10;
        public static final int QUANTIZE_MOTION_PHASE = 9;
        public static final int QUANTIZE_MOTION_STEPS = 8;
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C2167R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C2167R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C2167R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C2167R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C2167R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C2167R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C2167R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C2167R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C2167R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C2167R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C2167R.styleable.Motion);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public static class Constraint {
        ...
        public static class Delta {
            public static final int INITIAL_BOOLEAN = 4;
            public static final int INITIAL_FLOAT = 10;
            public static final int INITIAL_INT = 10;
            public static final int INITIAL_STRING = 5;
        ...
        public final ConstraintAttribute get(String attributeName, ConstraintAttribute.AttributeType attributeType) {
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m14023clone());
            }
        }
    }
    ...
    public final void createHorizontalChain(int leftId, int leftSide, int rightId, int rightSide, int[] chainIds, float[] weights, int style, int left, int right) {
        if (chainIds.length < 2) {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
        if (weights != null && weights.length != chainIds.length) {
    ...
    public void removeFromVerticalChain(int viewId) {
        if (this.mConstraints.containsKey(Integer.valueOf(viewId))) {
            ...
            Layout layout = constraint.layout;
            int i = layout.topToBottom;
            int i2 = layout.bottomToTop;
            if (i != -1 || i2 != -1) {
                if (i != -1 && i2 != -1) {
                    connect(i, 4, i2, 3, 0);
                    connect(i2, 3, i, 4, 0);
                } else {
                    int i3 = layout.bottomToBottom;
                    if (i3 != -1) {
                        connect(i, 4, i3, 4, 0);
                    } else {
                        int i4 = layout.topToTop;
                        if (i4 != -1) {
                            connect(i2, 3, i4, 3, 0);
                        }
                    }
    ...
    public final void addAttributes(ConstraintAttribute.AttributeType attributeType, String... attributeName) {
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < strArrSplit.length; i++) {
            String[] strArrSplit2 = strArrSplit[i].split(URLEncodedUtils.NAME_VALUE_SEPARATOR);
    ...
    public void parseStringAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < strArrSplitString.length; i++) {
            String[] strArrSplit = strArrSplitString[i].split(URLEncodedUtils.NAME_VALUE_SEPARATOR);
    ...
    */
    ...
    public final Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? C2167R.styleable.ConstraintOverride : C2167R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSetAsAttributeSet, C2167R.styleable.ConstraintOverride);
        populateOverride(context, constraint, typedArrayObtainStyledAttributes);
        typedArrayObtainStyledAttributes.recycle();
        return constraint;
    }

    public static void populateOverride(Context ctx, Constraint c, TypedArray a2) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 37:
                    ...
                    break;
                case 38:
                    int resourceId = a2.getResourceId(index, c.mViewId);
                ...
                case 85:
                    ...
                    break;
                case 86:
                    int i2 = a2.peekValue(index).type;
                    if (i2 == 1) {
                        ...
                        motion2.mQuantizeInterpolatorType = a2.getInteger(index, motion2.mQuantizeInterpolatorID);
                ...
                case 98:
                    if (MotionLayout.IS_IN_EDIT_MODE) {
                        int resourceId2 = a2.getResourceId(index, c.mViewId);
    ...
    public final void populateConstraint(Context ctx, Constraint c, TypedArray a2, boolean override) {
        if (override) {
        ...
        for (int i = 0; i < indexCount; i++) {
            int index = a2.getIndex(i);
            if (index != C2167R.styleable.Constraint_android_id && C2167R.styleable.Constraint_android_layout_marginStart != index && C2167R.styleable.Constraint_android_layout_marginEnd != index) {
            ...
            switch (mapToConstant.get(index)) {
                case 1:
                    Layout layout = c.layout;
                    layout.baselineToBaseline = lookupID(a2, index, layout.baselineToBaseline);
                    break;
                case 2:
                    Layout layout2 = c.layout;
                    layout2.bottomMargin = a2.getDimensionPixelSize(index, layout2.bottomMargin);
                    break;
                case 3:
                    Layout layout3 = c.layout;
                    layout3.bottomToBottom = lookupID(a2, index, layout3.bottomToBottom);
                    break;
                case 4:
                    Layout layout4 = c.layout;
                    layout4.bottomToTop = lookupID(a2, index, layout4.bottomToTop);
                    break;
                case 5:
                ...
                case 6:
                    ...
                    layout5.editorAbsoluteX = a2.getDimensionPixelOffset(index, layout5.editorAbsoluteX);
                    break;
                case 7:
                    Layout layout6 = c.layout;
                    layout6.editorAbsoluteY = a2.getDimensionPixelOffset(index, layout6.editorAbsoluteY);
                    break;
                case 8:
                    Layout layout7 = c.layout;
                    layout7.endMargin = a2.getDimensionPixelSize(index, layout7.endMargin);
                    break;
                case 9:
                    Layout layout8 = c.layout;
                    layout8.endToEnd = lookupID(a2, index, layout8.endToEnd);
                    break;
                case 10:
                    Layout layout9 = c.layout;
                    layout9.endToStart = lookupID(a2, index, layout9.endToStart);
                    break;
                case 11:
                    Layout layout10 = c.layout;
                    layout10.goneBottomMargin = a2.getDimensionPixelSize(index, layout10.goneBottomMargin);
                    break;
                case 12:
                    Layout layout11 = c.layout;
                    layout11.goneEndMargin = a2.getDimensionPixelSize(index, layout11.goneEndMargin);
                    break;
                case 13:
                    Layout layout12 = c.layout;
                    layout12.goneLeftMargin = a2.getDimensionPixelSize(index, layout12.goneLeftMargin);
                    break;
                case 14:
                    Layout layout13 = c.layout;
                    layout13.goneRightMargin = a2.getDimensionPixelSize(index, layout13.goneRightMargin);
                    break;
                case 15:
                    Layout layout14 = c.layout;
                    layout14.goneStartMargin = a2.getDimensionPixelSize(index, layout14.goneStartMargin);
                    break;
                case 16:
                    Layout layout15 = c.layout;
                    layout15.goneTopMargin = a2.getDimensionPixelSize(index, layout15.goneTopMargin);
                    break;
                case 17:
                    Layout layout16 = c.layout;
                    layout16.guideBegin = a2.getDimensionPixelOffset(index, layout16.guideBegin);
                    break;
                case 18:
                    Layout layout17 = c.layout;
                    layout17.guideEnd = a2.getDimensionPixelOffset(index, layout17.guideEnd);
                    break;
                case 19:
                    Layout layout18 = c.layout;
                    layout18.guidePercent = a2.getFloat(index, layout18.guidePercent);
                    break;
                case 20:
                    Layout layout19 = c.layout;
                    layout19.horizontalBias = a2.getFloat(index, layout19.horizontalBias);
                    break;
                case 21:
                    Layout layout20 = c.layout;
                    layout20.mHeight = a2.getLayoutDimension(index, layout20.mHeight);
                    break;
                case 22:
                    PropertySet propertySet = c.propertySet;
                    propertySet.visibility = a2.getInt(index, propertySet.visibility);
                ...
                case 23:
                    ...
                    layout21.mWidth = a2.getLayoutDimension(index, layout21.mWidth);
                    break;
                case 24:
                    Layout layout22 = c.layout;
                    layout22.leftMargin = a2.getDimensionPixelSize(index, layout22.leftMargin);
                    break;
                case 25:
                    Layout layout23 = c.layout;
                    layout23.leftToLeft = lookupID(a2, index, layout23.leftToLeft);
                    break;
                case 26:
                    Layout layout24 = c.layout;
                    layout24.leftToRight = lookupID(a2, index, layout24.leftToRight);
                    break;
                case 27:
                    Layout layout25 = c.layout;
                    layout25.orientation = a2.getInt(index, layout25.orientation);
                    break;
                case 28:
                    Layout layout26 = c.layout;
                    layout26.rightMargin = a2.getDimensionPixelSize(index, layout26.rightMargin);
                    break;
                case 29:
                    Layout layout27 = c.layout;
                    layout27.rightToLeft = lookupID(a2, index, layout27.rightToLeft);
                    break;
                case 30:
                    Layout layout28 = c.layout;
                    layout28.rightToRight = lookupID(a2, index, layout28.rightToRight);
                    break;
                case 31:
                    Layout layout29 = c.layout;
                    layout29.startMargin = a2.getDimensionPixelSize(index, layout29.startMargin);
                    break;
                case 32:
                    Layout layout30 = c.layout;
                    layout30.startToEnd = lookupID(a2, index, layout30.startToEnd);
                    break;
                case 33:
                    Layout layout31 = c.layout;
                    layout31.startToStart = lookupID(a2, index, layout31.startToStart);
                    break;
                case 34:
                    Layout layout32 = c.layout;
                    layout32.topMargin = a2.getDimensionPixelSize(index, layout32.topMargin);
                    break;
                case 35:
                    Layout layout33 = c.layout;
                    layout33.topToBottom = lookupID(a2, index, layout33.topToBottom);
                    break;
                case 36:
                    Layout layout34 = c.layout;
                    layout34.topToTop = lookupID(a2, index, layout34.topToTop);
                    break;
                case 37:
                    Layout layout35 = c.layout;
                    layout35.verticalBias = a2.getFloat(index, layout35.verticalBias);
                    break;
                case 38:
                    c.mViewId = a2.getResourceId(index, c.mViewId);
                    break;
                case 39:
                    ...
                    layout36.horizontalWeight = a2.getFloat(index, layout36.horizontalWeight);
                    break;
                case 40:
                    Layout layout37 = c.layout;
                    layout37.verticalWeight = a2.getFloat(index, layout37.verticalWeight);
                    break;
                case 41:
                    Layout layout38 = c.layout;
                    layout38.horizontalChainStyle = a2.getInt(index, layout38.horizontalChainStyle);
                    break;
                case 42:
                    Layout layout39 = c.layout;
                    layout39.verticalChainStyle = a2.getInt(index, layout39.verticalChainStyle);
                    break;
                case 43:
                    PropertySet propertySet3 = c.propertySet;
                    propertySet3.alpha = a2.getFloat(index, propertySet3.alpha);
                    break;
                case 44:
                    Transform transform = c.transform;
                    transform.applyElevation = true;
                    transform.elevation = a2.getDimension(index, transform.elevation);
                    break;
                case 45:
                    Transform transform2 = c.transform;
                    transform2.rotationX = a2.getFloat(index, transform2.rotationX);
                    break;
                case 46:
                    Transform transform3 = c.transform;
                    transform3.rotationY = a2.getFloat(index, transform3.rotationY);
                    break;
                case 47:
                    Transform transform4 = c.transform;
                    transform4.scaleX = a2.getFloat(index, transform4.scaleX);
                    break;
                case 48:
                    Transform transform5 = c.transform;
                    transform5.scaleY = a2.getFloat(index, transform5.scaleY);
                    break;
                case 49:
                    Transform transform6 = c.transform;
                    transform6.transformPivotX = a2.getDimension(index, transform6.transformPivotX);
                    break;
                case 50:
                    Transform transform7 = c.transform;
                    transform7.transformPivotY = a2.getDimension(index, transform7.transformPivotY);
                    break;
                case 51:
                    Transform transform8 = c.transform;
                    transform8.translationX = a2.getDimension(index, transform8.translationX);
                    break;
                case 52:
                    Transform transform9 = c.transform;
                    transform9.translationY = a2.getDimension(index, transform9.translationY);
                    break;
                case 53:
                    Transform transform10 = c.transform;
                    transform10.translationZ = a2.getDimension(index, transform10.translationZ);
                    break;
                case 54:
                    Layout layout40 = c.layout;
                    layout40.widthDefault = a2.getInt(index, layout40.widthDefault);
                    break;
                case 55:
                    Layout layout41 = c.layout;
                    layout41.heightDefault = a2.getInt(index, layout41.heightDefault);
                    break;
                case 56:
                    Layout layout42 = c.layout;
                    layout42.widthMax = a2.getDimensionPixelSize(index, layout42.widthMax);
                    break;
                case 57:
                    Layout layout43 = c.layout;
                    layout43.heightMax = a2.getDimensionPixelSize(index, layout43.heightMax);
                    break;
                case 58:
                    Layout layout44 = c.layout;
                    layout44.widthMin = a2.getDimensionPixelSize(index, layout44.widthMin);
                    break;
                case 59:
                    Layout layout45 = c.layout;
                    layout45.heightMin = a2.getDimensionPixelSize(index, layout45.heightMin);
                    break;
                case 60:
                    Transform transform11 = c.transform;
                    transform11.rotation = a2.getFloat(index, transform11.rotation);
                    break;
                case 61:
                    Layout layout46 = c.layout;
                    layout46.circleConstraint = lookupID(a2, index, layout46.circleConstraint);
                    break;
                case 62:
                    Layout layout47 = c.layout;
                    layout47.circleRadius = a2.getDimensionPixelSize(index, layout47.circleRadius);
                    break;
                case 63:
                    Layout layout48 = c.layout;
                    layout48.circleAngle = a2.getFloat(index, layout48.circleAngle);
                    break;
                case 64:
                    Motion motion = c.motion;
                    motion.mAnimateRelativeTo = lookupID(a2, index, motion.mAnimateRelativeTo);
                    break;
                case 65:
                    if (a2.peekValue(index).type == 3) {
                ...
                case 67:
                    Motion motion2 = c.motion;
                    motion2.mPathRotate = a2.getFloat(index, motion2.mPathRotate);
                    break;
                case 68:
                    PropertySet propertySet4 = c.propertySet;
                    propertySet4.mProgress = a2.getFloat(index, propertySet4.mProgress);
                    break;
                case 69:
                ...
                case 72:
                    ...
                    layout49.mBarrierDirection = a2.getInt(index, layout49.mBarrierDirection);
                    break;
                case 73:
                    Layout layout50 = c.layout;
                    layout50.mBarrierMargin = a2.getDimensionPixelSize(index, layout50.mBarrierMargin);
                    break;
                case 74:
                ...
                case 75:
                    ...
                    layout51.mBarrierAllowsGoneWidgets = a2.getBoolean(index, layout51.mBarrierAllowsGoneWidgets);
                    break;
                case 76:
                    Motion motion3 = c.motion;
                    motion3.mPathMotionArc = a2.getInt(index, motion3.mPathMotionArc);
                    break;
                case 77:
                ...
                case 78:
                    ...
                    propertySet5.mVisibilityMode = a2.getInt(index, propertySet5.mVisibilityMode);
                    break;
                case 79:
                    Motion motion4 = c.motion;
                    motion4.mMotionStagger = a2.getFloat(index, motion4.mMotionStagger);
                    break;
                case 80:
                    Layout layout52 = c.layout;
                    layout52.constrainedWidth = a2.getBoolean(index, layout52.constrainedWidth);
                    break;
                case 81:
                    Layout layout53 = c.layout;
                    layout53.constrainedHeight = a2.getBoolean(index, layout53.constrainedHeight);
                    break;
                case 82:
                    Motion motion5 = c.motion;
                    motion5.mAnimateCircleAngleTo = a2.getInteger(index, motion5.mAnimateCircleAngleTo);
                    break;
                case 83:
                    Transform transform12 = c.transform;
                    transform12.transformPivotTarget = lookupID(a2, index, transform12.transformPivotTarget);
                    break;
                case 84:
                    Motion motion6 = c.motion;
                    motion6.mQuantizeMotionSteps = a2.getInteger(index, motion6.mQuantizeMotionSteps);
                    break;
                case 85:
                    Motion motion7 = c.motion;
                    motion7.mQuantizeMotionPhase = a2.getFloat(index, motion7.mQuantizeMotionPhase);
                    break;
                case 86:
                    int i2 = a2.peekValue(index).type;
                    if (i2 == 1) {
                        ...
                        motion9.mQuantizeInterpolatorType = a2.getInteger(index, motion9.mQuantizeInterpolatorID);
                        break;
                    }
                case 87:
                    Log.w("ConstraintSet", "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index));
                ...
                case 91:
                    ...
                    layout54.baselineToTop = lookupID(a2, index, layout54.baselineToTop);
                    break;
                case 92:
                    Layout layout55 = c.layout;
                    layout55.baselineToBottom = lookupID(a2, index, layout55.baselineToBottom);
                    break;
                case 93:
                    Layout layout56 = c.layout;
                    layout56.baselineMargin = a2.getDimensionPixelSize(index, layout56.baselineMargin);
                    break;
                case 94:
                    Layout layout57 = c.layout;
                    layout57.goneBaselineMargin = a2.getDimensionPixelSize(index, layout57.goneBaselineMargin);
                    break;
                case 95:
                ...
                case 97:
                    ...
                    layout58.mWrapBehavior = a2.getInt(index, layout58.mWrapBehavior);
                    break;
            }
        }
    ...
    public final int[] convertReferenceString(View view, String referenceIdString) throws IllegalAccessException, IllegalArgumentException {
        int iIntValue;
        ...
        while (i < strArrSplit.length) {
            ...
            try {
                iIntValue = C2167R.id.class.getField(strTrim).getInt(null);
    ...
    public static String getDebugName(int v) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(LauncherConstants.UNDERSCORE_STRING) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
    ...
    public class WriteXmlEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{TtmlNode.LEFT, TtmlNode.RIGHT, "top", "bottom", TtmlNode.START, "end"}, -1);
        ...
        public final void writeBoolen(String dimString, boolean val, boolean def) throws IOException {
            if (val != def) {
                this.writer.write(SPACE + dimString + "=\"" + val + "dp\"");
            }
        }

        public final void writeEnum(String dimString, int val, String[] types, int def) throws IOException {
            if (val != def) {
                this.writer.write(SPACE + dimString + "=\"" + types[val] + "\"");
            }
        }

        public final void writeDimension(String dimString, int dim, int def) throws IOException {
            if (dim != def) {
                this.writer.write(SPACE + dimString + "=\"" + dim + "dp\"");
            }
        }

        public final void writeBaseDimension(String dimString, int dim, int def) throws IOException {
            if (dim != def) {
                if (dim == -2) {
        ...
        public void writeVariable(String name, int[] value) throws IOException {
            ...
            this.writer.write(SPACE + name);
            this.writer.write(io.appmetrica.analytics.coreutils.internal.StringUtils.PROCESS_POSTFIX_DELIMITER);
            int i = 0;
        ...
        public void writeVariable(String name, String value) throws IOException {
            ...
            this.writer.write(io.appmetrica.analytics.coreutils.internal.StringUtils.PROCESS_POSTFIX_DELIMITER);
            this.writer.write(", " + value);
            this.writer.write(StringUtils.f9903LF);
        }
    }
    ...
    public class WriteJsonEngine {
        ...
        public final void writeGuideline(int orientation, int guideBegin, int guideEnd, float guidePercent) {
        }
        ...
        public final void writeDimension(String dimString, int dim, int dimDefault, float dimPercent, int dimMin, int dimMax, boolean constrainedDim) throws IOException {
            if (dim != 0) {
                if (dim == -2) {
