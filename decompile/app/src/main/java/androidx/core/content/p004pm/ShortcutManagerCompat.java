...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat, @Nullable final IntentSender intentSender) throws PackageManager.NameNotFoundException {
        ...
        if (i >= 26) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i) {
        ...
        if (i2 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).getShortcuts(i));
        }
        if (i2 >= 25) {
            ShortcutManager shortcutManagerM399m = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(shortcutManagerM399m.getManifestShortcuts());
            }
            if ((i & 2) != 0) {
                arrayList.addAll(shortcutManagerM399m.getDynamicShortcuts());
            }
            if ((i & 4) != 0) {
                arrayList.addAll(shortcutManagerM399m.getPinnedShortcuts());
            }
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(@NonNull Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static boolean isRateLimitingActive(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).isRateLimitingActive();
        }
    ...
    public static int getIconMaxWidth(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(@NonNull Context context, @NonNull String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List dynamicShortcuts = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ShortcutInfoCompat$$ExternalSyntheticApiModelOutline13.m366m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(@NonNull Context context, @NonNull List<String> list, @Nullable CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(@NonNull Context context, @NonNull List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(@NonNull Context context, @NonNull List<String> list) {
        ...
        ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i >= 30) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (i >= 25) {
            ShortcutManager shortcutManagerM399m = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m399m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m398m()));
            if (shortcutManagerM399m.isRateLimitingActive()) {
                return false;
            }
            List dynamicShortcuts = shortcutManagerM399m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerM399m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerM399m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
