...
public final class LayoutInflaterCompat {
    ...
    public static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        public String toString() {
            return getClass().getName() + WebvttCssParser.RULE_START + this.mDelegateFactory + WebvttCssParser.RULE_END;
        }
    }

    public static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        if (!sCheckedField) {
            try {
