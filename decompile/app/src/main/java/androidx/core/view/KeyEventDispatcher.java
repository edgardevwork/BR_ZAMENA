...
public class KeyEventDispatcher {
    ...
    public static boolean actionBarOnMenuKeyEventPre28(ActionBar actionBar, KeyEvent keyEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static DialogInterface.OnKeyListener getDialogKeyListenerPre28(Dialog dialog) throws NoSuchFieldException, SecurityException {
    ...
    public static boolean dialogSuperDispatchKeyEventPre28(Dialog dialog, KeyEvent keyEvent) throws NoSuchFieldException, SecurityException {
