...
public class TypefaceCompatBaseImpl {
    ...
    public static long getUniqueKey(@Nullable Typeface typeface) throws NoSuchFieldException, SecurityException {
        if (typeface == null) {
            return 0L;
        }
        try {
    ...
    public class C22001 implements StyleExtractor<FontsContractCompat.FontInfo> {
        public C22001() {
        }
    ...
    public class C22012 implements StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry> {
        public C22012() {
        }
    ...
    public class C22023 implements StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry> {
        public C22023() {
        }
    ...
    public final void addFontFamily(Typeface typeface, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry) throws NoSuchFieldException, SecurityException {
        long uniqueKey = getUniqueKey(typeface);
        if (uniqueKey != 0) {
