...
public class TypefaceCompat {
    ...
    @Nullable
    public static Typeface getBestFontFromFamily(Context context, Typeface typeface, int i) throws NoSuchFieldException, SecurityException {
    ...
    @NonNull
    public static Typeface create(@NonNull Context context, @Nullable Typeface typeface, @IntRange(from = 1, m10to = 1000) int i, boolean z) {
        if (context == null) {
            throw new IllegalArgumentException("Context cannot be null");
        }
