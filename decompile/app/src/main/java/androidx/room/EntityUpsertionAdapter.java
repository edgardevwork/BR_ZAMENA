...
public final class EntityUpsertionAdapter<T> {
    ...
    public final void checkUniquenessException(SQLiteConstraintException ex) {
        String message = ex.getMessage();
        if (message == null) {
            throw ex;
        }
        if (!StringsKt__StringsKt.contains((CharSequence) message, (CharSequence) EntityUpsertionAdapterKt.ErrorMsg, true) && !StringsKt__StringsKt.contains$default((CharSequence) message, (CharSequence) EntityUpsertionAdapterKt.SQLITE_CONSTRAINT_UNIQUE, false, 2, (Object) null) && !StringsKt__StringsKt.contains$default((CharSequence) message, (CharSequence) EntityUpsertionAdapterKt.SQLITE_CONSTRAINT_PRIMARYKEY, false, 2, (Object) null)) {
            throw ex;
        }
    }
