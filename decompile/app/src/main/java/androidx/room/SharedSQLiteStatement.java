...
public abstract class SharedSQLiteStatement {
    ...
    public SharedSQLiteStatement(@NotNull RoomDatabase database) {
        ...
        this.stmt = LazyKt__LazyJVMKt.lazy(new Function0<SupportSQLiteStatement>() { // from class: androidx.room.SharedSQLiteStatement$stmt$2
            {
                super(0);
            }
    ...
    public final SupportSQLiteStatement getStmt() {
    ...
    public final SupportSQLiteStatement getStmt(boolean canUseCached) {
        if (canUseCached) {
            return getStmt();
        }
