...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0092R.styleable.ActionBarLayout);
            this.gravity = typedArrayObtainStyledAttributes.getInt(C0092R.styleable.ActionBarLayout_android_layout_gravity, 0);
