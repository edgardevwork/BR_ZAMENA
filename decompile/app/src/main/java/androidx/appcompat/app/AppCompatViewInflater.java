...
public class AppCompatViewInflater {
    ...
    public final View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        if (str.equals(SVG.View.NODE_NAME)) {
    ...
    public final View createViewByPrefix(Context context, String str, String str2) throws InflateException, NoSuchMethodException, SecurityException, ClassNotFoundException {
        String str3;
    ...
    public static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0092R.styleable.View, 0, 0);
        int resourceId = z ? typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.View_theme, 0)) != 0) {
