...
public class AlertController {
    ...
    public static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0092R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0092R.styleable.AlertDialog, C0092R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    public final void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C0092R.id.parentPanel);
        int i = C0092R.id.topPanel;
        View viewFindViewById4 = viewFindViewById3.findViewById(i);
        int i2 = C0092R.id.contentPanel;
        View viewFindViewById5 = viewFindViewById3.findViewById(i2);
        int i3 = C0092R.id.buttonPanel;
        View viewFindViewById6 = viewFindViewById3.findViewById(i3);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C0092R.id.customPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C0092R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C0092R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C0092R.id.textSpacerNoTitle)) != null) {
    ...
    public final void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View viewFindViewById = this.mWindow.findViewById(C0092R.id.scrollIndicatorUp);
        View viewFindViewById2 = this.mWindow.findViewById(C0092R.id.scrollIndicatorDown);
    ...
    public class C00952 implements NestedScrollView.OnScrollChangeListener {
        public final /* synthetic */ View val$bottom;
        public final /* synthetic */ View val$top;

        public C00952(View view, View view2) {
            this.val$top = view;
    ...
    public class RunnableC00963 implements Runnable {
        public final /* synthetic */ View val$bottom;
        public final /* synthetic */ View val$top;

        public RunnableC00963(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public class C00974 implements AbsListView.OnScrollListener {
        public final /* synthetic */ View val$bottom;
        public final /* synthetic */ View val$top;
        ...
        public C00974(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public class RunnableC00985 implements Runnable {
        public final /* synthetic */ View val$bottom;
        public final /* synthetic */ View val$top;

        public RunnableC00985(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public final void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0092R.id.custom);
    ...
    public final void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0092R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(R.id.icon);
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0092R.id.alertTitle);
    ...
    public final void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0092R.id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0092R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0092R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0092R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public static class AlertParams {
        ...
        public final void createListView(final AlertController alertController) {
            int i;
