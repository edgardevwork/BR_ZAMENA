...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0092R.attr.switchStyle);
    }
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        int[] iArr = C0092R.styleable.SwitchCompat;
        ...
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(tintTypedArrayObtainStyledAttributes.getText(C0092R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(tintTypedArrayObtainStyledAttributes.getText(C0092R.styleable.SwitchCompat_android_textOff));
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C0092R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(C0092R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C0092R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.TextAppearance_android_textSize, 0);
        ...
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.TextAppearance_android_textStyle, -1));
        if (tintTypedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    */
    ...
    public final void stopDrag(MotionEvent motionEvent) throws Resources.NotFoundException {
        this.mTouchMode = 0;
    ...
    public final void setOnStateDescriptionOnRAndAbove() throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(C0092R.string.abc_capital_on);
            }
    ...
    public final void setOffStateDescriptionOnRAndAbove() throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(C0092R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, string);
        }
    }
