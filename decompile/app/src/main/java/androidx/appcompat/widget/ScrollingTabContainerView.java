...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public final LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0092R.attr.actionBarTabBarStyle);
    ...
    public final Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0092R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int i) {
        ...
        RunnableC01671 runnableC01671 = new Runnable() { // from class: androidx.appcompat.widget.ScrollingTabContainerView.1
            public final /* synthetic */ View val$tabView;

            public RunnableC01671(View childAt2) {
                view = childAt2;
            }
        ...
        this.mTabSelector = runnableC01671;
        post(runnableC01671);
    }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            int i = C0092R.attr.actionBarTabStyle;
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0092R.attr.actionBarTabTextStyle);
