...
public final class ResourceManagerInternal {
    ...
    public final Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) throws Resources.NotFoundException {
    ...
    public final Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int i) throws XmlPullParserException, Resources.NotFoundException {
        int next;
    ...
    public final void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        Drawable drawable = getDrawable(context, C0129R.drawable.abc_vector_test);
