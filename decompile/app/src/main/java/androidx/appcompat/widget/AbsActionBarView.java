...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0092R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0092R.styleable.ActionBar, C0092R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0092R.styleable.ActionBar_height, 0));
