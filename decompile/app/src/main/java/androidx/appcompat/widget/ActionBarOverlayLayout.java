...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static final int[] ATTRS = {C0092R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    */
    public final boolean applyInsets(@NonNull View view, @NonNull Rect rect, boolean z, boolean z2, boolean z3, boolean z4) {
        boolean z5;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m441of(windowInsetsCompat.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        }
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0092R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0092R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0092R.id.action_bar));
        }
    }
