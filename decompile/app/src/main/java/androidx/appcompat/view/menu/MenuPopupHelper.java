...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0092R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view) {
        this(context, menuBuilder, view, false, C0092R.attr.popupMenuStyle, 0);
    }
    ...
    public final MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0092R.dimen.abc_cascading_menus_min_smallest_width)) {
