...
public final class MultiDexExtractor implements Closeable {
    ...
    public final List<ExtractedDex> performExtractions() throws IOException {
        boolean z;
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z2) {
                    ...
                    sb.append(z ? "succeeded" : EndArtifactPublishEvent.STATUS_FAILED);
                    sb.append(" '");
    ...
    public static void extract(ZipFile zipFile, ZipEntry zipEntry, File file, String str) throws IOException {
