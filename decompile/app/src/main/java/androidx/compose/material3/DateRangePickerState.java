...
public interface DateRangePickerState {
    ...
    void mo9404setDisplayModevCnGnXg(int i);

    void setDisplayedMonthMillis(long j);

    void setSelection(@Nullable Long startDateMillis, @Nullable Long endDateMillis);
}
