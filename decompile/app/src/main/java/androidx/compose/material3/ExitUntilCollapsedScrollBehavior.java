...
public final class ExitUntilCollapsedScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public static final class C14391 extends Lambda implements Function0<Boolean> {
        public static final C14391 INSTANCE = ;
    ...
    public /* synthetic */ ExitUntilCollapsedScrollBehavior(TopAppBarState topAppBarState, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, Function0 function0, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, animationSpec, decayAnimationSpec, (i & 8) != 0 ? C14391.INSTANCE : function0);
    }
