...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = NavigationBarTokens.INSTANCE.m10521getContainerElevationD9Ej5fM();

    private NavigationBarDefaults() {
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m9577getElevationD9Ej5fM() {
        return Elevation;
    }
