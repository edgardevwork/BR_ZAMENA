...
public final class NavigationBarItemColors {
    ...
    public final long m9584getSelectedIndicatorColor0d7_KjU() {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, @Nullable Composer composer, int i) {
        ...
        State<Color> stateM7665animateColorAsStateeuL9pac = SingleValueAnimationKt.m7665animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m11341equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m11341equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m11341equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m11341equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m11341equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m11341equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m11341equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
    ...
    public final NavigationBarItemColors m9579copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
