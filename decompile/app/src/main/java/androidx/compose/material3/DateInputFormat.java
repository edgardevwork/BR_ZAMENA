...
public final /* data */ class DateInputFormat {
    ...
    @NotNull
    public final DateInputFormat copy(@NotNull String patternWithDelimiters, char delimiter) {
