...
public final class FloatingActionButtonElevationAnimatable {
    ...
    @DebugMetadata(m7119c = "androidx.compose.material3.FloatingActionButtonElevationAnimatable", m7120f = "FloatingActionButton.kt", m7121i = {0, 0}, m7122l = {623}, m7123m = "animateElevation", m7124n = {"this", "to"}, m7125s = {"L$0", "L$1"})
    ...
    public static final class C14551 extends ContinuationImpl {
        ...
        public C14551(Continuation<? super C14551> continuation) {
            super(continuation);
        }
    ...
    /* compiled from: FloatingActionButton.kt */
    @Metadata(m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.material3.FloatingActionButtonElevationAnimatable", m7120f = "FloatingActionButton.kt", m7121i = {0}, m7122l = {TypedValues.MotionType.TYPE_POLAR_RELATIVETO}, m7123m = "snapElevation", m7124n = {"this"}, m7125s = {"L$0"})
    ...
    public static final class C14561 extends ContinuationImpl {
        ...
        public C14561(Continuation<? super C14561> continuation) {
            super(continuation);
        }
    ...
    public final float m9472calculateTargetu2uoSUM(Interaction interaction) {
    ...
    public final Object m9473updateElevationlDy3nrA(float f, float f2, float f3, float f4, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
    ...
    */
    public final Object snapElevation(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            float fM9472calculateTargetu2uoSUM = m9472calculateTargetu2uoSUM(this.targetInteraction);
            if (!C2046Dp.m13671equalsimpl0(this.animatable.getTargetValue().m13680unboximpl(), fM9472calculateTargetu2uoSUM)) {
                try {
                    Animatable<C2046Dp, AnimationVector1D> animatable = this.animatable;
                    C2046Dp c2046DpM13664boximpl = C2046Dp.m13664boximpl(fM9472calculateTargetu2uoSUM);
                    c14561.L$0 = this;
                    c14561.label = 1;
                    if (animatable.snapTo(c2046DpM13664boximpl, c14561) == coroutine_suspended) {
            ...
            floatingActionButtonElevationAnimatable = (FloatingActionButtonElevationAnimatable) c14561.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                floatingActionButtonElevationAnimatable.lastTargetInteraction = floatingActionButtonElevationAnimatable.targetInteraction;
            } catch (Throwable th2) {
    ...
    */
    public final Object animateElevation(@Nullable Interaction interaction, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        C14551 c14551;
        FloatingActionButtonElevationAnimatable floatingActionButtonElevationAnimatable;
        if (continuation instanceof C14551) {
            c14551 = (C14551) continuation;
            int i = c14551.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c14551.label = i - Integer.MIN_VALUE;
            } else {
                c14551 = new C14551(continuation);
            }
        }
        Object obj = c14551.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c14551.label;
        if (i2 != 0) {
            if (i2 != 1) {
            ...
            interaction = (Interaction) c14551.L$1;
            floatingActionButtonElevationAnimatable = (FloatingActionButtonElevationAnimatable) c14551.L$0;
            try {
                ResultKt.throwOnFailure(obj);
        ...
        ResultKt.throwOnFailure(obj);
        float fM9472calculateTargetu2uoSUM = m9472calculateTargetu2uoSUM(interaction);
        ...
        try {
            if (!C2046Dp.m13671equalsimpl0(this.animatable.getTargetValue().m13680unboximpl(), fM9472calculateTargetu2uoSUM)) {
                ...
                c14551.L$0 = this;
                c14551.L$1 = interaction;
                c14551.label = 1;
                if (ElevationKt.m9439animateElevationrAjV9yQ(animatable, fM9472calculateTargetu2uoSUM, interaction2, interaction, c14551) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            floatingActionButtonElevationAnimatable = this;
