...
@DebugMetadata(m7119c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1", m7120f = "Swipeable.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
...
public final class SwipeableKt$swipeable$3$4$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m7119c = "androidx.compose.material.SwipeableKt$swipeable$3$4$1$1", m7120f = "Swipeable.kt", m7121i = {}, m7122l = {625}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    ...
    public static final class C12141 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C12141(SwipeableState<T> swipeableState, float f, Continuation<? super C12141> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C12141(this.$state, this.$velocity, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C12141) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        ResultKt.throwOnFailure(obj);
        BuildersKt__Builders_commonKt.launch$default((CoroutineScope) this.L$0, null, null, new C12141(this.$state, this.F$0, null), 3, null);
        return Unit.INSTANCE;
    }
}
