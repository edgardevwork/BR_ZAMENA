...
public final class AltRouteKt {
    ...
    @NotNull
    public static final ImageVector getAltRoute(@NotNull Icons.AutoMirrored.Filled filled) {
        ImageVector imageVector = _altRoute;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.AltRoute", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
