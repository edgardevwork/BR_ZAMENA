...
public final class OutboundKt {
    ...
    @NotNull
    public static final ImageVector getOutbound(@NotNull Icons.AutoMirrored.Filled filled) {
        ImageVector imageVector = _outbound;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.Outbound", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
