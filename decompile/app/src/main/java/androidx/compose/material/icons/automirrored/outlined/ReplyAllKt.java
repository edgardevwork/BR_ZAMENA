...
public final class ReplyAllKt {
    ...
    @NotNull
    public static final ImageVector getReplyAll(@NotNull Icons.AutoMirrored.Outlined outlined) {
        ImageVector imageVector = _replyAll;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.ReplyAll", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
