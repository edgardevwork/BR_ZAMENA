...
public final class FormatListBulletedKt {
    ...
    @NotNull
    public static final ImageVector getFormatListBulleted(@NotNull Icons.AutoMirrored.TwoTone twoTone) {
        ImageVector imageVector = _formatListBulleted;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.FormatListBulleted", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
