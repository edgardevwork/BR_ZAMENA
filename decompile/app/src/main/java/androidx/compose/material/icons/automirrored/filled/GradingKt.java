...
public final class GradingKt {
    ...
    @NotNull
    public static final ImageVector getGrading(@NotNull Icons.AutoMirrored.Filled filled) {
        ImageVector imageVector = _grading;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.Grading", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
