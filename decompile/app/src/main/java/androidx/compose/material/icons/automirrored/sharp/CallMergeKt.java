...
public final class CallMergeKt {
    ...
    @NotNull
    public static final ImageVector getCallMerge(@NotNull Icons.AutoMirrored.Sharp sharp) {
        ImageVector imageVector = _callMerge;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Sharp.CallMerge", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
