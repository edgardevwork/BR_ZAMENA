...
public final class SpringSimulation {
    ...
    public final long m7705updateValuesIJZedt4$animation_core_release(float lastDisplacement, float lastVelocity, long timeElapsed) {
        double dCos;
        double dExp;
        init();
        float f = lastDisplacement - this.finalPosition;
