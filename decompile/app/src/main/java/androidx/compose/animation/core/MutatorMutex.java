...
public final class MutatorMutex {
    ...
    /* compiled from: InternalMutatorMutex.kt */
    @Metadata(m7104d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0000J\u0006\u0010\u000e\u001a\u00020\u000fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0010"}, m7105d2 = {"Landroidx/compose/animation/core/MutatorMutex$Mutator;", "", "priority", "Landroidx/compose/animation/core/MutatePriority;", "job", "Lkotlinx/coroutines/Job;", "(Landroidx/compose/animation/core/MutatePriority;Lkotlinx/coroutines/Job;)V", "getJob", "()Lkotlinx/coroutines/Job;", "getPriority", "()Landroidx/compose/animation/core/MutatePriority;", "canInterrupt", "", "other", "cancel", "", "animation-core_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
    ...
    @DebugMetadata(m7119c = "androidx.compose.animation.core.MutatorMutex$mutate$2", m7120f = "InternalMutatorMutex.kt", m7121i = {0, 0, 1, 1}, m7122l = {H262Reader.START_GROUP, 132}, m7123m = "invokeSuspend", m7124n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m7125s = {"L$0", "L$1", "L$0", "L$1"})
    ...
    public static final class C03252<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        public C03252(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super C03252> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C03252 c03252 = new C03252(this.$priority, this.this$0, this.$block, continuation);
            c03252.L$0 = obj;
            return c03252;
        }
                ...
                try {
                    if (r1 == 0) {
                        ...
                        if (r1 != 1) {
                            ...
                            try {
                                ResultKt.throwOnFailure(obj);
                                MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(mutatorMutex2.currentMutator, mutator2, null);
                                mutex2.unlock(null);
                                return obj;
                            } catch (Throwable th2) {
                                th = th2;
    ...
    public final <R> Object mutate(@NotNull MutatePriority mutatePriority, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1, @NotNull Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C03252(mutatePriority, this, function1, null), continuation);
    }
    ...
    @DebugMetadata(m7119c = "androidx.compose.animation.core.MutatorMutex$mutateWith$2", m7120f = "InternalMutatorMutex.kt", m7121i = {0, 0, 1, 1}, m7122l = {H262Reader.START_GROUP, BcBands.LOOKUPSWITCH}, m7123m = "invokeSuspend", m7124n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m7125s = {"L$0", "L$1", "L$0", "L$1"})
    ...
    /* loaded from: classes4.dex */
    public static final class C03262<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C03262(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C03262> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = mutatorMutex;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C03262 c03262 = new C03262(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c03262.L$0 = obj;
            return c03262;
        }
    ...
    public final <T, R> Object mutateWith(T t, @NotNull MutatePriority mutatePriority, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, @NotNull Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C03262(mutatePriority, this, function2, t, null), continuation);
    }
}
