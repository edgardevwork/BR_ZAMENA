...
public final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo7599measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> list, long j) {
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m13828boximpl(IntSizeKt.IntSize(width3, height3)));
