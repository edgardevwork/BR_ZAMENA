...
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        ...
        return Motion.m7699getValueimpl(this.spring.m7705updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, playTimeNanos / 1000000));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        this.spring.setFinalPosition(targetValue);
        return Motion.m7700getVelocityimpl(this.spring.m7705updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, playTimeNanos / 1000000));
    }
