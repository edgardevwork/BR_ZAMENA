...
final /* data */ class LayoutElement extends ModifierNodeElement<LayoutModifierImpl> {
    ...
    @NotNull
    public final LayoutElement copy(@NotNull Function3<? super MeasureScope, ? super Measurable, ? super Constraints, ? extends MeasureResult> measure) {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull LayoutModifierImpl node) {
