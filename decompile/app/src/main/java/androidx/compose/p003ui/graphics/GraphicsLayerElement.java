...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Float.compare(this.scaleX, graphicsLayerElement.scaleX) == 0 && Float.compare(this.scaleY, graphicsLayerElement.scaleY) == 0 && Float.compare(this.alpha, graphicsLayerElement.alpha) == 0 && Float.compare(this.translationX, graphicsLayerElement.translationX) == 0 && Float.compare(this.translationY, graphicsLayerElement.translationY) == 0 && Float.compare(this.shadowElevation, graphicsLayerElement.shadowElevation) == 0 && Float.compare(this.rotationX, graphicsLayerElement.rotationX) == 0 && Float.compare(this.rotationY, graphicsLayerElement.rotationY) == 0 && Float.compare(this.rotationZ, graphicsLayerElement.rotationZ) == 0 && Float.compare(this.cameraDistance, graphicsLayerElement.cameraDistance) == 0 && TransformOrigin.m11724equalsimpl0(this.transformOrigin, graphicsLayerElement.transformOrigin) && Intrinsics.areEqual(this.shape, graphicsLayerElement.shape) && this.clip == graphicsLayerElement.clip && Intrinsics.areEqual(this.renderEffect, graphicsLayerElement.renderEffect) && Color.m11341equalsimpl0(this.ambientShadowColor, graphicsLayerElement.ambientShadowColor) && Color.m11341equalsimpl0(this.spotShadowColor, graphicsLayerElement.spotShadowColor) && CompositingStrategy.m11425equalsimpl0(this.compositingStrategy, graphicsLayerElement.compositingStrategy);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        int iHashCode = ((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m11727hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31;
        RenderEffect renderEffect = this.renderEffect;
        return ((((((iHashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m11347hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m11347hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m11426hashCodeimpl(this.compositingStrategy);
    }
    ...
    public final long m11497getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m11494getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU, reason: not valid java name */
    public final long m11496getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getCompositingStrategy--NrFUSI, reason: not valid java name */
    public final int m11495getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public void update(@NotNull SimpleGraphicsLayerModifier node) {
        ...
        node.m11673setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m11670setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m11672setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m11671setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m11717boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m11330boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m11330boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m11422boximpl(this.compositingStrategy));
    }
}
