...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m13835getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m13836getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final float getHorizontalPosition(int i, boolean usePrimaryDirection) {
        return this.multiParagraph.getHorizontalPosition(i, usePrimaryDirection);
    }
    ...
    public final int m13137getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m13042getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m13139getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m13043getWordBoundaryjx7JFs(i);
    }
    ...
    public final Path getPathForRange(int i, int end) {
        return this.multiParagraph.getPathForRange(i, end);
    }

    /* renamed from: copy-O0kMr_c$default */
    public static /* synthetic */ TextLayoutResult m13135copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m13136copyO0kMr_c(textLayoutInput, j);
    }

    @NotNull
    /* renamed from: copy-O0kMr_c */
    public final TextLayoutResult m13136copyO0kMr_c(@NotNull TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m13834equalsimpl0(this.size, textLayoutResult.size) && this.firstBaseline == textLayoutResult.firstBaseline && this.lastBaseline == textLayoutResult.lastBaseline && Intrinsics.areEqual(this.placeholderRects, textLayoutResult.placeholderRects);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m13837hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    @NotNull
    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m13839toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
