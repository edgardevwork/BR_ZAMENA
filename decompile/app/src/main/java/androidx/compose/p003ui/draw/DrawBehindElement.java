...
final /* data */ class DrawBehindElement extends ModifierNodeElement<DrawBackgroundModifier> {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull DrawBackgroundModifier node) {
