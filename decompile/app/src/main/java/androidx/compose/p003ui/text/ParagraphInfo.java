...
public final /* data */ class ParagraphInfo {
    ...
    public final long m13055toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m11099getXimpl(j), Offset.m11100getYimpl(j) - this.top);
    }

    @NotNull
    public final Rect toGlobal(@NotNull Rect rect) {
        return rect.m11136translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    @NotNull
    public final Path toGlobal(@NotNull Path path) {
        path.mo11235translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m13054toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m13165getStartimpl(j)), toGlobalIndex(TextRange.m13160getEndimpl(j)));
    }
}
