...
public abstract class ModifierNodeElement<N extends Modifier.Node> implements Modifier.Element, InspectableValue {
    ...
    public abstract void update(@NotNull N node);
