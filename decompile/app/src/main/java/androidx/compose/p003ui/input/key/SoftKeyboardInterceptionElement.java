...
final /* data */ class SoftKeyboardInterceptionElement extends ModifierNodeElement<InterceptedKeyInputNode> {
    ...
    @NotNull
    public final SoftKeyboardInterceptionElement copy(@Nullable Function1<? super KeyEvent, Boolean> onKeyEvent, @Nullable Function1<? super KeyEvent, Boolean> onPreKeyEvent) {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull InterceptedKeyInputNode node) {
