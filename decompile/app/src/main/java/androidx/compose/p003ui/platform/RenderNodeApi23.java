...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(@NotNull AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m11429getAutoNrFUSI();
    ...
    public void mo12928setCompositingStrategyaDBOjCE(int i) {
        CompositingStrategy.Companion companion = CompositingStrategy.INSTANCE;
        if (CompositingStrategy.m11425equalsimpl0(i, companion.m11431getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m11425equalsimpl0(i, companion.m11430getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m11425equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m11431getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path clipPath, @NotNull Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m11311clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
    ...
    @Override // androidx.compose.p003ui.platform.DeviceRenderNode
    public void drawInto(@NotNull android.graphics.Canvas canvas) {
    ...
    /* compiled from: RenderNodeApi23.android.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\u0005\u001a\u00020\u0004X\u0080\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\n"}, m7105d2 = {"Landroidx/compose/ui/platform/RenderNodeApi23$Companion;", "", "()V", "needToValidateAccess", "", "testFailCreateRenderNode", "getTestFailCreateRenderNode$ui_release", "()Z", "setTestFailCreateRenderNode$ui_release", "(Z)V", "ui_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
