...
public final class ComposedModifierKt {
    ...
    /* compiled from: ComposedModifier.kt */
    @Metadata(m7104d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m7105d2 = {"<anonymous>", "", "it", "Landroidx/compose/ui/Modifier$Element;", "invoke", "(Landroidx/compose/ui/Modifier$Element;)Ljava/lang/Boolean;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    /* renamed from: androidx.compose.ui.ComposedModifierKt$materialize$1 */
    /* loaded from: classes.dex */
    public static final class C18401 extends Lambda implements Function1<Modifier.Element, Boolean> {
        public static final C18401 INSTANCE = ;
    ...
    @NotNull
    public static final Modifier materializeModifier(@NotNull final Composer composer, @NotNull Modifier modifier) {
        if (modifier.all(C18401.INSTANCE)) {
            return modifier;
        }
        ...
        Modifier modifier2 = (Modifier) modifier.foldIn(Modifier.INSTANCE, new Function2<Modifier, Modifier.Element, Modifier>() { // from class: androidx.compose.ui.ComposedModifierKt$materialize$result$1
            ...
            public final Modifier invoke(@NotNull Modifier modifier3, @NotNull Modifier.Element element) {
                ...
                if (z) {
                    ...
                    modifierMaterializeModifier = ComposedModifierKt.materializeModifier(composer, (Modifier) ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(factory, 3)).invoke(Modifier.INSTANCE, composer, 0));
                }
                return modifier3.then(modifierMaterializeModifier);
            }
        });
