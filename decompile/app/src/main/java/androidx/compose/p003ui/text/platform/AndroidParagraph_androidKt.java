...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m13417ActualParagraphO3s9Psw(@NotNull String str, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<SpanStyle>> list, @NotNull List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z, long j, @NotNull Density density, @NotNull FontFamily.Resolver resolver) {
    ...
    public static final Paragraph m13416ActualParagraphhBUhpc(@NotNull ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
