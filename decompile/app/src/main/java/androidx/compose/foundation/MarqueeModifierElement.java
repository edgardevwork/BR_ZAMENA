...
final /* data */ class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    public static /* synthetic */ MarqueeModifierElement m7853copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        return marqueeModifierElement.m7856copylWfNwf4(i, i6, i7, i8, marqueeSpacing2, f);
    }
    ...
    public final MarqueeModifierElement m7856copylWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, @NotNull MarqueeSpacing spacing, float velocity) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m7845equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual(this.spacing, marqueeModifierElement.spacing) && C2046Dp.m13671equalsimpl0(this.velocity, marqueeModifierElement.velocity);
    }

    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((Integer.hashCode(this.iterations) * 31) + MarqueeAnimationMode.m7846hashCodeimpl(this.animationMode)) * 31) + Integer.hashCode(this.delayMillis)) * 31) + Integer.hashCode(this.initialDelayMillis)) * 31) + this.spacing.hashCode()) * 31) + C2046Dp.m13672hashCodeimpl(this.velocity);
    }

    @NotNull
    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + ((Object) MarqueeAnimationMode.m7847toStringimpl(this.animationMode)) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + ((Object) C2046Dp.m13677toStringimpl(this.velocity)) + ')';
    }
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull MarqueeModifierNode node) {
        node.m7859updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("animationMode", MarqueeAnimationMode.m7842boximpl(this.animationMode));
        ...
        inspectorInfo.getProperties().set("velocity", C2046Dp.m13664boximpl(this.velocity));
    }
}
