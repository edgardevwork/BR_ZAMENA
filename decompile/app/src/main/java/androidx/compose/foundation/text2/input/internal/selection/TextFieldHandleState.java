...
public final /* data */ class TextFieldHandleState {
    ...
    @NotNull
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.INSTANCE.m11114getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    ...
    public static /* synthetic */ TextFieldHandleState m8724copyubNVwUQ$default(TextFieldHandleState textFieldHandleState, boolean z, long j, ResolvedTextDirection resolvedTextDirection, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldHandleState.m8726copyubNVwUQ(z, j2, resolvedTextDirection2, z2);
    }
    ...
    public final TextFieldHandleState m8726copyubNVwUQ(boolean visible, long position, @NotNull ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m11096equalsimpl0(this.position, textFieldHandleState.position) && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }

    public int hashCode() {
        return (((((Boolean.hashCode(this.visible) * 31) + Offset.m11101hashCodeimpl(this.position)) * 31) + this.direction.hashCode()) * 31) + Boolean.hashCode(this.handlesCrossed);
    }

    @NotNull
    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m11107toStringimpl(this.position)) + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
    ...
    public final long m8727getPositionF1C5BW0() {
        return this.position;
    }
