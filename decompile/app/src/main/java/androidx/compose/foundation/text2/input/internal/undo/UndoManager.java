...
public final class UndoManager<T> {
    ...
    public final void record(T undoableAction) {
        ...
        while (getSize() > this.capacity - 1) {
            CollectionsKt__MutableCollectionsKt.removeFirst(this.undoStack);
        }
    ...
    public final T undo() {
        ...
        T t = (T) CollectionsKt__MutableCollectionsKt.removeLast(this.undoStack);
    ...
    public final T redo() {
        ...
        T t = (T) CollectionsKt__MutableCollectionsKt.removeLast(this.redoStack);
    ...
    /* compiled from: UndoManager.kt */
    @Metadata(m7104d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J7\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u00020\u00010\u0004\"\u0006\b\u0001\u0010\u0006\u0018\u00012\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\u00010\u0004H\u0086\b¨\u0006\b"}, m7105d2 = {"Landroidx/compose/foundation/text2/input/internal/undo/UndoManager$Companion;", "", "()V", "createSaver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text2/input/internal/undo/UndoManager;", ExifInterface.GPS_DIRECTION_TRUE, "itemSaver", "foundation_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
        ...
        public final /* synthetic */ <T> Saver<UndoManager<T>, Object> createSaver(final Saver<T, Object> itemSaver) {
            ...
            return new Saver<UndoManager<T>, Object>() { // from class: androidx.compose.foundation.text2.input.internal.undo.UndoManager$Companion$createSaver$1
                ...
                public UndoManager<T> restore(@NotNull Object value) {
                    ...
                    return new UndoManager<>(listBuild, CollectionsKt__CollectionsJVMKt.build(listCreateListBuilder2), iIntValue);
                }
            };
        }
    }
