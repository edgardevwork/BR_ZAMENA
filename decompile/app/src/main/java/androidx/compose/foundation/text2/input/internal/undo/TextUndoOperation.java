...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text2.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        @NotNull
        public Object save(@NotNull SaverScope saverScope, @NotNull TextUndoOperation textUndoOperation) {
            return CollectionsKt__CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m13165getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m13160getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m13165getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m13160getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m13159getCollapsedimpl(this.postSelection)) {
            if (TextRange.m13159getCollapsedimpl(this.preSelection)) {
                if (TextRange.m13165getStartimpl(this.preSelection) > TextRange.m13165getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m13165getStartimpl(this.preSelection) == TextRange.m13165getStartimpl(this.postSelection) && TextRange.m13165getStartimpl(this.preSelection) == this.index) {
