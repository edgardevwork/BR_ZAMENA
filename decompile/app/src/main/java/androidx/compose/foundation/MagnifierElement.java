...
public final class MagnifierElement extends ModifierNodeElement<MagnifierNode> {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull MagnifierNode node) {
        node.m7836update5F03MCQ(this.sourceCenter, this.magnifierCenter, this.zoom, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, this.onSizeChanged, this.platformMagnifierFactory);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((((((((iHashCode + (function1 != null ? function1.hashCode() : 0)) * 31) + Float.hashCode(this.zoom)) * 31) + Boolean.hashCode(this.useTextDefault)) * 31) + DpSize.m13766hashCodeimpl(this.size)) * 31) + C2046Dp.m13672hashCodeimpl(this.cornerRadius)) * 31) + C2046Dp.m13672hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31;
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("size", DpSize.m13752boximpl(this.size));
        inspectorInfo.getProperties().set("cornerRadius", C2046Dp.m13664boximpl(this.cornerRadius));
        inspectorInfo.getProperties().set("elevation", C2046Dp.m13664boximpl(this.elevation));
