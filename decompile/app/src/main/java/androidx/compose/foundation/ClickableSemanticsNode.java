...
public final class ClickableSemanticsNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public ClickableSemanticsNode(boolean z, String str, Role role, Function0<Unit> function0, String str2, Function0<Unit> function02) {
        this.enabled = z;
    ...
    public final void m7817updateUMe6uN4(boolean enabled, @Nullable String onClickLabel, @Nullable Role role, @NotNull Function0<Unit> onClick, @Nullable String onLongClickLabel, @Nullable Function0<Unit> onLongClick) {
