...
@DebugMetadata(m7119c = "androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2", m7120f = "TransformableState.kt", m7121i = {}, m7122l = {H263Reader.START_CODE_VALUE_VOP}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
...
public final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m11088boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset offsetM11088boximpl = Offset.m11088boximpl(this.$offset);
            ...
            Function1<AnimationScope<Offset, AnimationVector2D>, Unit> function1 = new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                ...
                public final void invoke2(@NotNull AnimationScope<Offset, AnimationVector2D> animationScope) {
                    TransformScope.m7980transformByd4ec7I$default(transformScope, 0.0f, Offset.m11103minusMKHz9U(animationScope.getValue().getPackedValue(), longRef.element), 0.0f, 5, null);
                    longRef.element = animationScope.getValue().getPackedValue();
                }
            };
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, offsetM11088boximpl, animationSpec, false, function1, this, 4, null) == coroutine_suspended) {
