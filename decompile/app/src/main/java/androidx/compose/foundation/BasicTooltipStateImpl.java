...
public final class BasicTooltipStateImpl implements BasicTooltipState {
    ...
    public Object show(@NotNull MutatePriority mutatePriority, @NotNull Continuation<? super Unit> continuation) {
        Object objMutate = this.mutatorMutex.mutate(mutatePriority, new C03702(new BasicTooltipStateImpl$show$cancellableShow$1(this, null), null), continuation);
    ...
    @DebugMetadata(m7119c = "androidx.compose.foundation.BasicTooltipStateImpl$show$2", m7120f = "BasicTooltip.kt", m7121i = {}, m7122l = {156, Cea708Decoder.COMMAND_DF6}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.BasicTooltipStateImpl$show$2 */
    public static final class C03702 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        public final /* synthetic */ Function1<Continuation<? super Unit>, Object> $cancellableShow;
        public int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C03702(Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C03702> continuation) {
        ...
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return BasicTooltipStateImpl.this.new C03702(this.$cancellableShow, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        @Nullable
        public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
            return ((C03702) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        @DebugMetadata(m7119c = "androidx.compose.foundation.BasicTooltipStateImpl$show$2$1", m7120f = "BasicTooltip.kt", m7121i = {}, m7122l = {159}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
