...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements PersistentList.Builder<E> {
    ...
    private final Object[] makeMutable(Object[] buffer) {
        ...
        return isMutable(buffer) ? buffer : ArraysKt___ArraysJvmKt.copyInto$default(buffer, mutableBuffer(), 0, 0, RangesKt___RangesKt.coerceAtMost(buffer.length, 32), 6, (Object) null);
    }

    private final Object[] makeMutableShiftingRight(Object[] buffer, int distance) {
        if (isMutable(buffer)) {
            return ArraysKt___ArraysJvmKt.copyInto(buffer, buffer, distance, 0, 32 - distance);
        }
        return ArraysKt___ArraysJvmKt.copyInto(buffer, mutableBuffer(), distance, 0, 32 - distance);
    }
    ...
    private final void insertIntoTail(Object[] root, int index, E element) {
        ...
        Object[] objArrMakeMutable = makeMutable(this.tail);
        if (iTailSize < 32) {
            ArraysKt___ArraysJvmKt.copyInto(this.tail, objArrMakeMutable, index + 1, index, iTailSize);
        ...
        ArraysKt___ArraysJvmKt.copyInto(objArr, objArrMakeMutable, index + 1, index, 31);
        objArrMakeMutable[index] = element;
    ...
    private final Object[] insertIntoRoot(Object[] root, int shift, int index, Object element, ObjectRef elementCarry) {
        ...
        if (shift == 0) {
            ...
            Object[] objArrCopyInto = ArraysKt___ArraysJvmKt.copyInto(root, makeMutable(root), iIndexSegment + 1, iIndexSegment, 31);
    ...
    public boolean addAll(int index, @NotNull Collection<? extends E> elements) {
        ...
        if (size == 0) {
            CommonFunctionsKt.m10956assert(index >= rootSize());
            int i2 = index & 31;
            int size2 = ((index + elements.size()) - 1) & 31;
            Object[] objArr = this.tail;
            Object[] objArrCopyInto2 = ArraysKt___ArraysJvmKt.copyInto(objArr, makeMutable(objArr), size2 + 1, i2, tailSize());
        ...
        if (index >= rootSize()) {
            ...
            objArrCopyInto = ArraysKt___ArraysJvmKt.copyInto(this.tail, mutableBuffer(), 0, i4, iTailSize);
            int i5 = 32 - i4;
    ...
    private final Object[] shiftLeafBuffers(int startLeafIndex, int rightShift, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        while (listIteratorLeafBufferIterator.previousIndex() != startLeafIndex) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(objArrPrevious, nextBuffer, 0, 32 - rightShift, 32);
    ...
    private final void splitToBuffers(Collection<? extends E> elements, int index, Object[] startBuffer, int startBufferSize, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        if (i2 < 32) {
            ArraysKt___ArraysJvmKt.copyInto(objArrMakeMutable, nextBuffer, size + 1, i, startBufferSize);
        } else {
            int i3 = i2 - 31;
            if (nullBuffers == 1) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(objArrMakeMutable, nextBuffer, 0, i4, startBufferSize);
            ArraysKt___ArraysJvmKt.copyInto(objArrMakeMutable, objArrMutableBuffer, size + 1, i, i4);
    ...
    private final Object removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        ...
        CommonFunctionsKt.m10956assert(index < size);
        if (size == 1) {
        ...
        Object[] objArrCopyInto = ArraysKt___ArraysJvmKt.copyInto(objArr, makeMutable(objArr), index, index + 1, size);
    ...
    private final Object[] removeFromRootAt(Object[] root, int shift, int index, ObjectRef tailCarry) {
        ...
        if (shift == 0) {
            ...
            Object[] objArrCopyInto = ArraysKt___ArraysJvmKt.copyInto(root, makeMutable(root), iIndexSegment, iIndexSegment + 1, 32);
    ...
    private final boolean removeAll(Function1<? super E, Boolean> predicate) {
        ...
        if (iRemoveAll == 32) {
            CommonFunctionsKt.m10956assert(!listIteratorLeafBufferIterator.hasNext());
    ...
    private final Object[] nullifyAfter(Object[] root, int index, int shift) {
        ...
        if (iIndexSegment < 31) {
            ...
            if (root[i] != null) {
                if (isMutable(root)) {
                    ArraysKt___ArraysJvmKt.fill(root, (Object) null, i, 32);
                }
                root = ArraysKt___ArraysJvmKt.copyInto(root, mutableBuffer(), 0, 0, i);
            }
        }
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> predicate, int tailSize, ObjectRef bufferRef) {
        ...
        if (iRemoveAll == tailSize) {
            CommonFunctionsKt.m10956assert(bufferRef.getValue() == this.tail);
            return tailSize;
        }
