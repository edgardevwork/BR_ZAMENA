...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m10869boximpl(Composer composer) {
        return new Updater(composer);
    }

    @NotNull
    /* renamed from: constructor-impl */
    public static <T> Composer m10870constructorimpl(@NotNull Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl */
    public static boolean m10871equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m10872equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m10873hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl */
    public static String m10878toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m10871equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m10873hashCodeimpl(this.composer);
    }

    public String toString() {
        return m10878toStringimpl(this.composer);
    }
    ...
    public static final void m10876setimpl(Composer composer, int i, @NotNull Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl */
    public static final <V> void m10877setimpl(Composer composer, V v, @NotNull Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m10879updateimpl(Composer composer, int i, @NotNull Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl */
    public static final <V> void m10880updateimpl(Composer composer, V v, @NotNull Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m10874initimpl(Composer composer, @NotNull final Function1<? super T, Unit> function1) {
    ...
    public static final void m10875reconcileimpl(Composer composer, @NotNull final Function1<? super T, Unit> function1) {
