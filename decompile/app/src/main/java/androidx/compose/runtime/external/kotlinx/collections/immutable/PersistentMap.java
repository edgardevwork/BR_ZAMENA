...
public interface PersistentMap<K, V> extends ImmutableMap<K, V> {
    ...
    @Override // java.util.Map
    @NotNull
    PersistentMap<K, V> putAll(@NotNull Map<? extends K, ? extends V> m);
