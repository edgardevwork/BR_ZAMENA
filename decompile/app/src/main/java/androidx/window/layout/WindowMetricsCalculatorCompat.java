...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    @NotNull
    public WindowMetrics computeCurrentWindowMetrics(@NotNull Activity activity) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public final void getRectSizeFromDisplay(Activity activity, Rect bounds) {
    ...
    public final DisplayCutout getCutoutForDisplay(Display display) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            if (WindowMetricsCalculatorCompat$$ExternalSyntheticApiModelOutline0.m948m(obj)) {
                return WindowMetricsCalculatorCompat$$ExternalSyntheticApiModelOutline1.m949m(obj);
            }
            return null;
