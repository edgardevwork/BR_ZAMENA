...
public final class SplitPairFilter {
    ...
    @Nullable
    public final String secondaryActivityAction;
    ...
    public SplitPairFilter(@NotNull ComponentName primaryActivityName, @NotNull ComponentName secondaryActivityName, @Nullable String str) {
        ...
        if (StringsKt__StringsKt.contains$default(str2, charSequence, z, i, obj) && StringsKt__StringsKt.indexOf$default((CharSequence) str2, "*", 0, false, 6, (Object) null) != str2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in class name is only allowed at the end.".toString());
        }
    }
