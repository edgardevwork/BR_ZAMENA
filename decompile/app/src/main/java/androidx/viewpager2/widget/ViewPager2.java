...
import androidx.viewpager2.C3273R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    public final void initialize(Context context, AttributeSet attributeSet) throws IllegalStateException {
    ...
    public final void setOrientation(Context context, AttributeSet attributeSet) {
        int[] iArr = C3273R.styleable.ViewPager2;
        ...
        try {
            setOrientation(typedArrayObtainStyledAttributes.getInt(C3273R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    public final void registerCurrentItemDataSetTracker(@Nullable RecyclerView.Adapter<?> adapter) {
        if (adapter != null) {
            adapter.registerAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    public final void unregisterCurrentItemDataSetTracker(@Nullable RecyclerView.Adapter<?> adapter) {
        if (adapter != null) {
