...
public class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) throws Resources.NotFoundException {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(C0213R.layout.browser_actions_context_menu_row, (ViewGroup) null);
            ImageView imageView = (ImageView) view.findViewById(C0213R.id.browser_actions_menu_item_icon);
            TextView textView = (TextView) view.findViewById(C0213R.id.browser_actions_menu_item_text);
