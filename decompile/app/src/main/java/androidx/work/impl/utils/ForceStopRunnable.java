...
public class ForceStopRunnable implements Runnable {
            ...
            if (i >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i2 = 0; i2 < historicalProcessExitReasons.size(); i2++) {
                        ApplicationExitInfo applicationExitInfoM955m = ForceStopRunnable$$ExternalSyntheticApiModelOutline1.m955m(historicalProcessExitReasons.get(i2));
                        if (applicationExitInfoM955m.getReason() == 10 && applicationExitInfoM955m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
    ...
    public static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, Build.VERSION.SDK_INT >= 31 ? 167772160 : C2732C.BUFFER_FLAG_FIRST_SAMPLE);
