...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract Flow<WorkInfo> getWorkInfoByIdFlow(@NonNull UUID id);
    ...
    @NonNull
    public abstract Flow<List<WorkInfo>> getWorkInfosByTagFlow(@NonNull String tag);
    ...
    @NonNull
    public abstract Flow<List<WorkInfo>> getWorkInfosForUniqueWorkFlow(@NonNull String uniqueWorkName);
