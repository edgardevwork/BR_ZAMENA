...
public class GhostViewPlatform implements GhostView {
    ...
    public static void fetchAddGhostMethod() throws NoSuchMethodException, SecurityException {
    ...
    public static void fetchRemoveGhostMethod() throws NoSuchMethodException, SecurityException {
