...
public class VelocityTracker1D {
    public static final int ASSUME_POINTER_MOVE_STOPPED_MILLIS = 40;
    public static final int HISTORY_SIZE = 20;
    public static final int HORIZON_MILLIS = 100;
    ...
    public final float kineticEnergyToVelocity(float f) {
