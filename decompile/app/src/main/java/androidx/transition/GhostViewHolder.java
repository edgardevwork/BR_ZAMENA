...
public class GhostViewHolder extends FrameLayout {
    ...
    public GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(C3239R.id.ghost_view_holder, this);
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(C3239R.id.ghost_view_holder, null);
    ...
    public static GhostViewHolder getHolder(@NonNull ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(C3239R.id.ghost_view_holder);
    }
