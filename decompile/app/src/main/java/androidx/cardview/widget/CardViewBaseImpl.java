...
public class CardViewBaseImpl implements CardViewImpl {
    ...
    public final RoundRectDrawableWithShadow createBackground(Context context, ColorStateList colorStateList, float f, float f2, float f3) {
    ...
    public final RoundRectDrawableWithShadow getShadowBackground(CardViewDelegate cardViewDelegate) {
