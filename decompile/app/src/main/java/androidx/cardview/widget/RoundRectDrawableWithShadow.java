...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0232R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0232R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0232R.dimen.cardview_compat_inset_shadow);
