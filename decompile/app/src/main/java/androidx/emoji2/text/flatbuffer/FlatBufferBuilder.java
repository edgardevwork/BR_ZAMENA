...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f292bb = byteBuffer;
            byteBuffer.clear();
            this.f292bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f292bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f292bb.capacity();
    }
    ...
    public int offset() {
        return this.f292bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f292bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f292bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f292bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f292bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f292bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f292bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f292bb.getShort(iCapacity);
            if (s == this.f292bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f292bb.getShort(iCapacity + i7) != this.f292bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int iCapacity2 = this.f292bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f292bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f292bb.capacity() - i;
        if (this.f292bb.getShort((iCapacity - this.f292bb.getInt(iCapacity)) + i2) != 0) {
            return;
        }
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f292bb.capacity() - this.space);
        }
        this.f292bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f292bb.position(i);
        this.f292bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f292bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f292bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f292bb.capacity());
