...
public final class MetadataList extends Table {
    ...
    public MetadataItem list(MetadataItem metadataItem, int i) {
        ...
        if (i__offset != 0) {
            return metadataItem.__assign(__indirect(__vector(i__offset) + (i * 4)), this.f297bb);
        }
        return null;
    }
    ...
    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int i__offset = __offset(6);
        if (i__offset != 0) {
            return vector.__assign(__vector(i__offset), 4, this.f297bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i) {
            return metadataList.__assign(Table.__indirect(__element(i), this.f291bb), this.f291bb);
        }
    }
}
