...
public final class MetadataItem extends Table {
    ...
    public int m612id() {
        ...
        if (i__offset != 0) {
            return this.f297bb.getInt(i__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (i__offset == 0 || this.f297bb.get(i__offset + this.bb_pos) == 0) ? false : true;
    }

    public short sdkAdded() {
        int i__offset = __offset(8);
        if (i__offset != 0) {
            return this.f297bb.getShort(i__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (i__offset != 0) {
            return this.f297bb.getInt(__vector(i__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int i__offset = __offset(16);
        if (i__offset != 0) {
            return intVector.__assign(__vector(i__offset), this.f297bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(Table.__indirect(__element(i), this.f291bb), this.f291bb);
        }
    }
}
