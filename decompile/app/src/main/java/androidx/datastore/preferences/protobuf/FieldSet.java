...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C24601 c24601) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C24601) null);
    }
    ...
    public final void verifyType(WireFormat.FieldType fieldType, Object obj) {
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C24601.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 7:
    ...
    public final void writeMessageSetTo(Map.Entry<T, Object> entry, CodedOutputStream codedOutputStream) throws IOException {
        T key = entry.getKey();
    ...
    public static /* synthetic */ class C24601 {
    ...
    public static void writeElementNoTag(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, Object obj) throws IOException {
        switch (C24601.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public /* synthetic */ Builder(C24601 c24601) {
            this();
        }
