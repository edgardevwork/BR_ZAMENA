...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f271id] = fieldType52;
        }
    }
    ...
    public FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C24611.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i4 == 1 || i4 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C24611.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }

    /* renamed from: androidx.datastore.preferences.protobuf.FieldType$1 */
    public static /* synthetic */ class C24611 {
