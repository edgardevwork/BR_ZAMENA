...
public class ExifInterface {
    ...
    public static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, TarConstants.LF_GNUTYPE_LONGNAME, 89, TarConstants.LF_MULTIVOLUME, FramedLZ4CompressorInputStream.SKIPPABLE_FRAME_PREFIX_BYTE_MASK, 0};
    public static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, TarConstants.LF_GNUTYPE_LONGNAME, 89, TarConstants.LF_MULTIVOLUME, FramedLZ4CompressorInputStream.SKIPPABLE_FRAME_PREFIX_BYTE_MASK, 85, TarConstants.LF_GNUTYPE_SPARSE, 0, 73, 73};
    public static final byte[] PNG_SIGNATURE = {-119, FramedLZ4CompressorInputStream.SKIPPABLE_FRAME_PREFIX_BYTE_MASK, 78, 71, 13, 10, Ascii.SUB, 10};
    ...
    public static final byte[] WEBP_SIGNATURE_2 = {87, 69, 66, FramedLZ4CompressorInputStream.SKIPPABLE_FRAME_PREFIX_BYTE_MASK};
    ...
    static {
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, BZip2Constants.MAX_ALPHA_SIZE, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, BottomAppBarTopEdgeTreatment.ANGLE_UP, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, AudioAttributesCompat.FLAG_ALL_PUBLIC, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, DefaultImageHeaderParser.ORIENTATION_TAG_TYPE, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, InputDeviceCompat.SOURCE_DPAD, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void loadAttributes(@NonNull InputStream inputStream) {
        boolean z;
        if (inputStream == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x00f3 A[Catch: all -> 0x0103, Exception -> 0x0106, TryCatch #19 {Exception -> 0x0106, all -> 0x0103, blocks: (B:68:0x00ef, B:70:0x00f3, B:77:0x0110, B:76:0x0108), top: B:122:0x00ef }] */
    /* JADX WARN: Removed duplicated region for block: B:76:0x0108 A[Catch: all -> 0x0103, Exception -> 0x0106, TryCatch #19 {Exception -> 0x0106, all -> 0x0103, blocks: (B:68:0x00ef, B:70:0x00f3, B:77:0x0110, B:76:0x0108), top: B:122:0x00ef }] */
    ...
    */
    ...
    public static Long parseDateTime(@Nullable String str, @Nullable String str2, @Nullable String str3) throws NumberFormatException {
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(strSubstring) || "-".equals(strSubstring)) && StringUtils.PROCESS_POSTFIX_DELIMITER.equals(str3.substring(3, 4)) && i2 <= 14) {
    ...
    */
    public final void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws IOException {
        ...
        while (s4 < s3) {
            ...
            if (z2) {
                s = s3;
                s2 = s4;
                Log.d(TAG, String.format("ifdType: %d, tagNumber: %d, tagName: %s, dataFormat: %d, numberOfComponents: %d", Integer.valueOf(i), Integer.valueOf(unsignedShort2), exifTag3 != null ? exifTag3.name : null, Integer.valueOf(unsignedShort3), Integer.valueOf(i4)));
            } else {
                s = s3;
                s2 = s4;
            }
    ...
    public static Pair<Integer, Integer> guessDataFormat(String str) throws NumberFormatException {
        if (str.contains(",")) {
            String[] strArrSplit = str.split(",", -1);
        ...
        if (str.contains("/")) {
            ...
            if (strArrSplit2.length == 2) {
                try {
                    ...
                    if (j >= 0 && j2 >= 0) {
                        if (j <= ParserMinimalBase.MAX_INT_L && j2 <= ParserMinimalBase.MAX_INT_L) {
