...
public class SortedList<T> {
    ...
    public final void replaceAllInternal(@NonNull T[] tArr) {
    ...
    public final void replaceAllInsert(T t) {
        T[] tArr = this.mData;
        int i = this.mNewDataStart;
        tArr[i] = t;
    ...
    public final void replaceAllRemove() {
        this.mSize--;
        this.mOldDataStart++;
        this.mCallback.onRemoved(this.mNewDataStart, 1);
    }

    public final int sortAndDedup(@NonNull T[] tArr) {
        if (tArr.length == 0) {
            return 0;
        }
    ...
    public final int findSameItem(T t, T[] tArr, int i, int i2) {
        while (i < i2) {
    ...
    public final void merge(T[] tArr, int i) {
        boolean z = !(this.mCallback instanceof BatchedCallback);
        if (z) {
            beginBatchedUpdates();
        }
    ...
    public final int findIndexOf(T t, T[] tArr, int i, int i2, int i3) {
        while (i < i2) {
            int i4 = (i + i2) / 2;
            T t2 = tArr[i4];
    ...
    public final int linearEqualitySearch(T t, int i, int i2, int i3) {
        T t2;
    ...
    public final T[] copyArray(T[] tArr) {
