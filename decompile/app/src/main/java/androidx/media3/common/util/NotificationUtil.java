...
public final class NotificationUtil {
    ...
    public static void createNotificationChannel(Context context, String str, @StringRes int i, @StringRes int i2, int i3) {
        if (Util.SDK_INT >= 26) {
            ...
            NotificationChannel notificationChannelM28m = NotificationApiHelperForO$$ExternalSyntheticApiModelOutline4.m28m(str, context.getString(i), i3);
            if (i2 != 0) {
                notificationChannelM28m.setDescription(context.getString(i2));
            }
