...
public final class GlUtil {
    ...
    public static boolean isProtectedContentExtensionSupported(Context context) {
        ...
        if (i < 26 && (ManufacturerUtils.SAMSUNG.equals(Util.MANUFACTURER) || "XT1650".equals(Util.MODEL))) {
            return false;
        }
    ...
    @RequiresApi(17)
    public static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, @IntRange(from = 2, m10to = 3) int i, int[] iArr) throws GlException {
        boolean z = true;
