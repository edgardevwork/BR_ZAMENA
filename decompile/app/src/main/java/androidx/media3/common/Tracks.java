...
public final class Tracks implements Bundleable {
    ...
    public static final Tracks EMPTY = new Tracks(ImmutableList.m1171of());
    ...
    public static Tracks fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.Tracks$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
