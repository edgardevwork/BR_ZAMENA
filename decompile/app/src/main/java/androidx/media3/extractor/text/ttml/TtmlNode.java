...
public final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C2732C.TIME_UNSET, C2732C.TIME_UNSET, null, null, "", null, null);
    }
    ...
    public boolean isActive(long j) {
        ...
        return (j2 == C2732C.TIME_UNSET && this.endTimeUs == C2732C.TIME_UNSET) || (j2 <= j && this.endTimeUs == C2732C.TIME_UNSET) || ((j2 == C2732C.TIME_UNSET && j < this.endTimeUs) || (j2 <= j && j < this.endTimeUs));
    }
