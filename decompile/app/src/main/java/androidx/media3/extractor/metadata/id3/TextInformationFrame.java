...
public final class TextInformationFrame extends Id3Frame {
    ...
    public /* synthetic */ TextInformationFrame(Parcel parcel, C29571 c29571) {
        this(parcel);
    }
    ...
    public TextInformationFrame(String str, @Nullable String str2, String str3) {
        this(str, str2, ImmutableList.m1172of(str3));
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Util.areEqual(this.f327id, textInformationFrame.f327id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }

    public int hashCode() {
        int iHashCode = (527 + this.f327id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f327id + ": description=" + this.description + ": values=" + this.values;
    }
    ...
    /* renamed from: androidx.media3.extractor.metadata.id3.TextInformationFrame$1 */
    public class C29571 implements Parcelable.Creator<TextInformationFrame> {
        @Override // android.os.Parcelable.Creator
        public TextInformationFrame createFromParcel(Parcel parcel) {
            return new TextInformationFrame(parcel);
        }
