...
public final class ApicFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f322ID = "APIC";
    ...
    public String toString() {
        return this.f327id + ": mimeType=" + this.mimeType + ", description=" + this.description;
    }
    ...
    /* renamed from: androidx.media3.extractor.metadata.id3.ApicFrame$1 */
    /* loaded from: classes2.dex */
    public class C29481 implements Parcelable.Creator<ApicFrame> {
        @Override // android.os.Parcelable.Creator
        public ApicFrame createFromParcel(Parcel parcel) {
            return new ApicFrame(parcel);
        }
