...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.durationMs == eventMessage.durationMs && this.f321id == eventMessage.f321id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData);
    }

    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f321id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
