...
public final class VorbisUtil {
    ...
    public static ImmutableList<byte[]> parseVorbisCsdFromEsdsInitializationData(byte[] bArr) {
        ...
        return ImmutableList.m1173of(bArr2, bArr3);
    }
    ...
    public static Metadata parseVorbisComments(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String[] strArrSplitAtFirst = Util.splitAtFirst(str, URLEncodedUtils.NAME_VALUE_SEPARATOR);
            if (strArrSplitAtFirst.length != 2) {
                Log.m635w(TAG, "Failed to parse Vorbis comment: " + str);
                ...
                try {
                    ...
                    Log.m636w(TAG, "Failed to parse vorbis picture", e);
                }
            } else {
    ...
    public static void readMappings(int i, VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i2 = 0; i2 < bits; i2++) {
            ...
            if (bits2 != 0) {
                Log.m631e(TAG, "mapping type other than 0 not supported: " + bits2);
            } else {
