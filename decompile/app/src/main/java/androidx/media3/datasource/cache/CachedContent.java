...
public final class CachedContent {
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j, boolean z) {
        ...
        if (z) {
            File cacheFile = SimpleCacheSpan.getCacheFile((File) Assertions.checkNotNull(file.getParentFile()), this.f309id, simpleCacheSpan.position, j);
            if (file.renameTo(cacheFile)) {
                file = cacheFile;
            } else {
                Log.m635w(TAG, "Failed to rename " + file + " to " + cacheFile);
            }
        }
    ...
    public int hashCode() {
        return (((this.f309id * 31) + this.key.hashCode()) * 31) + this.metadata.hashCode();
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.f309id == cachedContent.f309id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata);
    }
