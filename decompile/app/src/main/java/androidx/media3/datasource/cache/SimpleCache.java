...
public final class SimpleCache implements Cache {
            ...
            if (databaseProvider != null) {
                ...
                if (jLoadUid != -1) {
                    try {
                        ...
                        Log.m635w(TAG, "Failed to delete file metadata: " + jLoadUid);
                    }
                    try {
    ...
    public synchronized void release() {
        ...
        try {
            ...
            Log.m632e(TAG, "Storing index file failed", e);
            unlockFolder(this.cacheDir);
        }
        this.released = true;
    }
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f309id, j, System.currentTimeMillis());
    }
    ...
    public final SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) throws SQLException {
        boolean z;
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m635w(TAG, "Failed to update index with new touch timestamp.");
            }
            z = false;
        } else {
            z = true;
    ...
    public final void removeSpanInternal(CacheSpan cacheSpan) {
        ...
        if (this.fileIndex != null) {
            ...
            try {
                ...
                Log.m635w(TAG, "Failed to remove file index entry for: " + name);
            }
        }
        this.contentIndex.maybeRemove(cachedContent.key);
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (name.endsWith(UID_FILE_SUFFIX)) {
                try {
                    ...
                    Log.m631e(TAG, "Malformed UID file: " + file);
                    file.delete();
                }
            }
        }
