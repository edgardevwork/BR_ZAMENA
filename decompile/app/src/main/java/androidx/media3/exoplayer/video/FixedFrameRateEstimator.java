...
public final class FixedFrameRateEstimator {
    ...
    public long lastFramePresentationTimeNs = C2732C.TIME_UNSET;

    public void reset() {
        this.currentMatcher.reset();
        this.candidateMatcher.reset();
        this.candidateMatcherActive = false;
        this.lastFramePresentationTimeNs = C2732C.TIME_UNSET;
    ...
    public void onNextFrame(long j) {
        ...
        if (this.currentMatcher.isSynced() && !this.switchToCandidateMatcherWhenSynced) {
            this.candidateMatcherActive = false;
        } else if (this.lastFramePresentationTimeNs != C2732C.TIME_UNSET) {
    ...
    public long getMatchingFrameDurationSumNs() {
        return isSynced() ? this.currentMatcher.getMatchingFrameDurationSumNs() : C2732C.TIME_UNSET;
    }

    public long getFrameDurationNs() {
        return isSynced() ? this.currentMatcher.getFrameDurationNs() : C2732C.TIME_UNSET;
    }
