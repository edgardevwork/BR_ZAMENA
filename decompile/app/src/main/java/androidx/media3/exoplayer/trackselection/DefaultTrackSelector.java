...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final Ordering<Integer> FORMAT_VALUE_ORDERING = Ordering.from(new Comparator() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda0
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return DefaultTrackSelector.lambda$static$0((Integer) obj, (Integer) obj2);
        }
    });
    public static final Ordering<Integer> NO_ORDER = Ordering.from(new Comparator() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda1
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
    ...
    public static final class Parameters extends TrackSelectionParameters implements Bundleable {
        ...
        public static final String f320xaec1bc6e;
        ...
        public /* synthetic */ Parameters(Builder builder, C29031 c29031) {
            this(builder);
        }
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            public /* synthetic */ Builder(Bundle bundle, C29031 c29031) {
                this(bundle);
            }

            public /* synthetic */ Builder(Parameters parameters, C29031 c29031) {
                this(parameters);
            }
            ...
            public Builder(Bundle bundle) {
                ...
                setAllowInvalidateSelectionsOnRendererCapabilitiesChange(bundle.getBoolean(Parameters.f320xaec1bc6e, parameters.allowInvalidateSelectionsOnRendererCapabilitiesChange));
                this.selectionOverrides = new SparseArray<>();
        ...
        static {
            ...
            f320xaec1bc6e = Util.intToStringMaxRadix(1017);
        ...
        public Bundle toBundle() {
            ...
            bundle.putBoolean(f320xaec1bc6e, this.allowInvalidateSelectionsOnRendererCapabilitiesChange);
    ...
    public static final class SelectionOverride implements Bundleable {
        ...
        public static final String FIELD_TRACK_TYPE = Util.intToStringMaxRadix(2);
    ...
    public DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, @Nullable Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m635w(TAG, AUDIO_CHANNEL_COUNT_CONSTRAINTS_WARN_MESSAGE);
        }
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.lambda$selectAudioTrack$3(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    public final /* synthetic */ List lambda$selectAudioTrack$3(Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectImageTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(4, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda2
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr2) {
                return DefaultTrackSelector.lambda$selectImageTrack$5(parameters, i, trackGroup, iArr2);
            }
    ...
    public final <T extends TrackInfo<T>> Pair<ExoTrackSelection.Definition, Integer> selectTracksForType(int i, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, TrackInfo.Factory<T> factory, Comparator<List<T>> comparator) {
        int i2;
        RandomAccess randomAccessM1172of;
                    ...
                    while (i5 < trackGroup.length) {
                        ...
                        if (zArr[i5] || selectionEligibility == 0) {
                            ...
                            if (selectionEligibility == 1) {
                                randomAccessM1172of = ImmutableList.m1172of(t);
                                i2 = rendererCount;
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                arrayList2.add(t);
                                ...
                                i2 = rendererCount;
                                randomAccessM1172of = arrayList2;
                            }
                            arrayList.add(randomAccessM1172of);
                        }
                        i5++;
                        rendererCount = i2;
                    }
    ...
    public static String normalizeUndeterminedLanguageToNull(@Nullable String str) {
        if (TextUtils.isEmpty(str) || TextUtils.equals(str, C2732C.LANGUAGE_UNDETERMINED)) {
            return null;
        }
        return str;
    }
    ...
    */
    ...
    public static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, @Nullable String str) {
            ImmutableList<String> immutableListM1172of;
            int formatLanguageScore;
            super(i, trackGroup, i2);
            int i4 = 0;
            this.isWithinRendererCapabilities = DefaultTrackSelector.isSupported(i3, false);
            ...
            if (parameters.preferredTextLanguages.isEmpty()) {
                immutableListM1172of = ImmutableList.m1172of("");
            } else {
                immutableListM1172of = parameters.preferredTextLanguages;
            }
            int i6 = 0;
            while (true) {
                if (i6 >= immutableListM1172of.size()) {
                    i6 = Integer.MAX_VALUE;
                    formatLanguageScore = 0;
                    break;
                } else {
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, immutableListM1172of.get(i6), parameters.selectUndeterminedTextLanguage);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i6++;
    ...
    public static class SpatializerWrapperV32 {
        ...
        public void ensureInitialized(DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                this.listener = new Spatializer$OnSpatializerStateChangedListener() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector.SpatializerWrapperV32.1
                    ...
                    public C29041(DefaultTrackSelector defaultTrackSelector2) {
        ...
        /* renamed from: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$SpatializerWrapperV32$1 */
        public class C29041 implements Spatializer$OnSpatializerStateChangedListener {
            public final /* synthetic */ DefaultTrackSelector val$defaultTrackSelector;
