...
public final class MediaParserChunkExtractor implements ChunkExtractor {
    ...
    public MediaParserChunkExtractor(int i, Format format, List<Format> list, PlayerId playerId) {
        ...
        this.pendingSeekUs = C2732C.TIME_UNSET;
    }
    ...
    public final void maybeExecutePendingSeek() {
        ...
        if (j == C2732C.TIME_UNSET || dummySeekMap == null) {
            return;
        }
        this.mediaParser.seek(MediaParserExtractorAdapter$$ExternalSyntheticApiModelOutline2.m780m(dummySeekMap.getSeekPoints(j).first));
        this.pendingSeekUs = C2732C.TIME_UNSET;
    }
