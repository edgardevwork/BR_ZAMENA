...
public final class ExoPlaybackException extends PlaybackException {
    ...
    public static final Bundleable.Creator<ExoPlaybackException> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.exoplayer.ExoPlaybackException$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return ExoPlaybackException.m14106$r8$lambda$jTIqJuGnIWSRQFd3O6cFsUL6Xg(bundle);
        }
    };
    public static final String FIELD_TYPE = Util.intToStringMaxRadix(1001);
    public static final String FIELD_RENDERER_NAME = Util.intToStringMaxRadix(1002);
    public static final String FIELD_RENDERER_INDEX = Util.intToStringMaxRadix(1003);
    public static final String FIELD_RENDERER_FORMAT = Util.intToStringMaxRadix(1004);
    public static final String FIELD_RENDERER_FORMAT_SUPPORT = Util.intToStringMaxRadix(1005);
    public static final String FIELD_IS_RECOVERABLE = Util.intToStringMaxRadix(1006);
    ...
    public static /* synthetic */ ExoPlaybackException m14106$r8$lambda$jTIqJuGnIWSRQFd3O6cFsUL6Xg(Bundle bundle) {
