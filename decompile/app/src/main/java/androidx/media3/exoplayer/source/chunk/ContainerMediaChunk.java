...
public class ContainerMediaChunk extends BaseMediaChunk {
    ...
    public final void load() throws IOException {
        ...
        if (this.nextLoadPosition == 0) {
            ...
            long j2 = j == C2732C.TIME_UNSET ? -9223372036854775807L : j - this.sampleOffsetUs;
            long j3 = this.clippedEndTimeUs;
            chunkExtractor.init(trackOutputProvider, j2, j3 == C2732C.TIME_UNSET ? -9223372036854775807L : j3 - this.sampleOffsetUs);
        }
        try {
