...
public final class PlaybackStats {
    ...
    public static PlaybackStats merge(PlaybackStats... playbackStatsArr) {
        ...
        int i4 = 0;
        int i5 = -1;
        long jMax = C2732C.TIME_UNSET;
        long jMin = C2732C.TIME_UNSET;
        int i6 = 0;
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        long j11 = C2732C.TIME_UNSET;
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        int i13 = 0;
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i == 0 ? C2732C.TIME_UNSET : this.totalValidJoinTimeMs / i;
    }
    ...
    public long getMeanPlayTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalPlayTimeMs() / this.foregroundPlaybackCount;
    }
    ...
    public long getMeanPausedTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalPausedTimeMs() / this.foregroundPlaybackCount;
    }
    ...
    public long getMeanRebufferTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalRebufferTimeMs() / this.foregroundPlaybackCount;
    }

    public long getMeanSingleRebufferTimeMs() {
        return this.totalRebufferCount == 0 ? C2732C.TIME_UNSET : (getPlaybackStateDurationMs(6) + getPlaybackStateDurationMs(7)) / this.totalRebufferCount;
    }
    ...
    public long getMeanSeekTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalSeekTimeMs() / this.foregroundPlaybackCount;
    }

    public long getMeanSingleSeekTimeMs() {
        return this.totalSeekCount == 0 ? C2732C.TIME_UNSET : getTotalSeekTimeMs() / this.totalSeekCount;
    }
    ...
    public long getMeanWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalWaitTimeMs() / this.foregroundPlaybackCount;
    }
    ...
    public long getMeanPlayAndWaitTimeMs() {
        return this.foregroundPlaybackCount == 0 ? C2732C.TIME_UNSET : getTotalPlayAndWaitTimeMs() / this.foregroundPlaybackCount;
    }
    ...
    public long getMeanElapsedTimeMs() {
        return this.playbackCount == 0 ? C2732C.TIME_UNSET : getTotalElapsedTimeMs() / this.playbackCount;
    }
