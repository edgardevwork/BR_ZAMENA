...
public final class AspectRatioFrameLayout extends FrameLayout {
    ...
    public AspectRatioFrameLayout(Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2997R.styleable.AspectRatioFrameLayout, 0, 0);
            try {
                this.resizeMode = typedArrayObtainStyledAttributes.getInt(C2997R.styleable.AspectRatioFrameLayout_resize_mode, 0);
            } finally {
