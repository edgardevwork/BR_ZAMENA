...
public final class PlayerControlViewLayoutManager {
    public static final long ANIMATION_INTERVAL_MS = 2000;
    public static final long DURATION_FOR_HIDING_ANIMATION_MS = 250;
    public static final long DURATION_FOR_SHOWING_ANIMATION_MS = 250;
    public static final int UX_STATE_ALL_VISIBLE = 0;
    public static final int UX_STATE_ANIMATING_HIDE = 3;
    public static final int UX_STATE_ANIMATING_SHOW = 4;
    ...
    public final Runnable showAllBarsRunnable = new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.showAllBars();
        }
    };
    public final Runnable hideAllBarsRunnable = new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda5
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.hideAllBars();
        }
    };
    public final Runnable hideProgressBarRunnable = new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda6
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.hideProgressBar();
        }
    };
    public final Runnable hideMainBarRunnable = new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda7
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.hideMainBar();
        }
    };
    public final Runnable hideControllerRunnable = new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda8
        @Override // java.lang.Runnable
        public final void run() {
            this.f$0.hideController();
        }
    };
    public final View.OnLayoutChangeListener onLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda9
    ...
    public final List<View> shownButtons = new ArrayList();

    public PlayerControlViewLayoutManager(PlayerControlView playerControlView) throws Resources.NotFoundException {
        this.playerControlView = playerControlView;
        this.controlsBackground = playerControlView.findViewById(C2997R.id.exo_controls_background);
        this.centerControls = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_center_controls);
        this.minimalControls = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_minimal_controls);
        ViewGroup viewGroup = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_bottom_bar);
        this.bottomBar = viewGroup;
        this.timeView = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_time);
        View viewFindViewById = playerControlView.findViewById(C2997R.id.exo_progress);
        this.timeBar = viewFindViewById;
        this.basicControls = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_basic_controls);
        this.extraControls = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) playerControlView.findViewById(C2997R.id.exo_extra_controls_scroll_view);
        View viewFindViewById2 = playerControlView.findViewById(C2997R.id.exo_overflow_show);
        this.overflowShowButton = viewFindViewById2;
        View viewFindViewById3 = playerControlView.findViewById(C2997R.id.exo_overflow_hide);
        if (viewFindViewById2 != null && viewFindViewById3 != null) {
            viewFindViewById2.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda10
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.onOverflowButtonClick(view);
                }
            });
            viewFindViewById3.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda10
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.onOverflowButtonClick(view);
                }
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda11
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda12
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        int i = C2997R.dimen.exo_styled_bottom_bar_height;
        float dimension = resources.getDimension(i) - resources.getDimension(C2997R.dimen.exo_styled_progress_bar_height);
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager.3
            ...
            public C29893(PlayerControlView playerControlView2) {
        ...
        animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager.4
            ...
            public C29904(PlayerControlView playerControlView2) {
                playerControlView = playerControlView2;
            }
        ...
        animatorSet3.addListener(new AnimatorListenerAdapter() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager.5
            ...
            public C29915(PlayerControlView playerControlView2) {
                playerControlView = playerControlView2;
            }
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public class C29871 extends AnimatorListenerAdapter {
        public C29871() {
        }
    ...
    public class C29882 extends AnimatorListenerAdapter {
        public C29882() {
        }
    ...
    public class C29893 extends AnimatorListenerAdapter {
        public final /* synthetic */ PlayerControlView val$playerControlView;
    ...
    public class C29904 extends AnimatorListenerAdapter {
        public final /* synthetic */ PlayerControlView val$playerControlView;
    ...
    public class C29915 extends AnimatorListenerAdapter {
        public final /* synthetic */ PlayerControlView val$playerControlView;
    ...
    public class C29926 extends AnimatorListenerAdapter {
        public C29926() {
        }
    ...
    public class C29937 extends AnimatorListenerAdapter {
        public C29937() {
        }
    ...
    public class C29948 extends AnimatorListenerAdapter {
        public C29948() {
        }
    ...
    public class C29959 extends AnimatorListenerAdapter {
        public C29959() {
        }
    ...
    public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        view.post(new Runnable() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void onOverflowButtonClick(View view) {
        resetHideCallbacks();
        if (view.getId() == C2997R.id.exo_overflow_show) {
            this.overflowShowAnimator.start();
        } else if (view.getId() == C2997R.id.exo_overflow_hide) {
    ...
    public final void updateLayoutForSizeChange() throws Resources.NotFoundException {
        ViewGroup viewGroup = this.minimalControls;
        if (viewGroup != null) {
            viewGroup.setVisibility(this.isMinimalMode ? 0 : 4);
        }
        if (this.timeBar != null) {
            int dimensionPixelSize = this.playerControlView.getResources().getDimensionPixelSize(C2997R.dimen.exo_styled_progress_margin_bottom);
    ...
    public final boolean shouldHideInMinimalMode(View view) {
        int id = view.getId();
        return id == C2997R.id.exo_bottom_bar || id == C2997R.id.exo_prev || id == C2997R.id.exo_next || id == C2997R.id.exo_rew || id == C2997R.id.exo_rew_with_amount || id == C2997R.id.exo_ffwd || id == C2997R.id.exo_ffwd_with_amount;
    }
    ...
    public static int getWidthWithMargins(@Nullable View view) {
        if (view == null) {
            return 0;
        }
    ...
    public static int getHeightWithMargins(@Nullable View view) {
        if (view == null) {
            return 0;
        }
