...
public abstract class ObjectList<E> {
    ...
    public static final class C02441 extends Lambda implements Function1<E, CharSequence> {
        public final /* synthetic */ ObjectList<E> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C02441(ObjectList<E> objectList) {
            super(1);
    ...
    public String toString() {
        return joinToString$default(this, null, "[", "]", 0, null, new Function1<E, CharSequence>(this) { // from class: androidx.collection.ObjectList.toString.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C02441(ObjectList<E> this) {
                super(1);
                this.this$0 = this;
            }
