...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final void writeMetadata(int i, long value) {
        long[] jArr = this.metadata;
        int i2 = i >> 3;
        int i3 = (i & 7) << 3;
