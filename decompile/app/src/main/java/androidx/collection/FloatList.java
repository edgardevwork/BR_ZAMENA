...
public abstract class FloatList {
    ...
    public final float elementAtOrElse(@IntRange(from = 0) int i, @NotNull Function1<? super Integer, Float> defaultValue) {
    ...
    public final boolean containsAll(@NotNull FloatList elements) {
        ...
        kotlin.ranges.IntRange intRangeUntil = RangesKt___RangesKt.until(0, elements._size);
        int first = intRangeUntil.getFirst();
        int last = intRangeUntil.getLast();
        if (first > last) {
            return true;
