...
public final class MutableLongSet extends LongSet {
    ...
    */
    ...
    public final int findAbsoluteInsertIndex(long element) {
        int iHashCode = Long.hashCode(element) * (-862048943);
        int i = iHashCode ^ (iHashCode << 16);
        int i2 = i >>> 7;
        int i3 = i & 127;
