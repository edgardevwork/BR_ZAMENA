...
public interface Delay {
    ...
    void mo17258scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(@NotNull Delay delay, long j, @NotNull Continuation<? super Unit> continuation) {
            ...
            delay.mo17258scheduleResumeAfterDelay(j, cancellableContinuationImpl);
