...
public class UnbiasedSelectImplementation<R> extends SelectImplementation<R> {
    ...
    @NotNull
    public final List<SelectImplementation<R>.ClauseData> clausesToRegister;
