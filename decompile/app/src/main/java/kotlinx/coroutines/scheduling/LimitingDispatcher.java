...
public final class LimitingDispatcher extends ExecutorCoroutineDispatcher implements TaskContext, Executor {
    ...
    public final void dispatch(Runnable block, boolean tailDispatch) {
        do {
