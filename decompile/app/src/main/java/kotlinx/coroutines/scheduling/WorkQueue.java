...
public final class WorkQueue {
    ...
    public final Task stealWithExclusiveMode(int stealingMode) {
    ...
    public final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!C2081xc40028dd.m347m(atomicReferenceFieldUpdater, this, task, null));
        return task;
    }

    public final Task tryExtractFromTheMiddle(int i, boolean onlyBlocking) {
        int i2 = i & 127;
        Task task = this.buffer.get(i2);
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && C7609xa7a47114.m1346m(this.buffer, i2, task, null)) {
                if (onlyBlocking) {
    ...
    public final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        ?? r1;
        do {
            atomicReferenceFieldUpdater = lastScheduledTask$FU;
        ...
        } while (!C2081xc40028dd.m347m(atomicReferenceFieldUpdater, this, r1, null));
        stolenTaskRef.element = r1;
        return -1L;
    }

    public final boolean pollTo(GlobalQueue queue) {
