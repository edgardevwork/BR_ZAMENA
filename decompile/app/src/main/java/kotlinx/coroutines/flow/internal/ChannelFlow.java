...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    */
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m7120f = "ChannelFlow.kt", m7121i = {}, m7122l = {123}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlow$collect$2 */
    /* loaded from: classes5.dex */
    public static final class C108992 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C108992(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C108992> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C108992 c108992 = new C108992(this.$collector, this.this$0, continuation);
            c108992.L$0 = obj;
            return c108992;
        }
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C108992) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C108992(flowCollector, channelFlow, null), continuation);
