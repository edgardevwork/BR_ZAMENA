...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m7120f = "Reduce.kt", m7121i = {0, 0}, m7122l = {Cea708Decoder.COMMAND_DLC}, m7123m = "emit", m7124n = {"this", "it"}, m7125s = {"L$0", "L$1"})
    @SourceDebugExtension({"SMAP\nLimit.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Limit.kt\nkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1$emit$1\n*L\n1#1,141:1\n*E\n"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    /* loaded from: classes8.dex */
    public static final class C108431 extends ContinuationImpl {
        public Object L$0;
        public Object L$1;
        public int label;
        public /* synthetic */ Object result;

        public C108431(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C108431) {
            c108431 = (C108431) continuation;
            int i = c108431.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c108431.label = i - Integer.MIN_VALUE;
            } else {
                c108431 = new C108431(continuation);
            }
        }
        Object objInvoke = c108431.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c108431.label;
        if (i2 == 0) {
            ...
            c108431.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(t, c108431);
            InlineMarker.mark(7);
            ...
            t = (T) c108431.L$1;
            flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c108431.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
