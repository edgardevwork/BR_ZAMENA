...
public final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m7120f = "Builders.kt", m7121i = {0}, m7122l = {334}, m7123m = "collectTo", m7124n = {PomReader.SCOPE}, m7125s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 */
    public static final class C107901 extends ContinuationImpl {
        public Object L$0;
        public int label;
        ...
        public C107901(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C107901> continuation) {
            super(continuation);
    ...
    */
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        C107901 c107901;
        if (continuation instanceof C107901) {
            c107901 = (C107901) continuation;
            int i = c107901.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c107901.label = i - Integer.MIN_VALUE;
            } else {
                c107901 = new C107901(this, continuation);
            }
        }
        Object obj = c107901.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c107901.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            c107901.L$0 = producerScope;
            c107901.label = 1;
            if (super.collectTo(producerScope, c107901) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c107901.L$0;
            ResultKt.throwOnFailure(obj);
        }
