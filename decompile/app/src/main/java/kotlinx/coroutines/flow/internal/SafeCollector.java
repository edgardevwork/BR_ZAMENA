...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(@NotNull Object result) {
        ...
        if (thM15702exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM15702exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    public final Object emit(Continuation<? super Unit> uCont, T value) {
    ...
    public final void checkContext(CoroutineContext currentContext, CoroutineContext previousContext, T value) {
    ...
    public final void exceptionTransparencyViolated(DownstreamExceptionContext exception, Object value) {
