...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(@NotNull final ReceiveChannel<? extends E> receiveChannel, int i, @NotNull CoroutineStart coroutineStart) {
        ...
        }, new C107272(receiveChannel, null), 1, null);
    }
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m7120f = "Broadcast.kt", m7121i = {0, 1}, m7122l = {56, 57}, m7123m = "invokeSuspend", m7124n = {"$this$broadcast", "$this$broadcast"}, m7125s = {"L$0", "L$0"})
    /* renamed from: kotlinx.coroutines.channels.BroadcastKt$broadcast$2 */
    public static final class C107272<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C107272(ReceiveChannel<? extends E> receiveChannel, Continuation<? super C107272> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C107272 c107272 = new C107272(this.$channel, continuation);
            c107272.L$0 = obj;
            return c107272;
        }
        ...
        public final Object invoke(@NotNull ProducerScope<? super E> producerScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C107272) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
