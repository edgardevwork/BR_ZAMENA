...
public final class ProduceKt {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.channels.ProduceKt", m7120f = "Produce.kt", m7121i = {0, 0}, m7122l = {Cea708Decoder.COMMAND_DF1}, m7123m = "awaitClose", m7124n = {"$this$awaitClose", "block"}, m7125s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.channels.ProduceKt$awaitClose$1 */
    /* loaded from: classes5.dex */
    public static final class C107761 extends ContinuationImpl {
        public Object L$0;
        public Object L$1;
        public int label;
        public /* synthetic */ Object result;

        public C107761(Continuation<? super C107761> continuation) {
            super(continuation);
        }
    ...
    /* renamed from: kotlinx.coroutines.channels.ProduceKt$awaitClose$2 */
    /* loaded from: classes5.dex */
    public static final class C107772 extends Lambda implements Function0<Unit> {
        public static final C107772 INSTANCE = ;
    ...
    */
    public static final Object awaitClose(@NotNull ProducerScope<?> producerScope, @NotNull Function0<Unit> function0, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        C107761 c107761;
        if (continuation instanceof C107761) {
            c107761 = (C107761) continuation;
            int i = c107761.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c107761.label = i - Integer.MIN_VALUE;
            } else {
                c107761 = new C107761(continuation);
            }
        }
        Object obj = c107761.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c107761.label;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                if (c107761.getContext().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context".toString());
                }
                c107761.L$0 = producerScope;
                c107761.L$1 = function0;
                c107761.label = 1;
                final CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt__IntrinsicsJvmKt.intercepted(c107761), 1);
                ...
                if (result == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c107761);
                }
                ...
                function0 = (Function0) c107761.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
