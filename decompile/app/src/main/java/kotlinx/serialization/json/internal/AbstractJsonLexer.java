...
public abstract class JsonReader {
    ...
    public int indexOf(char c, int startPos) {
        return StringsKt__StringsKt.indexOf$default(getSource(), c, startPos, false, 4, (Object) null);
    }
    ...
    public final boolean insideString(boolean isLenient, char c) {
        if (isLenient) {
    ...
    public final void writeRange(int fromIndex, int toIndex, boolean currentChunkHasEscape, Function1<? super String, Unit> consumeChunk) {
    ...
    public final int appendEscape(int lastPosition, int current) {
        appendRange(lastPosition, current);
        return appendEsc(current + 1);
    }

    public final String decodedString(int lastPosition, int currentPosition) {
    ...
    public final int appendEsc(int startPosition) {
        ...
        if (cEscapeToChar == 0) {
            fail$default(this, "Invalid escaped char '" + cCharAt + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    ...
    public final int appendHex(CharSequence source, int startPos) {
        int i = startPos + 4;
        if (i >= source.length()) {
    ...
    public final int fromHexChar(CharSequence source, int currentPosition) {
    ...
    public final void failOnUnknownKey(@NotNull String key) {
        ...
        fail("Encountered an unknown key '" + key + ExtendedMessageFormat.QUOTE, StringsKt__StringsKt.lastIndexOf$default((CharSequence) substring(0, this.currentPosition), key, 0, false, 6, (Object) null), AbstractJsonLexerKt.ignoreUnknownKeysHint);
        throw new KotlinNothingValueException();
    }
    ...
    public final boolean consumeBoolean(int start) {
        ...
        fail$default(this, "Expected valid boolean literal prefix, but had '" + consumeStringLenient() + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
        throw new KotlinNothingValueException();
    }

    public final void consumeBooleanLiteral(String literalSuffix, int current) {
