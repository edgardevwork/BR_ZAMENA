...
public class StreamingJsonDecoder extends AbstractDecoder implements JsonDecoder, ChunkedDecoder {
    ...
    /* compiled from: StreamingJsonDecoder.kt */
    @Metadata(m7104d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m7105d2 = {"Lkotlinx/serialization/json/internal/StreamingJsonDecoder$DiscriminatorHolder;", "", "discriminatorToSkip", "", "(Ljava/lang/String;)V", "kotlinx-serialization-json"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
    ...
    public final void skipLeftoverElements(SerialDescriptor descriptor) {
    ...
    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.CompositeDecoder
    public <T> T decodeSerializableElement(@NotNull SerialDescriptor descriptor, int i, @NotNull DeserializationStrategy<? extends T> deserializer, @Nullable T previousValue) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        Intrinsics.checkNotNullParameter(deserializer, "deserializer");
        ...
        T t = (T) super.decodeSerializableElement(descriptor, i, deserializer, previousValue);
        if (z) {
    ...
    public final boolean coerceInputValue(SerialDescriptor descriptor, int i) {
    ...
    public final int decodeObjectIndex(SerialDescriptor descriptor) {
    ...
    public final boolean handleUnknown(String key) {
    ...
    public byte decodeByte() {
        ...
        JsonReader.fail$default(this.lexer, "Failed to parse byte for input '" + jConsumeNumericLiteral + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
        throw new KotlinNothingValueException();
    }
    ...
    public short decodeShort() {
        ...
        JsonReader.fail$default(this.lexer, "Failed to parse short for input '" + jConsumeNumericLiteral + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
        throw new KotlinNothingValueException();
    }
    ...
    public int decodeInt() {
        ...
        JsonReader.fail$default(this.lexer, "Failed to parse int for input '" + jConsumeNumericLiteral + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
        throw new KotlinNothingValueException();
    }
    ...
    public float decodeFloat() throws NumberFormatException {
        ...
        try {
            ...
            JsonReader.fail$default(jsonReader, "Failed to parse type '" + TypedValues.Custom.S_FLOAT + "' for input '" + strConsumeStringLenient + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public double decodeDouble() throws NumberFormatException {
        ...
        try {
            ...
            JsonReader.fail$default(jsonReader, "Failed to parse type 'double' for input '" + strConsumeStringLenient + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public char decodeChar() {
        ...
        if (strConsumeStringLenient.length() != 1) {
            JsonReader.fail$default(this.lexer, "Expected single char, but got '" + strConsumeStringLenient + ExtendedMessageFormat.QUOTE, 0, null, 6, null);
            throw new KotlinNothingValueException();
        }
