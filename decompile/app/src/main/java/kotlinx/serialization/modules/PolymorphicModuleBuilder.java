...
public final class PolymorphicModuleBuilder<Base> {
    ...
    public final <T extends Base> void subclass(@NotNull KClass<T> subclass, @NotNull KSerializer<T> serializer) {
        ...
        this.subclasses.add(TuplesKt.m7112to(subclass, serializer));
    }
    ...
    public final void m17312default(@NotNull Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
