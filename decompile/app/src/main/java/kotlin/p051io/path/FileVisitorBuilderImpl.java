...
public final class FileVisitorBuilderImpl implements FileVisitorBuilder {
    ...
    @Override // kotlin.p051io.path.FileVisitorBuilder
    ...
    public final FileVisitor<Path> build() {
        checkIsNotBuilt();
        this.isBuilt = true;
        return DirectoryEntriesReader$$ExternalSyntheticApiModelOutline1.m7136m(new FileVisitorImpl(this.onPreVisitDirectory, this.onVisitFile, this.onVisitFileFailed, this.onPostVisitDirectory));
    }
    ...
    public final void checkNotDefined(Object function, String name) {
        if (function == null) {
            return;
        }
