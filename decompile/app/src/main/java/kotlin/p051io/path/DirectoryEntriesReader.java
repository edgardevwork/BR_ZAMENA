...
public final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(@NotNull PathNode directoryNode) throws IOException {
        ...
        Files.walkFileTree(directoryNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, DirectoryEntriesReader$$ExternalSyntheticApiModelOutline1.m7136m(this));
