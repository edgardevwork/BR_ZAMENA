    ...
    public final void collect(@NotNull Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                Throwable thInitCause = ExceptionsCollector$$ExternalSyntheticApiModelOutline3.m7141m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = ExceptionsCollector$$ExternalSyntheticApiModelOutline2.m7140m(thInitCause);
            }
