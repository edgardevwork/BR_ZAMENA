...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public final void copyElements(int newCapacity) {
    ...
    @InlineOnly
    public final E internalGet(int internalIndex) {
    ...
    public void add(int i, E element) {
        AbstractList.INSTANCE.checkPositionIndex$kotlin_stdlib(i, size());
        if (i == size()) {
            addLast(element);
            return;
        }
    ...
    public final void copyCollectionElements(int internalIndex, Collection<? extends E> elements) {
    ...
    public final boolean filterInPlace(Function1<? super E, Boolean> predicate) {
        int iPositiveMod;
        boolean z = false;
        z = false;
        z = false;
