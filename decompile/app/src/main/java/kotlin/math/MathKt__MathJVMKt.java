...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @InlineOnly
    /* renamed from: ln */
    public static final double m7222ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    public static final float m7223ln(float f) {
