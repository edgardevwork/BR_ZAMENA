...
public final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m16904getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(@NotNull Object result) {
        synchronized (this) {
            this.result = Result.m15698boximpl(result);
