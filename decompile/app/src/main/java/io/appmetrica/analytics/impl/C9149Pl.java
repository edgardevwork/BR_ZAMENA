...
public final class C9149Pl extends AbstractC9292Vl {
    ...
    public final ProtobufStateStorage mo5468a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C9456cf("app_permissions_state", iBinaryDataHelper, new C9999y8(c9393a2, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrM6997a, bArrM6997a2)), new C9296W1(new C8838D2()));
    }
