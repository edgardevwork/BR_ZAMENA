...
public final class C9220Sl extends AbstractC9292Vl {
    ...
    public final ProtobufStateStorage mo5468a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C9456cf("clids_info", iBinaryDataHelper, new C9999y8(c9155q3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrM6997a, bArrM6997a2)), new C9035L3());
    }
