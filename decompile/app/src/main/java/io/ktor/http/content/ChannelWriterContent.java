...
public final class ChannelWriterContent extends OutgoingContent.WriteChannelContent {
    ...
    public ChannelWriterContent(@NotNull Function2<? super ByteWriteChannel, ? super Continuation<? super Unit>, ? extends Object> body, @Nullable ContentType contentType, @Nullable HttpStatusCode httpStatusCode, @Nullable Long l) {
