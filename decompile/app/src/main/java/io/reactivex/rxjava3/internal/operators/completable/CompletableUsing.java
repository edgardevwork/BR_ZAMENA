...
public final class CompletableUsing<R> extends Completable {
    ...
    public void subscribeActual(CompletableObserver observer) {
        try {
            ...
            try {
                CompletableSource completableSourceApply = this.completableFunction.apply(r);
                Objects.requireNonNull(completableSourceApply, "The completableFunction returned a null CompletableSource");
                completableSourceApply.subscribe(new UsingObserver(observer, r, this.disposer, this.eager));
            } catch (Throwable th) {
