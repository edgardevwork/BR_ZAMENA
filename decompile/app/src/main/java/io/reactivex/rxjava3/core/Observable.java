...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Observable<T> doOnEach(@NonNull Consumer<? super T> onNext, @NonNull Consumer<? super Throwable> onError, @NonNull Action onComplete, @NonNull Action onAfterTerminate) {
        Objects.requireNonNull(onNext, "onNext is null");
    ...
    @NonNull
    public final Observable<T> timeout0(long timeout, @NonNull TimeUnit unit, @Nullable ObservableSource<? extends T> fallback, @NonNull Scheduler scheduler) {
        Objects.requireNonNull(unit, "unit is null");
        Objects.requireNonNull(scheduler, "scheduler is null");
    ...
    @NonNull
    public final <U, V> Observable<T> timeout0(@NonNull ObservableSource<U> firstTimeoutIndicator, @NonNull Function<? super T, ? extends ObservableSource<V>> itemTimeoutIndicator, @Nullable ObservableSource<? extends T> fallback) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R m7099to(@NonNull ObservableConverter<T, ? extends R> converter) {
    ...
    public final Flowable<T> toFlowable(@NonNull BackpressureStrategy strategy) {
        ...
        int i = C105441.$SwitchMap$io$reactivex$rxjava3$core$BackpressureStrategy[strategy.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C105441 {
