...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    public void subscribeActual(MaybeObserver<? super T> observer) {
        try {
            ...
            try {
                MaybeSource<? extends T> maybeSourceApply = this.sourceSupplier.apply(d);
                Objects.requireNonNull(maybeSourceApply, "The sourceSupplier returned a null MaybeSource");
                maybeSourceApply.subscribe(new UsingObserver(observer, d, this.resourceDisposer, this.eager));
            } catch (Throwable th) {
