...
public final class SingleLift<T, R> extends Single<R> {
    ...
    public void subscribeActual(SingleObserver<? super R> observer) {
        try {
            SingleObserver<? super Object> singleObserverApply = this.onLift.apply(observer);
            Objects.requireNonNull(singleObserverApply, "The onLift returned a null SingleObserver");
            this.source.subscribe(singleObserverApply);
        } catch (Throwable th) {
