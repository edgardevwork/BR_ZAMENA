...
public final class CompletableConcatIterable extends Completable {
    ...
    public void subscribeActual(CompletableObserver observer) {
        try {
            ...
            observer.onSubscribe(concatInnerObserver.f9708sd);
    ...
    public static final class ConcatInnerObserver extends AtomicInteger implements CompletableObserver {
        ...
        /* renamed from: sd */
        public final SequentialDisposable f9708sd = new SequentialDisposable();
        ...
        public void next() {
            if (!this.f9708sd.isDisposed() && getAndIncrement() == 0) {
                Iterator<? extends CompletableSource> it = this.sources;
                while (!this.f9708sd.isDisposed()) {
                    try {
                        if (!it.hasNext()) {
