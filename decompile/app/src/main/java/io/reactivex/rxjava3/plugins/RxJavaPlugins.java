...
public final class RxJavaPlugins {
    ...
    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> onInitComputationHandler;

    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> onInitIoHandler;

    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> onInitNewThreadHandler;

    @Nullable
    public static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler> onInitSingleHandler;
    ...
    @Nullable
    public static volatile BiFunction<? super ParallelFlowable, ? super Subscriber[], ? extends Subscriber[]> onParallelSubscribe;
    ...
    public static boolean isBug(Throwable error) {
        return (error instanceof OnErrorNotImplementedException) || (error instanceof MissingBackpressureException) || (error instanceof QueueOverflowException) || (error instanceof IllegalStateException) || (error instanceof NullPointerException) || (error instanceof IllegalArgumentException) || (error instanceof CompositeException);
    }
    ...
    @NonNull
    public static <T, R> R apply(@NonNull Function<T, R> f, @NonNull T t) {
        try {
            return f.apply(t);
        } catch (Throwable th) {
            throw ExceptionHelper.wrapOrThrow(th);
    ...
    @NonNull
    public static <T, U, R> R apply(@NonNull BiFunction<T, U, R> f, @NonNull T t, @NonNull U u) {
        try {
            return f.apply(t, u);
        } catch (Throwable th) {
            throw ExceptionHelper.wrapOrThrow(th);
    ...
    @NonNull
    public static Scheduler callRequireNonNull(@NonNull Supplier<Scheduler> s) {
        try {
    ...
    @NonNull
    public static Scheduler applyRequireNonNull(@NonNull Function<? super Supplier<Scheduler>, ? extends Scheduler> f, Supplier<Scheduler> s) {
        Object objApply = apply(f, s);
