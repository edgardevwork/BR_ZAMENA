...
public final class ObservableTimeout<T, U, V> extends AbstractObservableWithUpstream<T, T> {
    ...
    public static final class TimeoutObserver<T> extends AtomicLong implements Observer<T>, Disposable, TimeoutSelectorSupport {
        ...
        public TimeoutObserver(Observer<? super T> actual, Function<? super T, ? extends ObservableSource<?>> itemTimeoutIndicator) {
        ...
        public void onNext(T t) {
            ...
            if (j != Long.MAX_VALUE) {
                ...
                if (compareAndSet(j, j2)) {
                    ...
                    try {
                        ObservableSource<?> observableSourceApply = this.itemTimeoutIndicator.apply(t);
                        Objects.requireNonNull(observableSourceApply, "The itemTimeoutIndicator returned a null ObservableSource.");
    ...
    public static final class TimeoutFallbackObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable, TimeoutSelectorSupport {
        ...
        public TimeoutFallbackObserver(Observer<? super T> actual, Function<? super T, ? extends ObservableSource<?>> itemTimeoutIndicator, ObservableSource<? extends T> fallback) {
            this.downstream = actual;
            this.itemTimeoutIndicator = itemTimeoutIndicator;
