...
public final class SpscLinkedArrayQueue<T> implements SimplePlainQueue<T> {
    ...
    public static int calcDirectOffset(int index) {
        return index;
    }
    ...
    public final boolean writeToQueue(final AtomicReferenceArray<Object> buffer, final T e, final long index, final int offset) {
        soElement(buffer, offset, e);
        soProducerIndex(index + 1);
        return true;
    }

    public final void resize(final AtomicReferenceArray<Object> oldBuffer, final long currIndex, final int offset, final T e, final long mask) {
    ...
    public final void soNext(AtomicReferenceArray<Object> curr, AtomicReferenceArray<Object> next) {
        soElement(curr, calcDirectOffset(curr.length() - 1), next);
    }

    public final AtomicReferenceArray<Object> lvNextBufferAndUnlink(AtomicReferenceArray<Object> curr, int nextIndex) {
    ...
    public final void adjustLookAheadStep(int capacity) {
    ...
    public static int calcWrappedOffset(long index, int mask) {
        return calcDirectOffset(((int) index) & mask);
    }

    public static void soElement(AtomicReferenceArray<Object> buffer, int offset, Object e) {
        buffer.lazySet(offset, e);
    }

    public static Object lvElement(AtomicReferenceArray<Object> buffer, int offset) {
