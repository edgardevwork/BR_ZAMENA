...
public enum NotificationLite {
    ...
    public static final class ErrorNotification implements Serializable {
        ...
        /* renamed from: e */
        public final Throwable f9786e;

        public ErrorNotification(Throwable e) {
            this.f9786e = e;
        }

        public String toString() {
            return "NotificationLite.Error[" + this.f9786e + "]";
        }

        public int hashCode() {
            return this.f9786e.hashCode();
        }

        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return Objects.equals(this.f9786e, ((ErrorNotification) obj).f9786e);
            }
            return false;
        }
    }
    ...
    public static final class SubscriptionNotification implements Serializable {
        ...
        public SubscriptionNotification(Subscription s) {
            this.upstream = s;
        }
    ...
    public static final class DisposableNotification implements Serializable {
        ...
        public DisposableNotification(Disposable d) {
            this.upstream = d;
        }
    ...
    public static Throwable getError(Object o) {
        return ((ErrorNotification) o).f9786e;
    }
    ...
    public static <T> boolean accept(Object o, Subscriber<? super T> s) {
        ...
        if (o instanceof ErrorNotification) {
            s.onError(((ErrorNotification) o).f9786e);
            return true;
        }
        s.onNext(o);
        return false;
    ...
    public static <T> boolean accept(Object o, Observer<? super T> observer) {
        ...
        if (o instanceof ErrorNotification) {
            observer.onError(((ErrorNotification) o).f9786e);
            return true;
        }
        observer.onNext(o);
        return false;
