...
public final class CloudArrowBottomBlockKt {
    public static final float HEIGHT_COEFF_PATH = 0.8f;
    public static final float HEIGHT_COEFF_ROUND_RECT = 0.2f;
    public static final float WIDTH = 0.98f;
    public static final float WIDTH_COEFF_PATH = 0.5f;
    ...
    public static final void CloudArrowBottomBlock(@Nullable Modifier modifier, @Nullable Brush brush, @NotNull final Function2<? super Composer, ? super Integer, Unit> content, @Nullable Composer composer, final int i, final int i2) {
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(-122232625);
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
            modifier2 = modifier;
        ...
        if ((i3 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-122232625, i3, -1, "com.blackhub.bronline.game.ui.widget.block.cloud.CloudArrowBottomBlock (CloudArrowBottomBlock.kt:41)");
            }
            ...
            composerStartRestartGroup.startReplaceableGroup(-113300419);
            ...
            if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function1<DrawScope, Unit>() { // from class: com.blackhub.bronline.game.ui.widget.block.cloud.CloudArrowBottomBlockKt$CloudArrowBottomBlock$1$1$1
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@NotNull DrawScope Canvas) {
                        ...
                        Path.addRoundRect(new RoundRect(0.0f, 0.0f, Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()), Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.8f, CornerRadiusKt.CornerRadius(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.0f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.0f), CornerRadiusKt.CornerRadius(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.0f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.0f), CornerRadiusKt.CornerRadius(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.05f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.2f), CornerRadiusKt.CornerRadius(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.05f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.2f), null));
                        Path.moveTo(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.5f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()));
                        Path.lineTo(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.58f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.8f);
                        Path.lineTo(Size.m11168getWidthimpl(Canvas.mo11889getSizeNHjbRc()) * 0.42f, Size.m11165getHeightimpl(Canvas.mo11889getSizeNHjbRc()) * 0.8f);
                        Path.close();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            ...
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.blackhub.bronline.game.ui.widget.block.cloud.CloudArrowBottomBlockKt.CloudArrowBottomBlock.2
                ...
                public final void invoke(@Nullable Composer composer2, int i6) {
                    CloudArrowBottomBlockKt.CloudArrowBottomBlock(modifier4, brush2, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public static final void PreviewCloudArrowBottomBlock(Composer composer, final int i) {
        Composer composerStartRestartGroup = composer.startRestartGroup(-2091206870);
        if (i != 0 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2091206870, i, -1, "com.blackhub.bronline.game.ui.widget.block.cloud.PreviewCloudArrowBottomBlock (CloudArrowBottomBlock.kt:101)");
            }
            CloudArrowBottomBlock(SizeKt.m8177width3ABfNKs(SizeKt.m8158height3ABfNKs(Modifier.INSTANCE, PrimitiveResources_androidKt.dimensionResource(R.dimen._47sdp, composerStartRestartGroup, 6)), PrimitiveResources_androidKt.dimensionResource(R.dimen._175sdp, composerStartRestartGroup, 6)), null, ComposableSingletons$CloudArrowBottomBlockKt.INSTANCE.m15049getLambda1$app_siteRelease(), composerStartRestartGroup, 384, 2);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        ScopeUpdateScope scopeUpdateScopeEndRestartGroup = composerStartRestartGroup.endRestartGroup();
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.blackhub.bronline.game.ui.widget.block.cloud.CloudArrowBottomBlockKt.PreviewCloudArrowBottomBlock.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
