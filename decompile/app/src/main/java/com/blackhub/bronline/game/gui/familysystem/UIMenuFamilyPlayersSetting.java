...
public final class UIMenuFamilyPlayersSetting extends UILayout {
    ...
    public final void setStartParameters() throws JSONException {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup) {
        ...
        FamiliesFamilyControlBinding familiesFamilyControlBindingInflate = FamiliesFamilyControlBinding.inflate(inflater);
        Intrinsics.checkNotNullExpressionValue(familiesFamilyControlBindingInflate, "inflate(...)");
        this.binding = familiesFamilyControlBindingInflate;
        ...
        familiesFamilyControlBinding.buttonPlayersFilter.setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                UIMenuFamilyPlayersSetting.onCreateView$lambda$1(this.f$0, view);
            }
        });
        ...
        familiesFamilyControlBinding3.buttonPlayersSearch.setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UIMenuFamilyPlayersSetting.onCreateView$lambda$2(this.f$0, view);
            }
        });
        ...
        familiesFamilyControlBinding4.editTextSearch.addTextChangedListener(new TextWatcher() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting.onCreateView.3
            ...
            public void onTextChanged(@Nullable CharSequence p0, int p1, int p2, int p3) {
                ...
                filter.filter(UIMenuFamilyPlayersSetting.this.getPlayerSearch);
            }
        });
        ...
        familiesFamilyControlBinding5.buttonBackToMenu.setOnClickListener(new View.OnClickListener() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$$ExternalSyntheticLambda2
            ...
            public final void onClick(View view) throws JSONException {
                UIMenuFamilyPlayersSetting.onCreateView$lambda$3(this.f$0, view);
            }
        });
    ...
    /* compiled from: UIMenuFamilyPlayersSetting.kt */
    @Metadata(m7104d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016J*\u0010\u0006\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0016J*\u0010\f\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0016¨\u0006\r"}, m7105d2 = {"com/blackhub/bronline/game/gui/familysystem/UIMenuFamilyPlayersSetting$onCreateView$3", "Landroid/text/TextWatcher;", "afterTextChanged", "", "p0", "Landroid/text/Editable;", "beforeTextChanged", "", "p1", "", "p2", "p3", "onTextChanged", "app_siteRelease"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    @SourceDebugExtension({"SMAP\nUIMenuFamilyPlayersSetting.kt\nKotlin\n*S Kotlin\n*F\n+ 1 UIMenuFamilyPlayersSetting.kt\ncom/blackhub/bronline/game/gui/familysystem/UIMenuFamilyPlayersSetting$onCreateView$3\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,570:1\n1#2:571\n*E\n"})
    /* renamed from: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$onCreateView$3 */
    /* loaded from: classes.dex */
    public static final class C40263 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void afterTextChanged(@Nullable Editable p0) {
        }
    ...
    public static final void onCreateView$lambda$3(UIMenuFamilyPlayersSetting this$0, View view) throws JSONException {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    /* compiled from: UIMenuFamilyPlayersSetting.kt */
    @Metadata(m7104d1 = {"\u0000'\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u000026\u0012\u0013\u0012\u00110\u0002¢\u0006\f\b\u0003\u0012\b\b\u0004\u0012\u0004\b\b(\u0005\u0012\u0013\u0012\u00110\u0006¢\u0006\f\b\u0003\u0012\b\b\u0004\u0012\u0004\b\b(\u0007\u0012\u0004\u0012\u00020\b0\u0001j\u0002`\tJ\u0019\u0010\n\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0096\u0002¨\u0006\u000b"}, m7105d2 = {"com/blackhub/bronline/game/gui/familysystem/UIMenuFamilyPlayersSetting$setLogicForPlayerClick$1", "Lkotlin/Function2;", "Lcom/blackhub/bronline/game/gui/familysystem/data/FamilyPlayer;", "Lkotlin/ParameterName;", "name", "item", "", "position", "", "Lcom/blackhub/bronline/game/gui/familysystem/OnClickPlayerList;", "invoke", "app_siteRelease"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    /* renamed from: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setLogicForPlayerClick$1 */
    public static final class C40281 implements Function2<FamilyPlayer, Integer, Unit> {
        public C40281() {
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(FamilyPlayer familyPlayer, Integer num) throws JSONException {
            invoke(familyPlayer, num.intValue());
            return Unit.INSTANCE;
        }

        public void invoke(@NotNull FamilyPlayer item, int position) throws JSONException {
            Intrinsics.checkNotNullParameter(item, "item");
            if (System.currentTimeMillis() - UIMenuFamilyPlayersSetting.this.oldTimerPlayersClick > 500) {
    ...
    public final void setVisibleForFilter(boolean ifSetVisible) {
        ...
        if (jNIActivity != null) {
            if (ifSetVisible) {
                ...
                familiesFamilyControlBinding.buttonPlayersFilter.setBackgroundColor(jNIActivity.getResources().getColor(R.color.transparent, null));
            }
        }
    }
    ...
    /* compiled from: UIMenuFamilyPlayersSetting.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\n¢\u0006\u0002\b\u0006"}, m7105d2 = {"<anonymous>", "", BillingPurchaseRequestKt.SOURCE, "Lcom/blackhub/bronline/game/gui/entertainmentsystem/data/EntertainmentGamesFilter;", "position", "", "invoke"}, m7106k = 3, m7107mv = {1, 9, 0}, m7109xi = 48)
    /* renamed from: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setLogicForPlayersFilterClick$1 */
    /* loaded from: classes2.dex */
    public static final class C40291 extends Lambda implements Function2<EntertainmentGamesFilter, Integer, Unit> {
        public C40291() {
            super(2);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(EntertainmentGamesFilter entertainmentGamesFilter, Integer num) throws JSONException {
            invoke(entertainmentGamesFilter, num.intValue());
            return Unit.INSTANCE;
        }

        public final void invoke(@NotNull EntertainmentGamesFilter game, int i) throws JSONException {
            Intrinsics.checkNotNullParameter(game, "game");
            game.setClicked(true);
            EntertainmentSystemGamesFilterAdapter entertainmentSystemGamesFilterAdapter = UIMenuFamilyPlayersSetting.this.playersFilterAdapter;
            if (entertainmentSystemGamesFilterAdapter != null) {
            ...
            if (id == 0) {
                ...
                uIMenuFamilyPlayersSetting.setCurrentPlayersList(uIMenuFamilyPlayersSetting.setCurrentPlayersFilterList(0));
            } else if (id == 1) {
                UIMenuFamilyPlayersSetting uIMenuFamilyPlayersSetting2 = UIMenuFamilyPlayersSetting.this;
                uIMenuFamilyPlayersSetting2.setCurrentPlayersList(uIMenuFamilyPlayersSetting2.setCurrentPlayersFilterList(1));
            } else if (id == 2) {
                UIMenuFamilyPlayersSetting uIMenuFamilyPlayersSetting3 = UIMenuFamilyPlayersSetting.this;
                uIMenuFamilyPlayersSetting3.setCurrentPlayersList(uIMenuFamilyPlayersSetting3.setCurrentPlayersFilterList(2));
            } else if (id == 3) {
                UIMenuFamilyPlayersSetting uIMenuFamilyPlayersSetting4 = UIMenuFamilyPlayersSetting.this;
                uIMenuFamilyPlayersSetting4.setCurrentPlayersList(uIMenuFamilyPlayersSetting4.setCurrentPlayersFilterList(3));
            }
    ...
    public final void setLogicForPlayersFilterClick() {
        ...
        entertainmentSystemGamesFilterAdapter.setFilterClickListener(new Function2<EntertainmentGamesFilter, Integer, Unit>() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting.setLogicForPlayersFilterClick.1
            ...
            public final void invoke(@NotNull EntertainmentGamesFilter game, int i) throws JSONException {
                Intrinsics.checkNotNullParameter(game, "game");
                game.setClicked(true);
                EntertainmentSystemGamesFilterAdapter entertainmentSystemGamesFilterAdapter2 = UIMenuFamilyPlayersSetting.this.playersFilterAdapter;
    ...
    public final List<FamilyPlayer> setCurrentPlayersFilterList(int currentFilter) {
        ...
        List<FamilyPlayer> listSortedWith = CollectionsKt___CollectionsKt.sortedWith(this.allPlayersList, new Comparator() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setCurrentPlayersFilterList$$inlined$sortedBy$1
        ...
        if (currentFilter == 0) {
            for (FamilyPlayer familyPlayer : listSortedWith) {
                if (familyPlayer.getPlayersStatus() == 1) {
                    arrayList.add(familyPlayer);
                }
            }
        } else if (currentFilter == 1) {
            for (FamilyPlayer familyPlayer2 : listSortedWith) {
                if (familyPlayer2.getPlayersStatus() == 0) {
                    arrayList.add(familyPlayer2);
                }
            }
        } else if (currentFilter == 2) {
            arrayList.addAll(CollectionsKt___CollectionsKt.sortedWith(listSortedWith, new Comparator() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setCurrentPlayersFilterList$$inlined$sortedBy$2
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
            ...
            arrayList.addAll(CollectionsKt___CollectionsKt.sortedWith(listSortedWith, new Comparator() { // from class: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setCurrentPlayersFilterList$$inlined$sortedByDescending$1
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
    ...
    public final void setCurrentPlayersList(List<FamilyPlayer> thisList) throws JSONException {
    ...
    public final void setPlayersInfo(@NotNull Integer[] playersStates, @Nullable String playersRankName) {
        ...
        int iIntValue = playersStates[0].intValue();
    ...
    /* compiled from: UIMenuFamilyPlayersSetting.kt */
    @Metadata(m7104d1 = {"\u0000'\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u000026\u0012\u0013\u0012\u00110\u0002¢\u0006\f\b\u0003\u0012\b\b\u0004\u0012\u0004\b\b(\u0005\u0012\u0013\u0012\u00110\u0006¢\u0006\f\b\u0003\u0012\b\b\u0004\u0012\u0004\b\b(\u0007\u0012\u0004\u0012\u00020\b0\u0001j\u0002`\tJ\u0019\u0010\n\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0096\u0002¨\u0006\u000b"}, m7105d2 = {"com/blackhub/bronline/game/gui/familysystem/UIMenuFamilyPlayersSetting$setLogicForClickActionsButton$1", "Lkotlin/Function2;", "Lcom/blackhub/bronline/game/gui/familysystem/data/FamilyPlayersAction;", "Lkotlin/ParameterName;", "name", "thisAction", "", "action", "", "Lcom/blackhub/bronline/game/gui/familysystem/OnClickActionsButton;", "invoke", "app_siteRelease"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    /* renamed from: com.blackhub.bronline.game.gui.familysystem.UIMenuFamilyPlayersSetting$setLogicForClickActionsButton$1 */
    public static final class C40271 implements Function2<FamilyPlayersAction, Integer, Unit> {
        public C40271() {
        }
        ...
        public void invoke(@NotNull FamilyPlayersAction thisAction, int action) throws JSONException {
            ...
            if (System.currentTimeMillis() - UIMenuFamilyPlayersSetting.this.oldTimerPlayersClick > 1000) {
                UIMenuFamilyPlayersSetting.this.oldTimerPlayersClick = System.currentTimeMillis();
                ActionsWithJSON actionsWithJSON = UIMenuFamilyPlayersSetting.this.actionsWithJSON;
                if (actionsWithJSON != null) {
                    actionsWithJSON.setActionWithPlayer(thisAction.getActionsId(), action);
                }
                UIMenuFamilyPlayersSetting.this.oldAction[0] = Integer.valueOf(thisAction.getActionsId());
                UIMenuFamilyPlayersSetting.this.oldAction[1] = Integer.valueOf(action);
            }
        }
    }
    ...
    public final void updatePlayersAction() {
        ...
        for (int i = 0; i < size; i++) {
            if (this.oldAction[0].intValue() == this.playersActions.get(i).getActionsId()) {
                int iIntValue = this.oldAction[1].intValue();
                if (iIntValue == 0) {
