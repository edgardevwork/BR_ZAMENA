...
public final class MenuPauseViewModel extends ViewModel {
    ...
    public final void actionsWithJSONClickButton(int buttonId) throws JSONException {
    ...
    public final void applyGameSettings() throws JSONException {
