...
/* renamed from: com.blackhub.bronline.game.ui.widget.block.uiblock.CommonTasksKt$CommonTasks$2$1$2$1$3$1$invoke$$inlined$items$default$2 */
/* loaded from: classes7.dex */
public final class C6350x88edc293 extends Lambda implements Function1<Integer, Object> {
    public final /* synthetic */ List $items;
    public final /* synthetic */ Function1 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C6350x88edc293(Function1 function1, List list) {
        super(1);
        this.$key = function1;
        this.$items = list;
    }
