...
public final class SliderForNewMenuSettingsGraphicBinding implements ViewBinding {
    ...
    public static SliderForNewMenuSettingsGraphicBinding bind(@NonNull View rootView) {
        ...
        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.progress_0);
        if (viewFindChildViewById != null) {
            i = R.id.progress_1;
            View viewFindChildViewById2 = ViewBindings.findChildViewById(rootView, R.id.progress_1);
            if (viewFindChildViewById2 != null) {
                i = R.id.progress_2;
                View viewFindChildViewById3 = ViewBindings.findChildViewById(rootView, R.id.progress_2);
                if (viewFindChildViewById3 != null) {
                    i = R.id.progress_3;
                    View viewFindChildViewById4 = ViewBindings.findChildViewById(rootView, R.id.progress_3);
                    if (viewFindChildViewById4 != null) {
                        i = R.id.seek_bar;
                        Slider slider = (Slider) ViewBindings.findChildViewById(rootView, R.id.seek_bar);
                        if (slider != null) {
                            return new SliderForNewMenuSettingsGraphicBinding(rootView, viewFindChildViewById, viewFindChildViewById2, viewFindChildViewById3, viewFindChildViewById4, slider);
                        }
                    }
                }
            }
