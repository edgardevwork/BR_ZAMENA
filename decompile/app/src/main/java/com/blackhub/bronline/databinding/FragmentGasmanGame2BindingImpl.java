    ...
    */
    public void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivCornerStaticPipe4, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivCornerStaticPipe4, i2);
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivStraightLongStaticPipe, oneHundredThirtyTwo);
            ViewDataBindingAdaptersKt.setWidth(this.ivStraightLongStaticPipe, i);
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivStraightPipeMiddlePlot2, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivStraightPipeMiddlePlot2, i);
            ViewDataBindingAdaptersKt.setHeight(this.ivStraightPipeMiddlePlot3, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivStraightPipeMiddlePlot3, i);
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivTeePipeDropArea, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivTeePipeDropArea, oneHundredThirtyTwo);
        }
    }
}
