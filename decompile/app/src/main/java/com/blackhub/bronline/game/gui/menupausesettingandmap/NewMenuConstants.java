...
public final class NewMenuConstants {
    ...
    public static final int DEFAULT_VALUE_FOR_RADIO_WITHOUT_CENSORSHIP = 0;
    ...
    public static final boolean IS_WINTER_ENABLED = false;
    ...
    @NotNull
    public static final String PARAM_6 = "radio_without_censorship";
    ...
    public static final int SCREEN_SETTINGS_MENU = 1;
