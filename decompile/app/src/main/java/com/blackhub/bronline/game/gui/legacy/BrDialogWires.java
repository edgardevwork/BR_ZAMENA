...
public class BrDialogWires extends DialogFragment implements ISAMPGUI {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View viewInflate = inflater.inflate(R.layout.br_wires, (ViewGroup) null, false);
        ...
        this.mRitemMask = 0;
        this.mAttached = 0;
        this.mLitem[0] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_litem_0);
        this.mLitem[1] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_litem_1);
        this.mLitem[2] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_litem_2);
        this.mLitem[3] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_litem_3);
        this.mLitem[4] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_litem_4);
        this.mRitem[0] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_ritem_0);
        this.mRitem[1] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_ritem_1);
        this.mRitem[2] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_ritem_2);
        this.mRitem[3] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_ritem_3);
        this.mRitem[4] = (FrameLayout) viewInflate.findViewById(R.id.br_wires_ritem_4);
        this.mHintText = (TextView) viewInflate.findViewById(R.id.br_wires_hint);
        this.mTimerText = (TextView) viewInflate.findViewById(R.id.br_wires_time);
        this.mAttachedText = (TextView) viewInflate.findViewById(R.id.br_wires_attached);
        this.mHelpButton = (Button) viewInflate.findViewById(R.id.br_wires_help);
        this.mExitButton = (Button) viewInflate.findViewById(R.id.br_wires_exit);
        final ConstraintLayout constraintLayout = (ConstraintLayout) viewInflate.findViewById(R.id.br_wires_frame);
    ...
    public void onWiresGuiClosed() throws JSONException {
