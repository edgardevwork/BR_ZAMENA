...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, m9to = 1.0d) float f) {
    ...
    @NonNull
    @CheckResult
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, m10to = 100) int i) {
