...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public final Key findBestKey(int i, Bitmap.Config config) {
    ...
    public static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C65901.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C65901 {
