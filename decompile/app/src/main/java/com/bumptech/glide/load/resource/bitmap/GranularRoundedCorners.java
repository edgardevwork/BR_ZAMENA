...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    public static final String f530ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    public static final byte[] ID_BYTES = f530ID.getBytes(Key.CHARSET);
