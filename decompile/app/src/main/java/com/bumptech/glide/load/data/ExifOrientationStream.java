...
public final class ExifOrientationStream extends FilterInputStream {
    ...
    static {
        byte[] bArr = {-1, ExifInterface.MARKER_APP1, 0, 28, 69, 120, 105, 102, 0, 0, TarConstants.LF_MULTIVOLUME, TarConstants.LF_MULTIVOLUME, 0, 0, 0, 0, 0, 8, 0, 1, 1, Ascii.DC2, 0, 2, 0, 0, 0, 1, 0};
        EXIF_SEGMENT = bArr;
