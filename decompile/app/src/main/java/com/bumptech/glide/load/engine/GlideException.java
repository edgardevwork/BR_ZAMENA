...
public final class GlideException extends Exception {
    ...
    public final void printStackTrace(Appendable appendable) throws IOException {
    ...
    public static void appendExceptionMessage(Throwable th, Appendable appendable) throws IOException {
        try {
