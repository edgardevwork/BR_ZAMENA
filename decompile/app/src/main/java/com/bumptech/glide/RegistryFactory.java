...
public final class RegistryFactory {
    ...
    public static void initializeDefaults(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        registry2.append(cls, InputStream.class, modelLoaderFactoryInputStreamFactory).append(Integer.class, InputStream.class, modelLoaderFactoryInputStreamFactory).append(cls, (Class) obj, (ModelLoaderFactory) modelLoaderFactoryAssetFileDescriptorFactory).append(Integer.class, (Class) obj, (ModelLoaderFactory) modelLoaderFactoryAssetFileDescriptorFactory).append(cls, Drawable.class, modelLoaderFactoryDrawableFactory).append(Integer.class, Drawable.class, modelLoaderFactoryDrawableFactory).append(Uri.class, InputStream.class, ResourceUriLoader.newStreamFactory(context)).append(Uri.class, (Class) obj, (ModelLoaderFactory) ResourceUriLoader.newAssetFileDescriptorFactory(context));
        ResourceLoader.UriFactory uriFactory = new ResourceLoader.UriFactory(resources);
        ResourceLoader.AssetFileDescriptorFactory assetFileDescriptorFactory = new ResourceLoader.AssetFileDescriptorFactory(resources);
        ResourceLoader.StreamFactory streamFactory = new ResourceLoader.StreamFactory(resources);
        registry2.append(Integer.class, Uri.class, uriFactory).append(cls, Uri.class, uriFactory).append(Integer.class, (Class) obj, (ModelLoaderFactory) assetFileDescriptorFactory).append(cls, (Class) obj, (ModelLoaderFactory) assetFileDescriptorFactory).append(Integer.class, InputStream.class, streamFactory).append(cls, InputStream.class, streamFactory);
        registry2.append(String.class, InputStream.class, new DataUrlLoader.StreamFactory()).append(Uri.class, InputStream.class, new DataUrlLoader.StreamFactory()).append(String.class, InputStream.class, new StringLoader.StreamFactory()).append(String.class, ParcelFileDescriptor.class, new StringLoader.FileDescriptorFactory()).append(String.class, (Class) obj, (ModelLoaderFactory) new StringLoader.AssetFileDescriptorFactory()).append(Uri.class, InputStream.class, new AssetUriLoader.StreamFactory(context.getAssets())).append(Uri.class, (Class) obj, (ModelLoaderFactory) new AssetUriLoader.FileDescriptorFactory(context.getAssets())).append(Uri.class, InputStream.class, new MediaStoreImageThumbLoader.Factory(context)).append(Uri.class, InputStream.class, new MediaStoreVideoThumbLoader.Factory(context));
        if (i >= 29) {
    ...
    public static void initializeModules(Context context, Glide glide, Registry registry, List<GlideModule> list, @Nullable AppGlideModule appGlideModule) {
