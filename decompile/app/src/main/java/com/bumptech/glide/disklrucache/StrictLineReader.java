...
public class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    public static final byte f510CR = 13;

    /* renamed from: LF */
    public static final byte f511LF = 10;
    public byte[] buf;
    public final Charset charset;
    public int end;

    /* renamed from: in */
    public final InputStream f512in;
    public int pos;
    ...
    */
    ...
    public final void fillBuf() throws IOException {
        InputStream inputStream = this.f512in;
        byte[] bArr = this.buf;
