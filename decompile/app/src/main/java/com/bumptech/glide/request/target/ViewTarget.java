...
import com.bumptech.glide.C6562R;
...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
    ...
    public static int tagId = C6562R.id.glide_custom_view_target_tag;
    ...
    public final ViewTarget<T, Z> clearOnDetach() {
        ...
        this.attachStateListener = new View.OnAttachStateChangeListener() { // from class: com.bumptech.glide.request.target.ViewTarget.1
            public ViewOnAttachStateChangeListenerC66471() {
            }
    ...
    public class ViewOnAttachStateChangeListenerC66471 implements View.OnAttachStateChangeListener {
        public ViewOnAttachStateChangeListenerC66471() {
        }
