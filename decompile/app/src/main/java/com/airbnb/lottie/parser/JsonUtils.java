...
public class JsonUtils {
    public static final JsonReader.Options POINT_NAMES = JsonReader.Options.m963of("x", "y");
    ...
    public static /* synthetic */ class C34741 {
    ...
    public static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C34741.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    public static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C34741.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[tokenPeek.ordinal()];
        if (i == 1) {
