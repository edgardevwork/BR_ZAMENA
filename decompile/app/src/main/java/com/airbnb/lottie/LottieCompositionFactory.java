...
public class LottieCompositionFactory {
    ...
    public static final Set<LottieTaskIdleListener> taskIdleListeners = new HashSet();
    public static final byte[] ZIP_MAGIC = {FramedLZ4CompressorInputStream.SKIPPABLE_FRAME_PREFIX_BYTE_MASK, TarConstants.LF_GNUTYPE_LONGLINK, 3, 4};
    ...
    public static void clearCache(Context context) {
        ...
        NetworkCache networkCache = C3424L.networkCache(context);
    ...
    public static /* synthetic */ LottieResult lambda$fromUrl$0(Context context, String str, String str2) throws Exception {
        LottieResult<LottieComposition> lottieResultFetchSync = C3424L.networkFetcher(context).fetchSync(context, str, str2);
    ...
    public static LottieTask<LottieComposition> fromAsset(Context context, final String str, @Nullable final String str2) {
        ...
        return cache(str2, new Callable() { // from class: com.airbnb.lottie.LottieCompositionFactory$$ExternalSyntheticLambda11
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    public static LottieResult<LottieComposition> fromJsonInputStreamSync(InputStream inputStream, @Nullable String str, boolean z) {
        return fromJsonReaderSync(JsonReader.m962of(Okio.buffer(Okio.source(inputStream))), str, z);
    }
    ...
    public static LottieResult<LottieComposition> fromJsonStringSync(String str, @Nullable String str2) {
        return fromJsonReaderSync(JsonReader.m962of(Okio.buffer(Okio.source(new ByteArrayInputStream(str.getBytes())))), str2);
    }
    ...
    public static LottieResult<LottieComposition> fromJsonReaderSyncInternal(JsonReader jsonReader, @Nullable String str, boolean z) throws IOException {
    ...
    public static LottieTask<LottieComposition> fromZipStream(final Context context, final ZipInputStream zipInputStream, @Nullable final String str) {
        ...
        }, new Runnable() { // from class: com.airbnb.lottie.LottieCompositionFactory$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() throws IOException {
    ...
    public static LottieTask<LottieComposition> fromZipStream(final Context context, final ZipInputStream zipInputStream, @Nullable final String str, boolean z) {
        ...
        }, z ? new Runnable() { // from class: com.airbnb.lottie.LottieCompositionFactory$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                Utils.closeQuietly(zipInputStream);
            }
    ...
    @WorkerThread
    public static LottieResult<LottieComposition> fromZipStreamSyncInternal(Context context, ZipInputStream zipInputStream, @Nullable String str) throws IOException {
        LottieComposition lottieComposition;
        ...
        while (nextEntry != null) {
            ...
            if (name.contains("__MACOSX")) {
                ...
                value = fromJsonReaderSyncInternal(JsonReader.m962of(Okio.buffer(Okio.source(zipInputStream))), null, false).getValue();
            } else if (name.contains(".png") || name.contains(FileTypes.EXTENSION_WEBP) || name.contains(FileTypes.EXTENSION_JPG) || name.contains(FileTypes.EXTENSION_JPEG)) {
    ...
    public static Boolean isGzipCompressed(BufferedSource bufferedSource) {
        return matchesMagicBytes(bufferedSource, GZIP_MAGIC);
    }

    public static Boolean matchesMagicBytes(BufferedSource bufferedSource, byte[] bArr) {
        try {
    ...
    public static LottieTask<LottieComposition> cache(@Nullable final String str, Callable<LottieResult<LottieComposition>> callable, @Nullable Runnable runnable) {
        LottieComposition lottieComposition = str == null ? null : LottieCompositionCache.getInstance().get(str);
        ...
        if (str != null) {
            ...
            lottieTask2.addListener(new LottieListener() { // from class: com.airbnb.lottie.LottieCompositionFactory$$ExternalSyntheticLambda14
                @Override // com.airbnb.lottie.LottieListener
                public final void onResult(Object obj) {
                    LottieCompositionFactory.lambda$cache$15(str, atomicBoolean, (LottieComposition) obj);
                }
            });
            lottieTask2.addFailureListener(new LottieListener() { // from class: com.airbnb.lottie.LottieCompositionFactory$$ExternalSyntheticLambda15
                @Override // com.airbnb.lottie.LottieListener
                public final void onResult(Object obj) {
    ...
    public static void notifyTaskCacheIdleListeners(boolean z) {
