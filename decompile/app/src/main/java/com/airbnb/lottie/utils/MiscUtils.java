...
public class MiscUtils {
    ...
    public static double lerp(double d, double d2, @FloatRange(from = 0.0d, m9to = 1.0d) double d3) {
        return d + (d3 * (d2 - d));
    }

    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, m9to = 1.0d) float f3) {
        return f + (f3 * (f2 - f));
    }

    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, m9to = 1.0d) float f) {
        return (int) (i + (f * (i2 - i)));
    }
