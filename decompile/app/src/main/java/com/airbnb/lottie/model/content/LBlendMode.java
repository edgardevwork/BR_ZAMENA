...
public enum LBlendMode {
    ...
    /* renamed from: com.airbnb.lottie.model.content.LBlendMode$1 */
    public static /* synthetic */ class C34661 {
        public static final /* synthetic */ int[] $SwitchMap$com$airbnb$lottie$model$content$LBlendMode;
    ...
    public BlendModeCompat toNativeBlendMode() {
        int i = C34661.$SwitchMap$com$airbnb$lottie$model$content$LBlendMode[ordinal()];
        if (i == 2) {
