...
public class AnimatableTransformParser {
    public static final JsonReader.Options NAMES = JsonReader.Options.m963of("a", "p", "s", "rz", "r", "o", "so", "eo", "sk", "sa");
    public static final JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m963of("k");
