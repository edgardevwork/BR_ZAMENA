...
public class DropShadowKeyframeAnimation implements BaseKeyframeAnimation.AnimationListener {
    ...
    public final BaseKeyframeAnimation<Integer, Integer> color;
    public final BaseKeyframeAnimation<Float, Float> direction;
    public final BaseKeyframeAnimation<Float, Float> distance;
    public boolean isDirty = true;
    public final BaseKeyframeAnimation.AnimationListener listener;
    public final BaseKeyframeAnimation<Float, Float> opacity;
    public final BaseKeyframeAnimation<Float, Float> radius;
    ...
    public void applyTo(Paint paint) {
        if (this.isDirty) {
            this.isDirty = false;
            double dFloatValue = this.direction.getValue().floatValue() * 0.017453292519943295d;
