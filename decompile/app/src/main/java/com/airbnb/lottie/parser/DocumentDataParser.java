...
public class DocumentDataParser implements ValueParser<DocumentData> {
    ...
    public static final JsonReader.Options NAMES = JsonReader.Options.m963of("t", "f", "s", "j", AdminToolsKeys.ADMIN_TOOLS_PLAYER_TEXT_REPORT_KEY, MarketplaceKeys.MARKETPLACE_PUBLISHED_HOT_CARDS_KEY, MarketplaceKeys.MARKETPLACE_PAGES_KEY, "fc", GiftsKeys.GET_VALUE_OF_STANDARD_GIFTS_KEY, "sw", "of", "ps", "sz");
