...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (baseLayerForModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C34691.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
    ...
    public static /* synthetic */ class C34691 {
    ...
    public void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C3424L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C3424L.endSection("CompositionLayer#draw");
    }
    ...
    public void setProgress(@FloatRange(from = 0.0d, m9to = 1.0d) float f) {
        C3424L.beginSection("CompositionLayer#setProgress");
        this.progress = f;
        super.setProgress(f);
        ...
        C3424L.endSection("CompositionLayer#setProgress");
    }
