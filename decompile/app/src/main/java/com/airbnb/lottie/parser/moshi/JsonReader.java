...
public abstract class JsonReader implements Closeable {
    ...
    /* renamed from: of */
    public static JsonReader m962of(BufferedSource bufferedSource) {
    ...
    public static final class Options {
        ...
        /* renamed from: of */
        public static Options m963of(String... strArr) {
            try {
                ...
                return new Options((String[]) strArr.clone(), okio.Options.m7276of(byteStringArr));
            } catch (IOException e) {
