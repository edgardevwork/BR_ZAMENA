...
public class FontCharacterParser {
    public static final JsonReader.Options NAMES = JsonReader.Options.m963of("ch", "size", "w", "style", "fFamily", "data");
    public static final JsonReader.Options DATA_NAMES = JsonReader.Options.m963of("shapes");
