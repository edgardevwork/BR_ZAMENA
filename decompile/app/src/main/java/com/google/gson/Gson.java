...
public final class Gson {
    ...
    public final TypeAdapter<Number> doubleAdapter(boolean z) {
        if (z) {
    ...
    public class C77871 extends TypeAdapter<Number> {
        public C77871() {
        }
    ...
    public final TypeAdapter<Number> floatAdapter(boolean z) {
        if (z) {
    ...
    /* loaded from: classes6.dex */
    public class C77882 extends TypeAdapter<Number> {
        public C77882() {
        }
    ...
    /* loaded from: classes6.dex */
    public class C77893 extends TypeAdapter<Number> {
        @Override // com.google.gson.TypeAdapter
        /* renamed from: read */
        public Number read2(JsonReader jsonReader) throws IOException {
            if (jsonReader.peek() == JsonToken.NULL) {
    ...
    /* loaded from: classes6.dex */
    public class C77904 extends TypeAdapter<AtomicLong> {
        public C77904() {
        }
    ...
    /* loaded from: classes6.dex */
    public class C77915 extends TypeAdapter<AtomicLongArray> {
        public C77915() {
        }
    ...
    */
    ...
    public String toString() {
        return "{serializeNulls:" + this.serializeNulls + ",factories:" + this.factories + ",instanceCreators:" + this.constructorConstructor + WebvttCssParser.RULE_END;
    }
}
