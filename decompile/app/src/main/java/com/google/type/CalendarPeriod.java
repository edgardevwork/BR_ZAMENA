...
public enum CalendarPeriod implements Internal.EnumLite {
    ...
    public static final Internal.EnumLiteMap<CalendarPeriod> internalValueMap = new Internal.EnumLiteMap<CalendarPeriod>() { // from class: com.google.type.CalendarPeriod.1
    ...
    public static final class CalendarPeriodVerifier implements Internal.EnumVerifier {
        public static final Internal.EnumVerifier INSTANCE = new CalendarPeriodVerifier();
