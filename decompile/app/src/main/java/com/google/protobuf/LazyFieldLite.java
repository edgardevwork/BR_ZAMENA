...
public class LazyFieldLite {
    ...
    public static MessageLite mergeValueAndBytes(MessageLite value, ByteString otherBytes, ExtensionRegistryLite extensionRegistry) {
        try {
    ...
    public static void checkArguments(ExtensionRegistryLite extensionRegistry, ByteString bytes) {
