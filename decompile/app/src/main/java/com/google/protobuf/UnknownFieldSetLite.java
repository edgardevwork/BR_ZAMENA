...
public final class UnknownFieldSetLite {
    ...
    public UnknownFieldSetLite(int count, int[] tags, Object[] objects, boolean isMutable) {
    ...
    public static void writeField(int tag, Object object, Writer writer) throws IOException {
    ...
    public static boolean tagsEquals(int[] tags1, int[] tags2, int count) {
    ...
    public static boolean objectsEquals(Object[] objects1, Object[] objects2, int count) {
        for (int i = 0; i < count; i++) {
    ...
    public static int hashCode(int[] tags, int count) {
        int i = 17;
    ...
    public static int hashCode(Object[] objects, int count) {
        int iHashCode = 17;
        for (int i = 0; i < count; i++) {
    ...
    public final UnknownFieldSetLite mergeFrom(final CodedInputStream input) throws IOException {
        int tag;
        do {
            tag = input.readTag();
            if (tag == 0) {
