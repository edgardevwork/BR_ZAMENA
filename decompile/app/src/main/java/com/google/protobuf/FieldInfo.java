...
public final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static boolean isExactlyOneBitSet(int value) {
    ...
    public static FieldInfo forField(java.lang.reflect.Field field, int fieldNumber, FieldType fieldType, boolean enforceUtf8) {
        ...
        Internal.checkNotNull(field, SerializableConverter.ELEMENT_FIELD);
    ...
    public static /* synthetic */ class C79331 {
    ...
    public Class<?> getMessageFieldClass() {
        int i = C79331.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(C79331 c79331) {
            this();
        }
