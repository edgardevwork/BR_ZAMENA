...
public final class UnsafeUtil {
    ...
    public static int firstDifferingByteIndexNativeEndian(long left, long right) {
    ...
    public static java.lang.reflect.Field field(Class<?> clazz, String fieldName) {
        try {
    ...
    public static final class Android32MemoryAccessor extends MemoryAccessor {
        ...
        public static int smallAddress(long address) {
            return (int) address;
        }
