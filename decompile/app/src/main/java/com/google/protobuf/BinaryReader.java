...
public abstract class BinaryReader implements Reader {
    ...
    public /* synthetic */ BinaryReader(C79061 c79061) {
        this();
    }
    ...
    public static final class SafeHeapReader extends BinaryReader {
        ...
        public final <T> T readMessage(Schema<T> schema, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        public final <T> T readGroup(Schema<T> schema, ExtensionRegistryLite extensionRegistry) throws IOException {
            T tNewInstance = schema.newInstance();
        ...
        public final Object readField(WireFormat.FieldType fieldType, Class<?> messageType, ExtensionRegistryLite extensionRegistry) throws IOException {
            switch (C79061.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
                case 1:
        ...
        public final long readVarint64SlowPath() throws IOException {
            long j = 0;
        ...
        public final int readLittleEndian32() throws IOException {
            requireBytes(4);
            return readLittleEndian32_NoCheck();
        }

        public final long readLittleEndian64() throws IOException {
            requireBytes(8);
        ...
        public final void skipVarint() throws IOException {
            int i = this.limit;
            int i2 = this.pos;
            if (i - i2 >= 10) {
                byte[] bArr = this.buffer;
        ...
        public final void skipVarintSlowPath() throws IOException {
            for (int i = 0; i < 10; i++) {
                if (readByte() >= 0) {
                    return;
                }
        ...
        public final void skipBytes(final int size) throws IOException {
            requireBytes(size);
            this.pos += size;
        }
        ...
        public final void requireBytes(int size) throws IOException {
            if (size < 0 || size > this.limit - this.pos) {
                throw InvalidProtocolBufferException.truncatedMessage();
            }
        }

        public final void requireWireType(int requiredWireType) throws IOException {
            if (WireFormat.getTagWireType(this.tag) != requiredWireType) {
                throw InvalidProtocolBufferException.invalidWireType();
            }
        }

        public final void verifyPackedFixed64Length(int bytes) throws IOException {
            requireBytes(bytes);
            if ((bytes & 7) != 0) {
                throw InvalidProtocolBufferException.parseFailure();
            }
        ...
        public final void verifyPackedFixed32Length(int bytes) throws IOException {
            requireBytes(bytes);
            if ((bytes & 3) != 0) {
                throw InvalidProtocolBufferException.parseFailure();
            }
        ...
        public final void requirePosition(int expectedPosition) throws IOException {
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C79061 {
