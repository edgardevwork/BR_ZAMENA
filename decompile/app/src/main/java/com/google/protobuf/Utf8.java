...
public final class Utf8 {
    ...
    public static abstract class Processor {
        ...
        public abstract int encodeUtf8(CharSequence in, byte[] out, int offset, int length);

        public abstract void encodeUtf8Direct(CharSequence in, ByteBuffer out);
        ...
        */
        public final int partialIsValidUtf8Default(final int state, final ByteBuffer buffer, int index, final int limit) {
            byte b;
            int i;
            int i2;
            if (state != 0) {
    ...
    public static final class SafeProcessor extends Processor {
        ...
        */
        ...
        public static int partialIsValidUtf8NonAscii(byte[] bytes, int index, int limit) {
            while (index < limit) {
                int i = index + 1;
                byte b = bytes[index];
                if (b < 0) {
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public int partialIsValidUtf8(int state, byte[] bytes, final int index, final int limit) {
            byte b;
            long j;
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public int partialIsValidUtf8Direct(final int state, ByteBuffer buffer, final int index, final int limit) {
            byte b;
            long j;
        ...
        @Override // com.google.protobuf.Utf8.Processor
        public int encodeUtf8(final CharSequence in, final byte[] out, final int offset, final int length) {
            long j;
            String str;
            String str2;
            int i;
        ...
        public static int unsafeEstimateConsecutiveAscii(byte[] bytes, long offset, final int maxChars) {
            int i = 0;
            if (maxChars < 16) {
                return 0;
            }
        ...
        public static int unsafeEstimateConsecutiveAscii(long address, final int maxChars) {
            if (maxChars < 16) {
                return 0;
            }
            int i = (int) ((-address) & 7);
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public static int partialIsValidUtf8(final byte[] bytes, long offset, int remaining) {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public static int partialIsValidUtf8(long address, int remaining) {
        ...
        public static int unsafeIncompleteStateFor(byte[] bytes, int byte1, long offset, int remaining) {
            if (remaining == 0) {
        ...
        public static int unsafeIncompleteStateFor(long address, final int byte1, int remaining) {
            if (remaining == 0) {
                return Utf8.incompleteStateFor(byte1);
            }
            if (remaining == 1) {
    ...
    public static class DecodeUtil {
        ...
        public static void handleThreeBytes(byte byte1, byte byte2, byte byte3, char[] resultArr, int resultPos) throws InvalidProtocolBufferException {
            ...
            resultArr[resultPos] = (char) (((byte1 & Ascii.f786SI) << 12) | (trailingByteValue(byte2) << 6) | trailingByteValue(byte3));
        }
