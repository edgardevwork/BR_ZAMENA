...
final class C7654xb26d2aa8 extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch {
    private final String arch;
    private final String buildId;
    private final String libraryName;

    private C7654xb26d2aa8(String str, String str2, String str3) {
        this.arch = str;
    ...
    public String toString() {
        return "BuildIdMappingForArch{arch=" + this.arch + ", libraryName=" + this.libraryName + ", buildId=" + this.buildId + WebvttCssParser.RULE_END;
    }
    ...
    public static final class Builder extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch.Builder {
        ...
        public CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch build() {
            ...
            return new C7654xb26d2aa8(str3, str, str2);
        }
    }
}
