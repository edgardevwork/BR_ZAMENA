...
final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public /* synthetic */ AutoValue_PersistedInstallationEntry(String str, PersistedInstallation.RegistrationStatus registrationStatus, String str2, String str3, long j, long j2, String str4, C76961 c76961) {
    ...
    public String toString() {
        return "PersistedInstallationEntry{firebaseInstallationId=" + this.firebaseInstallationId + ", registrationStatus=" + this.registrationStatus + ", authToken=" + this.authToken + ", refreshToken=" + this.refreshToken + ", expiresInSecs=" + this.expiresInSecs + ", tokenCreationEpochInSecs=" + this.tokenCreationEpochInSecs + ", fisError=" + this.fisError + WebvttCssParser.RULE_END;
    }
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public /* synthetic */ Builder(PersistedInstallationEntry persistedInstallationEntry, C76961 c76961) {
