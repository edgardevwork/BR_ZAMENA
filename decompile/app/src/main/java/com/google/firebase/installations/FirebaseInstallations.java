...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public class ThreadFactoryC76911 implements ThreadFactory {
        private final AtomicInteger mCount = new AtomicInteger(1);
    ...
    public class C76922 implements FidListenerHandle {
        final /* synthetic */ FidListener val$listener;

        public C76922(FidListener fidListener) {
    ...
    public synchronized FidListenerHandle registerFidListener(@NonNull FidListener fidListener) {
        ...
        return new FidListenerHandle() { // from class: com.google.firebase.installations.FirebaseInstallations.2
            ...
            public C76922(FidListener fidListener2) {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C76933.f874xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(@NonNull PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C76933.f875xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C76933 {
        ...
        static {
            ...
            try {
                f875xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f875xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f874xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
