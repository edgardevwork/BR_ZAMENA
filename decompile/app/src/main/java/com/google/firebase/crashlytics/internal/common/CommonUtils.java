  ...
  (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) from 0x0084: INVOKE (r5v5 java.util.HashMap), ("x86"), (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) INTERFACE call: java.util.Map.put(java.lang.Object, java.lang.Object):java.lang.Object A[MD:(K, V):V (c)] (LINE:114)
    ...
    public static final class Architecture {
        ...
        public static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m1361v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    private static String hash(byte[] bArr, String str) throws NoSuchAlgorithmException {
        try {
            ...
            Logger.getLogger().m1358e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static List<BuildIdInfo> getBuildIdInfo(Context context) throws Resources.NotFoundException {
        ...
        if (resourcesIdentifier == 0 || resourcesIdentifier2 == 0 || resourcesIdentifier3 == 0) {
            Logger.getLogger().m1355d(String.format("Could not find resources: %d %d %d", Integer.valueOf(resourcesIdentifier), Integer.valueOf(resourcesIdentifier2), Integer.valueOf(resourcesIdentifier3)));
            return arrayList;
        }
        ...
        if (stringArray.length != stringArray3.length || stringArray2.length != stringArray3.length) {
            Logger.getLogger().m1355d(String.format("Lengths did not match: %d %d %d", Integer.valueOf(stringArray.length), Integer.valueOf(stringArray2.length), Integer.valueOf(stringArray3.length)));
            return arrayList;
        }
    ...
    public static boolean canTryConnection(Context context) {
        if (!checkPermission(context, DefaultConnectivityMonitorFactory.NETWORK_PERMISSION)) {
            return true;
        }
