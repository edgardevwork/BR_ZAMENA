...
public final /* data */ class ApplicationInfo {
    ...
    @NotNull
    public final ApplicationInfo copy(@NotNull String str, @NotNull String deviceModel, @NotNull String sessionSdkVersion, @NotNull String osVersion, @NotNull LogEnvironment logEnvironment, @NotNull AndroidApplicationInfo androidAppInfo) {
        ...
        return new ApplicationInfo(str, deviceModel, sessionSdkVersion, osVersion, logEnvironment, androidAppInfo);
    }
