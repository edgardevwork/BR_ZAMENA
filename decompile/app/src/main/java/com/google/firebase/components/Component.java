...
public final class Component<T> {
    ...
    public String toString() {
        return "Component<" + Arrays.toString(this.providedInterfaces.toArray()) + ">{" + this.instantiation + ", type=" + this.type + ", deps=" + Arrays.toString(this.dependencies.toArray()) + WebvttCssParser.RULE_END;
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m1350of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m1352of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m1351of(final T t, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
