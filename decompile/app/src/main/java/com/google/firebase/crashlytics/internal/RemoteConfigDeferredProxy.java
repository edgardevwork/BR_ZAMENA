...
public class RemoteConfigDeferredProxy {
    ...
    public void setupListener(UserMetadata userMetadata) {
        if (userMetadata == null) {
            Logger.getLogger().m1363w("Didn't successfully register with UserMetadata for rollouts listener");
        } else {
    ...
    public static /* synthetic */ void lambda$setupListener$0(CrashlyticsRemoteConfigListener crashlyticsRemoteConfigListener, Provider provider) {
        ...
        Logger.getLogger().m1355d("Registering RemoteConfig Rollouts subscriber");
    }
}
