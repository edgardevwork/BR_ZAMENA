...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    public static Settings defaultSettings(CurrentTimeProvider currentTimeProvider) {
        return new Settings(currentTimeProvider.getCurrentTimeMillis() + DefaultRepositoryCacheManager.MILLIS_IN_HOUR, new Settings.SessionData(8, 4), new Settings.FeatureFlagData(true, false, false), 0, 3600, 10.0d, 1.2d, 60);
    }
}
