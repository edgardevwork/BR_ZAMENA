...
public final class SessionsSettings {
    ...
    @DebugMetadata(m7119c = "com.google.firebase.sessions.settings.SessionsSettings", m7120f = "SessionsSettings.kt", m7121i = {0}, m7122l = {138, 139}, m7123m = "updateSettings", m7124n = {"this"}, m7125s = {"L$0"})
    /* renamed from: com.google.firebase.sessions.settings.SessionsSettings$updateSettings$1 */
    /* loaded from: classes7.dex */
    public static final class C77751 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C77751(Continuation<? super C77751> continuation) {
            super(continuation);
        }
    ...
    public SessionsSettings(@NotNull FirebaseApp firebaseApp, @NotNull CoroutineContext blockingDispatcher, @NotNull CoroutineContext backgroundDispatcher, @NotNull FirebaseInstallationsApi firebaseInstallationsApi) {
    ...
    public final long m15338getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo15336getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo15336getSessionRestartTimeoutFghU774();
        if (durationMo15336getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo15336getSessionRestartTimeoutFghU774.getRawValue();
            if (m15337isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo15336getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo15336getSessionRestartTimeoutFghU774();
        if (durationMo15336getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo15336getSessionRestartTimeoutFghU7742.getRawValue();
            if (m15337isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m15337isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m17059isPositiveimpl(sessionRestartTimeout) && Duration.m17054isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    public final Object updateSettings(@NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C77751) {
            c77751 = (C77751) continuation;
            int i = c77751.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c77751.label = i - Integer.MIN_VALUE;
            } else {
                c77751 = new C77751(continuation);
            }
        }
        Object obj = c77751.result;
        ...
        if (i2 == 0) {
            ...
            c77751.L$0 = this;
            c77751.label = 1;
            if (settingsProvider.updateSettings(c77751) == coroutine_suspended) {
            ...
            sessionsSettings = (SessionsSettings) c77751.L$0;
            ResultKt.throwOnFailure(obj);
        }
        SettingsProvider settingsProvider2 = sessionsSettings.remoteSettings;
        c77751.L$0 = null;
        c77751.label = 2;
        if (settingsProvider2.updateSettings(c77751) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
