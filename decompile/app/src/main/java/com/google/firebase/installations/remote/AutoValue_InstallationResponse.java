...
final class AutoValue_InstallationResponse extends InstallationResponse {
    ...
    public /* synthetic */ AutoValue_InstallationResponse(String str, String str2, String str3, TokenResult tokenResult, InstallationResponse.ResponseCode responseCode, C76971 c76971) {
    ...
    public String toString() {
        return "InstallationResponse{uri=" + this.uri + ", fid=" + this.fid + ", refreshToken=" + this.refreshToken + ", authToken=" + this.authToken + ", responseCode=" + this.responseCode + WebvttCssParser.RULE_END;
    }
    ...
    public static final class Builder extends InstallationResponse.Builder {
        ...
        public /* synthetic */ Builder(InstallationResponse installationResponse, C76971 c76971) {
