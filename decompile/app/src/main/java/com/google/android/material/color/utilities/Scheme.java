...
public class Scheme {
    ...
    public static Scheme light(int i) {
        return lightFromCorePalette(CorePalette.m1117of(i));
    }

    public static Scheme dark(int i) {
        return darkFromCorePalette(CorePalette.m1117of(i));
    }
    ...
    public static Scheme lightFromCorePalette(CorePalette corePalette) {
        return new Scheme().withPrimary(corePalette.f693a1.tone(40)).withOnPrimary(corePalette.f693a1.tone(100)).withPrimaryContainer(corePalette.f693a1.tone(90)).withOnPrimaryContainer(corePalette.f693a1.tone(10)).withSecondary(corePalette.f694a2.tone(40)).withOnSecondary(corePalette.f694a2.tone(100)).withSecondaryContainer(corePalette.f694a2.tone(90)).withOnSecondaryContainer(corePalette.f694a2.tone(10)).withTertiary(corePalette.f695a3.tone(40)).withOnTertiary(corePalette.f695a3.tone(100)).withTertiaryContainer(corePalette.f695a3.tone(90)).withOnTertiaryContainer(corePalette.f695a3.tone(10)).withError(corePalette.error.tone(40)).withOnError(corePalette.error.tone(100)).withErrorContainer(corePalette.error.tone(90)).withOnErrorContainer(corePalette.error.tone(10)).withBackground(corePalette.f696n1.tone(99)).withOnBackground(corePalette.f696n1.tone(10)).withSurface(corePalette.f696n1.tone(99)).withOnSurface(corePalette.f696n1.tone(10)).withSurfaceVariant(corePalette.f697n2.tone(90)).withOnSurfaceVariant(corePalette.f697n2.tone(30)).withOutline(corePalette.f697n2.tone(50)).withOutlineVariant(corePalette.f697n2.tone(80)).withShadow(corePalette.f696n1.tone(0)).withScrim(corePalette.f696n1.tone(0)).withInverseSurface(corePalette.f696n1.tone(20)).withInverseOnSurface(corePalette.f696n1.tone(95)).withInversePrimary(corePalette.f693a1.tone(80));
    }

    public static Scheme darkFromCorePalette(CorePalette corePalette) {
        return new Scheme().withPrimary(corePalette.f693a1.tone(80)).withOnPrimary(corePalette.f693a1.tone(20)).withPrimaryContainer(corePalette.f693a1.tone(30)).withOnPrimaryContainer(corePalette.f693a1.tone(90)).withSecondary(corePalette.f694a2.tone(80)).withOnSecondary(corePalette.f694a2.tone(20)).withSecondaryContainer(corePalette.f694a2.tone(30)).withOnSecondaryContainer(corePalette.f694a2.tone(90)).withTertiary(corePalette.f695a3.tone(80)).withOnTertiary(corePalette.f695a3.tone(20)).withTertiaryContainer(corePalette.f695a3.tone(30)).withOnTertiaryContainer(corePalette.f695a3.tone(90)).withError(corePalette.error.tone(80)).withOnError(corePalette.error.tone(20)).withErrorContainer(corePalette.error.tone(30)).withOnErrorContainer(corePalette.error.tone(80)).withBackground(corePalette.f696n1.tone(10)).withOnBackground(corePalette.f696n1.tone(90)).withSurface(corePalette.f696n1.tone(10)).withOnSurface(corePalette.f696n1.tone(90)).withSurfaceVariant(corePalette.f697n2.tone(30)).withOnSurfaceVariant(corePalette.f697n2.tone(80)).withOutline(corePalette.f697n2.tone(60)).withOutlineVariant(corePalette.f697n2.tone(30)).withShadow(corePalette.f696n1.tone(0)).withScrim(corePalette.f696n1.tone(0)).withInverseSurface(corePalette.f696n1.tone(90)).withInverseOnSurface(corePalette.f696n1.tone(20)).withInversePrimary(corePalette.f693a1.tone(40));
    }
