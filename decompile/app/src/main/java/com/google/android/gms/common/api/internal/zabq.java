...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    public final void zaI(int i) {
        ...
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 11, apiKey2), FileBasedLockStrategy.DEFAULT_TIMEOUT);
        this.zaa.zak.zac();
        Iterator it = this.zag.values().iterator();
        while (it.hasNext()) {
    ...
    private final boolean zaM(zai zaiVar) throws Resources.NotFoundException {
        ...
        googleApiManager3.zar.sendMessageDelayed(Message.obtain(googleApiManager3.zar, 16, zabsVar), FileBasedLockStrategy.DEFAULT_TIMEOUT);
