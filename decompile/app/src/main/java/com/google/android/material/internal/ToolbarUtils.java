...
public class ToolbarUtils {
    ...
    public class C69081 implements Comparator<View> {
        @Override // java.util.Comparator
        public int compare(View view, View view2) {
            return view.getTop() - view2.getTop();
        }
    ...
    public static List<TextView> getTextViewsWithText(@NonNull Toolbar toolbar, CharSequence charSequence) {
    ...
    @Nullable
    public static ImageView getImageView(@NonNull Toolbar toolbar, @Nullable Drawable drawable) {
        ImageView imageView;
        Drawable drawable2;
        if (drawable == null) {
            return null;
