...
import com.google.android.gms.base.C6754R;
...
public final class zac {
    ...
    public static String zab(Context context, int i) {
        ...
        return i != 1 ? i != 2 ? i != 3 ? resources.getString(R.string.ok) : resources.getString(C6754R.string.common_google_play_services_enable_button) : resources.getString(C6754R.string.common_google_play_services_update_button) : resources.getString(C6754R.string.common_google_play_services_install_button);
    }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C6754R.string.common_google_play_services_install_text, strZaa);
        }
        if (i == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C6754R.string.common_google_play_services_wear_update_text) : resources.getString(C6754R.string.common_google_play_services_update_text, strZaa);
        }
        if (i == 3) {
            return resources.getString(C6754R.string.common_google_play_services_enable_text, strZaa);
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(C6754R.string.common_google_play_services_unsupported_text, strZaa);
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(C6754R.string.common_google_play_services_updating_text, strZaa);
            default:
                return resources.getString(C6756R.string.common_google_play_services_unknown_issue, strZaa);
        }
    }
    ...
    public static String zae(Context context, int i) {
        ...
        return strZah == null ? context.getResources().getString(C6754R.string.common_google_play_services_notification_ticker) : strZah;
    }
    ...
    public static String zaf(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C6754R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C6754R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C6754R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zag(Context context, String str, String str2) throws Resources.NotFoundException {
        ...
        if (strZah == null) {
            strZah = resources.getString(C6756R.string.common_google_play_services_unknown_issue);
        }
