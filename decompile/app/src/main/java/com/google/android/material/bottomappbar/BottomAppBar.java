...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    public static final int FAB_ALIGNMENT_ANIM_DURATION_DEFAULT = 300;
    public static final float FAB_ALIGNMENT_ANIM_EASING_MIDPOINT = 0.2f;
    ...
    public static final int NO_FAB_END_MARGIN = -1;
    ...
    public static final int DEF_STYLE_RES = C6765R.style.Widget_MaterialComponents_BottomAppBar;
    public static final int FAB_ALIGNMENT_ANIM_DURATION_ATTR = C6765R.attr.motionDurationLong2;
    public static final int FAB_ALIGNMENT_ANIM_EASING_ATTR = C6765R.attr.motionEasingEmphasizedInterpolator;
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6765R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C6765R.styleable.BottomAppBar, i, i2, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C6765R.styleable.BottomAppBar_backgroundTint);
        int i3 = C6765R.styleable.BottomAppBar_navigationIconTint;
        if (typedArrayObtainStyledAttributes.hasValue(i3)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(i3, -1));
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C6765R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C6765R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C6765R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C6765R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = typedArrayObtainStyledAttributes.getInt(C6765R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = typedArrayObtainStyledAttributes.getInt(C6765R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.fabAnchorMode = typedArrayObtainStyledAttributes.getInt(C6765R.styleable.BottomAppBar_fabAnchorMode, 1);
        this.removeEmbeddedFabElevation = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_removeEmbeddedFabElevation, true);
        this.menuAlignmentMode = typedArrayObtainStyledAttributes.getInt(C6765R.styleable.BottomAppBar_menuAlignmentMode, 0);
        this.hideOnScroll = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_hideOnScroll, false);
        this.paddingBottomSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_paddingRightSystemWindowInsets, false);
        this.fabAlignmentModeEndMargin = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C6765R.styleable.BottomAppBar_fabAlignmentModeEndMargin, -1);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.BottomAppBar_addElevationShadow, true);
        typedArrayObtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C6765R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
    ...
    public final void maybeAnimateModeChange(int i) {
    ...
    public final void createFabTranslationXAnimation(int i, @NonNull List<Animator> list) {
    ...
    public final void createMenuViewTranslationAnimation(final int i, final boolean z, @NonNull List<Animator> list) {
    ...
    public final void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i, boolean z) {
        translateActionMenuView(actionMenuView, i, z, false);
    }

    public final void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i, final boolean z, boolean z2) {
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z) throws Resources.NotFoundException {
        ...
        if (getNavigationIcon() == null) {
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C6765R.dimen.m3_bottomappbar_horizontal_padding);
            if (!zIsLayoutRtl) {
    ...
    public final void addFabAnimationListeners(@NonNull FloatingActionButton floatingActionButton) {
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        if (bottomAppBar.fabAnchorMode == 1) {
                            ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C6765R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((view.getMeasuredHeight() - height) / 2));
                        }
            ...
            if (viewFindDependentView != null && !ViewCompat.isLaidOut(viewFindDependentView)) {
                ...
                if (viewFindDependentView instanceof FloatingActionButton) {
                    ...
                    if (floatingActionButton.getShowMotionSpec() == null) {
                        floatingActionButton.setShowMotionSpecResource(C6765R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (floatingActionButton.getHideMotionSpec() == null) {
                        floatingActionButton.setHideMotionSpecResource(C6765R.animator.mtrl_fab_hide_motion_spec);
                    }
