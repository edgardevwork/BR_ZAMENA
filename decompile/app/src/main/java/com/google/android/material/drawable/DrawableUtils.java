...
public final class DrawableUtils {
    ...
    @NonNull
    public static AttributeSet parseDrawableXml(@NonNull Context context, @XmlRes int i, @NonNull CharSequence charSequence) throws XmlPullParserException, Resources.NotFoundException {
        int next;
        try {
    ...
    @Nullable
    public static Drawable createTintableMutatedDrawableIfNeeded(@Nullable Drawable drawable, @Nullable ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, boolean z) {
        if (drawable == null) {
            return null;
        }
    ...
    public static int getTopLayerIntrinsicWidth(@NonNull Drawable drawable, @NonNull Drawable drawable2) {
        int intrinsicWidth = drawable2.getIntrinsicWidth();
        return intrinsicWidth != -1 ? intrinsicWidth : drawable.getIntrinsicWidth();
    }

    public static int getTopLayerIntrinsicHeight(@NonNull Drawable drawable, @NonNull Drawable drawable2) {
    ...
    public static ColorStateList getColorStateListOrNull(@Nullable Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !DrawableUtils$$ExternalSyntheticApiModelOutline0.m1118m(drawable)) {
            return null;
        }
        return DrawableUtils$$ExternalSyntheticApiModelOutline1.m1119m(drawable).getColorStateList();
    }
