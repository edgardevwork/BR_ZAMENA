...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m1069id = 2)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m1069id = 3)
    private final PendingIntent zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m1069id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) int i2, @Nullable @SafeParcelable.Param(m1070id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m1070id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
    ...
    public String toString() {
        ...
        stringHelper.add(ManifestParser.ATTR_RESOLUTION, this.zzc);
        stringHelper.add(ThrowableDeserializer.PROP_NAME_MESSAGE, this.zzd);
