...
public class SideSheetDialog extends SheetDialog<SideSheetCallback> {
    public static final int SIDE_SHEET_DIALOG_THEME_ATTR = C6765R.attr.sideSheetDialogTheme;
    public static final int SIDE_SHEET_DIALOG_DEFAULT_THEME_RES = C6765R.style.Theme_Material3_Light_SideSheetDialog;
    ...
    public int getLayoutResId() {
        return C6765R.layout.m3_side_sheet_dialog;
    }

    @Override // com.google.android.material.sidesheet.SheetDialog
    @IdRes
    public int getDialogId() {
        return C6765R.id.m3_side_sheet;
    }
