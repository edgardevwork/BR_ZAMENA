...
public final class zzni implements zznj {
    ...
    static {
        ...
        zzac = zzhrVarZza.zza("measurement.upload.refresh_blacklisted_config_interval", EventStoreConfig.DURATION_ONE_WEEK_MS);
        ...
        zzal = zzhrVarZza.zza("measurement.sdk.attribution.cache.ttl", EventStoreConfig.DURATION_ONE_WEEK_MS);
