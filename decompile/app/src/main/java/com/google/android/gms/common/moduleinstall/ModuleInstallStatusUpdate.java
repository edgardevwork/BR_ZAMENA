...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @InstallState
    @SafeParcelable.Field(getter = "getInstallState", m1069id = 2)
    private final int zab;

    @Nullable
    @SafeParcelable.Field(getter = "getBytesDownloaded", m1069id = 3)
    private final Long zac;

    @Nullable
    @SafeParcelable.Field(getter = "getTotalBytesToDownload", m1069id = 4)
    private final Long zad;

    @SafeParcelable.Field(getter = "getErrorCode", m1069id = 5)
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) @InstallState int i2, @Nullable @SafeParcelable.Param(m1070id = 3) Long l, @Nullable @SafeParcelable.Param(m1070id = 4) Long l2, @SafeParcelable.Param(m1070id = 5) int i3) {
        this.zaa = i;
        this.zab = i2;
        this.zac = l;
        this.zad = l2;
