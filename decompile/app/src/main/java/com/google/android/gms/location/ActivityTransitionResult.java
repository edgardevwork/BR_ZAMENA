...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", m1069id = 1)
    private final List<ActivityTransitionEvent> zza;

    @Nullable
    @SafeParcelable.Field(getter = "getExtras", m1069id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m1070id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m1070id = 1) List<ActivityTransitionEvent> list, @Nullable @SafeParcelable.Param(m1070id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
