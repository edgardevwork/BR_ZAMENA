...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    @AttrRes
    public static final int DEF_STYLE_ATTR = C6765R.attr.alertDialogStyle;

    @StyleRes
    public static final int DEF_STYLE_RES = C6765R.style.MaterialAlertDialog_MaterialComponents;

    @AttrRes
    public static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C6765R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C6765R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(null, C6765R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = typedArrayObtainStyledAttributes.getColor(C6765R.styleable.MaterialAlertDialog_backgroundTint, color);
