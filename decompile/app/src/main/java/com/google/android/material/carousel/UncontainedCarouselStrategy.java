...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    public static final float MEDIUM_LARGE_ITEM_PERCENTAGE_THRESHOLD = 0.85f;
    ...
    public final float calculateMediumChildSize(float f, float f2, float f3) {
    ...
    public final KeylineState createCenterAlignedKeylineState(float f, float f2, float f3, int i, float f4, float f5, float f6) {
    ...
    public final KeylineState createLeftAlignedKeylineState(Context context, float f, float f2, float f3, int i, float f4, int i2, float f5) {
        float fMin = Math.min(f5, f3);
