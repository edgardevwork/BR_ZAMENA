...
public final class zzai implements zzaq {
    ...
    public final String zzf() throws NumberFormatException {
        ...
        BigDecimal bigDecimal = bigDecimalValueOf.signum() == 0 ? new BigDecimal(BigInteger.ZERO, 0) : DecimalNode$$ExternalSyntheticBackportWithForwarding0.m1037m(bigDecimalValueOf);
