...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultThemeResId(@NonNull Context context) throws Resources.NotFoundException {
        int i;
        Resources resources = context.getResources();
        DisplayMetrics displayMetrics = resources.getDisplayMetrics();
        if (Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C6765R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis)) {
            i = C6765R.attr.materialCalendarTheme;
        } else {
            i = C6765R.attr.materialCalendarFullscreenTheme;
        }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C6765R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C6765R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(l.longValue()));
        }
        if (l == null) {
            return resources.getString(C6765R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(l2.longValue()));
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
        return resources.getString(C6765R.string.mtrl_picker_range_header_selected, dateRangeString.first, dateRangeString.second);
    }
    ...
    public String getSelectionContentDescription(@NonNull Context context) throws Resources.NotFoundException {
        ...
        if (str == null) {
            string = resources.getString(C6765R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string = str;
        }
        String str2 = dateRangeString.second;
        if (str2 == null) {
            string2 = resources.getString(C6765R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string2 = str2;
        }
        return resources.getString(C6765R.string.mtrl_picker_announce_current_range_selection, string, string2);
    }
    ...
    public int getDefaultTitleResId() {
        return C6765R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) throws Resources.NotFoundException {
        ...
        View viewInflate = layoutInflater.inflate(C6765R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C6765R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = (TextInputLayout) viewInflate.findViewById(C6765R.id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = viewInflate.getResources().getString(C6765R.string.mtrl_picker_invalid_range);
    ...
    public final void updateIfValidTextProposal(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2, @NonNull OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
    ...
    public final void updateError(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2) {
    ...
    public final void clearInvalidRange(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2) {
    ...
    public final void setInvalidRange(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2) {
