...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", m1069id = 3)
    private final long zzc;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) int i2, @SafeParcelable.Param(m1070id = 3) long j) {
