...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", m1069id = 1)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", m1069id = 2)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m1069id = 3)
    private final PendingIntent zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getConnectionResult", m1069id = 4)
    ...
    public Status(@SafeParcelable.Param(m1070id = 1) int i, @Nullable @SafeParcelable.Param(m1070id = 2) String str, @Nullable @SafeParcelable.Param(m1070id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m1070id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = str;
    ...
    public String toString() {
        ...
        stringHelper.add(ManifestParser.ATTR_RESOLUTION, this.zzd);
