...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(@NonNull Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C6765R.attr.motionDurationMedium4, getResources().getInteger(C6765R.integer.material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C6765R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
    ...
    public final void validateMenuItemId(int i) {
        if (isValidId(i)) {
            return;
        }
