...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C6765R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C6765R.attr.snackbarTextViewStyle};
    }
    ...
    @NonNull
    public static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        int i2;
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i2 = C6765R.layout.mtrl_layout_snackbar_include;
        } else {
            i2 = C6765R.layout.design_layout_snackbar_include;
        }
