...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", m1069id = 1)
    private final Status zza;

    @Nullable
    @SafeParcelable.Field(getter = "getLocationSettingsStates", m1069id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@NonNull @SafeParcelable.Param(m1070id = 1) Status status, @Nullable @SafeParcelable.Param(m1070id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
