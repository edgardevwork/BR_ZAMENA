...
public class SleepSegmentRequest extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getUserPreferredSleepWindow", m1069id = 1)
    private final List<zzbx> zza;

    @SafeParcelable.Field(defaultValue = "0", getter = "getRequestedDataType", m1069id = 2)
    ...
    public SleepSegmentRequest(@Nullable @SafeParcelable.Param(m1070id = 1) List<zzbx> list, @SafeParcelable.Param(m1070id = 2) int i) {
        this.zza = list;
        this.zzb = i;
    }
}
