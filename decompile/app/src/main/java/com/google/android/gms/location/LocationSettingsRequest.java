...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLocationRequests", m1069id = 1)
    private final List<LocationRequest> zza;

    @SafeParcelable.Field(defaultValue = "false", getter = "alwaysShow", m1069id = 2)
    private final boolean zzb;

    @SafeParcelable.Field(getter = "needBle", m1069id = 3)
    private final boolean zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getConfiguration", m1069id = 5)
    private zzbj zzd;
    ...
    public LocationSettingsRequest(@SafeParcelable.Param(m1070id = 1) List<LocationRequest> list, @SafeParcelable.Param(m1070id = 2) boolean z, @SafeParcelable.Param(m1070id = 3) boolean z2, @Nullable @SafeParcelable.Param(m1070id = 5) zzbj zzbjVar) {
        this.zza = list;
        this.zzb = z;
        this.zzc = z2;
        this.zzd = zzbjVar;
