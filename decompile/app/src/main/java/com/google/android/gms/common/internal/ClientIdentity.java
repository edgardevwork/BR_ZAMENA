...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    @SafeParcelable.Field(defaultValueUnchecked = "0", m1069id = 1)
    public final int uid;

    @SafeParcelable.Constructor
    public ClientIdentity(@SafeParcelable.Param(m1070id = 1) int i, @Nullable @SafeParcelable.Param(m1070id = 2) String str) {
        this.uid = i;
