...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", m1069id = 3)
    private final String tag;

    @SafeParcelable.VersionField(m1072id = 1)
    private final int versionCode;

    @SafeParcelable.Field(getter = "getPlaceId", m1069id = 2)
    private final String zza;

    @SafeParcelable.Field(getter = "getSource", m1069id = 4)
    private final String zzb;

    @SafeParcelable.Constructor
    public PlaceReport(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) String str, @SafeParcelable.Param(m1070id = 3) String str2, @SafeParcelable.Param(m1070id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
