...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    public FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int i;
        if (z) {
            i = C6765R.animator.mtrl_fab_transformation_sheet_expand_spec;
        } else {
            i = C6765R.animator.mtrl_fab_transformation_sheet_collapse_spec;
        }
    ...
    public final void updateImportantForAccessibility(@NonNull View view, boolean z) {
