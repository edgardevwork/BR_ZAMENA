...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m1148or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m1149or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy(components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m1147or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m1146in(Collection<? extends T> target) {
    ...
    public static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        public final Function<A, ? extends B> f793f;

        /* renamed from: p */
        public final Predicate<B> f794p;

        public CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f794p = (Predicate) Preconditions.checkNotNull(p);
            this.f793f = (Function) Preconditions.checkNotNull(f);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.f794p.apply(this.f793f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f793f.equals(compositionPredicate.f793f) && this.f794p.equals(compositionPredicate.f794p);
        }

        public int hashCode() {
            return this.f793f.hashCode() ^ this.f794p.hashCode();
        }

        public String toString() {
            return this.f794p + "(" + this.f793f + ")";
        }
    }
