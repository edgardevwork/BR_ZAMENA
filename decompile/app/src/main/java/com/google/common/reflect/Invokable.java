...
public abstract class Invokable<T, R> implements AnnotatedElement, Member {
    ...
    @CheckForNull
    public abstract Object invokeInternal(@CheckForNull Object receiver, Object[] args) throws IllegalAccessException, InvocationTargetException;
    ...
    public final TypeToken<? extends R> getReturnType() {
        return (TypeToken<? extends R>) TypeToken.m1343of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add((ImmutableList.Builder) new Parameter(this, i, TypeToken.m1343of(genericParameterTypes[i]), parameterAnnotations[i], annotatedParameterTypes[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type type : getGenericExceptionTypes()) {
            builder.add((ImmutableList.Builder) TypeToken.m1343of(type));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> returnType) {
        return returning(TypeToken.m1342of((Class) returnType));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m1342of((Class) getDeclaringClass());
    }
    ...
    public static class MethodInvokable<T> extends Invokable<T, Object> {
        ...
        @CheckForNull
        public final Object invokeInternal(@CheckForNull Object receiver, Object[] args) throws IllegalAccessException, InvocationTargetException {
    ...
    public static boolean initAnnotatedTypeExists() throws ClassNotFoundException {
        try {
