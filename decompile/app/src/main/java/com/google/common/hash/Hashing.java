...
public final class Hashing {
    ...
    public static class Sha1Holder {
        public static final HashFunction SHA_1 = new MessageDigestHashFunction(MessageDigestAlgorithms.SHA_1, "Hashing.sha1()");
    }
    ...
    public enum ChecksumType implements ImmutableSupplier<Checksum> {
        ...
        /* synthetic */ ChecksumType(String str, C74531 c74531) {
            this(str);
        }

        /* renamed from: com.google.common.hash.Hashing$ChecksumType$1 */
        /* loaded from: classes7.dex */
        public enum C74541 extends ChecksumType {
            @Override // com.google.common.base.Supplier
            public Checksum get() {
                return new CRC32();
            }
        ...
        /* loaded from: classes7.dex */
        public enum C74552 extends ChecksumType {
            @Override // com.google.common.base.Supplier
            public Checksum get() {
                return new Adler32();
            }
    ...
    public static final class ConcatenatedHashFunction extends AbstractCompositeHashFunction {
        public /* synthetic */ ConcatenatedHashFunction(HashFunction[] hashFunctionArr, C74531 c74531) {
