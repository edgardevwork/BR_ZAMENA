...
public final class Functions {
    ...
    public static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        public final Function<A, ? extends B> f791f;

        /* renamed from: g */
        public final Function<B, C> f792g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f792g = (Function) Preconditions.checkNotNull(g);
            this.f791f = (Function) Preconditions.checkNotNull(f);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f792g.apply(this.f791f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f791f.equals(functionComposition.f791f) && this.f792g.equals(functionComposition.f792g);
        }

        public int hashCode() {
            return this.f791f.hashCode() ^ this.f792g.hashCode();
        }

        public String toString() {
            return this.f792g + "(" + this.f791f + ")";
        }
    }
