...
public final class QuotaLimit extends GeneratedMessageLite<QuotaLimit, Builder> implements QuotaLimitOrBuilder {
    ...
    public final void setDefaultLimit(long j) {
    ...
    public final void clearMaxLimit() {
        this.maxLimit_ = 0L;
    }
    ...
    public final void setFreeTier(long j) {
        this.freeTier_ = j;
    }

    public final void clearFreeTier() {
        this.freeTier_ = 0L;
    }
    ...
    public final void setDurationBytes(ByteString byteString) throws IllegalArgumentException {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final void setMetricBytes(ByteString byteString) throws IllegalArgumentException {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public final MapFieldLite<String, Long> internalGetValues() {
        return this.values_;
    }

    public final MapFieldLite<String, Long> internalGetMutableValues() {
    ...
    public final Map<String, Long> getMutableValuesMap() {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<QuotaLimit, Builder> implements QuotaLimitOrBuilder {
        public /* synthetic */ Builder(C71351 c71351) {
            this();
        }
        ...
        public Builder setDurationBytes(ByteString byteString) throws IllegalArgumentException {
            copyOnWrite();
        ...
        public Builder setMetricBytes(ByteString byteString) throws IllegalArgumentException {
            copyOnWrite();
    ...
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C71351 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f762xa1df5c61;
        ...
        static {
            ...
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f762xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        C71351 c71351 = null;
        switch (C71351.f762xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new QuotaLimit();
            case 2:
                return new Builder(c71351);
            case 3:
