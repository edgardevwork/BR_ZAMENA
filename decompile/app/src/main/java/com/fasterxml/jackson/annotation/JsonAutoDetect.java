...
public @interface JsonAutoDetect {
    ...
    public enum Visibility {
        ...
        public boolean isVisible(Member member) {
            int i = C66641.f616x23d16a11[ordinal()];
            if (i == 1) {
                return true;
            }
            if (i == 3) {
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        public static final Visibility DEFAULT_FIELD_VISIBILITY;
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C66641.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
        ...
        public static Value _predefined(Visibility visibility, Visibility visibility2, Visibility visibility3, Visibility visibility4, Visibility visibility5) {
    ...
    public static /* synthetic */ class C66641 {

        /* renamed from: $SwitchMap$com$fasterxml$jackson$annotation$JsonAutoDetect$Visibility */
        public static final /* synthetic */ int[] f616x23d16a11;
        ...
        static {
            ...
            try {
                f616x23d16a11[Visibility.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f616x23d16a11[Visibility.NON_PRIVATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f616x23d16a11[Visibility.PROTECTED_AND_PUBLIC.ordinal()] = 4;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f616x23d16a11[Visibility.PUBLIC_ONLY.ordinal()] = 5;
