...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    public static final class EnumKD extends StdKeyDeserializer {
        ...
        public final EnumResolver _getToStringResolver(DeserializationContext deserializationContext) {
            EnumResolver enumResolverConstructUsingToString = this._byToStringResolver;
