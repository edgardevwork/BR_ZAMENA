...
public final class ByteQuadsCanonicalizer {
    ...
    public ByteQuadsCanonicalizer(int i, int i2) {
        this._parent = null;
        this._count = 0;
    ...
    */
    public final boolean _verifyLongName(int[] iArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
    ...
    public final int _resizeAndFindOffsetForAdd(int i) {
        rehash();
        int i_calcOffset = _calcOffset(i);
        int[] iArr = this._hashArea;
        if (iArr[i_calcOffset + 3] == 0) {
    ...
    public final boolean _checkNeedForRehash() {
