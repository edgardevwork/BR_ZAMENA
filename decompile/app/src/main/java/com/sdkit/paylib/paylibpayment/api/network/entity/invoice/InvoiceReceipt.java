...
public final /* data */ class InvoiceReceipt {
    ...
    public final InvoiceReceipt copy(InvoiceReceiptStatus receiptStatus, String receiptId, Date receiptDate, String receiptFiscalNumber, String ecrRegistrationNumber, String receiptFiscalNumberOfDocument, String receiptFiscalAttributeOfDocument, Integer totalSum, String receiptUrl) {
        return new InvoiceReceipt(receiptStatus, receiptId, receiptDate, receiptFiscalNumber, ecrRegistrationNumber, receiptFiscalNumberOfDocument, receiptFiscalAttributeOfDocument, totalSum, receiptUrl);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InvoiceReceipt)) {
            return false;
        }
        InvoiceReceipt invoiceReceipt = (InvoiceReceipt) other;
        return this.receiptStatus == invoiceReceipt.receiptStatus && Intrinsics.areEqual(this.receiptId, invoiceReceipt.receiptId) && Intrinsics.areEqual(this.receiptDate, invoiceReceipt.receiptDate) && Intrinsics.areEqual(this.receiptFiscalNumber, invoiceReceipt.receiptFiscalNumber) && Intrinsics.areEqual(this.ecrRegistrationNumber, invoiceReceipt.ecrRegistrationNumber) && Intrinsics.areEqual(this.receiptFiscalNumberOfDocument, invoiceReceipt.receiptFiscalNumberOfDocument) && Intrinsics.areEqual(this.receiptFiscalAttributeOfDocument, invoiceReceipt.receiptFiscalAttributeOfDocument) && Intrinsics.areEqual(this.totalSum, invoiceReceipt.totalSum) && Intrinsics.areEqual(this.receiptUrl, invoiceReceipt.receiptUrl);
    }
