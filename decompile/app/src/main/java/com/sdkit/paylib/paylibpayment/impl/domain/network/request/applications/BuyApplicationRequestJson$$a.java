...
public final class BuyApplicationRequestJson$$a implements GeneratedSerializer {

    /* renamed from: a */
    public static final BuyApplicationRequestJson$$a f5071a;

    /* renamed from: b */
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f5072b;

    static {
        BuyApplicationRequestJson$$a buyApplicationRequestJson$$a = new BuyApplicationRequestJson$$a();
        f5071a = buyApplicationRequestJson$$a;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sdkit.paylib.paylibpayment.impl.domain.network.request.applications.BuyApplicationRequestJson", buyApplicationRequestJson$$a, 2);
        ...
        f5072b = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public BuyApplicationRequestJson deserialize(Decoder decoder) {
        ...
        return new BuyApplicationRequestJson(i, strDecodeStringElement, (String) objDecodeNullableSerializableElement, null);
    }
    ...
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public void serialize(Encoder encoder, BuyApplicationRequestJson value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor);
        BuyApplicationRequestJson.m4195a(value, compositeEncoderBeginStructure, descriptor);
