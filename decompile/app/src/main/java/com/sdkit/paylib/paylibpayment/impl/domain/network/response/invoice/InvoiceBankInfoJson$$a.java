...
public final class InvoiceBankInfoJson$$a implements GeneratedSerializer {

    /* renamed from: a */
    public static final InvoiceBankInfoJson$$a f5281a;

    /* renamed from: b */
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f5282b;

    static {
        InvoiceBankInfoJson$$a invoiceBankInfoJson$$a = new InvoiceBankInfoJson$$a();
        f5281a = invoiceBankInfoJson$$a;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sdkit.paylib.paylibpayment.impl.domain.network.response.invoice.InvoiceBankInfoJson", invoiceBankInfoJson$$a, 4);
        ...
        f5282b = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    /* renamed from: a */
    public InvoiceBankInfoJson deserialize(Decoder decoder) {
        ...
        return new InvoiceBankInfoJson(i, (String) objDecodeNullableSerializableElement4, (String) objDecodeNullableSerializableElement3, (String) objDecodeNullableSerializableElement, (String) objDecodeNullableSerializableElement2, null);
    }
    ...
    /* renamed from: a */
    public void serialize(Encoder encoder, InvoiceBankInfoJson value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor);
        InvoiceBankInfoJson.m4337a(value, compositeEncoderBeginStructure, descriptor);
