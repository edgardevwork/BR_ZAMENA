...
public final /* data */ class VerifyPhoneNumberResponse implements ResponseWithError {
    ...
    public static /* synthetic */ VerifyPhoneNumberResponse copy$default(VerifyPhoneNumberResponse verifyPhoneNumberResponse, RequestMeta requestMeta, ErrorModel errorModel, SmsConfirmConstraints smsConfirmConstraints, int i, Object obj) {
        if ((i & 1) != 0) {
            requestMeta = verifyPhoneNumberResponse.meta;
        }
        if ((i & 2) != 0) {
            errorModel = verifyPhoneNumberResponse.error;
        }
        if ((i & 4) != 0) {
            smsConfirmConstraints = verifyPhoneNumberResponse.smsConfirmConstraints;
        }
    ...
    public final VerifyPhoneNumberResponse copy(RequestMeta meta, ErrorModel error, SmsConfirmConstraints smsConfirmConstraints) {
        return new VerifyPhoneNumberResponse(meta, error, smsConfirmConstraints);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof VerifyPhoneNumberResponse)) {
            return false;
        }
        VerifyPhoneNumberResponse verifyPhoneNumberResponse = (VerifyPhoneNumberResponse) other;
        return Intrinsics.areEqual(this.meta, verifyPhoneNumberResponse.meta) && Intrinsics.areEqual(this.error, verifyPhoneNumberResponse.error) && Intrinsics.areEqual(this.smsConfirmConstraints, verifyPhoneNumberResponse.smsConfirmConstraints);
    }
    ...
    public String toString() {
        return "VerifyPhoneNumberResponse(meta=" + this.meta + ", error=" + this.error + ", smsConfirmConstraints=" + this.smsConfirmConstraints + ')';
    }
    ...
    public /* synthetic */ VerifyPhoneNumberResponse(RequestMeta requestMeta, ErrorModel errorModel, SmsConfirmConstraints smsConfirmConstraints, int i, DefaultConstructorMarker defaultConstructorMarker) {
