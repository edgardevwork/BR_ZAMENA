package com.sdkit.paylib.paylibpayment.api.network.response.products;
...
public final /* data */ class ProductsResponse implements ResponseWithCode {
    ...
    public /* synthetic */ ProductsResponse(RequestMeta requestMeta, int i, String str, String str2, List list, List list2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
