...
public final /* data */ class SubscriptionInfoResponse implements ResponseWithCode {
    ...
    public final PurchaseSubscriptionInfo payload;

    public SubscriptionInfoResponse(RequestMeta requestMeta, int i, String str, String str2, List<DigitalShopGeneralError> list, PurchaseSubscriptionInfo purchaseSubscriptionInfo) {
        this.meta = requestMeta;
        this.code = i;
        this.errorMessage = str;
        this.errorDescription = str2;
        this.errors = list;
        this.payload = purchaseSubscriptionInfo;
    }
    ...
    public static /* synthetic */ SubscriptionInfoResponse copy$default(SubscriptionInfoResponse subscriptionInfoResponse, RequestMeta requestMeta, int i, String str, String str2, List list, PurchaseSubscriptionInfo purchaseSubscriptionInfo, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            requestMeta = subscriptionInfoResponse.meta;
        }
        if ((i2 & 2) != 0) {
            i = subscriptionInfoResponse.code;
        }
        int i3 = i;
        if ((i2 & 4) != 0) {
            str = subscriptionInfoResponse.errorMessage;
        }
        String str3 = str;
        if ((i2 & 8) != 0) {
            str2 = subscriptionInfoResponse.errorDescription;
        }
        String str4 = str2;
        if ((i2 & 16) != 0) {
            list = subscriptionInfoResponse.errors;
        }
        List list2 = list;
        if ((i2 & 32) != 0) {
            purchaseSubscriptionInfo = subscriptionInfoResponse.payload;
        }
        return subscriptionInfoResponse.copy(requestMeta, i3, str3, str4, list2, purchaseSubscriptionInfo);
    }
    ...
    public final SubscriptionInfoResponse copy(RequestMeta meta, int code, String errorMessage, String errorDescription, List<DigitalShopGeneralError> errors, PurchaseSubscriptionInfo payload) {
        return new SubscriptionInfoResponse(meta, code, errorMessage, errorDescription, errors, payload);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.meta, subscriptionInfoResponse.meta) && this.code == subscriptionInfoResponse.code && Intrinsics.areEqual(this.errorMessage, subscriptionInfoResponse.errorMessage) && Intrinsics.areEqual(this.errorDescription, subscriptionInfoResponse.errorDescription) && Intrinsics.areEqual(this.errors, subscriptionInfoResponse.errors) && Intrinsics.areEqual(this.payload, subscriptionInfoResponse.payload);
    }
    ...
    public int hashCode() {
        ...
        PurchaseSubscriptionInfo purchaseSubscriptionInfo = this.payload;
        return iHashCode3 + (purchaseSubscriptionInfo != null ? purchaseSubscriptionInfo.hashCode() : 0);
    }

    public String toString() {
        return "SubscriptionInfoResponse(meta=" + this.meta + ", code=" + this.code + ", errorMessage=" + this.errorMessage + ", errorDescription=" + this.errorDescription + ", errors=" + this.errors + ", payload=" + this.payload + ')';
    }
