...
public final /* data */ class SubscriptionDefaultResponse implements ResponseWithCode {
    ...
    public SubscriptionDefaultResponse(RequestMeta requestMeta, int i, String str, String str2, List<DigitalShopGeneralError> list) {
    ...
    public static /* synthetic */ SubscriptionDefaultResponse copy$default(SubscriptionDefaultResponse subscriptionDefaultResponse, RequestMeta requestMeta, int i, String str, String str2, List list, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            requestMeta = subscriptionDefaultResponse.meta;
        }
        if ((i2 & 2) != 0) {
            i = subscriptionDefaultResponse.code;
        }
        int i3 = i;
        if ((i2 & 4) != 0) {
            str = subscriptionDefaultResponse.errorMessage;
        }
        String str3 = str;
        if ((i2 & 8) != 0) {
            str2 = subscriptionDefaultResponse.errorDescription;
        }
        String str4 = str2;
        if ((i2 & 16) != 0) {
            list = subscriptionDefaultResponse.errors;
        }
        return subscriptionDefaultResponse.copy(requestMeta, i3, str3, str4, list);
    }
    ...
    public final SubscriptionDefaultResponse copy(RequestMeta meta, int code, String errorMessage, String errorDescription, List<DigitalShopGeneralError> errors) {
        return new SubscriptionDefaultResponse(meta, code, errorMessage, errorDescription, errors);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SubscriptionDefaultResponse)) {
            return false;
        }
        SubscriptionDefaultResponse subscriptionDefaultResponse = (SubscriptionDefaultResponse) other;
        return Intrinsics.areEqual(this.meta, subscriptionDefaultResponse.meta) && this.code == subscriptionDefaultResponse.code && Intrinsics.areEqual(this.errorMessage, subscriptionDefaultResponse.errorMessage) && Intrinsics.areEqual(this.errorDescription, subscriptionDefaultResponse.errorDescription) && Intrinsics.areEqual(this.errors, subscriptionDefaultResponse.errors);
    }
