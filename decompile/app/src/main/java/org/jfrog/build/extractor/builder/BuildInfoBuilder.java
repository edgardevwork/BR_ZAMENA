...
public class BuildInfoBuilder {
    ...
    public BuildInfo build() {
        ...
        if (StringUtils.isNotBlank(this.version)) {
            buildInfo.setVersion(this.version);
        }
        buildInfo.setName(this.name);
        buildInfo.setNumber(this.number);
        buildInfo.setProject(this.project);
        buildInfo.setAgent(this.agent);
        buildInfo.setBuildAgent(this.buildAgent);
        buildInfo.setStarted(this.started);
        buildInfo.setStartedMillis(this.startedMillis);
        buildInfo.setDurationMillis(this.durationMillis);
        buildInfo.setPrincipal(this.principal);
        buildInfo.setArtifactoryPrincipal(this.artifactoryPrincipal);
        buildInfo.setArtifactoryPluginVersion(this.artifactoryPluginVersion);
        buildInfo.setUrl(this.url);
        buildInfo.setParentName(this.parentName);
        buildInfo.setParentNumber(this.parentNumber);
        buildInfo.setRunParameters(this.runParameters);
        buildInfo.setModules(this.modules != null ? new ArrayList(this.modules.values()) : null);
        buildInfo.setStatuses(this.statuses);
        buildInfo.setProperties(this.properties);
        buildInfo.setVcs(this.vcs);
        buildInfo.setBuildRetention(this.buildRetention);
        buildInfo.setIssues(this.issues);
        return buildInfo;
    }
    ...
    public BuildInfoBuilder setProject(String str) {
        this.project = str;
        return this;
    }
}
