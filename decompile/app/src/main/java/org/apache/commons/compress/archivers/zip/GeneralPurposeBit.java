...
public final class GeneralPurposeBit implements Cloneable {
    ...
    public static final int NUMBER_OF_SHANNON_FANO_TREES_FLAG = 4;
    public static final int SLIDING_DICTIONARY_SIZE_FLAG = 2;
    public static final int STRONG_ENCRYPTION_FLAG = 64;
    public static final int UFT8_NAMES_FLAG = 2048;
    public boolean dataDescriptorFlag;
    public boolean encryptionFlag;
    public boolean languageEncodingFlag;
    public int numberOfShannonFanoTrees;
    public int slidingDictionarySize;
    public boolean strongEncryptionFlag;
