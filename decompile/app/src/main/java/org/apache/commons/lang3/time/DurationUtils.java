...
public class DurationUtils {
    public static final Range<Long> LONG_TO_INT_RANGE = Range.between(NumberUtils.LONG_INT_MIN_VALUE, NumberUtils.LONG_INT_MAX_VALUE);
    ...
    public static /* synthetic */ class C110881 {
    ...
    public static ChronoUnit toChronoUnit(TimeUnit timeUnit) {
        int[] iArr = C110881.$SwitchMap$java$util$concurrent$TimeUnit;
    ...
    public static Duration zeroIfNull(Duration duration) {
        return DurationUtils$$ExternalSyntheticApiModelOutline0.m7359m(ObjectUtils.defaultIfNull(duration, Duration.ZERO));
    }
}
