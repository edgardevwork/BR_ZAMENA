...
public class ValidatingObjectInputStream extends ObjectInputStream {
    public final List<ClassNameMatcher> acceptMatchers;
    public final List<ClassNameMatcher> rejectMatchers;
    ...
    public final void validateClassName(String str) throws InvalidClassException {
