...
public class SegmentOptions {
    public static final int DEFLATE_HINT = 32;
    public static final int HAVE_ALL_CODE_FLAGS = 4;
    public static final int HAVE_CLASS_FLAGS_HI = 512;
    public static final int HAVE_CODE_FLAGS_HI = 1024;
    public static final int HAVE_CP_NUMBERS = 2;
    public static final int HAVE_FIELD_FLAGS_HI = 1024;
    public static final int HAVE_FILE_HEADERS = 16;
    public static final int HAVE_FILE_MODTIME = 64;
    public static final int HAVE_FILE_OPTIONS = 128;
    public static final int HAVE_FILE_SIZE_HI = 256;
    public static final int HAVE_METHOD_FLAGS_HI = 2048;
    public static final int HAVE_SPECIAL_FORMATS = 1;
    public static final int UNUSED = -8184;
