...
public class LockableFileWriter extends Writer {
    ...
    public final void testLockDir(File file) throws IOException {
        if (!file.exists()) {
    ...
    public final void createLock() throws IOException {
    ...
    public final Writer initWriter(File file, Charset charset, boolean z) throws IOException {
