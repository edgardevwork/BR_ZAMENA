...
public class FileFilterUtils {
    ...
    public static <R, A> R filterFiles(final IOFileFilter iOFileFilter, Stream<File> stream, Collector<? super File, A, R> collector) {
    ...
    /* renamed from: or */
    public static IOFileFilter m7339or(IOFileFilter... iOFileFilterArr) {
