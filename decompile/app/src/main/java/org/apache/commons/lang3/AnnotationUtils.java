...
public class AnnotationUtils {
    ...
    public static boolean equals(Annotation annotation, Annotation annotation2) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public static int hashMember(String str, Object obj) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        int iHashCode;
