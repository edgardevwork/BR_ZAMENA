...
public class Metaphone implements StringEncoder {
    ...
    public final boolean isLastChar(int i, int i2) {
        return i2 + 1 == i;
    }
    ...
    */
            ...
            if (cCharAt == 'C' || !isPreviousChar(sb, i, cCharAt)) {
                switch (cCharAt) {
                    ...
                    case 'U':
                        ...
                        break;
                    case 'B':
                        if (!isPreviousChar(sb, i, GMTDateParser.MONTH) || !isLastChar(length2, i)) {
                            sb2.append(cCharAt);
                            break;
                        }
                        break;
    ...
    public final boolean isVowel(StringBuilder sb, int i) {
        return VOWELS.indexOf(sb.charAt(i)) >= 0;
    }

    public final boolean isPreviousChar(StringBuilder sb, int i, char c) {
        return i > 0 && i < sb.length() && sb.charAt(i - 1) == c;
    }

    public final boolean isNextChar(StringBuilder sb, int i, char c) {
        return i >= 0 && i < sb.length() - 1 && sb.charAt(i + 1) == c;
    }

    public final boolean regionMatch(StringBuilder sb, int i, String str) {
