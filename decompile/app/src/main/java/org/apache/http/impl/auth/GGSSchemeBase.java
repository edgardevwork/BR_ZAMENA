...
public abstract class GGSSchemeBase extends AuthSchemeBase {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C111231 {
        public static final /* synthetic */ int[] $SwitchMap$org$apache$http$impl$auth$GGSSchemeBase$State;
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest, HttpContext httpContext) throws AuthenticationException {
        ...
        int i = C111231.$SwitchMap$org$apache$http$impl$auth$GGSSchemeBase$State[this.state.ordinal()];
        if (i == 1) {
        ...
        if (i == 3) {
            try {
                ...
                if (!this.stripPort) {
                    hostName = hostName + StringUtils.PROCESS_POSTFIX_DELIMITER + targetHost.getPort();
                }
    ...
    public final String resolveCanonicalHostname(String str) throws UnknownHostException {
