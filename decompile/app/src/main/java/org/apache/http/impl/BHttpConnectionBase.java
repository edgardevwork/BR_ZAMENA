...
import org.apache.http.impl.p060io.HttpTransportMetricsImpl;
import org.apache.http.impl.p060io.IdentityInputStream;
import org.apache.http.impl.p060io.IdentityOutputStream;
import org.apache.http.impl.p060io.SessionInputBufferImpl;
import org.apache.http.impl.p060io.SessionOutputBufferImpl;
...
public class BHttpConnectionBase implements HttpInetConnection {
    ...
    public final int fillInputBuffer(int i) throws IOException {
        Socket socket = this.socketHolder.get();
