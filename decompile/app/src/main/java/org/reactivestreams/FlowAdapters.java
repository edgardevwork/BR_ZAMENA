...
public final class FlowAdapters {
    ...
    public static <T> Flow.Publisher<T> toFlowPublisher(Publisher<? extends T> publisher) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline0.m7391m(publisher)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline1.m7392m(publisher);
        }
    ...
    public static <T, U> Flow.Processor<T, U> toFlowProcessor(Processor<? super T, ? extends U> processor) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline4.m7395m(processor)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline5.m7396m(processor);
        }
    ...
    public static <T> Flow.Subscriber<T> toFlowSubscriber(Subscriber<T> subscriber) {
        ...
        if (FlowAdapters$$ExternalSyntheticApiModelOutline2.m7393m(subscriber)) {
            return FlowAdapters$$ExternalSyntheticApiModelOutline3.m7394m(subscriber);
        }
