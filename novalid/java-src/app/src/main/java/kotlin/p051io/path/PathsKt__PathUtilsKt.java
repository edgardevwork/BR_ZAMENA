...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(@NotNull Path path, @NotNull String glob) throws IOException {
        ...
        try {
            ...
            Intrinsics.checkNotNull(directoryStreamM7174m);
            List<Path> list = CollectionsKt___CollectionsKt.toList(directoryStreamM7174m);
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM7174m = C10627xcfce04b.m7174m(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM7174m);
            Object objInvoke = block.invoke(CollectionsKt___CollectionsKt.asSequence(directoryStreamM7174m));
    ...
    public static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM7174m = C10627xcfce04b.m7174m(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM7174m);
            T tInvoke = block.invoke(CollectionsKt___CollectionsKt.asSequence(directoryStreamM7174m));
            InlineMarker.finallyStart(1);
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM7174m = C10627xcfce04b.m7174m(directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM7174m);
            Iterator it = directoryStreamM7174m.iterator();
            while (it.hasNext()) {
    ...
    public static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline8.m7219m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    public static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline8.m7219m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline10.m7191m(fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        fileAttributeViewNotAvailable(path, PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline8.m7219m());
    ...
    public static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalkKt$$ExternalSyntheticApiModelOutline0.m7151m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(...)");
        return (A) C10641xe3555820.m7188m(attributes);
    }
