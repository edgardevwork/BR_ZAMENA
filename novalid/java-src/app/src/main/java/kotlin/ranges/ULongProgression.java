...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m16907getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM15872constructorimpl = ((int) ULong.m15872constructorimpl(j ^ ULong.m15872constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM15872constructorimpl2 = (iM15872constructorimpl + ((int) ULong.m15872constructorimpl(j2 ^ ULong.m15872constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM15872constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m15918toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m15918toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    /* compiled from: ULongRange.kt */
    @Metadata(m7104d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\t¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m7105d2 = {"Lkotlin/ranges/ULongProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/ULongProgression;", "rangeStart", "Lkotlin/ULong;", "rangeEnd", "step", "", "fromClosedRange-7ftBX0g", "(JJJ)Lkotlin/ranges/ULongProgression;", "kotlin-stdlib"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    ...
    public static final class Companion {
        ...
        public final ULongProgression m16933fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
