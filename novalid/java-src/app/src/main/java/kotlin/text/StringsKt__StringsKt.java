...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    /* compiled from: Strings.kt */
    @Metadata(m7104d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\f\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\t\u0010\u0004\u001a\u00020\u0005H\u0096\u0002J\b\u0010\u0006\u001a\u00020\u0007H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\b"}, m7105d2 = {"kotlin/text/StringsKt__StringsKt$iterator$1", "Lkotlin/collections/CharIterator;", FirebaseAnalytics.Param.INDEX, "", "hasNext", "", "nextChar", "", "kotlin-stdlib"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    /* renamed from: kotlin.text.StringsKt__StringsKt$iterator$1 */
    /* loaded from: classes7.dex */
    public static final class C107011 extends CharIterator {
        public final /* synthetic */ CharSequence $this_iterator;
        public int index;

        public C107011(CharSequence charSequence) {
    ...
    public static final CharIterator iterator(@NotNull CharSequence charSequence) {
        ...
        return new CharIterator() { // from class: kotlin.text.StringsKt__StringsKt.iterator.1
            ...
            public C107011(CharSequence charSequence2) {
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i, boolean z) {
        ...
        ?? it = new IntRange(RangesKt___RangesKt.coerceAtLeast(i, 0), getLastIndex(charSequence)).iterator();
        while (it.hasNext()) {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m7112to(Integer.valueOf(iIndexOf$default), str);
        }
            ...
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                while (true) {
                    ...
                    if (str3 == null) {
                        ...
                        return TuplesKt.m7112to(Integer.valueOf(first), str3);
                    }
                }
            }
        } else {
            ...
            if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                while (true) {
                    ...
                    if (str5 == null) {
                        ...
                        return TuplesKt.m7112to(Integer.valueOf(first2), str5);
                    }
                }
            }
        }
    ...
    public static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, final char[] cArr, int i, final boolean z, int i2) {
        ...
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$1
            ...
            public final Pair<Integer, Integer> invoke(@NotNull CharSequence $receiver, int i3) {
                ...
                return TuplesKt.m7112to(Integer.valueOf(iIndexOfAny), 1);
            }
        });
    }
    ...
    public static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, String[] strArr, int i, final boolean z, int i2) {
        ...
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public final Pair<Integer, Integer> invoke(@NotNull CharSequence $receiver, int i3) {
                ...
                if (pairFindAnyOf$StringsKt__StringsKt != null) {
                    return TuplesKt.m7112to(pairFindAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) pairFindAnyOf$StringsKt__StringsKt.getSecond()).length()));
                }
                return null;
            }
        });
    ...
    /* compiled from: Strings.kt */
    @Metadata(m7104d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m7105d2 = {"<anonymous>", "", "it", "Lkotlin/ranges/IntRange;", "invoke"}, m7106k = 3, m7107mv = {1, 9, 0}, m7109xi = 48)
    /* renamed from: kotlin.text.StringsKt__StringsKt$splitToSequence$1 */
    /* loaded from: classes7.dex */
    public static final class C107021 extends Lambda implements Function1<IntRange, String> {
        public final /* synthetic */ CharSequence $this_splitToSequence;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C107021(CharSequence charSequence) {
            super(1);
            charSequence = charSequence;
        }
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i) {
        ...
        return SequencesKt___SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C107021(CharSequence charSequence2) {
                super(1);
                charSequence = charSequence2;
            }
    ...
    /* loaded from: classes7.dex */
    public static final class C107032 extends Lambda implements Function1<IntRange, String> {
        public final /* synthetic */ CharSequence $this_splitToSequence;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C107032(CharSequence charSequence) {
            super(1);
            charSequence = charSequence;
        }
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i) {
        ...
        return SequencesKt___SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.2
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C107032(CharSequence charSequence2) {
                super(1);
                charSequence = charSequence2;
            }
