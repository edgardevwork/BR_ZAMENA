...
public final class ResultKt {
    ...
    public static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m15699constructorimpl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m15699constructorimpl(createFailure(th));
        }
    }
    ...
    public static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m15699constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m15699constructorimpl(createFailure(th));
        }
    ...
    public static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return thM15702exceptionOrNullimpl == null ? obj : onFailure.invoke(thM15702exceptionOrNullimpl);
    }
    ...
    public static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m15705isFailureimpl(obj) ? r : obj;
    }
    ...
    public static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return onFailure.invoke(thM15702exceptionOrNullimpl);
    }
    ...
    public static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        if (!Result.m15706isSuccessimpl(obj)) {
            return Result.m15699constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m15699constructorimpl(transform.invoke(obj));
    }
    ...
    public static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m15699constructorimpl(transform.invoke(thM15702exceptionOrNullimpl));
    }
    ...
    public static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable thM15702exceptionOrNullimpl = Result.m15702exceptionOrNullimpl(obj);
        if (thM15702exceptionOrNullimpl != null) {
            action.invoke(thM15702exceptionOrNullimpl);
        }
        return obj;
    }
