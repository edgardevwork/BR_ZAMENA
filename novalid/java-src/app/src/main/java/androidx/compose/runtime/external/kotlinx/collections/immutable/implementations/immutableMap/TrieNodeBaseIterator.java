...
public abstract class TrieNodeBaseIterator<K, V, T> implements Iterator<T>, KMappedMarker {
    ...
    public final boolean hasNextNode() {
        CommonFunctionsKt.m10956assert(this.index >= this.dataSize);
