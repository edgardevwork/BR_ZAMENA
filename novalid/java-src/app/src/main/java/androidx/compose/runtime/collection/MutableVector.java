...
public final class MutableVector<T> implements RandomAccess {
    ...
    public final void add(int index, T element) {
        ...
        int i = this.size;
        if (index != i) {
            ArraysKt___ArraysJvmKt.copyInto(tArr, tArr, index + 1, index, i);
        }
        tArr[index] = element;
        this.size++;
    }
    ...
    public final boolean addAll(int index, @NotNull MutableVector<T> elements) {
        ...
        int i = this.size;
        if (index != i) {
            ArraysKt___ArraysJvmKt.copyInto(tArr, tArr, elements.size + index, index, i);
        }
    ...
    public final void removeRange(int start, int end) {
        if (end > start) {
            ...
            if (end < i) {
                T[] tArr = this.content;
                ArraysKt___ArraysJvmKt.copyInto(tArr, tArr, start, end, i);
            }
