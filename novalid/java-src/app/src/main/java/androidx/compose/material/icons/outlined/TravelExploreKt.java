...
public final class TravelExploreKt {
    ...
    public static final ImageVector getTravelExplore(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.TravelExplore", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
