...
public final /* synthetic */ class SnapshotStateKt__DerivedStateKt {
    ...
    public static final <R> R notifyObservers$SnapshotStateKt__DerivedStateKt(DerivedState<?> derivedState, Function0<? extends R> function0) {
