...
public final /* data */ class RowColumnParentData {
    ...
    public int hashCode() {
        ...
        return iHashCode + (crossAxisAlignment == null ? 0 : crossAxisAlignment.hashCode());
    }
