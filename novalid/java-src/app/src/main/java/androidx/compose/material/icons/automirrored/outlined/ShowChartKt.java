...
public final class ShowChartKt {
    ...
    @NotNull
    public static final ImageVector getShowChart(@NotNull Icons.AutoMirrored.Outlined outlined) {
        ImageVector imageVector = _showChart;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.ShowChart", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
