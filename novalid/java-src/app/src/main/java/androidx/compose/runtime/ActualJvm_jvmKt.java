...
public final class ActualJvm_jvmKt {
    ...
    public static final <R> R m10844synchronized(@NotNull Object obj, @NotNull Function0<? extends R> function0) {
        R rInvoke;
        synchronized (obj) {
            try {
