...
public final class ComposableLambdaNImpl implements ComposableLambdaN {
    ...
    public Object invoke(@NotNull final Object... args) {
        ...
        Object[] array = ArraysKt___ArraysKt.slice(args, RangesKt___RangesKt.until(0, args.length - 1)).toArray(new Object[0]);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.runtime.internal.ComposableLambdaNImpl.invoke.1
                ...
                public final void invoke(@NotNull Composer composer, int i2) {
                    Object[] array2 = ArraysKt___ArraysKt.slice(args, RangesKt___RangesKt.until(0, iRealParamCount)).toArray(new Object[0]);
