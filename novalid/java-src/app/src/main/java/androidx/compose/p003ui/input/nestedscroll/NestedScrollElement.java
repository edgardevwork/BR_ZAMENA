...
final class NestedScrollElement extends ModifierNodeElement<NestedScrollNode> {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull NestedScrollNode node) {
    ...
    public void inspectableProperties(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(Http2ExchangeCodec.CONNECTION, this.connection);
