...
public final class PathComponent extends VNode {
    ...
    public PathComponent() {
        ...
        this.pathMeasure = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.NONE, (Function0) new Function0<PathMeasure>() { // from class: androidx.compose.ui.graphics.vector.PathComponent$pathMeasure$2
    ...
    /* renamed from: setPathFillType-oQ8Xj4U */
    public final void m11980setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo11233setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    /* renamed from: setStrokeLineCap-BeK7IIE */
    public final void m11981setStrokeLineCapBeK7IIE(int i) {
    ...
    /* renamed from: setStrokeLineJoin-Ww9F2mQ */
    public final void m11982setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo11231getFillTypeRgk1Os = this.renderPath.mo11231getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo11233setFillTypeoQ8Xj4U(iMo11231getFillTypeRgk1Os);
        }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m11879drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m11879drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
