...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo7650measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        CheckScrollableContainerConstraintsKt.m7799checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        ...
        return MeasureScope.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo12610measureBRTryo0, this.this$0.getIsVertical() ? 0 : i, this.this$0.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
