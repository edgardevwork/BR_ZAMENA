...
public final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m8087setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m8088setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo7650measure3p2s80s(@NotNull final MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo12610measureBRTryo0.getWidth(), placeableMo12610measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo12610measureBRTryo0, measureScope.mo7868roundToPx0680j_4(this.this$0.getX()), measureScope.mo7868roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo12610measureBRTryo0, measureScope.mo7868roundToPx0680j_4(this.this$0.getX()), measureScope.mo7868roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
