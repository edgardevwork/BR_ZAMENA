...
@DebugMetadata(m7119c = "androidx.compose.runtime.collection.IdentityArrayMap$asMap$1$values$1$iterator$1", m7120f = "IdentityArrayMap.kt", m7121i = {0, 0}, m7122l = {271}, m7123m = "invokeSuspend", m7124n = {"$this$sequence", FirebaseAnalytics.Param.INDEX}, m7125s = {"L$0", "I$0"})
/* loaded from: classes2.dex */
public final class IdentityArrayMap$asMap$1$values$1$iterator$1<Value> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Value>, Continuation<? super Unit>, Object> {
    public int I$0;
    public int I$1;
    ...
    public IdentityArrayMap$asMap$1$values$1$iterator$1(IdentityArrayMap<Key, Value> identityArrayMap, Continuation<? super IdentityArrayMap$asMap$1$values$1$iterator$1> continuation) {
    ...
    */
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            i++;
            if (i < size) {
                Object obj2 = this.this$0.getValues()[i];
