...
public final class DraggableNode extends AbstractDraggableNode {
    ...
    public DraggableNode(@NotNull DraggableState draggableState, @NotNull Function1<? super PointerInputChange, Boolean> function1, @NotNull Orientation orientation, boolean z, @Nullable MutableInteractionSource mutableInteractionSource, @NotNull Function0<Boolean> function0, @NotNull Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> function3, @NotNull Function3<? super CoroutineScope, ? super Velocity, ? super Continuation<? super Unit>, ? extends Object> function32, boolean z2) {
        ...
        this.abstractDragScope = new AbstractDragScope() { // from class: androidx.compose.foundation.gestures.DraggableNode$abstractDragScope$1
            ...
            public void mo7879dragByk4lQ0M(long pixels) {
                this.this$0.getDragScope().dragBy(DraggableKt.m7929toFloat3MmeM6k(pixels, this.this$0.orientation));
            }
        };
    ...
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.DraggableNode$drag$2", m7120f = "Draggable.kt", m7121i = {}, m7122l = {322}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.DraggableNode$drag$2 */
    public static final class C04752 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        public C04752(Function2<? super AbstractDragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04752> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C04752 c04752 = DraggableNode.this.new C04752(this.$block, continuation);
            c04752.L$0 = obj;
            return c04752;
        }
        ...
        public final Object invoke(@NotNull DragScope dragScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C04752) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object drag(@NotNull Function2<? super AbstractDragScope, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Object objDrag = this.state.drag(MutatePriority.UserInput, new C04752(function2, null), continuation);
