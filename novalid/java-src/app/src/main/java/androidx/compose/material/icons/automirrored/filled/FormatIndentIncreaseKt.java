...
public final class FormatIndentIncreaseKt {
    ...
    @NotNull
    public static final ImageVector getFormatIndentIncrease(@NotNull Icons.AutoMirrored.Filled filled) {
        ImageVector imageVector = _formatIndentIncrease;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.FormatIndentIncrease", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
