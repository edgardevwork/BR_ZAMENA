...
public final class ColorSpaces {
    ...
    static {
        ...
        CieLab = lab;
        Rgb rgb15 = new Rgb(Scope.NONE_SCOPE, fArr, illuminant.getD65(), transferParameters2, 16);
        Unspecified = rgb15;
    ...
    @Nullable
    public final ColorSpace match(@Size(9) @NotNull float[] fArr, @NotNull TransferParameters transferParameters) {
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m11746equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m11753getRgbxdoWZVw())) {
                ...
                if (ColorSpaceKt.compare(fArr, rgb.getTransform()) && ColorSpaceKt.compare(transferParameters, rgb.getTransferParameters())) {
                    return colorSpace;
                }
            }
        }
