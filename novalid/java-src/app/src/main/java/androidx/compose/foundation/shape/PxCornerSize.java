...
public final /* data */ class CornerSize implements androidx.compose.foundation.shape.CornerSize, InspectableValue {
    ...
    @NotNull
    public final CornerSize copy(float size) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof CornerSize) && Float.compare(this.size, ((CornerSize) other).size) == 0;
    }
