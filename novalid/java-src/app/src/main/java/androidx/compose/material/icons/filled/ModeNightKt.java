...
public final class ModeNightKt {
    ...
    public static final ImageVector getModeNight(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ModeNight", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
