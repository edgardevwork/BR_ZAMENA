...
public final class VisibleModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public VisibleModifier(boolean z, @NotNull Function1<? super InspectorInfo, Unit> function1) {
        super(function1);
        this.visible = z;
    }
    ...
    public MeasureResult mo7625measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo12610measureBRTryo0.getWidth(), placeableMo12610measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.VisibleModifier$measure$2
            {
                super(1);
            }
