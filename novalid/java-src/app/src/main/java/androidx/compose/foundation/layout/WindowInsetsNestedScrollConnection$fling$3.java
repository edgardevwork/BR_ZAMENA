...
@DebugMetadata(m7119c = "androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection$fling$3", m7120f = "WindowInsetsConnection.android.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
...
public final class WindowInsetsNestedScrollConnection$fling$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: WindowInsetsConnection.android.kt */
    @Metadata(m7104d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection$fling$3$1", m7120f = "WindowInsetsConnection.android.kt", m7121i = {}, m7122l = {374}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    ...
    public static final class C05831 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C05831(int i, int i2, float f, WindowInsetsAnimationController windowInsetsAnimationController, boolean z, WindowInsetsNestedScrollConnection windowInsetsNestedScrollConnection, Continuation<? super C05831> continuation) {
            super(2, continuation);
            this.$current = i;
            this.$target = i2;
            this.$flingAmount = f;
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C05831(this.$current, this.$target, this.$flingAmount, this.$animationController, this.$targetShown, this.this$0, continuation);
        }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        windowInsetsNestedScrollConnection.animationJob = BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C05831(this.$current, this.$target, this.$flingAmount, this.$animationController, this.$targetShown, windowInsetsNestedScrollConnection, null), 3, null);
        return Unit.INSTANCE;
    }
}
