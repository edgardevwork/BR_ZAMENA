...
public final class AnchoredDraggableState<T> {
    ...
    @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState", m7120f = "AnchoredDraggable.kt", m7121i = {0}, m7122l = {529}, m7123m = "anchoredDrag", m7124n = {"this"}, m7125s = {"L$0"})
    ...
    public static final class C10201 extends ContinuationImpl {
        ...
        public C10201(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C10201> continuation) {
            super(continuation);
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState", m7120f = "AnchoredDraggable.kt", m7121i = {0}, m7122l = {575}, m7123m = "anchoredDrag", m7124n = {"this"}, m7125s = {"L$0"})
    /* renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$3 */
    public static final class C10223 extends ContinuationImpl {
        public Object L$0;
        public int label;
        public /* synthetic */ Object result;
        public final /* synthetic */ AnchoredDraggableState<T> this$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10223(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C10223> continuation) {
            super(continuation);
            this.this$0 = anchoredDraggableState;
        }
    ...
    public static final class C10181 extends Lambda implements Function1<T, Boolean> {
        public static final C10181 INSTANCE = ;
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, function1, function0, animationSpec, (i & 16) != 0 ? C10181.INSTANCE : function12);
    }
    ...
    public static final class C10192 extends Lambda implements Function1<T, Boolean> {
        public static final C10192 INSTANCE = ;
    ...
    public /* synthetic */ AnchoredDraggableState(Object obj, DraggableAnchors draggableAnchors, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, draggableAnchors, function1, function0, animationSpec, (i & 32) != 0 ? C10192.INSTANCE : function12);
    }
    ...
    */
    public final Object anchoredDrag(@NotNull MutatePriority mutatePriority, @NotNull Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        T tClosestAnchor;
        T tClosestAnchor2;
        if (continuation instanceof C10201) {
            c10201 = (C10201) continuation;
            int i = c10201.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10201.label = i - Integer.MIN_VALUE;
            } else {
                c10201 = new C10201(this, continuation);
            }
        }
        Object obj = c10201.result;
        ...
        if (i2 != 0) {
            ...
            anchoredDraggableState = (AnchoredDraggableState) c10201.L$0;
            try {
        ...
        try {
            ...
            C10212 c10212 = new C10212(this, function3, null);
            c10201.L$0 = this;
            c10201.label = 1;
            if (internalMutatorMutex.mutate(mutatePriority, c10212, c10201) == coroutine_suspended) {
    ...
    @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {530}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$2 */
    /* loaded from: classes2.dex */
    public static final class C10212 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10212(AnchoredDraggableState<T> anchoredDraggableState, Function3<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C10212> continuation) {
        ...
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C10212(this.this$0, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        @Nullable
        public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
            return ((C10212) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* compiled from: AnchoredDraggable.kt */
        @Metadata(m7104d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\n¢\u0006\u0002\b\u0003"}, m7105d2 = {"<anonymous>", "Landroidx/compose/material/DraggableAnchors;", ExifInterface.GPS_DIRECTION_TRUE, "invoke"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
        /* renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$2$1 */
        /* loaded from: classes3.dex */
        ...
        /* compiled from: AnchoredDraggable.kt */
        @Metadata(m7104d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "latestAnchors", "Landroidx/compose/material/DraggableAnchors;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
        @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$2$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {531}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                AnonymousClass1 anonymousClass1 = new Function0<DraggableAnchors<T>>() { // from class: androidx.compose.material.AnchoredDraggableState.anchoredDrag.2.1
                    public final /* synthetic */ AnchoredDraggableState<T> this$0;
    ...
    */
    public final Object anchoredDrag(T t, @NotNull MutatePriority mutatePriority, @NotNull Function4<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function4, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        T tClosestAnchor;
        T tClosestAnchor2;
        if (continuation instanceof C10223) {
            c10223 = (C10223) continuation;
            int i = c10223.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c10223.label = i - Integer.MIN_VALUE;
            } else {
                c10223 = new C10223(this, continuation);
            }
        }
        Object obj = c10223.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c10223.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(obj);
            if (getAnchors().hasAnchorFor(t)) {
                try {
                    InternalMutatorMutex internalMutatorMutex = this.dragMutex;
                    C10234 c10234 = new C10234(this, t, function4, null);
                    c10223.L$0 = this;
                    c10223.label = 1;
                    if (internalMutatorMutex.mutate(mutatePriority, c10234, c10223) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    anchoredDraggableState = this;
            ...
            anchoredDraggableState = (AnchoredDraggableState) c10223.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                anchoredDraggableState.setDragTarget(null);
                tClosestAnchor2 = anchoredDraggableState.getAnchors().closestAnchor(anchoredDraggableState.getOffset());
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {577}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$4 */
    /* loaded from: classes2.dex */
    public static final class C10234 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C10234(AnchoredDraggableState<T> anchoredDraggableState, T t, Function4<? super AnchoredDragScope, ? super DraggableAnchors<T>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function4, Continuation<? super C10234> continuation) {
            super(1, continuation);
            this.this$0 = anchoredDraggableState;
            this.$targetValue = t;
        ...
        @NotNull
        public final Continuation<Unit> create(@NotNull Continuation<?> continuation) {
            return new C10234(this.this$0, this.$targetValue, this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        @Nullable
        public final Object invoke(@Nullable Continuation<? super Unit> continuation) {
            return ((C10234) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                AnonymousClass1 anonymousClass1 = new Function0<Pair<? extends DraggableAnchors<T>, ? extends T>>() { // from class: androidx.compose.material.AnchoredDraggableState.anchoredDrag.4.1
                    public final /* synthetic */ AnchoredDraggableState<T> this$0;
        ...
        /* compiled from: AnchoredDraggable.kt */
        @Metadata(m7104d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00030\u0002\u0012\u0004\u0012\u0002H\u00030\u0001\"\u0004\b\u0000\u0010\u0003H\n¢\u0006\u0002\b\u0004"}, m7105d2 = {"<anonymous>", "Lkotlin/Pair;", "Landroidx/compose/material/DraggableAnchors;", ExifInterface.GPS_DIRECTION_TRUE, "invoke"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
        /* renamed from: androidx.compose.material.AnchoredDraggableState$anchoredDrag$4$1 */
        /* loaded from: classes3.dex */
        ...
        /* compiled from: AnchoredDraggable.kt */
        @Metadata(m7104d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0018\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00020\u0005\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "<name for destructuring parameter 0>", "Lkotlin/Pair;", "Landroidx/compose/material/DraggableAnchors;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
        @DebugMetadata(m7119c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {580}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    ...
    /* renamed from: androidx.compose.material.AnchoredDraggableState$trySnapTo$1 */
    public static final class C10241 extends Lambda implements Function0<Unit> {
        public final /* synthetic */ T $targetValue;
        public final /* synthetic */ AnchoredDraggableState<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C10241(AnchoredDraggableState<T> anchoredDraggableState, T t) {
            super(0);
            this.this$0 = anchoredDraggableState;
            t = t;
        }
    ...
    private final boolean trySnapTo(T targetValue) {
        return this.dragMutex.tryMutate(new Function0<Unit>(this) { // from class: androidx.compose.material.AnchoredDraggableState.trySnapTo.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C10241(AnchoredDraggableState<T> this, T targetValue2) {
                super(0);
                this.this$0 = this;
                t = targetValue2;
            }
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002Jw\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u0002H\u00060\u0004\"\b\b\u0001\u0010\u0006*\u00020\u00012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0012\u0010\n\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\f0\u000b2!\u0010\r\u001a\u001d\u0012\u0013\u0012\u00110\t¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u0010\u0012\u0004\u0012\u00020\t0\u000b2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\t0\u0012H\u0007¨\u0006\u0013"}, m7105d2 = {"Landroidx/compose/material/AnchoredDraggableState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material/AnchoredDraggableState;", ExifInterface.GPS_DIRECTION_TRUE, "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "confirmValueChange", "Lkotlin/Function1;", "", "positionalThreshold", "Lkotlin/ParameterName;", "name", "distance", "velocityThreshold", "Lkotlin/Function0;", "material_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
