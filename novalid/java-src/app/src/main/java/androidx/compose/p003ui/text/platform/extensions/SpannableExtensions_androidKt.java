...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(@NotNull Spannable spannable, @Nullable TextIndent textIndent, float f, @NotNull Density density) {
        float fM13857getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m13854equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m13854equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m13875isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m13875isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM13856getTypeUIouoOA = TextUnit.m13856getTypeUIouoOA(textIndent.getFirstLine());
            TextUnitType.Companion companion = TextUnitType.INSTANCE;
            float fM13857getValueimpl2 = 0.0f;
            if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13890getSpUIouoOA())) {
                fM13857getValueimpl = density.mo7873toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM13857getValueimpl = TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13889getEmUIouoOA()) ? TextUnit.m13857getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM13856getTypeUIouoOA2 = TextUnit.m13856getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA2, companion.m13890getSpUIouoOA())) {
                fM13857getValueimpl2 = density.mo7873toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA2, companion.m13889getEmUIouoOA())) {
                fM13857getValueimpl2 = TextUnit.m13857getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM13857getValueimpl), (int) Math.ceil(fM13857getValueimpl2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m13435setLineHeightKmRG4DE(@NotNull Spannable spannable, long j, float f, @NotNull Density density, @NotNull LineHeightStyle lineHeightStyle) {
        float fM13430resolveLineHeightInPxo2QH7mI = m13430resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM13430resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightStyleSpan(fM13430resolveLineHeightInPxo2QH7mI, 0, (spannable.length() == 0 || StringsKt___StringsKt.last(spannable) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m13543isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m13544isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m13436setLineHeightr9BaKPg(@NotNull Spannable spannable, long j, float f, @NotNull Density density) {
        float fM13430resolveLineHeightInPxo2QH7mI = m13430resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM13430resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM13430resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m13430resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM13857getValueimpl;
        long jM13856getTypeUIouoOA = TextUnit.m13856getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13890getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo7873toPxR2X_6o(j);
            }
            fM13857getValueimpl = TextUnit.m13857getValueimpl(j) / TextUnit.m13857getValueimpl(density.mo7877toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13889getEmUIouoOA())) {
                return Float.NaN;
            }
            fM13857getValueimpl = TextUnit.m13857getValueimpl(j);
        }
        return fM13857getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(@NotNull Spannable spannable, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<SpanStyle>> list, @NotNull Density density, @NotNull Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM13429createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM13429createLetterSpacingSpaneAf_CNQ = m13429createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM13429createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m13432setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m13433setColorRPmYEkk(spannable, item.m13124getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m13434setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m13431setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m13429createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM13856getTypeUIouoOA = TextUnit.m13856getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13890getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo7873toPxR2X_6o(j));
        }
        if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13889getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m13857getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        long jM13856getTypeUIouoOA = TextUnit.m13856getTypeUIouoOA(spanStyle.getLetterSpacing());
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        return TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13890getSpUIouoOA()) || TextUnitType.m13885equalsimpl0(TextUnit.m13856getTypeUIouoOA(spanStyle.getLetterSpacing()), companion.m13889getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m11394toArgb8_81llA(shadow.getColor()), Offset.m11099getXimpl(shadow.getOffset()), Offset.m11100getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m13434setFontSizeKmRG4DE(@NotNull Spannable spannable, long j, @NotNull Density density, int i, int i2) {
        long jM13856getTypeUIouoOA = TextUnit.m13856getTypeUIouoOA(j);
        TextUnitType.Companion companion = TextUnitType.INSTANCE;
        if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13890getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt__MathJVMKt.roundToInt(density.mo7873toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m13885equalsimpl0(jM13856getTypeUIouoOA, companion.m13889getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m13857getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m13432setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m13448unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m13433setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m13198getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        if (hasFontAttributes(textStyle)) {
            long j = 0;
            long j2 = 0;
            spanStyle = new SpanStyle(j, j2, textStyle.getFontWeight(), textStyle.m13197getFontStyle4Lr2A7w(), textStyle.m13198getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null);
        } else {
            spanStyle = null;
        }
        flattenFontStylesAndApply(spanStyle, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(@NotNull SpanStyle spanStyle2, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM13271boximpl, FontSynthesis.m13282boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m13291getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m13431setBackgroundRPmYEkk(@NotNull Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m11376getUnspecified0d7_KjU()) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m11394toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk, reason: not valid java name */
    public static final void m13433setColorRPmYEkk(@NotNull Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m11376getUnspecified0d7_KjU()) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m11394toArgb8_81llA(j)), i, i2);
        }
    }
}
