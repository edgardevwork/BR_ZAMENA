...
public final class AnchoredDraggableKt {
    ...
    @ExperimentalMaterial3Api
    @NotNull
    public static final <T> Modifier anchoredDraggable(@NotNull Modifier modifier, @NotNull AnchoredDraggableState<T> anchoredDraggableState, @NotNull Orientation orientation, boolean z, boolean z2, @Nullable MutableInteractionSource mutableInteractionSource) {
        return DraggableKt.draggable(modifier, anchoredDraggableState.getDraggableState(), orientation, (TsExtractor.TS_PACKET_SIZE & 4) != 0 ? true : z, (TsExtractor.TS_PACKET_SIZE & 8) != 0 ? null : mutableInteractionSource, (TsExtractor.TS_PACKET_SIZE & 16) != 0 ? false : anchoredDraggableState.isAnimationRunning(), (TsExtractor.TS_PACKET_SIZE & 32) != 0 ? new DraggableKt.C04701(null) : null, (TsExtractor.TS_PACKET_SIZE & 64) != 0 ? new DraggableKt.C04712(null) : new C12841(anchoredDraggableState, null), (TsExtractor.TS_PACKET_SIZE & 128) != 0 ? false : z2);
    }
    ...
    @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$anchoredDraggable$1", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material3.AnchoredDraggableKt$anchoredDraggable$1 */
    /* loaded from: classes.dex */
    public static final class C12841 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        public C12841(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C12841> continuation) {
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, float f, @Nullable Continuation<? super Unit> continuation) {
            C12841 c12841 = new C12841(this.$state, continuation);
            c12841.L$0 = coroutineScope;
            c12841.F$0 = f;
            return c12841.invokeSuspend(Unit.INSTANCE);
        }
        ...
        @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$anchoredDraggable$1$1", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {176}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/material3/AnchoredDragScope;", "anchors", "Landroidx/compose/material3/DraggableAnchors;", "latestTarget"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$snapTo$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material3.AnchoredDraggableKt$snapTo$2 */
    /* loaded from: classes.dex */
    public static final class C12882<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        public /* synthetic */ Object L$0;
        public /* synthetic */ Object L$1;
        public /* synthetic */ Object L$2;
        public int label;

        public C12882(Continuation<? super C12882> continuation) {
        ...
        public final Object invoke(@NotNull AnchoredDragScope anchoredDragScope, @NotNull DraggableAnchors<T> draggableAnchors, T t, @Nullable Continuation<? super Unit> continuation) {
            C12882 c12882 = new C12882(continuation);
            c12882.L$0 = anchoredDragScope;
            c12882.L$1 = draggableAnchors;
            c12882.L$2 = t;
            return c12882.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(@NotNull AnchoredDraggableState<T> anchoredDraggableState, T t, @NotNull Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C12882(null), continuation, 2, null);
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/material3/AnchoredDragScope;", "anchors", "Landroidx/compose/material3/DraggableAnchors;", "latestTarget"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$animateTo$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {696}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material3.AnchoredDraggableKt$animateTo$2 */
    /* loaded from: classes.dex */
    public static final class C12852<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C12852(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C12852> continuation) {
            super(4, continuation);
        ...
        @Nullable
        public final Object invoke(@NotNull AnchoredDragScope anchoredDragScope, @NotNull DraggableAnchors<T> draggableAnchors, T t, @Nullable Continuation<? super Unit> continuation) {
            C12852 c12852 = new C12852(this.$this_animateTo, this.$velocity, continuation);
            c12852.L$0 = anchoredDragScope;
            c12852.L$1 = draggableAnchors;
            c12852.L$2 = t;
            return c12852.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (!Float.isNaN(fPositionOf)) {
                    ...
                    Function2<Float, Float, Unit> function2 = new Function2<Float, Float, Unit>() { // from class: androidx.compose.material3.AnchoredDraggableKt.animateTo.2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
    ...
    public static final <T> Object animateTo(@NotNull AnchoredDraggableState<T> anchoredDraggableState, T t, float f, @NotNull Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C12852(anchoredDraggableState, f, null), continuation, 2, null);
        return objAnchoredDrag$default == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnchoredDrag$default : Unit.INSTANCE;
    }
    ...
    */
    public static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C12861) {
            ...
            if ((i & Integer.MIN_VALUE) != 0) {
                c12861.label = i - Integer.MIN_VALUE;
            } else {
                c12861 = new C12861(continuation);
            }
        }
        Object obj = c12861.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c12861.label;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                C12872 c12872 = new C12872(function0, function2, null);
                c12861.label = 1;
                if (CoroutineScopeKt.coroutineScope(c12872, c12861) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i2 != 1) {
    ...
    @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$restartable$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {735}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.material3.AnchoredDraggableKt$restartable$2 */
    /* loaded from: classes.dex */
    public static final class C12872 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C12872(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C12872> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C12872 c12872 = new C12872(this.$inputs, this.$block, continuation);
            c12872.L$0 = obj;
            return c12872;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C12872) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            ...
            /* compiled from: AnchoredDraggable.kt */
            @Metadata(m7104d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m7105d2 = {"<anonymous>", "", "I", "Lkotlinx/coroutines/CoroutineScope;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
            @DebugMetadata(m7119c = "androidx.compose.material3.AnchoredDraggableKt$restartable$2$1$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {741}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
