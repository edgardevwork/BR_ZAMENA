...
public final class AndroidPaint_androidKt {
    ...
    public static final void m11224setNativeBlendModeGB0RdKg(@NotNull Paint paint, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m11742setBlendModeGB0RdKg(paint, i);
        } else {
            paint.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m11192toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m11225setNativeColor4WTKRHQ(@NotNull Paint paint, long j) {
        paint.setColor(ColorKt.m11394toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m11229setNativeStyle5YerkU(@NotNull Paint paint, int i) {
        paint.setStyle(PaintingStyle.m11603equalsimpl0(i, PaintingStyle.INSTANCE.m11608getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(@NotNull Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m11608getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m11607getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(@NotNull Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m11694getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m11692getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m11227setNativeStrokeCapCSYIeUk(@NotNull Paint paint, int i) {
        Paint.Cap cap;
        StrokeCap.Companion companion = StrokeCap.INSTANCE;
        if (StrokeCap.m11688equalsimpl0(i, companion.m11694getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m11688equalsimpl0(i, companion.m11693getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m11688equalsimpl0(i, companion.m11692getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(@NotNull Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m11702getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m11228setNativeStrokeJoinkLtJ_vA(@NotNull Paint paint, int i) {
        Paint.Join join;
        StrokeJoin.Companion companion = StrokeJoin.INSTANCE;
        if (StrokeJoin.m11698equalsimpl0(i, companion.m11703getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m11698equalsimpl0(i, companion.m11702getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m11698equalsimpl0(i, companion.m11704getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(@NotNull Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m11442getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m11440getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m11226setNativeFilterQuality50PEsBU(@NotNull Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m11435equalsimpl0(i, FilterQuality.INSTANCE.m11442getNonefv9h1I()));
    }
