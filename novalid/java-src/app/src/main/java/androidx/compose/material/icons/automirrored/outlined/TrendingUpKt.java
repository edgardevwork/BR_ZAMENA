...
public final class TrendingUpKt {
    ...
    @NotNull
    public static final ImageVector getTrendingUp(@NotNull Icons.AutoMirrored.Outlined outlined) {
        ImageVector imageVector = _trendingUp;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.TrendingUp", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
