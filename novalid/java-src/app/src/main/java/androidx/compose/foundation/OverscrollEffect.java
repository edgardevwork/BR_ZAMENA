...
public interface OverscrollEffect {
    ...
    Object mo7751applyToFlingBMRW4eQ(long j, @NotNull Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation);

    /* renamed from: applyToScroll-Rhakbz0 */
    long mo7752applyToScrollRhakbz0(long delta, int source, @NotNull Function1<? super Offset, Offset> performScroll);
