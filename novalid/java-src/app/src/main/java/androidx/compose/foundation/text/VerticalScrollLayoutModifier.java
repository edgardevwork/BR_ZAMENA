...
public final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo7625measure3p2s80s(@NotNull final MeasureScope measureScope, @NotNull Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo12610measureBRTryo0.getWidth(), iMin, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, false, placeableMo12610measureBRTryo0.getWidth()), iMin, placeableMo12610measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo12610measureBRTryo0, 0, MathKt__MathJVMKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
