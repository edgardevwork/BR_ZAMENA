...
public final class AnchoredDraggableKt {
    ...
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {708}, m7123m = "restartable", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$1 */
    /* loaded from: classes4.dex */
    public static final class C04321<I> extends ContinuationImpl {
        public int label;
        public /* synthetic */ Object result;

        public C04321(Continuation<? super C04321> continuation) {
            super(continuation);
        }
    ...
    public static final <T> Modifier anchoredDraggable(@NotNull Modifier modifier, @NotNull AnchoredDraggableState<T> anchoredDraggableState, @NotNull Orientation orientation, boolean z, boolean z2, @Nullable MutableInteractionSource mutableInteractionSource, boolean z3) {
        return DraggableKt.draggable(modifier, anchoredDraggableState.getDraggableState(), orientation, (TsExtractor.TS_PACKET_SIZE & 4) != 0 ? true : z, (TsExtractor.TS_PACKET_SIZE & 8) != 0 ? null : mutableInteractionSource, (TsExtractor.TS_PACKET_SIZE & 16) != 0 ? false : z3, (TsExtractor.TS_PACKET_SIZE & 32) != 0 ? new DraggableKt.C04701(null) : null, (TsExtractor.TS_PACKET_SIZE & 64) != 0 ? new DraggableKt.C04712(null) : new C04301(anchoredDraggableState, null), (TsExtractor.TS_PACKET_SIZE & 128) != 0 ? false : z2);
    }
    ...
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$anchoredDraggable$1", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.AnchoredDraggableKt$anchoredDraggable$1 */
    /* loaded from: classes4.dex */
    public static final class C04301 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        public C04301(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C04301> continuation) {
        ...
        public final Object invoke(@NotNull CoroutineScope coroutineScope, float f, @Nullable Continuation<? super Unit> continuation) {
            C04301 c04301 = new C04301(this.$state, continuation);
            c04301.L$0 = coroutineScope;
            c04301.F$0 = f;
        ...
        @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$anchoredDraggable$1$1", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {176}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/foundation/gestures/AnchoredDragScope;", "anchors", "Landroidx/compose/foundation/gestures/DraggableAnchors;", "latestTarget"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$snapTo$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.AnchoredDraggableKt$snapTo$2 */
    /* loaded from: classes4.dex */
    public static final class C04342<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        public /* synthetic */ Object L$0;
        public /* synthetic */ Object L$1;
        public /* synthetic */ Object L$2;
        public int label;

        public C04342(Continuation<? super C04342> continuation) {
        ...
        public final Object invoke(@NotNull AnchoredDragScope anchoredDragScope, @NotNull DraggableAnchors<T> draggableAnchors, T t, @Nullable Continuation<? super Unit> continuation) {
            C04342 c04342 = new C04342(continuation);
            c04342.L$0 = anchoredDragScope;
            c04342.L$1 = draggableAnchors;
            c04342.L$2 = t;
            return c04342.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object snapTo(@NotNull AnchoredDraggableState<T> anchoredDraggableState, T t, @NotNull Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C04342(null), continuation, 2, null);
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m7105d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/foundation/gestures/AnchoredDragScope;", "anchors", "Landroidx/compose/foundation/gestures/DraggableAnchors;", "latestTarget"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$animateTo$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {687}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.AnchoredDraggableKt$animateTo$2 */
    /* loaded from: classes4.dex */
    public static final class C04312<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C04312(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C04312> continuation) {
            super(4, continuation);
        ...
        @Nullable
        public final Object invoke(@NotNull AnchoredDragScope anchoredDragScope, @NotNull DraggableAnchors<T> draggableAnchors, T t, @Nullable Continuation<? super Unit> continuation) {
            C04312 c04312 = new C04312(this.$this_animateTo, this.$velocity, continuation);
            c04312.L$0 = anchoredDragScope;
            c04312.L$1 = draggableAnchors;
            c04312.L$2 = t;
            return c04312.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                if (!Float.isNaN(fPositionOf)) {
                    ...
                    Function2<Float, Float, Unit> function2 = new Function2<Float, Float, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableKt.animateTo.2.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(2);
                        }
    ...
    public static final <T> Object animateTo(@NotNull AnchoredDraggableState<T> anchoredDraggableState, T t, float f, @NotNull Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C04312(anchoredDraggableState, f, null), continuation, 2, null);
        return objAnchoredDrag$default == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnchoredDrag$default : Unit.INSTANCE;
    }
    ...
    */
    public static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        C04321 c04321;
        if (continuation instanceof C04321) {
            c04321 = (C04321) continuation;
            int i = c04321.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c04321.label = i - Integer.MIN_VALUE;
            } else {
                c04321 = new C04321(continuation);
            }
        }
        Object obj = c04321.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c04321.label;
        try {
            if (i2 == 0) {
                ResultKt.throwOnFailure(obj);
                C04332 c04332 = new C04332(function0, function2, null);
                c04321.label = 1;
                if (CoroutineScopeKt.coroutineScope(c04332, c04321) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i2 != 1) {
    ...
    @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {711}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2 */
    /* loaded from: classes4.dex */
    public static final class C04332 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C04332(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04332> continuation) {
            super(2, continuation);
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C04332 c04332 = new C04332(this.$inputs, this.$block, continuation);
            c04332.L$0 = obj;
            return c04332;
        }
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            ...
            /* compiled from: AnchoredDraggable.kt */
            @Metadata(m7104d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m7105d2 = {"<anonymous>", "", "I", "Lkotlinx/coroutines/CoroutineScope;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
            @DebugMetadata(m7119c = "androidx.compose.foundation.gestures.AnchoredDraggableKt$restartable$2$1$2", m7120f = "AnchoredDraggable.kt", m7121i = {}, m7122l = {717}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
