...
public final class LogoutKt {
    ...
    @NotNull
    public static final ImageVector getLogout(@NotNull Icons.AutoMirrored.Outlined outlined) {
        ImageVector imageVector = _logout;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.Logout", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
