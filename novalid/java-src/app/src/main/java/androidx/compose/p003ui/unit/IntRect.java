...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m13812getSizeYbymL2g$annotations() {
    }
    ...
    /* compiled from: IntRect.kt */
    @Metadata(m7104d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m7105d2 = {"Landroidx/compose/ui/unit/IntRect$Companion;", "", "()V", "Zero", "Landroidx/compose/ui/unit/IntRect;", "getZero$annotations", "getZero", "()Landroidx/compose/ui/unit/IntRect;", "ui-unit_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
    ...
    public final long m13820getSizeYbymL2g() {
    ...
    public final IntRect m13824translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m13794getXimpl(offset), this.top + IntOffset.m13795getYimpl(offset), this.right + IntOffset.m13794getXimpl(offset), this.bottom + IntOffset.m13795getYimpl(offset));
    }
    ...
    public final long m13822getTopLeftnOccac() {
        return IntOffsetKt.IntOffset(this.left, this.top);
    }

    /* renamed from: getTopCenter-nOcc-ac, reason: not valid java name */
    public final long m13821getTopCenternOccac() {
        return IntOffsetKt.IntOffset(this.left + (getWidth() / 2), this.top);
    }

    /* renamed from: getTopRight-nOcc-ac, reason: not valid java name */
    public final long m13823getTopRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.top);
    }

    /* renamed from: getCenterLeft-nOcc-ac, reason: not valid java name */
    public final long m13818getCenterLeftnOccac() {
        return IntOffsetKt.IntOffset(this.left, this.top + (getHeight() / 2));
    }

    /* renamed from: getCenter-nOcc-ac, reason: not valid java name */
    public final long m13817getCenternOccac() {
        return IntOffsetKt.IntOffset(this.left + (getWidth() / 2), this.top + (getHeight() / 2));
    }

    /* renamed from: getCenterRight-nOcc-ac, reason: not valid java name */
    public final long m13819getCenterRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.top + (getHeight() / 2));
    }

    /* renamed from: getBottomLeft-nOcc-ac, reason: not valid java name */
    public final long m13815getBottomLeftnOccac() {
        return IntOffsetKt.IntOffset(this.left, this.bottom);
    }

    /* renamed from: getBottomCenter-nOcc-ac, reason: not valid java name */
    public final long m13814getBottomCenternOccac() {
        return IntOffsetKt.IntOffset(this.left + (getWidth() / 2), this.bottom);
    }

    /* renamed from: getBottomRight-nOcc-ac, reason: not valid java name */
    public final long m13816getBottomRightnOccac() {
        return IntOffsetKt.IntOffset(this.right, this.bottom);
    }

    /* renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m13813containsgyyYBs(long offset) {
        return IntOffset.m13794getXimpl(offset) >= this.left && IntOffset.m13794getXimpl(offset) < this.right && IntOffset.m13795getYimpl(offset) >= this.top && IntOffset.m13795getYimpl(offset) < this.bottom;
    }
