...
final /* data */ class FocusChangedElement extends ModifierNodeElement<FocusChangedNode> {
    ...
    @NotNull
    public final FocusChangedElement copy(@NotNull Function1<? super FocusState, Unit> onFocusChanged) {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull FocusChangedNode node) {
