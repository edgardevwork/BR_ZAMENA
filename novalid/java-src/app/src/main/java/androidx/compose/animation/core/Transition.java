...
public final class Transition<S> {
        ...
        if ((i2 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (!isSeeking()) {
                ...
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    composerStartRestartGroup.startReplaceableGroup(-561029496);
                    ...
                    EffectsKt.LaunchedEffect(this, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue, composerStartRestartGroup, ((i2 >> 3) & 14) | 64);
                }
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        @NotNull
        private final MutableState com.bumptech.glide.load.engine.executor.GlideExecutor.DEFAULT_ANIMATION_EXECUTOR_NAME java.lang.String;
        ...
        public TransitionAnimationState(T t, @NotNull V v, @NotNull TwoWayConverter<T, V> twoWayConverter, @NotNull String str) {
            ...
            this.com.bumptech.glide.load.engine.executor.GlideExecutor.DEFAULT_ANIMATION_EXECUTOR_NAME java.lang.String = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TargetBasedAnimation(getAnimationSpec(), twoWayConverter, t, getTargetValue(), v), null, 2, null);
        ...
        private final void setAnimation(TargetBasedAnimation<T, V> targetBasedAnimation) {
            this.com.bumptech.glide.load.engine.executor.GlideExecutor.DEFAULT_ANIMATION_EXECUTOR_NAME java.lang.String.setValue(targetBasedAnimation);
        }

        @NotNull
        public final TargetBasedAnimation<T, V> getAnimation() {
            return (TargetBasedAnimation) this.com.bumptech.glide.load.engine.executor.GlideExecutor.DEFAULT_ANIMATION_EXECUTOR_NAME java.lang.String.getValue();
        }
    ...
    /* compiled from: Transition.kt */
    @Metadata(m7104d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\bf\u0018\u0000*\u0004\b\u0001\u0010\u00012\u00020\u0002J\u001a\u0010\b\u001a\u00020\t*\u00028\u00012\u0006\u0010\u0006\u001a\u00028\u0001H\u0096\u0004¢\u0006\u0002\u0010\nR\u0012\u0010\u0003\u001a\u00028\u0001X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005R\u0012\u0010\u0006\u001a\u00028\u0001X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0007\u0010\u0005ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000bÀ\u0006\u0003"}, m7105d2 = {"Landroidx/compose/animation/core/Transition$Segment;", "S", "", "initialState", "getInitialState", "()Ljava/lang/Object;", "targetState", "getTargetState", "isTransitioningTo", "", "(Ljava/lang/Object;Ljava/lang/Object;)Z", "animation-core_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
