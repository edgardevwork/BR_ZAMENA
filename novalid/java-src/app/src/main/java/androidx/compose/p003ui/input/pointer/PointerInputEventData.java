...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m12498copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, @NotNull List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return PointerId.m12466equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m11096equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m11096equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m12556equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m11096equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m11096equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m12467hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m11101hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m11101hashCodeimpl(this.position)) * 31) + Boolean.hashCode(this.down)) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m12557hashCodeimpl(this.type)) * 31) + Boolean.hashCode(this.issuesEnterExit)) * 31) + this.historical.hashCode()) * 31) + Offset.m11101hashCodeimpl(this.scrollDelta)) * 31) + Offset.m11101hashCodeimpl(this.originalEventPosition);
    }

    @NotNull
    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m12468toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m11107toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m11107toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m12558toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m11107toStringimpl(this.scrollDelta)) + ", originalEventPosition=" + ((Object) Offset.m11107toStringimpl(this.originalEventPosition)) + ')';
    }
    ...
    public final long m12499getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m12502getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m12501getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m12504getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m11115getZeroF1C5BW0() : j5, (i2 & 1024) != 0 ? Offset.INSTANCE.m11115getZeroF1C5BW0() : j6, null);
    }
    ...
    public final long m12503getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m12500getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
