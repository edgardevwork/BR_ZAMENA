...
public final class MotionPhotosPausedKt {
    ...
    public static final ImageVector getMotionPhotosPaused(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.MotionPhotosPaused", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
