...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    @NotNull
    private final RenderNode renderNode = RenderNodeApi29$$ExternalSyntheticApiModelOutline54.m287m("Compose");
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m11429getAutoNrFUSI();
