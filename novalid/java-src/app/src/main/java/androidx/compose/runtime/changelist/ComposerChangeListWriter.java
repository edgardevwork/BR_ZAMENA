...
public final class ComposerChangeListWriter {
    ...
    public final void removeNode(int nodeIndex, int i) {
        if (i > 0) {
            if (!(nodeIndex >= 0)) {
    ...
    public final void moveNode(int from, int to, int i) {
        if (i > 0) {
    ...
    private final void realizeMoveNode(int to, int from, int i) {
        pushApplierOperationPreamble();
        this.changeList.pushMoveNode(to, from, i);
    }
