...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(@NotNull AnnotatedString annotatedString, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<Placeholder>> list, @NotNull Density density, @NotNull FontFamily.Resolver resolver) {
        ...
        this.minIntrinsicWidth = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$minIntrinsicWidth$2
            {
                super(0);
            }
        ...
        this.maxIntrinsicWidth = LazyKt__LazyJVMKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$maxIntrinsicWidth$2
            {
                super(0);
            }
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        if (TextDirection.m13568equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m13577getUnspecifieds_7Xco())) {
            return style.m13073copyykzQM6k((509 & 1) != 0 ? style.textAlign : 0, (509 & 2) != 0 ? style.textDirection : defaultStyle.getTextDirection(), (509 & 4) != 0 ? style.lineHeight : 0L, (509 & 8) != 0 ? style.textIndent : null, (509 & 16) != 0 ? style.platformStyle : null, (509 & 32) != 0 ? style.lineHeightStyle : null, (509 & 64) != 0 ? style.lineBreak : 0, (509 & 128) != 0 ? style.hyphens : 0, (509 & 256) != 0 ? style.textMotion : null);
        }
        return style;
    }
}
