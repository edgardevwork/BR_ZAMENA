...
public final class PlaylistPlayKt {
    ...
    @NotNull
    public static final ImageVector getPlaylistPlay(@NotNull Icons.AutoMirrored.Rounded rounded) {
        ImageVector imageVector = _playlistPlay;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.PlaylistPlay", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
