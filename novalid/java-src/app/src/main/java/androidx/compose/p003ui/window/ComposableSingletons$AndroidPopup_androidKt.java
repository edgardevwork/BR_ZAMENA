...
public final class ComposableSingletons$AndroidPopup_androidKt {
    ...
    @NotNull
    public static Function2<Composer, Integer, Unit> f11140lambda1 = ComposableLambdaKt.composableLambdaInstance(-1131826196, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.ComposableSingletons$AndroidPopup_androidKt$lambda-1$1
    ...
    public final Function2<Composer, Integer, Unit> m13918getLambda1$ui_release() {
        return f11140lambda1;
    }
}
