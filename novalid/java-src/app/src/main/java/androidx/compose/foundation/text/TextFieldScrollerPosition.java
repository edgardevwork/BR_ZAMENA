...
public final class TextFieldScrollerPosition {
    ...
    private static final Saver<TextFieldScrollerPosition, Object> Saver = ListSaverKt.listSaver(new Function2<SaverScope, TextFieldScrollerPosition, List<? extends Object>>() { // from class: androidx.compose.foundation.text.TextFieldScrollerPosition$Companion$Saver$1
        ...
        public final List<Object> invoke(@NotNull SaverScope saverScope, @NotNull TextFieldScrollerPosition textFieldScrollerPosition) {
            return CollectionsKt__CollectionsKt.listOf(Float.valueOf(textFieldScrollerPosition.getOffset()), Boolean.valueOf(textFieldScrollerPosition.getOrientation() == Orientation.Vertical));
        }
    ...
    public TextFieldScrollerPosition(@NotNull Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m13170getZerod9O1mEE();
    ...
    public final void m8487setPreviousSelection5zctL8(long j) {
    ...
    public final void update(@NotNull Orientation orientation, @NotNull Rect cursorRect, int containerSize, int textFieldSize) {
        ...
        setOffset(RangesKt___RangesKt.coerceIn(getOffset(), 0.0f, f));
    }
    ...
    public final int m8485getOffsetToFollow5zctL8(long selection) {
        return TextRange.m13165getStartimpl(selection) != TextRange.m13165getStartimpl(this.previousSelection) ? TextRange.m13165getStartimpl(selection) : TextRange.m13160getEndimpl(selection) != TextRange.m13160getEndimpl(this.previousSelection) ? TextRange.m13160getEndimpl(selection) : TextRange.m13163getMinimpl(selection);
    }

    /* compiled from: TextFieldScroll.kt */
    @Metadata(m7104d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001d\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00010\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m7105d2 = {"Landroidx/compose/foundation/text/TextFieldScrollerPosition$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/TextFieldScrollerPosition;", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "foundation_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
