...
public final class FilledTonalIconButtonTokens {
    ...
    static {
        ...
        ContainerSize = C2046Dp.m13666constructorimpl((float) 40.0d);
        ...
        Size = C2046Dp.m13666constructorimpl((float) 24.0d);
    ...
    public final float m10471getContainerSizeD9Ej5fM() {
    ...
    public final float m10472getSizeD9Ej5fM() {
        return Size;
    }
