...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m9074animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        State<BorderStroke> stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(stateRememberUpdatedState.getValue().m13680unboximpl(), new SolidColor(stateIndicatorColor.getValue().m11350unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
