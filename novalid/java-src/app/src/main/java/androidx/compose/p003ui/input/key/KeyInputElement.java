...
final /* data */ class KeyInputElement extends ModifierNodeElement<KeyInputNode> {
    ...
    @NotNull
    public final KeyInputElement copy(@Nullable Function1<? super KeyEvent, Boolean> onKeyEvent, @Nullable Function1<? super KeyEvent, Boolean> onPreKeyEvent) {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public void update(@NotNull KeyInputNode node) {
