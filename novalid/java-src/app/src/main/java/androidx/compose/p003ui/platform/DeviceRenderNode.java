...
public interface DeviceRenderNode {
    ...
    int mo12927getCompositingStrategyNrFUSI();
    ...
    void record(@NotNull CanvasHolder canvasHolder, @Nullable Path clipPath, @NotNull Function1<? super androidx.compose.p003ui.graphics.Canvas, Unit> drawBlock);
    ...
    void mo12928setCompositingStrategyaDBOjCE(int i);
