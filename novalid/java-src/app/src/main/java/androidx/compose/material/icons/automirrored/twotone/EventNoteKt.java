...
public final class EventNoteKt {
    ...
    @NotNull
    public static final ImageVector getEventNote(@NotNull Icons.AutoMirrored.TwoTone twoTone) {
        ImageVector imageVector = _eventNote;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.EventNote", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
