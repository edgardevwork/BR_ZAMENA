...
public final class TrendingDownKt {
    ...
    @NotNull
    public static final ImageVector getTrendingDown(@NotNull Icons.AutoMirrored.Rounded rounded) {
        ImageVector imageVector = _trendingDown;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.TrendingDown", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
