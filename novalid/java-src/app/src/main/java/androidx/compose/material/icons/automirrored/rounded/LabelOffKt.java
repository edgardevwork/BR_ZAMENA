...
public final class LabelOffKt {
    ...
    @NotNull
    public static final ImageVector getLabelOff(@NotNull Icons.AutoMirrored.Rounded rounded) {
        ImageVector imageVector = _labelOff;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Rounded.LabelOff", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
