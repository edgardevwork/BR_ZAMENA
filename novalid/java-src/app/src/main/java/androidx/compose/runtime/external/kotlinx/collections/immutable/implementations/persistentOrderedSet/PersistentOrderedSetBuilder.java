...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        if (persistentHashMapBuild2 == this.set.getHashMap$runtime_release()) {
            CommonFunctionsKt.m10956assert(this.firstElement == this.set.getFirstElement());
            CommonFunctionsKt.m10956assert(this.lastElement == this.set.getLastElement());
