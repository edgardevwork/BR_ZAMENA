...
public final class ModeOfTravelKt {
    ...
    public static final ImageVector getModeOfTravel(@NotNull Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ModeOfTravel", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
