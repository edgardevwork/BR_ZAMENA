...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m13315copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m13318copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final TypefaceRequest m13318copye1PVR60(@Nullable FontFamily fontFamily, @NotNull FontWeight fontWeight, int fontStyle, int fontSynthesis, @Nullable Object resourceLoaderCacheKey) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m13274equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m13285equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily = this.fontFamily;
        int iHashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m13275hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m13286hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m13276toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m13289toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m13319getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m13320getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
