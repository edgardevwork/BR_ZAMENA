...
public final class ScrollableTabData {
    ...
    public final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int iMo7868roundToPx0680j_4 = density.mo7868roundToPx0680j_4(((TabPosition) CollectionsKt___CollectionsKt.last((List) list)).m9919getRightD9Ej5fM()) + i;
