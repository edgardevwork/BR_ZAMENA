...
public final class PagerBeyondBoundsState implements LazyLayoutBeyondBoundsState {
    ...
    public int getLastPlacedIndex() {
        return Math.min(getItemCount() - 1, ((PageInfo) CollectionsKt___CollectionsKt.last((List) this.state.getLayoutInfo().getVisiblePagesInfo())).getIndex() + this.beyondBoundsPageCount);
    }
}
