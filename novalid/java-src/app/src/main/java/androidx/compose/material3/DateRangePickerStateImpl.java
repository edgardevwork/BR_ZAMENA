...
public final class DateRangePickerStateImpl extends BaseDatePickerStateImpl implements DateRangePickerState {
    ...
    @NotNull
    public MutableState<CalendarDate> _selectedEndDate;

    @NotNull
    public MutableState<CalendarDate> _selectedStartDate;
    ...
    public int mo9403getDisplayModejFl4v0() {
        return this._displayMode.getValue().getValue();
    }

    @Override // androidx.compose.material3.DateRangePickerState
    /* renamed from: setDisplayMode-vCnGnXg */
    public void mo9404setDisplayModevCnGnXg(int i) {
    ...
    @Override // androidx.compose.material3.DateRangePickerState
    public void setSelection(@Nullable Long startDateMillis, @Nullable Long endDateMillis) {
    ...
    /* compiled from: DateRangePicker.kt */
    @Metadata(m7104d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00010\u00042\u0006\u0010\u0006\u001a\u00020\u00072\n\u0010\b\u001a\u00060\tj\u0002`\n¨\u0006\u000b"}, m7105d2 = {"Landroidx/compose/material3/DateRangePickerStateImpl$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/DateRangePickerStateImpl;", "selectableDates", "Landroidx/compose/material3/SelectableDates;", "locale", "Ljava/util/Locale;", "Landroidx/compose/material3/CalendarLocale;", "material3_release"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
        ...
        public final Saver<DateRangePickerStateImpl, Object> Saver(@NotNull final SelectableDates selectableDates, @NotNull final Locale locale) {
            return ListSaverKt.listSaver(new Function2<SaverScope, DateRangePickerStateImpl, List<? extends Object>>() { // from class: androidx.compose.material3.DateRangePickerStateImpl$Companion$Saver$1
                ...
                public final List<Object> invoke(@NotNull SaverScope saverScope, @NotNull DateRangePickerStateImpl dateRangePickerStateImpl) {
                    return CollectionsKt__CollectionsKt.listOf(dateRangePickerStateImpl.getSelectedStartDateMillis(), dateRangePickerStateImpl.getSelectedEndDateMillis(), Long.valueOf(dateRangePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getLast()), Integer.valueOf(dateRangePickerStateImpl.mo9403getDisplayModejFl4v0()));
                }
                ...
                public final DateRangePickerStateImpl invoke2(@NotNull List<? extends Object> list) {
                    ...
                    return new DateRangePickerStateImpl(l, l2, l3, intRange, DisplayMode.m9414constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
                }
            });
        }
    }
