...
public final class PanoramaHorizontalSelectKt {
    ...
    public static final ImageVector getPanoramaHorizontalSelect(@NotNull Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PanoramaHorizontalSelect", C2046Dp.m13666constructorimpl(24.0f), C2046Dp.m13666constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
