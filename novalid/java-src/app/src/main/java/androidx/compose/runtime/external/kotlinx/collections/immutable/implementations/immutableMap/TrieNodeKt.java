...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] replaceNodeWithEntry(Object[] objArr, int i, int i2, K k, V v) {
        ...
        ArraysKt___ArraysJvmKt.copyInto(objArrCopyOf, objArrCopyOf, i + 2, i + 1, objArr.length);
        ArraysKt___ArraysJvmKt.copyInto(objArrCopyOf, objArrCopyOf, i2 + 2, i2, i);
        objArrCopyOf[i2] = k;
        objArrCopyOf[i2 + 1] = v;
        return objArrCopyOf;
    }
