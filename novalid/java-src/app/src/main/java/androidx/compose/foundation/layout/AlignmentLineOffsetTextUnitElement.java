...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public AlignmentLineOffsetTextUnitElement(AlignmentLine alignmentLine, long j, long j2, Function1<? super InspectorInfo, Unit> function1) {
    ...
    @Override // androidx.compose.p003ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m13858hashCodeimpl(this.before)) * 31) + TextUnit.m13858hashCodeimpl(this.after);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m13854equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m13854equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(@NotNull AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m8021setBeforeR2X_6o(this.before);
        node.m8020setAfterR2X_6o(this.after);
    }
}
