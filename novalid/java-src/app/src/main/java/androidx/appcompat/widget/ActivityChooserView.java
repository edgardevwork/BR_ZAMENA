...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0092R.styleable.ActivityChooserView;
        ...
        this.mInitialActivityCount = typedArrayObtainStyledAttributes.getInt(C0092R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        typedArrayObtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0092R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View viewFindViewById = findViewById(C0092R.id.activity_chooser_view_content);
        this.mActivityChooserContent = viewFindViewById;
        this.mActivityChooserContentBackground = viewFindViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0092R.id.default_activity_button);
        ...
        int i2 = C0092R.id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i2);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0092R.id.expand_activities_button);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0092R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C0092R.string.abc_activitychooserview_choose_application));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    View viewInflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0092R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    viewInflate.setId(1);
                    ((TextView) viewInflate.findViewById(C0092R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0092R.string.abc_activity_chooser_view_see_all));
                    return viewInflate;
                }
                throw new IllegalArgumentException();
            }
            if (view == null || view.getId() != C0092R.id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0092R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ImageView imageView = (ImageView) view.findViewById(C0092R.id.icon);
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            imageView.setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0092R.id.title)).setText(resolveInfo.loadLabel(packageManager));
