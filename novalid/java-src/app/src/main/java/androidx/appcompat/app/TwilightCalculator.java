...
public class TwilightCalculator {
    ...
    /* renamed from: C1 */
    public static final float f11C1 = 0.0334196f;

    /* renamed from: C2 */
    public static final float f12C2 = 3.49066E-4f;

    /* renamed from: C3 */
    public static final float f13C3 = 5.236E-6f;
    public static final int DAY = 0;
    public static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    public static final float f14J0 = 9.0E-4f;
