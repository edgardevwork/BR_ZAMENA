...
public class TooltipPopup {
    ...
    public TooltipPopup(@NonNull Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0092R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0092R.id.message);
        ...
        layoutParams.windowAnimations = C0092R.style.Animation_AppCompat_Tooltip;
    ...
    public final void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) throws Resources.NotFoundException {
        int height;
        int i3;
        layoutParams.token = view.getApplicationWindowToken();
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0092R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0092R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0092R.dimen.tooltip_y_offset_touch : C0092R.dimen.tooltip_y_offset_non_touch);
