...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        int[] iArr = C0092R.styleable.ButtonBarLayout;
        ...
        this.mAllowStacking = typedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        if (this.mStacked != z) {
            if (!z || this.mAllowStacking) {
                ...
                View viewFindViewById = findViewById(C0092R.id.spacer);
