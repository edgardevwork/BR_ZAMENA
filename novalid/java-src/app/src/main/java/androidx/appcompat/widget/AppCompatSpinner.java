...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(@NonNull Context context, int i) {
        this(context, null, C0092R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0092R.attr.spinnerStyle);
    }
    ...
    */
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2, Resources.Theme theme) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0092R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, theme);
        } else {
            int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.Spinner_popupTheme, 0);
            if (resourceId != 0) {
        ...
        try {
            if (i2 == -1) {
                ...
                try {
                    ...
                    textArray = tintTypedArrayObtainStyledAttributes.getTextArray(C0092R.styleable.Spinner_android_entries);
                    if (textArray != null) {
                    }
            ...
            if (i2 != 0) {
                ...
                dialogPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0092R.styleable.Spinner_android_prompt));
            } else if (i2 == 1) {
                final DropdownPopup dropdownPopup = new DropdownPopup(this.mPopupContext, attributeSet, i);
                TintTypedArray tintTypedArrayObtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0092R.styleable.Spinner, i, 0);
                this.mDropDownWidth = tintTypedArrayObtainStyledAttributes2.getLayoutDimension(C0092R.styleable.Spinner_android_dropDownWidth, -2);
                dropdownPopup.setBackgroundDrawable(tintTypedArrayObtainStyledAttributes2.getDrawable(C0092R.styleable.Spinner_android_popupBackground));
                dropdownPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0092R.styleable.Spinner_android_prompt));
            ...
            if (textArray != null) {
                ...
                arrayAdapter.setDropDownViewResource(C0092R.layout.support_simple_spinner_dropdown_item);
    ...
    public static final class Api17Impl {
        ...
        @DoNotInline
        public static void setTextAlignment(@NonNull View view, int i) {
        ...
        @DoNotInline
        public static void setTextDirection(@NonNull View view, int i) {
