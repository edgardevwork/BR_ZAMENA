...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0092R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0092R.id.edit_query);
        }
    }
    ...
    public final CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0092R.attr.textColorSearchUrl, typedValue, true);
    ...
    public final Drawable getIcon1(Cursor cursor) throws NumberFormatException, IOException {
    ...
    public final Drawable getDrawableFromResourceValue(String str) throws NumberFormatException, IOException {
    ...
    public final Drawable getDrawable(Uri uri) throws IOException {
        try {
            if (DefaultDataSource.SCHEME_ANDROID_RESOURCE.equals(uri.getScheme())) {
                try {
    ...
    public final Drawable getDefaultIcon1() throws PackageManager.NameNotFoundException {
    ...
    public final Drawable getActivityIconWithCache(ComponentName componentName) throws PackageManager.NameNotFoundException {
