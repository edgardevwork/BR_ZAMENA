...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        this.mContext.getTheme().resolveAttribute(C0092R.attr.actionModeShareDrawable, typedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0092R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0092R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (iMin < activityCount) {
            SubMenu subMenuAddSubMenu = subMenu.addSubMenu(0, iMin, iMin, this.mContext.getString(C0092R.string.abc_activity_chooser_view_see_all));
