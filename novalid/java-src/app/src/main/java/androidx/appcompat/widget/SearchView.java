...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0092R.attr.searchViewStyle);
    }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C0092R.styleable.SearchView;
        ...
        LayoutInflater.from(context).inflate(tintTypedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.SearchView_layout, C0092R.layout.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0092R.id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0092R.id.search_edit_frame);
        View viewFindViewById = findViewById(C0092R.id.search_plate);
        this.mSearchPlate = viewFindViewById;
        View viewFindViewById2 = findViewById(C0092R.id.submit_area);
        this.mSubmitArea = viewFindViewById2;
        ImageView imageView = (ImageView) findViewById(C0092R.id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0092R.id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0092R.id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0092R.id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0092R.id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(viewFindViewById, tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(viewFindViewById2, tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_submitBackground));
        int i2 = C0092R.styleable.SearchView_searchIcon;
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i2));
        imageView2.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i2));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(C0092R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0092R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = tintTypedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.SearchView_suggestionRowLayout, C0092R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = tintTypedArrayObtainStyledAttributes.getResourceId(C0092R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(tintTypedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0092R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0092R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0092R.styleable.SearchView_queryHint);
        int i3 = tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.SearchView_android_imeOptions, -1);
        if (i3 != -1) {
            setImeOptions(i3);
        }
        int i4 = tintTypedArrayObtainStyledAttributes.getInt(C0092R.styleable.SearchView_android_inputType, -1);
        if (i4 != -1) {
            setInputType(i4);
        }
        setFocusable(tintTypedArrayObtainStyledAttributes.getBoolean(C0092R.styleable.SearchView_android_focusable, true));
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0092R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0092R.dimen.abc_search_view_preferred_height);
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + WebvttCssParser.RULE_END;
        }
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0092R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0092R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    public final Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) throws Resources.NotFoundException {
        String string;
        ComponentName searchActivity = searchableInfo.getSearchActivity();
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0092R.attr.autoCompleteTextViewStyle);
        }
