...
public final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    public static final int ITEM_LAYOUT = C0092R.layout.abc_popup_menu_item_layout;
    ...
    public final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.StandardMenuPopup.1
        public ViewTreeObserverOnGlobalLayoutListenerC01361() {
        }
    ...
    public final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: androidx.appcompat.view.menu.StandardMenuPopup.2
        ...
        public ViewOnAttachStateChangeListenerC01372() {
        }
    ...
    public class ViewTreeObserverOnGlobalLayoutListenerC01361 implements ViewTreeObserver.OnGlobalLayoutListener {
        public ViewTreeObserverOnGlobalLayoutListenerC01361() {
        }
    ...
    /* loaded from: classes4.dex */
    public class ViewOnAttachStateChangeListenerC01372 implements View.OnAttachStateChangeListener {
        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewAttachedToWindow(View view) {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0092R.dimen.abc_config_prefDialogWidth));
    ...
    public final boolean tryShow() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        View view;
        if (isShowing()) {
            return true;
        }
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0092R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
