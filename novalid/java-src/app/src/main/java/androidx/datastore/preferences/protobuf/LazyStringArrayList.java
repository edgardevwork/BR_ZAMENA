...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public final void add(int i, ByteString byteString) {
        ensureIsMutable();
        this.list.add(i, byteString);
        ((AbstractList) this).modCount++;
    }

    public final void add(int i, byte[] bArr) {
        ensureIsMutable();
    ...
    public final Object setAndReturn(int i, ByteString byteString) {
        ensureIsMutable();
    ...
    public final Object setAndReturn(int i, byte[] bArr) {
        ensureIsMutable();
