...
public abstract class IntList {
    ...
    public final int elementAtOrElse(@IntRange(from = 0) int i, @NotNull Function1<? super Integer, Integer> defaultValue) {
