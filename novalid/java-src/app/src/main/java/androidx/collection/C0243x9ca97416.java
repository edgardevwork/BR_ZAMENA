...
@DebugMetadata(m7119c = "androidx.collection.MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1", m7120f = "ScatterMap.kt", m7121i = {0, 0, 0, 0, 0, 0, 0}, m7122l = {1495}, m7123m = "invokeSuspend", m7124n = {"$this$iterator", "m$iv", "lastIndex$iv", "i$iv", "slot$iv", "bitCount$iv", "j$iv"}, m7125s = {"L$0", "L$1", "I$0", "I$1", "J$0", "I$2", "I$3"})
...
public final class C0243x9ca97416 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Integer>, Continuation<? super Unit>, Object> {
    public int I$0;
    public int I$1;
    public int I$2;
    public int I$3;
    ...
    public C0243x9ca97416(MutableScatterMap<K, V> mutableScatterMap, Continuation<? super C0243x9ca97416> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        C0243x9ca97416 c0243x9ca97416 = new C0243x9ca97416(this.this$0, continuation);
        c0243x9ca97416.L$0 = obj;
        return c0243x9ca97416;
    }
    ...
    public final Object invoke(@NotNull SequenceScope<? super Integer> sequenceScope, @Nullable Continuation<? super Unit> continuation) {
        return ((C0243x9ca97416) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
