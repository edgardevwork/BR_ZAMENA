...
public abstract class LongList {
    ...
    public final long elementAtOrElse(@IntRange(from = 0) int i, @NotNull Function1<? super Integer, Long> defaultValue) {
