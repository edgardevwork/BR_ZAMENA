...
public final class MutableObjectList<E> extends ObjectList<E> {
    ...
    public final void add(@IntRange(from = 0) int i, E element) {
        int i2;
    ...
    public final void removeRange(@IntRange(from = 0) int i, @IntRange(from = 0) int end) {
        ...
        if (end != i) {
            if (end < i2) {
                Object[] objArr = this.content;
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i, end, i2);
            }
            int i3 = this._size;
            int i4 = i3 - (end - i);
            ArraysKt___ArraysJvmKt.fill(this.content, (Object) null, i4, i3);
            this._size = i4;
        }
    }
    ...
    public final E set(@IntRange(from = 0) int i, E element) {
        if (i < 0 || i >= this._size) {
            StringBuilder sb = new StringBuilder();
            sb.append("set index ");
            sb.append(i);
    ...
    /* compiled from: ObjectList.kt */
    @Metadata(m7104d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010+\n\u0000\n\u0002\u0010!\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\t\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001b\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0015\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fJ\t\u0010\r\u001a\u00020\u000eH\u0096\u0002J\b\u0010\u000f\u001a\u00020\u000eH\u0016J\u000e\u0010\u0010\u001a\u00028\u0001H\u0096\u0002¢\u0006\u0002\u0010\u0011J\b\u0010\u0012\u001a\u00020\u0006H\u0016J\r\u0010\u0013\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\u0011J\b\u0010\u0014\u001a\u00020\u0006H\u0016J\b\u0010\u0015\u001a\u00020\nH\u0016J\u0015\u0010\u0016\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fR\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0017"}, m7105d2 = {"Landroidx/collection/MutableObjectList$MutableObjectListIterator;", ExifInterface.GPS_DIRECTION_TRUE, "", IFramePlayerOptions.Builder.LIST, "", FirebaseAnalytics.Param.INDEX, "", "(Ljava/util/List;I)V", "prevIndex", "add", "", "element", "(Ljava/lang/Object;)V", "hasNext", "", "hasPrevious", LinkHeader.Rel.Next, "()Ljava/lang/Object;", "nextIndex", "previous", "previousIndex", "remove", "set", "collection"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
    ...
    public static final class ObjectListMutableList<T> implements List<T>, KMutableList {
        ...
        public T set(int i, T element) {
            ObjectListKt.checkIndex(this, i);
            return this.objectList.set(i, element);
        }
    ...
    public static final class SubList<T> implements List<T>, KMutableList {
        ...
        @Override // java.util.List
        public void add(int i, T element) {
            this.list.add(i + this.start, element);
            this.end++;
        }
        ...
        public T set(int i, T element) {
            ObjectListKt.checkIndex(this, i);
            return this.list.set(i + this.start, element);
        }
