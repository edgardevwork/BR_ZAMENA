...
public final class TsExtractor implements Extractor {
    ...
    */
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        extractorInput.peekFully(data, 0, TsBinarySearchSeeker.MINIMUM_SEARCH_RANGE_BYTES);
        int i = 0;
        while (i < 188) {
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean z = timestampAdjuster.getTimestampOffsetUs() == C2732C.TIME_UNSET;
            if (!z) {
    ...
    public class PmtReader implements SectionPayloadReader {
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public final TsPayloadReader.EsInfo readEsInfo(ParsableByteArray parsableByteArray, int i) {
            int i2;
