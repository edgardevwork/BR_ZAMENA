...
public final class CustomSpanBundler {
    ...
    public static final String FIELD_END_INDEX = Util.intToStringMaxRadix(1);
    public static final String FIELD_FLAGS = Util.intToStringMaxRadix(2);
    public static final String FIELD_TYPE = Util.intToStringMaxRadix(3);
    public static final String FIELD_PARAMS = Util.intToStringMaxRadix(4);
