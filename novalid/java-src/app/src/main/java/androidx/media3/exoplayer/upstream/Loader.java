...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction RETRY = createRetryAction(false, C2732C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C2732C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C2732C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C2732C.TIME_UNSET);
    ...
    public static final class LoadErrorAction {
        ...
        public /* synthetic */ LoadErrorAction(int i, long j, C29091 c29091) {
            this(i, j);
        }
    ...
    public final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m632e(TAG, "Unexpected exception loading stream", e2);
                obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (OutOfMemoryError e3) {
                if (this.released) {
                    return;
                }
                Log.m632e(TAG, "OutOfMemory error loading stream", e3);
                obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (Error e4) {
                if (!this.released) {
                    Log.m632e(TAG, "Unexpected error loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    Log.m632e(TAG, "Unexpected exception handling load completed", e);
            ...
            if (loadErrorActionOnLoadError.type != 3) {
                if (loadErrorActionOnLoadError.type != 2) {
                    ...
                    if (loadErrorActionOnLoadError.retryDelayMillis != C2732C.TIME_UNSET) {
