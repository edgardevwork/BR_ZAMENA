...
public final class ClippingMediaSource extends WrappingMediaSource {
    ...
    public static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            this.startUs = jMax;
            this.endUs = jMax2;
            this.durationUs = jMax2 == C2732C.TIME_UNSET ? -9223372036854775807L : jMax2 - jMax;
            if (window.isDynamic && (jMax2 == C2732C.TIME_UNSET || (j3 != C2732C.TIME_UNSET && jMax2 == j3))) {
                z = true;
            }
            this.isDynamic = z;
        }
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f306id, period.uid, 0, j == C2732C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}
