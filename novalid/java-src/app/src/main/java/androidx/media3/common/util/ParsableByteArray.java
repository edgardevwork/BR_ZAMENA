...
public final class ParsableByteArray {
    ...
    /* renamed from: LF */
    public static final char[] f308LF = {'\n'};
    public static final ImmutableSet<Charset> SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.m1223of(Charsets.US_ASCII, Charsets.UTF_8, Charsets.UTF_16, Charsets.UTF_16BE, Charsets.UTF_16LE);
    public byte[] data;
    public int limit;
    public int position;
    ...
    public final int findNextLineTerminator(Charset charset) {
        int i;
    ...
    public final void skipLineTerminator(Charset charset) {
        if (readCharacterIfInList(charset, CR_AND_LF) == '\r') {
            readCharacterIfInList(charset, f308LF);
        }
    }
