...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public DecoderAudioRenderer(@Nullable Handler handler, @Nullable AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
        ...
        setOutputStreamOffsetUs(C2732C.TIME_UNSET);
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m632e(TAG, "Audio codec error", e3);
    ...
    public final boolean drainOutputBuffer() throws ExoPlaybackException, DecoderException, AudioSink.WriteException, AudioSink.InitializationException, AudioSink.ConfigurationException {
    ...
    public final boolean feedInputBuffer() throws ExoPlaybackException, DecoderException {
        T t = this.decoder;
        ...
        if (!this.firstStreamSampleRead) {
            ...
            this.inputBuffer.addFlag(C2732C.BUFFER_FLAG_FIRST_SAMPLE);
        }
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2, MediaSource.MediaPeriodId mediaPeriodId) throws ExoPlaybackException {
        ...
        if (this.outputStreamOffsetUs == C2732C.TIME_UNSET) {
            setOutputStreamOffsetUs(j2);
            return;
        }
        int i = this.pendingOutputStreamOffsetCount;
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.m635w(TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
    ...
    public final void maybeInitDecoder() throws ExoPlaybackException {
        ...
        try {
            ...
            Log.m632e(TAG, "Audio codec error", e);
    ...
    public final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m632e(DecoderAudioRenderer.TAG, "Audio sink error", exc);
