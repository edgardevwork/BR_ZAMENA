...
public abstract class BasePlayer implements Player {
    ...
    public final void setMediaItem(MediaItem mediaItem) {
        setMediaItems(ImmutableList.m1172of(mediaItem));
    }

    @Override // androidx.media3.common.Player
    public final void setMediaItem(MediaItem mediaItem, long j) {
        setMediaItems(ImmutableList.m1172of(mediaItem), 0, j);
    }

    @Override // androidx.media3.common.Player
    public final void setMediaItem(MediaItem mediaItem, boolean z) {
        setMediaItems(ImmutableList.m1172of(mediaItem), z);
    }
    ...
    public final void addMediaItem(int i, MediaItem mediaItem) {
        addMediaItems(i, ImmutableList.m1172of(mediaItem));
    }

    @Override // androidx.media3.common.Player
    public final void addMediaItem(MediaItem mediaItem) {
        addMediaItems(ImmutableList.m1172of(mediaItem));
    }
    ...
    public final void replaceMediaItem(int i, MediaItem mediaItem) {
        replaceMediaItems(i, i + 1, ImmutableList.m1172of(mediaItem));
    }
    ...
    public final int getBufferedPercentage() {
        ...
        if (bufferedPosition == C2732C.TIME_UNSET || duration == C2732C.TIME_UNSET) {
            return 0;
        }
        if (duration == 0) {
            return 100;
    ...
    public final long getCurrentLiveOffset() {
        Timeline currentTimeline = getCurrentTimeline();
        return (currentTimeline.isEmpty() || currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).windowStartTimeMs == C2732C.TIME_UNSET) ? C2732C.TIME_UNSET : (this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - getContentPosition();
    }
    ...
    public final long getContentDuration() {
        Timeline currentTimeline = getCurrentTimeline();
        return currentTimeline.isEmpty() ? C2732C.TIME_UNSET : currentTimeline.getWindow(getCurrentMediaItemIndex(), this.window).getDurationMs();
    }
    ...
    public final void seekToDefaultPositionInternal(int i, int i2) {
        seekTo(i, C2732C.TIME_UNSET, i2, false);
    }
    ...
    public final void repeatCurrentMediaItem(int i) {
        seekTo(getCurrentMediaItemIndex(), C2732C.TIME_UNSET, i, true);
    }
}
