...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public void prepareSourceInternal(@Nullable TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.lambda$prepareSourceInternal$0(componentListener);
            }
        });
    }

    public final /* synthetic */ void lambda$prepareSourceInternal$0(ComponentListener componentListener) {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f316id;
    ...
    public void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$releaseSourceInternal$1(componentListener);
            }
        });
    }

    public final /* synthetic */ void lambda$releaseSourceInternal$1(ComponentListener componentListener) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i2 < adMediaSourceHolderArr2.length) {
                    ...
                    jArr[i][i2] = adMediaSourceHolder == null ? C2732C.TIME_UNSET : adMediaSourceHolder.getDurationUs();
                    i2++;
                }
            }
            i++;
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onAdPlaybackState$0(adPlaybackState);
                }
            });
        }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onPrepareComplete$0(mediaPeriodId);
                }
            });
        }

        public final /* synthetic */ void lambda$onPrepareComplete$0(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onPrepareError$1(mediaPeriodId, iOException);
                }
            });
        }

        public final /* synthetic */ void lambda$onPrepareError$1(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
    ...
    public final class AdMediaSourceHolder {
        ...
        /* renamed from: id */
        public final MediaSource.MediaPeriodId f318id;
        public Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f318id = mediaPeriodId;
        }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, MediaItem mediaItem) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f318id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(i);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f316id.windowSequenceNumber));
                }
            }
        ...
        public long getDurationUs() {
            Timeline timeline = this.timeline;
            return timeline == null ? C2732C.TIME_UNSET : timeline.getPeriod(0, AdsMediaSource.this.period).getDurationUs();
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f318id);
            }
        }
