...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public final /* synthetic */ void lambda$inputFormatChanged$2(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        public final /* synthetic */ void lambda$positionAdvancing$3(long j) {
        ...
        public final /* synthetic */ void lambda$underrun$4(int i, long j, long j2) {
        ...
        public final /* synthetic */ void lambda$decoderReleased$5(String str) {
        ...
        public final /* synthetic */ void lambda$skipSilenceEnabledChanged$7(boolean z) {
        ...
        public final /* synthetic */ void lambda$audioSinkError$8(Exception exc) {
        ...
        public final /* synthetic */ void lambda$audioCodecError$9(Exception exc) {
        ...
        public void audioTrackInitialized(final AudioSink.AudioTrackConfig audioTrackConfig) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$audioTrackInitialized$10(audioTrackConfig);
                    }
                });
            }
        }

        public final /* synthetic */ void lambda$audioTrackInitialized$10(AudioSink.AudioTrackConfig audioTrackConfig) {
        ...
        public void audioTrackReleased(final AudioSink.AudioTrackConfig audioTrackConfig) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$audioTrackReleased$11(audioTrackConfig);
                    }
                });
            }
        }

        public final /* synthetic */ void lambda$audioTrackReleased$11(AudioSink.AudioTrackConfig audioTrackConfig) {
