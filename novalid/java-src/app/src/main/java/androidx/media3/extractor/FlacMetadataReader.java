    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        if (bits == 0) {
            ...
            if (bits == 3) {
                ...
                flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m1172of(PictureFrame.fromPictureBlock(parsableByteArray)));
            } else {
