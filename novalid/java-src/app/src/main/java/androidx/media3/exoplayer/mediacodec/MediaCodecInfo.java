...
public final class MediaCodecInfo {
    ...
    public final void logNoSupport(String str) {
        Log.m629d(TAG, "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }

    public final void logAssumedSupport(String str) {
        Log.m629d(TAG, "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }
    ...
    public static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m635w(TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + "]");
        return i2;
    }
