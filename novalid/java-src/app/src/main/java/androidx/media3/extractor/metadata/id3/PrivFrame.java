...
public final class PrivFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f330ID = "PRIV";
    ...
    public String toString() {
        return this.f327id + ": owner=" + this.owner;
    }
    ...
    /* renamed from: androidx.media3.extractor.metadata.id3.PrivFrame$1 */
    public class C29561 implements Parcelable.Creator<PrivFrame> {
        @Override // android.os.Parcelable.Creator
        public PrivFrame createFromParcel(Parcel parcel) {
            return new PrivFrame(parcel);
        }
