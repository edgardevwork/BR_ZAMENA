...
public class AsynchronousMediaCodecBufferEnqueuer implements MediaCodecBufferEnqueuer {
    ...
    public final void doHandleMessage(Message message) throws MediaCodec.CryptoException {
        ...
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
            }
        } else {
            messageParams = (MessageParams) message.obj;
    ...
    public final void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) throws MediaCodec.CryptoException {
        try {
            this.codec.queueInputBuffer(i, i2, i3, j, i4);
        } catch (RuntimeException e) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.pendingRuntimeException, null, e);
        }
    }
    ...
    public static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        cryptoInfo2.iv = (byte[]) Assertions.checkNotNull(copy(cryptoInfo.f310iv, cryptoInfo2.iv));
