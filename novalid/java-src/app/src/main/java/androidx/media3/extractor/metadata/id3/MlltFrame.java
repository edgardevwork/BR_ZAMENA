...
public final class MlltFrame extends Id3Frame {
    ...
    /* renamed from: ID */
    public static final String f329ID = "MLLT";
    ...
    /* renamed from: androidx.media3.extractor.metadata.id3.MlltFrame$1 */
    public class C29551 implements Parcelable.Creator<MlltFrame> {
        @Override // android.os.Parcelable.Creator
        public MlltFrame createFromParcel(Parcel parcel) {
            return new MlltFrame(parcel);
        }
