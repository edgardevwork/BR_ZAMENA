...
public final class ProgressiveMediaSource extends BaseMediaSource implements ProgressiveMediaPeriod.Listener {
    ...
    public /* synthetic */ ProgressiveMediaSource(MediaItem mediaItem, DataSource.Factory factory, ProgressiveMediaExtractor.Factory factory2, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, int i, C28791 c28791) {
    ...
    public ProgressiveMediaSource(MediaItem mediaItem, DataSource.Factory factory, ProgressiveMediaExtractor.Factory factory2, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, int i) {
        ...
        this.timelineDurationUs = C2732C.TIME_UNSET;
    }
    ...
    public final void notifySourceInfoRefreshed() {
        ...
        if (this.timelineIsPlaceholder) {
            singlePeriodTimeline = new ForwardingTimeline(singlePeriodTimeline) { // from class: androidx.media3.exoplayer.source.ProgressiveMediaSource.1
                public C28791(Timeline singlePeriodTimeline2) {
    ...
    public class C28791 extends ForwardingTimeline {
        public C28791(Timeline singlePeriodTimeline2) {
            super(singlePeriodTimeline2);
        }
