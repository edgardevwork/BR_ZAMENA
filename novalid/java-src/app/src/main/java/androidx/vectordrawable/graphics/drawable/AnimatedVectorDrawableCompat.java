...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public AnimatedVectorDrawableCompat(@Nullable Context context, @Nullable AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, @Nullable Resources resources) {
        ...
        C32571 c32571 = new Drawable.Callback() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.1
            public C32571() {
            }
        ...
        this.mCallback = c32571;
        this.mContext = context;
        if (animatedVectorDrawableCompatState != null) {
            this.mAnimatedVectorState = animatedVectorDrawableCompatState;
        } else {
            this.mAnimatedVectorState = new AnimatedVectorDrawableCompatState(context, animatedVectorDrawableCompatState, c32571, resources);
        }
    }
    ...
    /* loaded from: classes2.dex */
    public class C32571 implements Drawable.Callback {
        public C32571() {
        }
    ...
    /* loaded from: classes2.dex */
    public class C32582 extends AnimatorListenerAdapter {
        public C32582() {
        }
