...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public static final class Failure {
        ...
        public class C20831 extends Throwable {
            public C20831(String str) {
                super(str);
            }
    ...
    public static abstract class AtomicHelper {
        ...
        public /* synthetic */ AtomicHelper(C20821 c20821) {
            this();
        }
    }
    ...
    public static final class SafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return C2081xc40028dd.m347m(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return C2081xc40028dd.m347m(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return C2081xc40028dd.m347m(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }
    }
