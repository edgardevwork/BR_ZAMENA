...
public class WidgetFrame {
    public static final boolean OLD_SYSTEM = true;
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i5 = (int) (keyPositionFindPreviousPosition.f213x * i);
                i10 = i16;
                i9 = i2;
                i6 = (int) (keyPositionFindPreviousPosition.f214y * i9);
            ...
            if (keyPositionFindNextPosition != null) {
                i8 = (int) (keyPositionFindNextPosition.f213x * i);
                i17 = (int) (keyPositionFindNextPosition.f214y * i9);
        ...
        widgetFrame.top = i24;
        float f10 = 1.0f - f;
        widgetFrame.right = i23 + ((int) ((i3 * f10) + (i20 * f)));
        widgetFrame.bottom = i24 + ((int) ((f10 * i4) + (i21 * f)));
    ...
    public final void serializeAnchor(StringBuilder sb, ConstraintAnchor.Type type) {
