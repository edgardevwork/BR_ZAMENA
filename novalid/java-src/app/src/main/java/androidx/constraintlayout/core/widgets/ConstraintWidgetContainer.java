...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public final void addMinWrap(ConstraintAnchor constraintAnchor, SolverVariable solverVariable) {
        this.mSystem.addGreaterThan(this.mSystem.createObjectVariable(constraintAnchor), solverVariable, 0, 5);
    }

    public final void addMaxWrap(ConstraintAnchor constraintAnchor, SolverVariable solverVariable) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:337:0x0312 A[PHI: r2 r16
  0x0312: PHI (r2v15 boolean) = (r2v14 boolean), (r2v19 boolean), (r2v19 boolean), (r2v19 boolean) binds: [B:324:0x02d3, B:332:0x02f8, B:333:0x02fa, B:335:0x0300] A[DONT_GENERATE, DONT_INLINE]
  0x0312: PHI (r16v4 boolean) = (r16v3 boolean), (r16v5 boolean), (r16v5 boolean), (r16v5 boolean) binds: [B:324:0x02d3, B:332:0x02f8, B:333:0x02fa, B:335:0x0300] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        while (zAddChildrenToSolver) {
            ...
            if (z6 && i8 < 8 && Optimizer.flags[2]) {
                ...
                while (i11 < size) {
                    ...
                    iMax4 = Math.max(iMax4, constraintWidget3.f216mX + constraintWidget3.getWidth());
                    iMax3 = Math.max(iMax3, constraintWidget3.f217mY + constraintWidget3.getHeight());
                    i11++;
            ...
            zAddChildrenToSolver = i8 > i3 ? false : z4;
            i7 = i8;
            i4 = 0;
        }
