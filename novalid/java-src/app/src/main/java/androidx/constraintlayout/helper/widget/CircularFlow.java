...
public class CircularFlow extends VirtualLayout {
    public static float DEFAULT_ANGLE = 0.0f;
    public static int DEFAULT_RADIUS = 0;
    public static final String TAG = "CircularFlow";
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C2167R.styleable.ConstraintLayout_Layout_circularflow_viewCenter) {
                    this.mViewCenter = typedArrayObtainStyledAttributes.getResourceId(index, 0);
                } else if (index == C2167R.styleable.ConstraintLayout_Layout_circularflow_angles) {
                    String string = typedArrayObtainStyledAttributes.getString(index);
                    this.mReferenceAngles = string;
                    setAngles(string);
                } else if (index == C2167R.styleable.ConstraintLayout_Layout_circularflow_radiusInDP) {
                    String string2 = typedArrayObtainStyledAttributes.getString(index);
                    this.mReferenceRadius = string2;
                    setRadius(string2);
                } else if (index == C2167R.styleable.ConstraintLayout_Layout_circularflow_defaultAngle) {
                ...
                } else if (index == C2167R.styleable.ConstraintLayout_Layout_circularflow_defaultRadius) {
    ...
    public final void anchorReferences() {
    ...
    public final float[] removeAngle(float[] angles, int index) {
        return (angles == null || index < 0 || index >= this.mCountAngle) ? angles : removeElementFromArray(angles, index);
    }

    public final int[] removeRadius(int[] radius, int index) {
    ...
    public final void addAngle(String angleString) {
        float[] fArr;
    ...
    public final void addRadius(String radiusString) {
        int[] iArr;
