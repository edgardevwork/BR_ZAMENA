...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C2167R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = typedArrayObtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C2167R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    public final void addID(String idString) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
    ...
    public final int findId(String referenceId) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
        ConstraintLayout constraintLayout = getParent() instanceof ConstraintLayout ? (ConstraintLayout) getParent() : null;
        int iFindId = 0;
        ...
        if (iFindId == 0) {
            try {
                iFindId = C2167R.id.class.getField(referenceId).getInt(null);
    ...
    public final int findId(ConstraintLayout container, String idString) throws Resources.NotFoundException {
        Resources resources;
    ...
    public final int[] convertReferenceString(View view, String referenceIdString) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
