...
public class KeyPosition extends KeyPositionBase {
    ...
    public void load(Context context, AttributeSet attrs) {
        Loader.read(this, context.obtainStyledAttributes(attrs, C2167R.styleable.KeyPosition));
    }
    ...
    public final void calcScreenPosition(int layoutWidth, int layoutHeight) {
    ...
    public final void calcPathPosition(float start_x, float start_y, float end_x, float end_y) {
    ...
    public final void calcCartesianPosition(float start_x, float start_y, float end_x, float end_y) {
        float f = end_x - start_x;
        float f2 = end_y - start_y;
    ...
    public static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C2167R.styleable.KeyPosition_motionTarget, 1);
            mAttrMap.append(C2167R.styleable.KeyPosition_framePosition, 2);
            mAttrMap.append(C2167R.styleable.KeyPosition_transitionEasing, 3);
            mAttrMap.append(C2167R.styleable.KeyPosition_curveFit, 4);
            mAttrMap.append(C2167R.styleable.KeyPosition_drawPath, 5);
            mAttrMap.append(C2167R.styleable.KeyPosition_percentX, 6);
            mAttrMap.append(C2167R.styleable.KeyPosition_percentY, 7);
            mAttrMap.append(C2167R.styleable.KeyPosition_keyPositionType, 9);
            mAttrMap.append(C2167R.styleable.KeyPosition_sizePercent, 8);
            mAttrMap.append(C2167R.styleable.KeyPosition_percentWidth, 11);
            mAttrMap.append(C2167R.styleable.KeyPosition_percentHeight, 12);
            mAttrMap.append(C2167R.styleable.KeyPosition_pathMotionArc, 10);
        }
