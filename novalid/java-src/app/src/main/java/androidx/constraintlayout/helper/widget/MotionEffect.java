...
public class MotionEffect extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C2167R.styleable.MotionEffect);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C2167R.styleable.MotionEffect_motionEffect_start) {
                ...
                } else if (index == C2167R.styleable.MotionEffect_motionEffect_end) {
                ...
                } else if (index == C2167R.styleable.MotionEffect_motionEffect_translationX) {
                ...
                } else if (index == C2167R.styleable.MotionEffect_motionEffect_translationY) {
