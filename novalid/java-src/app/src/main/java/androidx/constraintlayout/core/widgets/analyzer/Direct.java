...
public class Direct {
    ...
    public static final boolean EARLY_TERMINATION = true;
    ...
    public static void solveBarrier(int i, Barrier barrier, BasicMeasure.Measurer measurer, int i2, boolean z) {
    ...
    /* renamed from: ls */
    public static String m349ls(int i) {
    ...
    public static void solveHorizontalCenterConstraints(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z) {
    ...
    public static void solveVerticalCenterConstraints(int i, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
    ...
    public static boolean solveChain(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead, boolean z, boolean z2, boolean z3) {
        ...
        while (true) {
            ...
            if (z5) {
                    ...
                    while (!z6) {
                        if (constraintWidget5.getVisibility() != 8) {
                            ...
                            if (i == 0) {
                                ...
                                horizontalSolvingPass(1, constraintWidget5, constraintWidgetContainer.getMeasurer(), zIsRtl);
                            ...
                            horizontalSolvingPass(r2, constraintWidget5, constraintWidgetContainer.getMeasurer(), zIsRtl);
                        } else {
                        ...
                        if (constraintAnchor4 != null) {
                            ...
                            ConstraintAnchor constraintAnchor5 = constraintWidget.mListAnchors[i2].mTarget;
                            if (constraintAnchor5 == null || constraintAnchor5.mOwner != constraintWidget5) {
                ...
                int margin4 = margin + constraintWidget2.mListAnchors[i2].getMargin();
                if (i == 0) {
                    height2 = constraintWidget2.getWidth();
                } else {
                    height2 = constraintWidget2.getHeight();
                }
                margin = margin4 + height2 + constraintWidget2.mListAnchors[i4].getMargin();
                i6++;
                if (constraintWidget2.getVisibility() != 8) {
                    i5++;
                }
