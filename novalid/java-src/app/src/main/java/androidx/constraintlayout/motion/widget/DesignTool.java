...
public class DesignTool implements ProxyInterface {
    ...
    public static int GetPxFromDp(int dpi, String value) {
        int iIndexOf;
    ...
    public static void Connect(int dpi, ConstraintSet set, View view, HashMap<String, String> attributes, int from, int to) {
    ...
    public static void SetBias(ConstraintSet set, View view, HashMap<String, String> attributes, int type) {
        String str;
        if (type != 1) {
    ...
    public static void SetDimensions(int dpi, ConstraintSet set, View view, HashMap<String, String> attributes, int type) {
        String str;
        if (type != 1) {
            str = "layout_width";
        } else {
    ...
    public static void SetAbsolutePositions(int dpi, ConstraintSet set, View view, HashMap<String, String> attributes) {
    ...
    public boolean setKeyFramePosition(Object view, int position, int type, float x, float y) {
        ...
        if (motionLayout.mScene != null) {
            ...
            int i = (int) (motionLayout2.mTransitionPosition * 100.0f);
            if (motionController != null) {
                View view2 = (View) view;
                if (motionLayout2.mScene.hasKeyFramePosition(view2, i)) {
