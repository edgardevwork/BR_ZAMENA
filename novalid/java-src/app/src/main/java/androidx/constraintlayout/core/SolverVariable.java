...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    public static String getUniqueName(Type type, String str) {
        ...
        int i = C21271.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C21271 {
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f191id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f191id - solverVariable.f191id;
    }
