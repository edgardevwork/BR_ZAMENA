...
public class State {
    ...
    public final String createHelperKey() {
        ...
        this.numHelpers = i + 1;
        sb.append(i);
        sb.append(PomModuleDescriptorBuilder.EXTRA_INFO_DELIMITER);
        return sb.toString();
    }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i = C21341.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class C21341 {
    ...
    public void apply(ConstraintWidgetContainer constraintWidgetContainer) throws NumberFormatException {
