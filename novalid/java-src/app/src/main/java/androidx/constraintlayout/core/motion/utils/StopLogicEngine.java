...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2 = str + " ===== " + this.mType + StringUtils.f9903LF;
        ...
        String str3 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + StringUtils.f9903LF;
        if (this.mNumberOfStages > 1) {
            str3 = str3 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + StringUtils.f9903LF;
        }
        if (this.mNumberOfStages > 2) {
            str3 = str3 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + StringUtils.f9903LF;
        }
