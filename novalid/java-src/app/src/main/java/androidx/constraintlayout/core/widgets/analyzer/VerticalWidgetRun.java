...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public static /* synthetic */ class C21421 {
        ...
        static {
            ...
            try {
                f224x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f224x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i;
        int i2 = C21421.f224x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {
