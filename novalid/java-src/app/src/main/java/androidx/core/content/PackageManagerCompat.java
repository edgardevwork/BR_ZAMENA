...
public final class PackageManagerCompat {
    ...
    public static String getPermissionRevocationVerifierApp(@NonNull PackageManager packageManager) {
        String str = null;
        Iterator<ResolveInfo> it = packageManager.queryIntentActivities(new Intent(ACTION_PERMISSION_REVOCATION_SETTINGS).setData(Uri.fromParts(BundleInfo.PACKAGE_TYPE, "com.example", null)), 0).iterator();
        while (it.hasNext()) {
