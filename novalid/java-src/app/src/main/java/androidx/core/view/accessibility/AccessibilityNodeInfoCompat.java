...
public class AccessibilityNodeInfoCompat {
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(@NonNull Map<Region, View> map) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mInfo = C2344x7af9ff6a.m595m(map);
            } else {
                this.mInfo = null;
            }
        }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            getExtras().putInt(SPANS_ACTION_ID_KEY, C2171R.id.accessibility_action_clickable_span);
    ...
    public final SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C2171R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    public final SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C2171R.id.tag_accessibility_clickable_spans);
    }
