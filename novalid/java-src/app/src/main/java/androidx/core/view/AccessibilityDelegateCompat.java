...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i, @Nullable Bundle bundle) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        ...
        return (zPerformAccessibilityAction || i != C2171R.id.accessibility_action_clickable_span || bundle == null) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int i, View view) {
        WeakReference weakReference;
        SparseArray sparseArray = (SparseArray) view.getTag(C2171R.id.tag_accessibility_clickable_spans);
    ...
    public static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C2171R.id.tag_accessibility_actions);
