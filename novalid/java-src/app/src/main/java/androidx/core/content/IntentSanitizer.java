...
public class IntentSanitizer {
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        if (extras != null) {
            for (String str3 : extras.keySet()) {
                ...
                } else if (str3.equals(P2ArtifactParser.RuleHandler.OUTPUT) && ((~this.mAllowedFlags) & 3) != 0) {
    ...
    public static final class Builder {
        ...
        public boolean mAllowSourceBounds;
        public int mAllowedFlags;
        public Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda1
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$0((String) obj);
            }
        };
        public Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda2
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$1((Uri) obj);
            }
        };
        public Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda3
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$2((String) obj);
            }
        };
        public Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda4
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$3((String) obj);
            }
        };
        public Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda5
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$4((String) obj);
            }
        };
        public Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda6
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        public Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda7
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$6((Uri) obj);
            }
        };
        public Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda8
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        public Builder allowAction(@NonNull Predicate<String> predicate) {
            ...
            this.mAllowedActions = this.mAllowedActions.m482or(predicate);
            return this;
        }
        ...
        public Builder allowData(@NonNull Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.m482or(predicate);
            return this;
        }
        ...
        public Builder allowType(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m482or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m482or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m482or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(@NonNull Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m482or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(@NonNull Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m482or(predicate);
            return this;
        }
        ...
        public Builder allowClipData(@NonNull Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m482or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            this.mAllowedExtras.put(str, predicate2.m482or(predicate));
            return this;
        }
        ...
        public Builder allowExtraOutput(@NonNull final String str) {
            allowExtra(P2ArtifactParser.RuleHandler.OUTPUT, Uri.class, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda0
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraOutput(@NonNull Predicate<Uri> predicate) {
            allowExtra(P2ArtifactParser.RuleHandler.OUTPUT, Uri.class, predicate);
            return this;
        }
