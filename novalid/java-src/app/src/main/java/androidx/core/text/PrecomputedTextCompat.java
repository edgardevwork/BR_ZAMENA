...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public static class Builder {
            ...
            @NonNull
            public final TextPaint mPaint;
            public int mBreakStrategy = 1;
            public int mHyphenationFrequency = 1;
            public TextDirectionHeuristic mTextDir = TextDirectionHeuristics.FIRSTSTRONG_LTR;
        ...
        public Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = PrecomputedTextCompat$Params$$ExternalSyntheticApiModelOutline9.m472m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (PrecomputedTextCompat$$ExternalSyntheticApiModelOutline1.m455m(this.mText)) {
            return PrecomputedTextCompat$$ExternalSyntheticApiModelOutline2.m456m(this.mText);
        }
        return null;
    }
