...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    @Override // androidx.sqlite.p009db.SupportSQLiteDatabase
    public long insert(@NotNull String table, int conflictAlgorithm, @NotNull ContentValues contentValues) {
        Intrinsics.checkNotNullParameter(table, "table");
        Intrinsics.checkNotNullParameter(contentValues, "values");
        return this.delegate.insert(table, conflictAlgorithm, contentValues);
    }
    ...
    @Override // androidx.sqlite.p009db.SupportSQLiteDatabase
    public int update(@NotNull String table, int conflictAlgorithm, @NotNull ContentValues contentValues, @Nullable String whereClause, @Nullable Object[] whereArgs) {
        Intrinsics.checkNotNullParameter(table, "table");
        Intrinsics.checkNotNullParameter(contentValues, "values");
        return this.delegate.update(table, conflictAlgorithm, contentValues, whereClause, whereArgs);
    }
