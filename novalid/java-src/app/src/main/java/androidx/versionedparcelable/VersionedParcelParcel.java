...
public class VersionedParcelParcel extends VersionedParcel {
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i, this.mPrefix + GlideException.IndentedAppendable.INDENT, this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
