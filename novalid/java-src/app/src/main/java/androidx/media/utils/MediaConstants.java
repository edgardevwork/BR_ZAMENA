...
public final class MediaConstants {
    ...
    @SuppressLint({"IntentName"})
    public static final String f298x83542815 = "androidx.media.BrowserRoot.Extras.APPLICATION_PREFERENCES_USING_CAR_APP_LIBRARY_INTENT";
    ...
    @SuppressLint({"IntentName"})
    public static final String f299xeb069e96 = "androidx.media.PlaybackStateCompat.Extras.ERROR_RESOLUTION_USING_CAR_APP_LIBRARY_INTENT";
