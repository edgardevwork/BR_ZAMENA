...
import androidx.lifecycle.runtime.C2684R;
...
@Metadata(m7104d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a\u0013\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0002H\u0007¢\u0006\u0002\b\u0003\u001a\u001b\u0010\u0004\u001a\u00020\u0005*\u00020\u00022\b\u0010\u0006\u001a\u0004\u0018\u00010\u0001H\u0007¢\u0006\u0002\b\u0007¨\u0006\b"}, m7105d2 = {"findViewTreeLifecycleOwner", "Landroidx/lifecycle/LifecycleOwner;", "Landroid/view/View;", "get", "setViewTreeLifecycleOwner", "", "lifecycleOwner", "set", "lifecycle-runtime_release"}, m7106k = 2, m7107mv = {1, 8, 0}, m7109xi = 48)
...
public final class ViewTreeLifecycleOwner {
    ...
    public static final void set(@NotNull View view, @Nullable LifecycleOwner lifecycleOwner) {
        ...
        view.setTag(C2684R.id.view_tree_lifecycle_owner, lifecycleOwner);
    }
    ...
    public static final LifecycleOwner get(@NotNull View view) {
        ...
        return (LifecycleOwner) SequencesKt___SequencesKt.firstOrNull(SequencesKt___SequencesKt.mapNotNull(SequencesKt__SequencesKt.generateSequence(view, new Function1<View, View>() { // from class: androidx.lifecycle.ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$1
            ...
            public final LifecycleOwner invoke(@NotNull View viewParent) {
                ...
                Object tag = viewParent.getTag(C2684R.id.view_tree_lifecycle_owner);
