...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m7104d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m7105d2 = {"<anonymous>", "Lkotlinx/coroutines/DisposableHandle;", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    @DebugMetadata(m7119c = "androidx.lifecycle.LiveDataScopeImpl$emitSource$2", m7120f = "CoroutineLiveData.kt", m7121i = {}, m7122l = {94}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.lifecycle.LiveDataScopeImpl$emitSource$2 */
    /* loaded from: classes4.dex */
    public static final class C26422 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super DisposableHandle>, Object> {
        public final /* synthetic */ LiveData<T> $source;
        public int label;
        public final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C26422(LiveDataScopeImpl<T> liveDataScopeImpl, LiveData<T> liveData, Continuation<? super C26422> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C26422(this.this$0, this.$source, continuation);
        }
    ...
    public Object emitSource(@NotNull LiveData<T> liveData, @NotNull Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new C26422(this, liveData, null), continuation);
    }
    ...
    @DebugMetadata(m7119c = "androidx.lifecycle.LiveDataScopeImpl$emit$2", m7120f = "CoroutineLiveData.kt", m7121i = {}, m7122l = {99}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
    /* renamed from: androidx.lifecycle.LiveDataScopeImpl$emit$2 */
    /* loaded from: classes4.dex */
    public static final class C26412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        public final /* synthetic */ T $value;
        public int label;
        public final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C26412(LiveDataScopeImpl<T> liveDataScopeImpl, T t, Continuation<? super C26412> continuation) {
            super(2, continuation);
            this.this$0 = liveDataScopeImpl;
            this.$value = t;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C26412(this.this$0, this.$value, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
            return ((C26412) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        Object objWithContext = BuildersKt.withContext(this.coroutineContext, new C26412(this, t, null), continuation);
