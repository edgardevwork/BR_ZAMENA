...
import androidx.databinding.library.C2404R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    public static final CreateWeakListener CREATE_PROPERTY_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.1
    ...
    public static final CreateWeakListener CREATE_LIST_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.2
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new WeakListListener(viewDataBinding, i, referenceQueue).getListener();
        }
    };
    public static final CreateWeakListener CREATE_MAP_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.3
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new WeakMapListener(viewDataBinding, i, referenceQueue).getListener();
        }
    };
    public static final CreateWeakListener CREATE_LIVE_DATA_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.4
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new LiveDataListener(viewDataBinding, i, referenceQueue).getListener();
        }
    };
    public static final CallbackRegistry.NotifierCallback<OnRebindCallback, ViewDataBinding, Void> REBIND_NOTIFIER = new CallbackRegistry.NotifierCallback<OnRebindCallback, ViewDataBinding, Void>() { // from class: androidx.databinding.ViewDataBinding.5
    ...
    public static final View.OnAttachStateChangeListener ROOT_REATTACHED_LISTENER = new View.OnAttachStateChangeListener() { // from class: androidx.databinding.ViewDataBinding.6
    ...
    public class C23751 implements CreateWeakListener {
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new WeakPropertyListener(viewDataBinding, i, referenceQueue).getListener();
        }
    ...
    /* loaded from: classes3.dex */
    public class C23762 implements CreateWeakListener {
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new WeakListListener(viewDataBinding, i, referenceQueue).getListener();
        }
    ...
    /* loaded from: classes3.dex */
    public class C23773 implements CreateWeakListener {
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new WeakMapListener(viewDataBinding, i, referenceQueue).getListener();
        }
    ...
    /* loaded from: classes3.dex */
    public class C23784 implements CreateWeakListener {
        @Override // androidx.databinding.CreateWeakListener
        public WeakListener create(ViewDataBinding viewDataBinding, int i, ReferenceQueue<ViewDataBinding> referenceQueue) {
            return new LiveDataListener(viewDataBinding, i, referenceQueue).getListener();
        }
    ...
    /* loaded from: classes3.dex */
    public class C23795 extends CallbackRegistry.NotifierCallback<OnRebindCallback, ViewDataBinding, Void> {
        @Override // androidx.databinding.CallbackRegistry.NotifierCallback
        public void onNotifyCallback(OnRebindCallback onRebindCallback, ViewDataBinding viewDataBinding, int i, Void r4) {
            if (i == 1) {
                if (onRebindCallback.onPreBind(viewDataBinding)) {
    ...
    /* renamed from: androidx.databinding.ViewDataBinding$6 */
    /* loaded from: classes2.dex */
    public class ViewOnAttachStateChangeListenerC23806 implements View.OnAttachStateChangeListener {
        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewDetachedFromWindow(View view) {
        }
    ...
    /* renamed from: androidx.databinding.ViewDataBinding$7 */
    /* loaded from: classes2.dex */
    ...
    public ViewDataBinding(DataBindingComponent dataBindingComponent, View view, int i) {
        ...
        if (USE_CHOREOGRAPHER) {
            ...
            this.mFrameCallback = new Choreographer.FrameCallback() { // from class: androidx.databinding.ViewDataBinding.8
                public ChoreographerFrameCallbackC23828() {
                }
    ...
    /* renamed from: androidx.databinding.ViewDataBinding$8 */
    /* loaded from: classes2.dex */
    public class ChoreographerFrameCallbackC23828 implements Choreographer.FrameCallback {
        public ChoreographerFrameCallbackC23828() {
        }
    ...
    public void setRootTag(View view) {
        view.setTag(C2404R.id.dataBinding, this);
    }
    ...
    public static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C2404R.id.dataBinding);
        }
        return null;
    }
    ...
    */
    public static void mapBindings(DataBindingComponent dataBindingComponent, View view, Object[] objArr, IncludedLayouts includedLayouts, SparseIntArray sparseIntArray, boolean z) {
        int i;
        boolean z2;
        int i2;
        int i3;
    ...
    public static class OnStartListener implements LifecycleObserver {
        ...
        public /* synthetic */ OnStartListener(ViewDataBinding viewDataBinding, C23751 c23751) {
