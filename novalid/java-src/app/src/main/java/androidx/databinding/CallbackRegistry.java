...
public class CallbackRegistry<C, T, A> implements Cloneable {
    ...
    public final void notifyFirst64(T sender, int arg, A arg2) {
        notifyCallbacks(sender, arg, arg2, 0, Math.min(64, this.mCallbacks.size()), this.mFirst64Removed);
    }

    public final void notifyRecurse(T sender, int arg, A arg2) {
    ...
    public final void notifyRemainder(T sender, int arg, A arg2, int remainderIndex) {
        if (remainderIndex < 0) {
    ...
    public final void removeRemovedCallbacks(int startIndex, long removed) {
    ...
    public final void setRemovalBit(int index) {
        if (index < 64) {
    ...
    public synchronized CallbackRegistry<C, T, A> m14053clone() {
