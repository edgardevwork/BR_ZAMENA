    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(20) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                map2.put(P2ArtifactParser.RuleHandler.OUTPUT, new TableInfo.Column(P2ArtifactParser.RuleHandler.OUTPUT, "BLOB", true, 0, null, 1));
                ...
                map2.put("last_enqueue_time", new TableInfo.Column("last_enqueue_time", "INTEGER", true, 0, ScanBuild.XRAY_FATAL_FAIL_STATUS, 1));
