...
public final class ActivityResultCallerLauncher<I, O> extends ActivityResultLauncher<Unit> {
    ...
    @NotNull
    public final Lazy resultContract = LazyKt__LazyJVMKt.lazy(new Function0<ActivityResultCallerLauncher$resultContract$2.C00851>(this) { // from class: androidx.activity.result.ActivityResultCallerLauncher$resultContract$2
