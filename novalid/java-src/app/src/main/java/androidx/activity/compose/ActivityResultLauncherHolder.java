...
public final class ActivityResultLauncherHolder<I> {
    ...
    public final void launch(@Nullable I input, @Nullable ActivityOptionsCompat options) {
        Unit unit;
