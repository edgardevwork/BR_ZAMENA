...
import androidx.gridlayout.C2611R;
...
public class GridLayout extends ViewGroup {
    ...
    public static final int ORIENTATION = C2611R.styleable.GridLayout_orientation;
    public static final int ROW_COUNT = C2611R.styleable.GridLayout_rowCount;
    public static final int COLUMN_COUNT = C2611R.styleable.GridLayout_columnCount;
    public static final int USE_DEFAULT_MARGINS = C2611R.styleable.GridLayout_useDefaultMargins;
    public static final int ALIGNMENT_MODE = C2611R.styleable.GridLayout_alignmentMode;
    public static final int ROW_ORDER_PRESERVED = C2611R.styleable.GridLayout_rowOrderPreserved;
    public static final int COLUMN_ORDER_PRESERVED = C2611R.styleable.GridLayout_columnOrderPreserved;
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C2611R.dimen.default_gap);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2611R.styleable.GridLayout);
        try {
    ...
    public final void drawLine(Canvas canvas, int i, int i2, int i3, int i4, Paint paint) {
    ...
    public final class Axis {
        ...
        public final PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc assocM613of = Assoc.m613of(Spec.class, Bounds.class);
            int childCount = GridLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = GridLayout.this.getLayoutParams(GridLayout.this.getChildAt(i));
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                assocM613of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return assocM613of.pack();
        }
        ...
        public final PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc assocM613of = Assoc.m613of(Interval.class, MutableInt.class);
            Spec[] specArr = getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                assocM613of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return assocM613of.pack();
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        static {
            Interval interval = new Interval(Integer.MIN_VALUE, C2732C.RATE_UNSET_INT);
            DEFAULT_SPAN = interval;
            DEFAULT_SPAN_SIZE = interval.size();
            MARGIN = C2611R.styleable.GridLayout_Layout_android_layout_margin;
            LEFT_MARGIN = C2611R.styleable.GridLayout_Layout_android_layout_marginLeft;
            TOP_MARGIN = C2611R.styleable.GridLayout_Layout_android_layout_marginTop;
            RIGHT_MARGIN = C2611R.styleable.GridLayout_Layout_android_layout_marginRight;
            BOTTOM_MARGIN = C2611R.styleable.GridLayout_Layout_android_layout_marginBottom;
            COLUMN = C2611R.styleable.GridLayout_Layout_layout_column;
            COLUMN_SPAN = C2611R.styleable.GridLayout_Layout_layout_columnSpan;
            COLUMN_WEIGHT = C2611R.styleable.GridLayout_Layout_layout_columnWeight;
            ROW = C2611R.styleable.GridLayout_Layout_layout_row;
            ROW_SPAN = C2611R.styleable.GridLayout_Layout_layout_rowSpan;
            ROW_WEIGHT = C2611R.styleable.GridLayout_Layout_layout_rowWeight;
            GRAVITY = C2611R.styleable.GridLayout_Layout_layout_gravity;
        }
        ...
        public final void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2611R.styleable.GridLayout_Layout);
            try {
    ...
    public static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m613of(Class<K> cls, Class<V> cls2) {
