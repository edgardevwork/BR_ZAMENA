...
public final class ChannelSegment<E> extends Segment<ChannelSegment<E>> {
    ...
    public final void setElementLazy(int index, Object value) {
    ...
    public final boolean casState$kotlinx_coroutines_core(int index, @Nullable Object from, @Nullable Object to) {
        return C7609xa7a47114.m1346m(this.data, (index * 2) + 1, from, to);
    }
