...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m7120f = "Builders.kt", m7121i = {0}, m7122l = {116}, m7123m = "collect", m7124n = {"$this$asFlow_u24lambda_u245"}, m7125s = {"L$0"})
    @SourceDebugExtension({"SMAP\nSafeCollector.common.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SafeCollector.common.kt\nkotlinx/coroutines/flow/internal/SafeCollector_commonKt$unsafeFlow$1$collect$1\n*L\n1#1,113:1\n*E\n"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4$1 */
    /* loaded from: classes5.dex */
    public static final class C107961 extends ContinuationImpl {
        public Object L$0;
        public Object L$1;
        public int label;
        public /* synthetic */ Object result;

        public C107961(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator it;
        if (continuation instanceof C107961) {
            c107961 = (C107961) continuation;
            int i = c107961.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c107961.label = i - Integer.MIN_VALUE;
            } else {
                c107961 = new C107961(continuation);
            }
        }
        Object obj = c107961.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c107961.label;
        if (i2 == 0) {
            ...
            it = (Iterator) c107961.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c107961.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Object next = it.next();
            c107961.L$0 = flowCollector2;
            c107961.L$1 = it;
            c107961.label = 1;
            if (flowCollector2.emit(next, c107961) == coroutine_suspended) {
