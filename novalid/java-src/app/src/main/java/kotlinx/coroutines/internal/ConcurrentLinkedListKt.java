...
public final class ConcurrentLinkedListKt {
    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(@NotNull S s, long j, @NotNull Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.id >= j && !s.isRemoved()) {
                return SegmentOrClosed.m17260constructorimpl(s);
            }
            Object nextOrClosed = s.getNextOrClosed();
            if (nextOrClosed == CLOSED) {
                return SegmentOrClosed.m17260constructorimpl(CLOSED);
            }
    ...
    public static final boolean moveForward$atomicfu(@Nullable Object obj, @NotNull AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, @NotNull Object obj2) {
        while (true) {
            ...
            if (C2081xc40028dd.m347m(atomicReferenceFieldUpdater, obj, segment, obj2)) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final boolean moveForward$atomicfu$array(@Nullable Object obj, @NotNull AtomicReferenceArray atomicReferenceArray, int i, @NotNull Object obj2) {
        while (true) {
            ...
            if (C7609xa7a47114.m1346m(atomicReferenceArray, i, segment, obj2)) {
                if (segment.decPointers$kotlinx_coroutines_core()) {
                    segment.remove();
                }
                return true;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    public static final Object findSegmentAndMoveForward$atomicfu(@Nullable Object obj, @NotNull AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, long j, @NotNull Object obj2, @NotNull Function2<? super Long, Object, Object> function2) {
        Object objFindSegmentInternal;
        loop0: while (true) {
            objFindSegmentInternal = findSegmentInternal(obj2, j, function2);
            if (!SegmentOrClosed.m17265isClosedimpl(objFindSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (C2081xc40028dd.m347m(atomicReferenceFieldUpdater, obj, segment, segmentM17263getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    public static final Object findSegmentAndMoveForward$atomicfu$array(@Nullable Object obj, @NotNull AtomicReferenceArray atomicReferenceArray, int i, long j, @NotNull Object obj2, @NotNull Function2<? super Long, Object, Object> function2) {
        Object objFindSegmentInternal;
        loop0: while (true) {
            objFindSegmentInternal = findSegmentInternal(obj2, j, function2);
            if (!SegmentOrClosed.m17265isClosedimpl(objFindSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (C7609xa7a47114.m1346m(atomicReferenceArray, i, segment, segmentM17263getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (segmentM17263getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
    ...
    public static final boolean addConditionally$atomicfu(Object obj, AtomicIntegerFieldUpdater atomicIntegerFieldUpdater, int i, Function1<? super Integer, Boolean> function1) {
        int i2;
        do {
    ...
    public static final boolean addConditionally$atomicfu$array(Object obj, AtomicIntegerArray atomicIntegerArray, int i, int i2, Function1<? super Integer, Boolean> function1) {
        int i3;
        do {
