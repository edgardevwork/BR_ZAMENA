...
public final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m7120f = "Share.kt", m7121i = {}, m7122l = {HttpStatus.SC_CONFLICT}, m7123m = "collect", m7124n = {}, m7125s = {})
    /* renamed from: kotlinx.coroutines.flow.SubscribedSharedFlow$collect$1 */
    /* loaded from: classes8.dex */
    public static final class C108981 extends ContinuationImpl {
        public int label;
        public /* synthetic */ Object result;
        public final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C108981(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C108981> continuation) {
            super(continuation);
    ...
    */
    public Object collect(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<?> continuation) throws Throwable {
        C108981 c108981;
        if (continuation instanceof C108981) {
            c108981 = (C108981) continuation;
            int i = c108981.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c108981.label = i - Integer.MIN_VALUE;
            } else {
                c108981 = new C108981(this, continuation);
            }
        }
        Object obj = c108981.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c108981.label;
        if (i2 == 0) {
            ...
            c108981.label = 1;
            if (sharedFlow.collect(subscribedFlowCollector, c108981) == coroutine_suspended) {
