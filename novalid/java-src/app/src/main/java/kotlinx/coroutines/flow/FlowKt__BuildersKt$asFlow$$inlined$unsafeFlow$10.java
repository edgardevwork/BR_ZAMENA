...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m7120f = "Builders.kt", m7121i = {0}, m7122l = {116}, m7123m = "collect", m7124n = {"$this$asFlow_u24lambda_u2419"}, m7125s = {"L$0"})
    @SourceDebugExtension({"SMAP\nSafeCollector.common.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SafeCollector.common.kt\nkotlinx/coroutines/flow/internal/SafeCollector_commonKt$unsafeFlow$1$collect$1\n*L\n1#1,113:1\n*E\n"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10$1 */
    /* loaded from: classes5.dex */
    public static final class C107931 extends ContinuationImpl {
        public Object L$0;
        public Object L$1;
        public int label;
        public /* synthetic */ Object result;

        public C107931(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Long> flowCollector, @NotNull Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator<Long> it;
        if (continuation instanceof C107931) {
            c107931 = (C107931) continuation;
            int i = c107931.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c107931.label = i - Integer.MIN_VALUE;
            } else {
                c107931 = new C107931(continuation);
            }
        }
        Object obj = c107931.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c107931.label;
        if (i2 == 0) {
            ...
            it = (Iterator) c107931.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c107931.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Long lBoxLong = Boxing.boxLong(((LongIterator) it).nextLong());
            c107931.L$0 = flowCollector2;
            c107931.L$1 = it;
            c107931.label = 1;
            if (flowCollector2.emit(lBoxLong, c107931) == coroutine_suspended) {
