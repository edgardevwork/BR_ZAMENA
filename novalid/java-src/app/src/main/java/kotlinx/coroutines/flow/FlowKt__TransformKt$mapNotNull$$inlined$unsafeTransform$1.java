...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C108742<T> implements FlowCollector {
        public final /* synthetic */ FlowCollector $this_unsafeFlow;
        public final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 176)
        @DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m7120f = "Transform.kt", m7121i = {0}, m7122l = {223, 224}, m7123m = "emit", m7124n = {"$this$mapNotNull_u24lambda_u246"}, m7125s = {"L$0"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C108742.this.emit(null, this);
            }
        }

        public C108742(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C108742(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        C108742 c108742 = new C108742(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c108742, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
