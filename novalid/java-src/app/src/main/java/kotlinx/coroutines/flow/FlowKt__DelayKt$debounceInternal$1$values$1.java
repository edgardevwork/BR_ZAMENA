...
@DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m7120f = "Delay.kt", m7121i = {}, m7122l = {210}, m7123m = "invokeSuspend", m7124n = {}, m7125s = {})
...
public final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class C108141<T> implements FlowCollector {
        public final /* synthetic */ ProducerScope<Object> $$this$produce;

        public C108141(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C108141 c108141 = new C108141(producerScope);
            this.label = 1;
            if (flow.collect(c108141, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
