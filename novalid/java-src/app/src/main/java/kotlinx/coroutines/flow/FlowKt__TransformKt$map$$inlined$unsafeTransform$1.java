...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C108722<T> implements FlowCollector {
        public final /* synthetic */ FlowCollector $this_unsafeFlow;
        public final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 176)
        @DebugMetadata(m7119c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m7120f = "Transform.kt", m7121i = {}, m7122l = {223, 223}, m7123m = "emit", m7124n = {}, m7125s = {})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C108722.this.emit(null, this);
            }
        }

        public C108722(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C108722(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        C108722 c108722 = new C108722(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c108722, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
