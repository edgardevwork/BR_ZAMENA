...
public abstract class TaggedDecoder<Tag> implements Decoder, CompositeDecoder {
    ...
    public final <E> E tagBlock(Tag tag, Function0<? extends E> block) {
        pushTag(tag);
