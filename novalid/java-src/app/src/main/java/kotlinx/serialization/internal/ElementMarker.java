...
public final class ElementMarker {
    ...
    public final long[] prepareHighMarksArray(int elementsCount) {
    ...
    public final void markHigh(int index) {
        int i = (index >>> 6) - 1;
