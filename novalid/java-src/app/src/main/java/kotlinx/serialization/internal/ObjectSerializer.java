...
public final class ObjectSerializer<T> implements KSerializer<T> {
    ...
    public ObjectSerializer(@NotNull final String serialName, @NotNull T objectInstance) {
        ...
        this.descriptor = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<SerialDescriptor>() { // from class: kotlinx.serialization.internal.ObjectSerializer$descriptor$2
