...
public class JsonTreeDecoder extends AbstractJsonTreeDecoder {
    ...
    public final boolean coerceInputValue(SerialDescriptor descriptor, int i, String tag) {
        Json json = getJson();
    ...
    public final boolean absenceIsNull(SerialDescriptor descriptor, int i) {
        boolean z = (getJson().getConfiguration().getExplicitNulls() || descriptor.isElementOptional(i) || !descriptor.getElementDescriptor(i).isNullable()) ? false : true;
        this.forceNull = z;
        return z;
    }
