...
public final class JsonElementKt {
    ...
    @NotNull
    /* renamed from: JsonPrimitive-7apg3OU */
    public static final JsonPrimitive m17308JsonPrimitive7apg3OU(byte b) {
        return m17309JsonPrimitiveVKZWuLQ(ULong.m15872constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    @NotNull
    /* renamed from: JsonPrimitive-xj2QHRw */
    public static final JsonPrimitive m17311JsonPrimitivexj2QHRw(short s) {
        return m17309JsonPrimitiveVKZWuLQ(ULong.m15872constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    @NotNull
    /* renamed from: JsonPrimitive-WZ4Q5Ns */
    public static final JsonPrimitive m17310JsonPrimitiveWZ4Q5Ns(int i) {
        return m17309JsonPrimitiveVKZWuLQ(ULong.m15872constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    @SuppressAnimalSniffer
    @NotNull
    /* renamed from: JsonPrimitive-VKZWuLQ */
    public static final JsonPrimitive m17309JsonPrimitiveVKZWuLQ(long j) {
        return JsonUnquotedLiteral(JsonElementKt$$ExternalSyntheticBackport1.m7237m(j, 10));
    }
