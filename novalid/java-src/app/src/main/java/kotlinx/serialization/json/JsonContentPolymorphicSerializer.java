...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    @NotNull
    public abstract DeserializationStrategy<T> selectDeserializer(@NotNull JsonElement element);
    ...
    private final Void throwSubtypeNotRegistered(KClass<?> subClass, KClass<?> baseClass) {
        ...
        throw new SerializationException("Class '" + simpleName + "' is not registered for polymorphic serialization " + ("in the scope of '" + baseClass.getSimpleName() + ExtendedMessageFormat.QUOTE) + ".\nMark the base class as 'sealed' or register the serializer explicitly.");
    }
}
