...
public final class JsonIteratorKt {
    ...
    public static final DecodeSequenceMode determineFormat(JsonReader jsonReader, DecodeSequenceMode decodeSequenceMode) {
    ...
    public static final boolean tryConsumeStartArray(JsonReader jsonReader) {
