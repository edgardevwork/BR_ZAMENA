...
public final class PolymorphismValidator implements SerializersModuleCollector {
    ...
    public final void checkKind(SerialDescriptor descriptor, KClass<?> actualClass) {
    ...
    public final void checkDiscriminatorCollisions(SerialDescriptor descriptor, KClass<?> actualClass) {
