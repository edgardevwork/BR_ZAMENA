...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public final AtomicReference<BehaviorDisposable<T>[]> observers;
    ...
    public void onError(Throwable t) {
        ...
        if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.terminalEvent, null, t)) {
    ...
    public void onComplete() {
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
    ...
    public boolean add(BehaviorDisposable<T> rs) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.observers, behaviorDisposableArr, behaviorDisposableArr2));
        return true;
    }
