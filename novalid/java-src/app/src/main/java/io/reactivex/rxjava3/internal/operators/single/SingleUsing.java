...
public final class SingleUsing<T, U> extends Single<T> {
    ...
    public void subscribeActual(final SingleObserver<? super T> observer) {
        try {
            ...
            try {
                SingleSource<? extends T> singleSourceApply = this.singleFunction.apply(u);
                Objects.requireNonNull(singleSourceApply, "The singleFunction returned a null SingleSource");
                singleSourceApply.subscribe(new UsingSingleObserver(observer, u, this.eager, this.disposer));
            } catch (Throwable th) {
                th = th;
