...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public final Single<T> timeout0(final long timeout, final TimeUnit unit, final Scheduler scheduler, final SingleSource<? extends T> fallback) {
        Objects.requireNonNull(unit, "unit is null");
        Objects.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R m7100to(@NonNull SingleConverter<T, ? extends R> converter) {
    ...
    @NonNull
    public static <T> Single<T> toSingle(@NonNull Flowable<T> source) {
