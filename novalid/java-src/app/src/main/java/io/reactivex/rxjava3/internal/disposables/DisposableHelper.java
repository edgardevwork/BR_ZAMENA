...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> field, Disposable d) {
        ...
        } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(field, disposable, d));
        if (disposable == null) {
            return true;
        }
        disposable.dispose();
    ...
    public static boolean setOnce(AtomicReference<Disposable> field, Disposable d) {
        ...
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(field, null, d)) {
            return true;
        }
        d.dispose();
