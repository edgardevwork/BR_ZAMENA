...
public final class ObservableSequenceEqualSingle<T> extends Single<Boolean> implements FuseToObservable<Boolean> {
    ...
    public static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        public EqualCoordinator(SingleObserver<? super Boolean> actual, int bufferSize, ObservableSource<? extends T> first, ObservableSource<? extends T> second, BiPredicate<? super T, ? super T> comparer) {
        ...
        public void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f9753v1 == null) {
                    this.f9753v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f9753v1 == null;
                if (this.f9754v2 == null) {
                    this.f9754v2 = spscLinkedArrayQueue2.poll();
                }
                T t = this.f9754v2;
                boolean z4 = t == null;
                if (z && z2 && z3 && z4) {
                ...
                if (!z3 && !z4) {
                    try {
                        if (!this.comparer.test(this.f9753v1, t)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onSuccess(Boolean.FALSE);
                            return;
                        } else {
