...
public final class FlowableInternalHelper {
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, Publisher<T>> {
        ...
        public Publisher<T> apply(final T v) throws Throwable {
            Publisher<U> publisherApply = this.itemDelay.apply(v);
            Objects.requireNonNull(publisherApply, "The itemDelay returned a null Publisher");
            return new FlowableTakePublisher(publisherApply, 1L).map(Functions.justFunction(v)).defaultIfEmpty(v);
        }
    }
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u) throws Throwable {
            return this.combiner.apply(this.f9721t, u);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, Publisher<R>> {
        ...
        public Publisher<R> apply(final T t) throws Throwable {
            ...
            return new FlowableMapPublisher(publisherApply, new FlatMapWithCombinerInner(this.combiner, t));
        }
    }
