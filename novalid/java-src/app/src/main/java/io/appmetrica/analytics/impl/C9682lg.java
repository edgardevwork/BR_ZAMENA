...
public final class C9682lg implements Function {

    /* renamed from: a */
    public final /* synthetic */ C10016z0 f8591a;

    public C9682lg(C10016z0 c10016z0) {
        this.f8591a = c10016z0;
    }

    @Override // io.appmetrica.analytics.coreapi.internal.backport.Function
    public final Object apply(Object obj) throws UnsupportedEncodingException {
        String str = (String) obj;
        C10016z0 c10016z0 = this.f8591a;
        ...
        C9445c4 c9445c4 = new C9445c4("", "", 5897, 0, orCreatePublicLogger);
        if (str != null) {
            c9445c4.m5943f(str);
        }
        c9445c4.f7321m = bundle;
        c9445c4.f7311c = this.f8591a.f9379f.f6303f;
        return c9445c4;
    }
}
