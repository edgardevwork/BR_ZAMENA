...
public final class C9239Tg extends AbstractC8802Bg {
    public C9239Tg(C8892F6 c8892f6) {
        super(c8892f6);
    }
    ...
    public final boolean mo5003a(@Nullable Boolean bool) {
        return !this.f6380a.isRestrictedForReporter() && ((Boolean) WrapUtils.getOrDefault(bool, Boolean.TRUE)).booleanValue();
    }
}
