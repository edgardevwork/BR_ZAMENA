...
public enum EnumC9329Xa {
    ...
    /* renamed from: K */
    public static final HashMap f7492K = new HashMap();
    ...
    static {
        for (EnumC9329Xa enumC9329Xa : values()) {
            f7492K.put(Integer.valueOf(enumC9329Xa.f7518a), enumC9329Xa);
        }
    }

    EnumC9329Xa(int i, String str) {
        this.f7518a = i;
        this.f7519b = str;
    }

    /* renamed from: a */
    public final int m5745a() {
        return this.f7518a;
    }

    /* renamed from: a */
    public static EnumC9329Xa m5744a(int i) {
        EnumC9329Xa enumC9329Xa = (EnumC9329Xa) f7492K.get(Integer.valueOf(i));
        return enumC9329Xa == null ? EVENT_TYPE_UNDEFINED : enumC9329Xa;
    }
}
