...
public final class ClientPluginBuilder<PluginConfig> {
    ...
    @NotNull
    public final List<HookHandler<?>> hooks;
    ...
    /* compiled from: ClientPluginBuilder.kt */
    @Metadata(m7104d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, m7105d2 = {"<anonymous>", "", "PluginConfig", "", "invoke"}, m7106k = 3, m7107mv = {1, 8, 0}, m7109xi = 48)
    /* renamed from: io.ktor.client.plugins.api.ClientPluginBuilder$onClose$1 */
    /* loaded from: classes8.dex */
    public static final class C101481 extends Lambda implements Function0<Unit> {
        public static final C101481 INSTANCE = ;
    ...
    public final void onRequest(@NotNull Function4<? super OnRequestContext, ? super HttpRequestBuilder, Object, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m7074on(RequestHook.INSTANCE, block);
    }

    public final void onResponse(@NotNull Function3<? super OnResponseContext, ? super HttpResponse, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m7074on(ResponseHook.INSTANCE, block);
    }

    public final void transformRequestBody(@NotNull Function5<? super TransformRequestBodyContext, ? super HttpRequestBuilder, Object, ? super TypeInfo, ? super Continuation<? super OutgoingContent>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m7074on(TransformRequestBodyHook.INSTANCE, block);
    }

    public final void transformResponseBody(@NotNull Function5<? super TransformResponseBodyContext, ? super HttpResponse, ? super ByteReadChannel, ? super TypeInfo, ? super Continuation<Object>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        m7074on(TransformResponseBodyHook.INSTANCE, block);
    }
    ...
    /* renamed from: on */
    public final <HookHandler> void m7074on(@NotNull ClientHook<HookHandler> hook, HookHandler handler) {
