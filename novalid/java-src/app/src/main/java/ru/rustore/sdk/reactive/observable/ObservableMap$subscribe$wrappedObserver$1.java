...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public ObservableMap$subscribe$wrappedObserver$1(ObservableObserver<R> observableObserver, ObservableMap<T, R> observableMap) {
    ...
    public void onNext(T item) {
        ...
        try {
            ...
            objM15699constructorimpl = Result.m15699constructorimpl(observableMap.block.invoke(item));
        } catch (Throwable th) {
        ...
        if (Result.m15706isSuccessimpl(objM15699constructorimpl) && !getDisposed()) {
            observableObserver.onNext(objM15699constructorimpl);
        }
