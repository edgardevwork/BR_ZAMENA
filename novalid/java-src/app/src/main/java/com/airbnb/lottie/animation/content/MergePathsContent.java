...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        ...
        int i = C34361.f369x7df623d1[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
    ...
    public static /* synthetic */ class C34361 {

        /* renamed from: $SwitchMap$com$airbnb$lottie$model$content$MergePaths$MergePathsMode */
        public static final /* synthetic */ int[] f369x7df623d1;
        ...
        static {
            ...
            try {
                f369x7df623d1[MergePaths.MergePathsMode.ADD.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f369x7df623d1[MergePaths.MergePathsMode.SUBTRACT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f369x7df623d1[MergePaths.MergePathsMode.INTERSECT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f369x7df623d1[MergePaths.MergePathsMode.EXCLUDE_INTERSECTIONS.ordinal()] = 5;
