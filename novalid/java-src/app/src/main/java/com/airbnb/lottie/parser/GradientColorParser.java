...
public class GradientColorParser implements ValueParser<GradientColor> {
    ...
    */
    ...
    public final GradientColor addOpacityStopsToGradientIfNeeded(GradientColor gradientColor, List<Float> list) {
    ...
    public final int getColorInBetweenOpacityStops(float f, int i, float[] fArr, float[] fArr2) {
        float fLerp;
