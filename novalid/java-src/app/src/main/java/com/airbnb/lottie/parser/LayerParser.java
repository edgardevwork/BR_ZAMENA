...
public class LayerParser {
    public static final JsonReader.Options NAMES = JsonReader.Options.m963of("nm", "ind", "refId", "ty", "parent", "sw", "sh", GiftsKeys.GET_VALUE_OF_STANDARD_GIFTS_KEY, "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", "w", "h", "ip", BlackPassKeys.OP_PRICE_TITLE, "tm", BlackPassKeys.CL_MARATHON_LEVEL, "hd", "ao", HalloweenAwardKeys.HALLOWEEN_AWARD_MONEY_BP_KEY);
    public static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m963of("d", "a");
    public static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m963of("ty", "nm");
            ...
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 9:
                    ...
                    if (iNextInt4 >= Layer.MatteType.values().length) {
                        ...
                        int i = C34751.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[matteType2.ordinal()];
                        if (i == 1) {
    ...
    public static /* synthetic */ class C34751 {
