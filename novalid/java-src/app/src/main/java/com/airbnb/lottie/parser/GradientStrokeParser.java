...
public class GradientStrokeParser {
    public static final JsonReader.Options NAMES = JsonReader.Options.m963of("nm", "g", "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
    public static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m963of("p", "k");
