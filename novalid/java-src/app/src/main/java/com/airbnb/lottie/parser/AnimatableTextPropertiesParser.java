...
public class AnimatableTextPropertiesParser {
    public static final JsonReader.Options PROPERTIES_NAMES = JsonReader.Options.m963of("a");
    public static final JsonReader.Options ANIMATABLE_PROPERTIES_NAMES = JsonReader.Options.m963of("fc", GiftsKeys.GET_VALUE_OF_STANDARD_GIFTS_KEY, "sw", "t");
