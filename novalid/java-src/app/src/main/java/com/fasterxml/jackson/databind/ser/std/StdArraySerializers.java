...
public class StdArraySerializers {
    ...
    public static class BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Boolean.class);
    ...
    public static class ShortArraySerializer extends TypedPrimitiveArraySerializer<short[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Short.TYPE);
    ...
    public static class CharArraySerializer extends StdSerializer<char[]> {
        ...
        public final void _writeArrayContents(JsonGenerator jsonGenerator, char[] cArr) throws IOException {
    ...
    public static class IntArraySerializer extends ArraySerializerBase<int[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Integer.TYPE);
    ...
    public static class LongArraySerializer extends TypedPrimitiveArraySerializer<long[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Long.TYPE);
    ...
    public static class FloatArraySerializer extends TypedPrimitiveArraySerializer<float[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Float.TYPE);
    ...
    public static class DoubleArraySerializer extends ArraySerializerBase<double[]> {
        public static final JavaType VALUE_TYPE = TypeFactory.defaultInstance().uncheckedSimpleType(Double.TYPE);
