...
public class BigIntegerNode extends NumericNode {
    ...
    public static final BigInteger MIN_INTEGER = BigInteger.valueOf(ParserMinimalBase.MIN_INT_L);
    public static final BigInteger MAX_INTEGER = BigInteger.valueOf(ParserMinimalBase.MAX_INT_L);
