...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
    ...
    public final SettableBeanProperty _findWithAlias(String str) {
        if (str == null) {
            return null;
        }
    ...
    public final SettableBeanProperty _find2ViaAlias(String str, int i, Object obj) {
        int i2 = this._hashMask + 1;
        int i3 = ((i >> 1) + i2) << 1;
        Object obj2 = this._hashArea[i3];
        if (str.equals(obj2)) {
    ...
    public final Map<String, String> _buildAliasMapping(Map<String, List<PropertyName>> map, boolean z, Locale locale) {
