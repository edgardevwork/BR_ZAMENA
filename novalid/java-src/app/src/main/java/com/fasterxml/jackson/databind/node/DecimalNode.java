...
public class DecimalNode extends NumericNode {
    ...
    public static final BigDecimal MIN_INTEGER = BigDecimal.valueOf(ParserMinimalBase.MIN_INT_L);
    public static final BigDecimal MAX_INTEGER = BigDecimal.valueOf(ParserMinimalBase.MAX_INT_L);
    ...
    public boolean canConvertToExactIntegral() {
        return this._value.signum() == 0 || this._value.scale() <= 0 || DecimalNode$$ExternalSyntheticBackportWithForwarding0.m1037m(this._value).scale() <= 0;
    }
