...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    public static class Std implements VisibilityChecker<Std>, Serializable {
        ...
        public final JsonAutoDetect.Visibility _defaultOrOverride(JsonAutoDetect.Visibility visibility, JsonAutoDetect.Visibility visibility2) {
        ...
        public Std withVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
            switch (C66911.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[propertyAccessor.ordinal()]) {
                case 1:
    ...
    public static /* synthetic */ class C66911 {
