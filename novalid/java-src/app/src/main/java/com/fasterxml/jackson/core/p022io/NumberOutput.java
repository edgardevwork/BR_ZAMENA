...
import com.fasterxml.jackson.core.p022io.schubfach.FloatToDecimal;
...
public final class NumberOutput {
    ...
    public static long BILLION_L = 1000000000;
    ...
    public static final int[] TRIPLET_TO_CHARS = new int[1000];
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", "2", "3", "4", YouTubePlayerBridge.ERROR_HTML_5_PLAYER, "6", "7", "8", "9", "10"};
        sSmallIntStrs2 = new String[]{ScanBuild.XRAY_FATAL_FAIL_STATUS, "-2", "-3", "-4", "-5", "-6", "-7", "-8", "-9", "-10"};
    }
    ...
    public static int outputInt(int i, byte[] bArr, int i2) {
        ...
        if (i < 0) {
            ...
            bArr[i2] = Cea608Decoder.CTRL_CARRIAGE_RETURN;
            i = -i;
            i2++;
        }
        if (i < MILLION) {
    ...
    public static int outputLong(long j, byte[] bArr, int i) {
        ...
        if (j < 0) {
            ...
            bArr[i] = Cea608Decoder.CTRL_CARRIAGE_RETURN;
            j = -j;
            i++;
        } else if (j <= MAX_INT_AS_LONG) {
            return outputInt((int) j, bArr, i);
    ...
    public static int _outputUptoBillion(int i, char[] cArr, int i2) {
        if (i < MILLION) {
            if (i < 1000) {
                return _leading3(i, cArr, i2);
            }
    ...
    public static int _outputFullBillion(int i, char[] cArr, int i2) {
        int i3 = i / 1000;
        int i4 = i - (i3 * 1000);
        int i5 = i3 / 1000;
        int[] iArr = TRIPLET_TO_CHARS;
    ...
    public static int _outputUptoBillion(int i, byte[] bArr, int i2) {
        if (i < MILLION) {
            if (i < 1000) {
                return _leading3(i, bArr, i2);
            }
    ...
    public static int _outputFullBillion(int i, byte[] bArr, int i2) {
        int i3 = i / 1000;
        int i4 = i - (i3 * 1000);
        int i5 = i3 / 1000;
        int i6 = i3 - (i5 * 1000);
    ...
    public static int _outputUptoMillion(char[] cArr, int i, int i2, int i3) {
        int[] iArr = TRIPLET_TO_CHARS;
        int i4 = iArr[i2];
        if (i2 > 9) {
            if (i2 > 99) {
    ...
    public static int _outputUptoMillion(byte[] bArr, int i, int i2, int i3) {
        int[] iArr = TRIPLET_TO_CHARS;
        int i4 = iArr[i2];
        if (i2 > 9) {
            if (i2 > 99) {
    ...
    public static int _leading3(int i, char[] cArr, int i2) {
    ...
    public static int _leading3(int i, byte[] bArr, int i2) {
        int i3 = TRIPLET_TO_CHARS[i];
        if (i > 9) {
            if (i > 99) {
                bArr[i2] = (byte) (i3 >> 16);
    ...
    public static int _full3(int i, char[] cArr, int i2) {
        int i3 = TRIPLET_TO_CHARS[i];
        cArr[i2] = (char) (i3 >> 16);
        int i4 = i2 + 2;
    ...
    public static int _full3(int i, byte[] bArr, int i2) {
        int i3 = TRIPLET_TO_CHARS[i];
        bArr[i2] = (byte) (i3 >> 16);
        int i4 = i2 + 2;
        bArr[i2 + 1] = (byte) (i3 >> 8);
    ...
    public static int _outputSmallestL(char[] cArr, int i) {
    ...
    public static int _outputSmallestL(byte[] bArr, int i) {
    ...
    public static int _outputSmallestI(char[] cArr, int i) {
    ...
    public static int _outputSmallestI(byte[] bArr, int i) {
