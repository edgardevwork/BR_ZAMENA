...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.EnumC6665As enumC6665As) {
        this._mapper.activateDefaultTyping(polymorphicTypeValidator, defaultTyping, enumC6665As);
        return (B) _this();
    }
