...
/* renamed from: com.blackhub.bronline.game.ui.bprewards.BpRewardsMainUIKt$BpRewardsMainUI$1$1$12$invoke$$inlined$items$default$2 */
/* loaded from: classes.dex */
public final class C5006x7c2e2bf6 extends Lambda implements Function1<Integer, Object> {
    public final /* synthetic */ List $items;
    public final /* synthetic */ Function1 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5006x7c2e2bf6(Function1 function1, List list) {
        super(1);
        this.$key = function1;
        this.$items = list;
    }
