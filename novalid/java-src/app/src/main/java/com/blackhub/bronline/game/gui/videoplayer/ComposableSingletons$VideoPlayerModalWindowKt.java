...
public final class ComposableSingletons$VideoPlayerModalWindowKt {
    ...
    @NotNull
    public static Function2<Composer, Integer, Unit> f11150lambda1 = ComposableLambdaKt.composableLambdaInstance(1795099522, false, new Function2<Composer, Integer, Unit>() { // from class: com.blackhub.bronline.game.gui.videoplayer.ComposableSingletons$VideoPlayerModalWindowKt$lambda-1$1
        ...
        public final void invoke(@Nullable Composer composer, int i) {
            if ((i & 11) != 2 || !composer.getSkipping()) {
                ...
                TextKt.m10024Text4IGK_g(StringResources_androidKt.stringResource(R.string.videoplayer_hint, composer, 6), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, TypographyStyle.INSTANCE.m14848montserratRegularCustomSpbl3sdaw(R.dimen._16wsp, 0L, TextAlign.INSTANCE.m13558getCentere0LSkKk(), 0L, 0.0f, composer, 196614, 26), composer, 0, 0, 65534);
    ...
    public final Function2<Composer, Integer, Unit> m14764getLambda1$app_siteRelease() {
        return f11150lambda1;
    }
}
