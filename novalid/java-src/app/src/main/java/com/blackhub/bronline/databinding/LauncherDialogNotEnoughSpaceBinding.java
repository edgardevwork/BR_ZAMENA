...
public final class LauncherDialogNotEnoughSpaceBinding implements ViewBinding {
    ...
    public static LauncherDialogNotEnoughSpaceBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.launcher_dialog_not_enough_space, parent, false);
        if (attachToParent) {
    ...
    public static LauncherDialogNotEnoughSpaceBinding bind(@NonNull View rootView) {
        ...
        if (viewFindChildViewById != null) {
            ...
            if (appCompatButton != null) {
                ...
                View viewFindChildViewById2 = ViewBindings.findChildViewById(rootView, R.id.main_view_dialog_not_enough_space);
                if (viewFindChildViewById2 != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            return new LauncherDialogNotEnoughSpaceBinding((ConstraintLayout) rootView, viewFindChildViewById, appCompatButton, viewFindChildViewById2, textView, textView2);
                        }
                    }
                }
            }
