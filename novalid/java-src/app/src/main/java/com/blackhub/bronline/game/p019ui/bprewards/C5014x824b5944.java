...
/* renamed from: com.blackhub.bronline.game.ui.bprewards.BpRewardsMainUIKt$BpRewardsMainUI$1$1$9$8$invoke$$inlined$items$default$2 */
/* loaded from: classes.dex */
public final class C5014x824b5944 extends Lambda implements Function1<Integer, Object> {
    public final /* synthetic */ List $items;
    public final /* synthetic */ Function1 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5014x824b5944(Function1 function1, List list) {
        super(1);
        this.$key = function1;
        this.$items = list;
    }
