    ...
    */
    public void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivStraightPipeBotPlot, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivStraightPipeBotPlot, i);
            ViewDataBindingAdaptersKt.setHeight(this.ivStraightPipeBotPlot1, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivStraightPipeBotPlot1, i);
            ...
            ViewDataBindingAdaptersKt.setHeight(this.ivTeePipeMiddlePlot, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivTeePipeMiddlePlot, oneHundredThirty);
            ViewDataBindingAdaptersKt.setHeight(this.ivTeePipeMiddlePlot1, i2);
            ViewDataBindingAdaptersKt.setWidth(this.ivTeePipeMiddlePlot1, oneHundredThirty);
