...
public final /* data */ class DeletePurchaseResponse implements ResponseWithCode {
    ...
    public /* synthetic */ DeletePurchaseResponse(RequestMeta requestMeta, int i, String str, String str2, List list, int i2, DefaultConstructorMarker defaultConstructorMarker) {
