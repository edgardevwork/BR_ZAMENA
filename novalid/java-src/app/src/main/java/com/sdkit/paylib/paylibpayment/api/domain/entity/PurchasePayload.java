...
public final /* data */ class PurchasePayload {
    ...
    public static /* synthetic */ PurchasePayload copy$default(PurchasePayload purchasePayload, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = purchasePayload.purchaseId;
        }
        if ((i & 2) != 0) {
            str2 = purchasePayload.invoiceId;
        }
    ...
    public final PurchasePayload copy(String purchaseId, String invoiceId) {
        return new PurchasePayload(purchaseId, invoiceId);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.purchaseId, purchasePayload.purchaseId) && Intrinsics.areEqual(this.invoiceId, purchasePayload.invoiceId);
    }
