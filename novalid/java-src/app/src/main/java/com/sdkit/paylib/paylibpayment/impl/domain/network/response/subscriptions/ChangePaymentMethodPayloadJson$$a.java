...
public final class ChangePaymentMethodPayloadJson$$a implements GeneratedSerializer {

    /* renamed from: a */
    public static final ChangePaymentMethodPayloadJson$$a f5665a;

    /* renamed from: b */
    public static final /* synthetic */ PluginGeneratedSerialDescriptor f5666b;

    static {
        ChangePaymentMethodPayloadJson$$a changePaymentMethodPayloadJson$$a = new ChangePaymentMethodPayloadJson$$a();
        f5665a = changePaymentMethodPayloadJson$$a;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sdkit.paylib.paylibpayment.impl.domain.network.response.subscriptions.ChangePaymentMethodPayloadJson", changePaymentMethodPayloadJson$$a, 2);
        pluginGeneratedSerialDescriptor.addElement("purchase_id", true);
        pluginGeneratedSerialDescriptor.addElement("invoice_id", true);
        f5666b = pluginGeneratedSerialDescriptor;
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public ChangePaymentMethodPayloadJson deserialize(Decoder decoder) {
        ...
        return new ChangePaymentMethodPayloadJson(i, (String) objDecodeNullableSerializableElement2, (String) objDecodeNullableSerializableElement, null);
    }
    ...
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public void serialize(Encoder encoder, ChangePaymentMethodPayloadJson value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor);
        ChangePaymentMethodPayloadJson.m4552a(value, compositeEncoderBeginStructure, descriptor);
