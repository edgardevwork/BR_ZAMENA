...
public final /* data */ class DeleteCardResponse implements ResponseWithError {
    ...
    public static /* synthetic */ DeleteCardResponse copy$default(DeleteCardResponse deleteCardResponse, RequestMeta requestMeta, ErrorModel errorModel, int i, Object obj) {
        if ((i & 1) != 0) {
            requestMeta = deleteCardResponse.meta;
        }
        if ((i & 2) != 0) {
            errorModel = deleteCardResponse.error;
        }
    ...
    public final DeleteCardResponse copy(RequestMeta meta, ErrorModel error) {
        return new DeleteCardResponse(meta, error);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DeleteCardResponse)) {
            return false;
        }
        DeleteCardResponse deleteCardResponse = (DeleteCardResponse) other;
        return Intrinsics.areEqual(this.meta, deleteCardResponse.meta) && Intrinsics.areEqual(this.error, deleteCardResponse.error);
    }
    ...
    public String toString() {
        return "DeleteCardResponse(meta=" + this.meta + ", error=" + this.error + ')';
    }
