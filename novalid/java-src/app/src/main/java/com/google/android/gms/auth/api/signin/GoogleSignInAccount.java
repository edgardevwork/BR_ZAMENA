...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getId", m1069id = 2)
    private final String zad;

    @Nullable
    @SafeParcelable.Field(getter = "getIdToken", m1069id = 3)
    private final String zae;

    @Nullable
    @SafeParcelable.Field(getter = "getEmail", m1069id = 4)
    private final String zaf;

    @Nullable
    @SafeParcelable.Field(getter = "getDisplayName", m1069id = 5)
    private final String zag;

    @Nullable
    @SafeParcelable.Field(getter = "getPhotoUrl", m1069id = 6)
    private final Uri zah;

    @Nullable
    @SafeParcelable.Field(getter = "getServerAuthCode", m1069id = 7)
    private String zai;

    @SafeParcelable.Field(getter = "getExpirationTimeSecs", m1069id = 8)
    private final long zaj;

    @SafeParcelable.Field(getter = "getObfuscatedIdentifier", m1069id = 9)
    private final String zak;

    @Nullable
    @SafeParcelable.Field(getter = "getGivenName", m1069id = 11)
    private final String zal;

    @Nullable
    @SafeParcelable.Field(getter = "getFamilyName", m1069id = 12)
    private final String zam;
    private final Set zan = new HashSet();

    @SafeParcelable.Constructor
    public GoogleSignInAccount(@SafeParcelable.Param(m1070id = 1) int i, @Nullable @SafeParcelable.Param(m1070id = 2) String str, @Nullable @SafeParcelable.Param(m1070id = 3) String str2, @Nullable @SafeParcelable.Param(m1070id = 4) String str3, @Nullable @SafeParcelable.Param(m1070id = 5) String str4, @Nullable @SafeParcelable.Param(m1070id = 6) Uri uri, @Nullable @SafeParcelable.Param(m1070id = 7) String str5, @SafeParcelable.Param(m1070id = 8) long j, @SafeParcelable.Param(m1070id = 9) String str6, @SafeParcelable.Param(m1070id = 10) List list, @Nullable @SafeParcelable.Param(m1070id = 11) String str7, @Nullable @SafeParcelable.Param(m1070id = 12) String str8) {
        this.zab = i;
        this.zad = str;
        this.zae = str2;
        this.zaf = str3;
