...
public class FirebaseApp {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m1352of(context, (Class<Context>) Context.class, (Class<? super Context>[]) new Class[0])).addComponent(Component.m1352of(this, (Class<FirebaseApp>) FirebaseApp.class, (Class<? super FirebaseApp>[]) new Class[0])).addComponent(Component.m1352of(firebaseOptions, (Class<FirebaseOptions>) FirebaseOptions.class, (Class<? super FirebaseOptions>[]) new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m1352of(startupTime, (Class<StartupTime>) StartupTime.class, (Class<? super StartupTime>[]) new Class[0]));
        }
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(INSTANCE, null, globalBackgroundStateListener)) {
