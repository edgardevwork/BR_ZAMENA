...
public final class LongArrayList extends AbstractProtobufList<Long> implements Internal.LongList, RandomAccess, PrimitiveNonBoxingCollection {
    public static final LongArrayList EMPTY_LIST = new LongArrayList(new long[0], 0, false);
    public long[] array;
    public int size;
    ...
    public LongArrayList(long[] other, int size, boolean isMutable) {
        super(isMutable);
        this.array = other;
        this.size = size;
    }
    ...
    public final void addLong(int index, long element) {
        int i;
        ensureIsMutable();
