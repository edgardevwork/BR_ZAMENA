...
public class RippleUtils {
    ...
    public static class RippleUtilsLollipop {
        ...
        public static Drawable createOvalRipple(@NonNull Context context, @Px int i) {
            ...
            return new RippleDrawable(MaterialColors.getColorStateList(context, C6765R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i, i, i, i));
        }
    }
}
