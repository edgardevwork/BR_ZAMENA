...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C6765R.attr.editTextStyle);
    }

    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, 0), attributeSet, i);
        this.parentRect = new Rect();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C6765R.styleable.TextInputEditText, i, C6765R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
    ...
    public final boolean shouldUseTextInputLayoutFocusedRect(@Nullable TextInputLayout textInputLayout) {
    ...
    @NonNull
    public final String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
