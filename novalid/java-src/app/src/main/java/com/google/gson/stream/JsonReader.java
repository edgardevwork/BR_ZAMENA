...
public class JsonReader implements Closeable {
    ...
    */
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(ExtendedMessageFormat.QUOTE);
        } else if (iDoPeek == 13) {
    ...
    public double nextDouble() throws IOException, NumberFormatException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? ExtendedMessageFormat.QUOTE : '\"');
        } else if (iDoPeek == 10) {
    ...
    */
    ...
    public final void consumeNonExecutePrefix() throws IOException {
