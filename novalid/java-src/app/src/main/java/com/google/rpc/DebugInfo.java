...
public final class DebugInfo extends GeneratedMessageLite<DebugInfo, Builder> implements DebugInfoOrBuilder {
    ...
    public final void ensureStackEntriesIsMutable() {
    ...
    public final void setStackEntries(int i, String str) {
        str.getClass();
        ensureStackEntriesIsMutable();
        this.stackEntries_.set(i, str);
    }

    public final void addStackEntries(String str) {
        str.getClass();
        ensureStackEntriesIsMutable();
        this.stackEntries_.add(str);
    }

    public final void addAllStackEntries(Iterable<String> iterable) {
        ensureStackEntriesIsMutable();
        AbstractMessageLite.addAll((Iterable) iterable, (List) this.stackEntries_);
    }

    public final void clearStackEntries() {
        this.stackEntries_ = GeneratedMessageLite.emptyProtobufList();
    }

    public final void addStackEntriesBytes(ByteString byteString) throws IllegalArgumentException {
    ...
    public final void setDetailBytes(ByteString byteString) throws IllegalArgumentException {
        AbstractMessageLite.checkByteStringIsUtf8(byteString);
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DebugInfo, Builder> implements DebugInfoOrBuilder {
        public /* synthetic */ Builder(C79831 c79831) {
            this();
        }
        ...
        public Builder addStackEntriesBytes(ByteString byteString) throws IllegalArgumentException {
            copyOnWrite();
        ...
        public Builder setDetailBytes(ByteString byteString) throws IllegalArgumentException {
            copyOnWrite();
    ...
    public static /* synthetic */ class C79831 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f935xa1df5c61;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        C79831 c79831 = null;
        switch (C79831.f935xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new DebugInfo();
            case 2:
                return new Builder(c79831);
            case 3:
