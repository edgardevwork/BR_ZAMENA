...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public LazyStringArrayList(boolean isMutable) {
        super(isMutable);
    ...
    public LazyStringArrayList(ArrayList<Object> list) {
        this.list = list;
    }
    ...
    public final void add(int index, ByteString element) {
        ensureIsMutable();
        this.list.add(index, element);
        ((AbstractList) this).modCount++;
    }
    ...
    public final Object setAndReturn(int index, ByteString s) {
        ensureIsMutable();
    ...
    public final Object setAndReturn(int index, byte[] s) {
        ensureIsMutable();
        return this.list.set(index, s);
    }
