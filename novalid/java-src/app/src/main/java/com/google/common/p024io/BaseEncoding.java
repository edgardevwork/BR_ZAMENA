...
public abstract class BaseEncoding {
    ...
    public class C74651 extends ByteSink {
        public final /* synthetic */ CharSink val$encodedSink;

        public C74651(final CharSink val$encodedSink) {
    ...
    public final ByteSink encodingSink(CharSink encodedSink) {
        ...
        return new ByteSink() { // from class: com.google.common.io.BaseEncoding.1
            ...
            public C74651(CharSink encodedSink2) {
    ...
    /* loaded from: classes6.dex */
    public class C74662 extends ByteSource {
        public final /* synthetic */ CharSource val$encodedSource;

        public C74662(final CharSource val$encodedSource) {
    ...
    public final ByteSource decodingSource(CharSource encodedSource) {
        ...
        return new ByteSource() { // from class: com.google.common.io.BaseEncoding.2
            ...
            public C74662(CharSource encodedSource2) {
    ...
    public static class StandardBaseEncoding extends BaseEncoding {
        ...
        public StandardBaseEncoding(String name, String alphabetChars, @CheckForNull Character paddingChar) {
            this(new Alphabet(name, alphabetChars.toCharArray()), paddingChar);
        }

        public StandardBaseEncoding(Alphabet alphabet, @CheckForNull Character paddingChar) {
        ...
        @Override // com.google.common.p024io.BaseEncoding
        ...
        public class C74701 extends OutputStream {
            ...
            public void write(int b) throws IOException {
                ...
                while (true) {
                    ...
                    val$out.write(alphabet.encode((this.bitBuffer >> (i - i2)) & alphabet.mask));
                    this.writtenChars++;
            ...
            public void close() throws IOException {
                ...
                if (i > 0) {
                    ...
                    Alphabet alphabet = StandardBaseEncoding.this.alphabet;
                    val$out.write(alphabet.encode((i2 << (alphabet.bitsPerChar - i)) & alphabet.mask));
                    this.writtenChars++;
                    if (StandardBaseEncoding.this.paddingChar != null) {
                        while (true) {
                            ...
                            val$out.write(standardBaseEncoding.paddingChar.charValue());
                            this.writtenChars++;
                        }
                    }
                }
        ...
        public void encodeChunkTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            ...
            while (i < len * 8) {
                Alphabet alphabet = this.alphabet;
                target.append(alphabet.encode(((int) (j >>> (i3 - i))) & alphabet.mask));
        ...
        /* loaded from: classes7.dex */
        public class C74712 extends InputStream {
            ...
            public C74712(final Reader val$reader) {
    ...
    public static final class Base16Encoding extends StandardBaseEncoding {
        ...
        @Override // com.google.common.io.BaseEncoding.StandardBaseEncoding, com.google.common.p024io.BaseEncoding
        public void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            Preconditions.checkNotNull(target);
            Preconditions.checkPositionIndexes(off, off + len, bytes.length);
            for (int i = 0; i < len; i++) {
    ...
    public static final class Base64Encoding extends StandardBaseEncoding {
        public Base64Encoding(String name, String alphabetChars, @CheckForNull Character paddingChar) {
            this(new Alphabet(name, alphabetChars.toCharArray()), paddingChar);
        }

        public Base64Encoding(Alphabet alphabet, @CheckForNull Character paddingChar) {
    ...
    @J2ktIncompatible
    @GwtIncompatible
    public static Reader ignoringReader(Reader delegate, String toIgnore) {
        ...
        return new Reader() { // from class: com.google.common.io.BaseEncoding.3
            ...
            public C74673(Reader delegate2, String toIgnore2) {
            ...
            public int read() throws IOException {
                ...
                } while (val$toIgnore.indexOf((char) i) >= 0);
                return i;
            }
    ...
    public class C74673 extends Reader {
        public final /* synthetic */ Reader val$delegate;
        public final /* synthetic */ String val$toIgnore;
    ...
    public static Appendable separatingAppendable(Appendable delegate, String separator, int afterEveryChars) {
        ...
        return new Appendable(afterEveryChars, delegate, separator) { // from class: com.google.common.io.BaseEncoding.4
            ...
            public C74684(int afterEveryChars2, Appendable delegate2, String separator2) {
    ...
    public class C74684 implements Appendable {
        public int charsUntilSeparator;
        public final /* synthetic */ int val$afterEveryChars;
        public final /* synthetic */ Appendable val$delegate;
        public final /* synthetic */ String val$separator;
    ...
    public class C74695 extends Writer {
        public final /* synthetic */ Writer val$delegate;
        public final /* synthetic */ Appendable val$separatingAppendable;

        public C74695(final Appendable val$separatingAppendable, final Writer val$delegate) {
        ...
        public void write(int c) throws IOException {
            val$separatingAppendable.append((char) c);
        }
    ...
    @J2ktIncompatible
    @GwtIncompatible
    public static Writer separatingWriter(Writer delegate, String separator, int afterEveryChars) {
        return new Writer() { // from class: com.google.common.io.BaseEncoding.5
            public final /* synthetic */ Writer val$delegate;
            public final /* synthetic */ Appendable val$separatingAppendable;

            public C74695(final Appendable val$separatingAppendable, Writer delegate2) {
                val$separatingAppendable = val$separatingAppendable;
                val$delegate = delegate2;
            }
