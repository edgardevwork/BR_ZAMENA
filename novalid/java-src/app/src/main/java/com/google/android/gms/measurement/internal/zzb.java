...
public final class zzb extends zze {
    ...
    public static /* synthetic */ void zzb(zzb zzbVar, String str, long j) throws IllegalStateException, IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        zzbVar.zzt();
        Preconditions.checkNotEmpty(str);
        Integer num = zzbVar.zzb.get(str);
        if (num != null) {
    ...
    @WorkerThread
    private final void zza(long j, zzlk zzlkVar) throws IllegalStateException, IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        if (zzlkVar == null) {
        ...
        zzm().zzc(GUIManagerKt.APPMETRICA_DEVICE_ID_KEY, "_xa", bundle);
    }

    @WorkerThread
    private final void zza(String str, long j, zzlk zzlkVar) throws IllegalStateException, IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        if (zzlkVar == null) {
        ...
        bundle.putLong("_xt", j);
        zzos.zza(zzlkVar, bundle, true);
        zzm().zzc(GUIManagerKt.APPMETRICA_DEVICE_ID_KEY, "_xu", bundle);
    }
