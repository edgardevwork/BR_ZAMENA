...
public interface Geofence {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setCircularRegion(@FloatRange(from = -90.0d, m9to = 90.0d) double d, @FloatRange(from = -180.0d, m9to = 180.0d) double d2, @FloatRange(from = 0.0d, fromInclusive = false) float f) {
