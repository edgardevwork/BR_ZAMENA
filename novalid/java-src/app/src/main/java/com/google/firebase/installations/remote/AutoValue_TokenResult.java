...
final class AutoValue_TokenResult extends TokenResult {
    ...
    public /* synthetic */ AutoValue_TokenResult(String str, long j, TokenResult.ResponseCode responseCode, C76981 c76981) {
    ...
    public String toString() {
        return "TokenResult{token=" + this.token + ", tokenExpirationTimestamp=" + this.tokenExpirationTimestamp + ", responseCode=" + this.responseCode + WebvttCssParser.RULE_END;
    }
    ...
    public static final class Builder extends TokenResult.Builder {
        ...
        public /* synthetic */ Builder(TokenResult tokenResult, C76981 c76981) {
            this(tokenResult);
        }
