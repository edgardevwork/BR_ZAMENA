...
public class ShapeableDelegateV22 extends ShapeableDelegate {
    ...
    public final boolean isShapeRoundRect() {
    ...
    public final boolean offsetZeroCornerEdgeBoundsIfPossible() {
        ShapeAppearanceModel shapeAppearanceModel;
    ...
    public static boolean shapeUsesAllRoundedCornerTreatments(ShapeAppearanceModel shapeAppearanceModel) {
    ...
    /* renamed from: com.google.android.material.shape.ShapeableDelegateV22$1 */
    /* loaded from: classes4.dex */
    public class C69721 extends ViewOutlineProvider {
        public C69721() {
        }
