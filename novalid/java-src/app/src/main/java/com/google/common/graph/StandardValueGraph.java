...
public class StandardValueGraph<N, V> extends AbstractValueGraph<N, V> {
    ...
    public StandardValueGraph(AbstractGraphBuilder<? super N> builder) {
        this(builder, builder.nodeOrder.createMap(builder.expectedNodeCount.mo1139or((Optional<Integer>) 10).intValue()), 0L);
    }
    ...
    public Set<EndpointPair<N>> incidentEdges(N node) {
        return new IncidentEdgeSet<N>(this, this, node) { // from class: com.google.common.graph.StandardValueGraph.1
            ...
            public C74341(BaseGraph this, BaseGraph this, Object node2, final GraphConnections val$connections) {
                super(this, node2);
    ...
    public class C74341 extends IncidentEdgeSet<N> {
        public final /* synthetic */ GraphConnections val$connections;
    ...
    @CheckForNull
    public final V edgeValueOrDefaultInternal(N nodeU, N nodeV, @CheckForNull V defaultValue) {
        GraphConnections<N, V> graphConnections = this.nodeConnections.get(nodeU);
