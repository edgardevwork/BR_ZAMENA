...
public class ModuleInstallIntentResponse extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m1069id = 1)
    private final PendingIntent zaa;

    @SafeParcelable.Constructor
    @KeepForSdk
    public ModuleInstallIntentResponse(@Nullable @SafeParcelable.Param(m1070id = 1) PendingIntent pendingIntent) {
