...
public class CircularRevealHelper {
    ...
    public final float getDistanceToFurthestCorner(@NonNull CircularRevealWidget.RevealInfo revealInfo) {
    ...
    public final void drawOverlayDrawable(@NonNull Canvas canvas) {
    ...
    public final void drawDebugMode(@NonNull Canvas canvas) {
        this.delegate.actualDraw(canvas);
        if (shouldDrawScrim()) {
            CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
    ...
    public final void drawDebugCircle(@NonNull Canvas canvas, int i, float f) {
