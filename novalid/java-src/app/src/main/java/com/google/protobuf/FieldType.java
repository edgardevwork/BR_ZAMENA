...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f916id] = fieldType52;
        }
    }

    public FieldType(String $enum$name, int $enum$ordinal, int id, Collection collection, JavaType javaType) {
        int i;
        this.f916id = id;
        this.collection = collection;
        this.javaType = javaType;
        int i2 = C79361.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i2 == 1 || i2 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i = C79361.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i == 2 || i == 3) ? false : true;
    }

    /* renamed from: com.google.protobuf.FieldType$1 */
    public static /* synthetic */ class C79361 {
    ...
    public final boolean isValidForList(java.lang.reflect.Field field) {
    ...
    public static java.lang.reflect.Type getGenericSuperList(Class<?> clazz) {
    ...
    public static java.lang.reflect.Type getListParameter(Class<?> clazz, java.lang.reflect.Type[] realTypes) {
        while (true) {
            int i = 0;
            if (clazz != List.class) {
