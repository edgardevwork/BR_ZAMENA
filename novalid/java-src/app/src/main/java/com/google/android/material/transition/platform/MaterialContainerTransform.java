...
public final class MaterialContainerTransform extends Transition {
    ...
    public static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            ...
            int i2 = C6765R.id.mtrl_motion_snapshot_view;
        ...
        transitionValues.values.put("materialContainerTransition:shapeAppearance", captureShapeAppearance(view4, relativeBounds, shapeAppearanceModel));
    }
    ...
    public static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(new int[]{C6765R.attr.transitionShapeAppearance});
    ...
    public final void maybeApplyThemeValues(Context context, boolean z) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C6765R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, z ? C6765R.attr.motionDurationLong2 : C6765R.attr.motionDurationMedium4);
        if (this.pathMotionCustom) {
            return;
        }
        TransitionUtils.maybeApplyThemePath(this, context, C6765R.attr.motionPath);
    }
    ...
    public final boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
    ...
    public final ProgressThresholdsGroup buildThresholdsGroup(boolean z) {
    ...
    public final ProgressThresholdsGroup getThresholdsOrDefault(boolean z, ProgressThresholdsGroup progressThresholdsGroup, ProgressThresholdsGroup progressThresholdsGroup2) {
        if (!z) {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        public final void updateProgress(float f) {
            ...
            this.shadowPaint.setShadowLayer(f10, (int) (fCalculateElevationDxMultiplier * f10), f11, 754974720);
        ...
        public final void drawDebugCumulativePath(Canvas canvas, RectF rectF, Path path, @ColorInt int i) {
            PointF motionPathPoint = getMotionPathPoint(rectF);
        ...
        public final void drawDebugRect(Canvas canvas, RectF rectF, @ColorInt int i) {
            this.debugPaint.setColor(i);
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, m9to = 1.0d) float f, @FloatRange(from = 0.0d, m9to = 1.0d) float f2) {
            this.start = f;
            this.end = f2;
        }
