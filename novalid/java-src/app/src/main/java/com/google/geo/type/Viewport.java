...
public final class Viewport extends GeneratedMessageLite<Viewport, Builder> implements ViewportOrBuilder {
    ...
    public final void setLow(LatLng latLng) {
        latLng.getClass();
        this.low_ = latLng;
    }

    public final void mergeLow(LatLng latLng) {
        latLng.getClass();
    ...
    public final void setHigh(LatLng latLng) {
        latLng.getClass();
        this.high_ = latLng;
    }

    public final void mergeHigh(LatLng latLng) {
        latLng.getClass();
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Viewport, Builder> implements ViewportOrBuilder {
        public /* synthetic */ Builder(C77791 c77791) {
            this();
        }
    ...
    public static /* synthetic */ class C77791 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f893xa1df5c61;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        C77791 c77791 = null;
        switch (C77791.f893xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new Viewport();
            case 2:
                return new Builder(c77791);
            case 3:
