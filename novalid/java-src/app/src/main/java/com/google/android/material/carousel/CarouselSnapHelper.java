...
public class CarouselSnapHelper extends SnapHelper {
    public static final float HORIZONTAL_SNAP_SPEED = 100.0f;
    public static final float VERTICAL_SNAP_SPEED = 50.0f;
    public final boolean disableFling;
    ...
    public final int[] calculateDistanceToSnap(@NonNull RecyclerView.LayoutManager layoutManager, @NonNull View view, boolean z) {
    ...
    public final int distanceToFirstFocalKeyline(@NonNull View view, CarouselLayoutManager carouselLayoutManager, boolean z) {
    ...
    @Nullable
    public final View findViewNearestFirstKeyline(RecyclerView.LayoutManager layoutManager) {
