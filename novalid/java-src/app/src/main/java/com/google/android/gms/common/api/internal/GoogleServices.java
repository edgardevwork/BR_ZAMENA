...
public final class GoogleServices {
    ...
    public GoogleServices(Context context) throws Resources.NotFoundException {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", TypedValues.Custom.S_INT, resources.getResourcePackageName(C6756R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
