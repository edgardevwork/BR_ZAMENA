...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f713x = f;
        pathLineOperation.f714y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f713x = f3;
        pathLineOperation2.f714y = f4;
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f714y - this.startY, this.operation.f713x - this.startX), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f714y - this.startY) / (this.operation.f713x - this.startX)));
        }
    }

    /* loaded from: classes7.dex */
    public static class InnerCornerShadowOperation extends ShadowCompatOperation {
        public final PathLineOperation operation1;
        public final PathLineOperation operation2;
        public final float startX;
        public final float startY;
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f713x - this.startX, this.operation1.f714y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f713x - this.operation1.f713x, this.operation2.f714y - this.operation1.f714y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f713x, this.operation1.f714y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f714y - this.startY) / (this.operation1.f713x - this.startX)));
        }

        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f714y - this.operation1.f714y) / (this.operation2.f713x - this.operation1.f713x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            path.lineTo(this.f713x, this.f714y);
    ...
    public static class PathQuadOperation extends PathOperation {
        ...
        public final void setControlY(float f) {
            this.controlY = f;
        }
        ...
        public final void setControlX(float f) {
            this.controlX = f;
        }
    }
