...
public enum DayOfWeek implements Internal.EnumLite {
    ...
    public static final Internal.EnumLiteMap<DayOfWeek> internalValueMap = new Internal.EnumLiteMap<DayOfWeek>() { // from class: com.google.type.DayOfWeek.1
    ...
    public static final class DayOfWeekVerifier implements Internal.EnumVerifier {
        public static final Internal.EnumVerifier INSTANCE = new DayOfWeekVerifier();
