...
public enum LaunchStage implements Internal.EnumLite {
    ...
    public static final Internal.EnumLiteMap<LaunchStage> internalValueMap = new Internal.EnumLiteMap<LaunchStage>() { // from class: com.google.api.LaunchStage.1
    ...
    public static final class LaunchStageVerifier implements Internal.EnumVerifier {
        public static final Internal.EnumVerifier INSTANCE = new LaunchStageVerifier();
