...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m1069id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) ArrayList arrayList, @SafeParcelable.Param(m1070id = 3) String str) {
        this.zaa = i;
