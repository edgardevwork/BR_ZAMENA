...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public final void setMethods(int index, Method value) {
        value.getClass();
        ensureMethodsIsMutable();
        this.methods_.set(index, value);
    }

    public final void addMethods(Method value) {
        value.getClass();
        ensureMethodsIsMutable();
        this.methods_.add(value);
    }

    public final void addMethods(int index, Method value) {
        value.getClass();
        ensureMethodsIsMutable();
        this.methods_.add(index, value);
    }

    public final void addAllMethods(Iterable<? extends Method> values) {
        ensureMethodsIsMutable();
    ...
    public final void removeMethods(int index) {
        ensureMethodsIsMutable();
    ...
    public final void setOptions(int index, Option value) {
        value.getClass();
        ensureOptionsIsMutable();
        this.options_.set(index, value);
    }

    public final void addOptions(Option value) {
        value.getClass();
        ensureOptionsIsMutable();
        this.options_.add(value);
    }

    public final void addOptions(int index, Option value) {
        value.getClass();
        ensureOptionsIsMutable();
        this.options_.add(index, value);
    }

    public final void addAllOptions(Iterable<? extends Option> values) {
        ensureOptionsIsMutable();
    ...
    public final void removeOptions(int index) {
        ensureOptionsIsMutable();
    ...
    public final void setVersionBytes(ByteString value) throws IllegalArgumentException {
        AbstractMessageLite.checkByteStringIsUtf8(value);
    ...
    public final void mergeSourceContext(SourceContext value) {
        value.getClass();
        SourceContext sourceContext = this.sourceContext_;
    ...
    public final void setMixins(int index, Mixin value) {
        value.getClass();
        ensureMixinsIsMutable();
        this.mixins_.set(index, value);
    }

    public final void addMixins(Mixin value) {
        value.getClass();
        ensureMixinsIsMutable();
        this.mixins_.add(value);
    }

    public final void addMixins(int index, Mixin value) {
        value.getClass();
        ensureMixinsIsMutable();
        this.mixins_.add(index, value);
    }

    public final void addAllMixins(Iterable<? extends Mixin> values) {
        ensureMixinsIsMutable();
        AbstractMessageLite.addAll((Iterable) values, (List) this.mixins_);
    }

    public final void clearMixins() {
        this.mixins_ = GeneratedMessageLite.emptyProtobufList();
    }

    public final void removeMixins(int index) {
        ensureMixinsIsMutable();
    ...
    public final void setSyntaxValue(int value) {
        this.syntax_ = value;
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        public /* synthetic */ Builder(C79041 c79041) {
            this();
        }
    ...
    public static /* synthetic */ class C79041 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f905xa1df5c61;
        ...
        static {
            ...
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f905xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        C79041 c79041 = null;
        switch (C79041.f905xa1df5c61[method.ordinal()]) {
            case 1:
                return new Api();
            case 2:
                return new Builder(c79041);
            case 3:
