...
public final class zzaf implements zzak, zzaq, Iterable<zzaq> {
    ...
    public final zzaq zza(String str, zzh zzhVar, List<zzaq> list) {
        if ("concat".equals(str) || "every".equals(str) || "filter".equals(str) || "forEach".equals(str) || "indexOf".equals(str) || "join".equals(str) || "lastIndexOf".equals(str) || "map".equals(str) || "pop".equals(str) || LauncherConstants.PUSH.equals(str) || "reduce".equals(str) || "reduceRight".equals(str) || "reverse".equals(str) || "shift".equals(str) || "slice".equals(str) || "some".equals(str) || "sort".equals(str) || "splice".equals(str) || "toString".equals(str) || "unshift".equals(str)) {
    ...
    public final zzaq zza(String str) {
        zzaq zzaqVar;
        if (CacheFileMetadataIndex.COLUMN_LENGTH.equals(str)) {
    ...
    public final boolean zzc(String str) {
        return CacheFileMetadataIndex.COLUMN_LENGTH.equals(str) || this.zzb.containsKey(str);
    }
}
