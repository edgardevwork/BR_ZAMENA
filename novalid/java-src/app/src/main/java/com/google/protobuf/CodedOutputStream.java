...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public /* synthetic */ CodedOutputStream(C79151 c79151) {
        this();
    }
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            while ((value & JsonParser.MIN_BYTE_I) != 0) {
                try {
                    byte[] bArr = this.buffer;
                    int i = this.position;
                    this.position = i + 1;
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public final void encode(String value) throws IOException {
            try {
    ...
    public static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public final void repositionBuffer(long pos) {
    ...
    public static final class ByteOutputEncoder extends AbstractBufferedEncoder {
        ...
        public final void flushIfNotAvailable(int requiredSize) throws IOException {
