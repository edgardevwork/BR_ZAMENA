...
import com.google.firebase.perf.p025v1.GaugeMetadata;
...
public class GaugeManager {
        ...
        try {
            ...
            this.gaugeManagerDataCollectionJob = this.gaugeManagerExecutor.get().scheduleAtFixedRate(new Runnable() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.lambda$startCollectingGauges$2(strSessionId, applicationProcessState);
                }
    ...
    public void stopCollectingGauges() {
        ...
        this.gaugeManagerExecutor.get().schedule(new Runnable() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$stopCollectingGauges$3(str, applicationProcessState);
            }
    ...
    public static /* synthetic */ class C77201 {
    ...
    private long getCpuGaugeCollectionFrequencyMs(ApplicationProcessState applicationProcessState) {
        ...
        int i = C77201.$SwitchMap$com$google$firebase$perf$v1$ApplicationProcessState[applicationProcessState.ordinal()];
        if (i == 1) {
