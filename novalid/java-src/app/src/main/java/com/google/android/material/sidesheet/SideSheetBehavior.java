...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    public static final int DEFAULT_ACCESSIBILITY_PANE_TITLE = C6765R.string.side_sheet_accessibility_pane_title;
    public static final int DEF_STYLE_RES = C6765R.style.Widget_Material3_SideSheet;
    ...
    @NonNull
    public final Set<SideSheetCallback> callbacks;
    ...
    @Nullable
    public WeakReference<View> coplanarSiblingViewRef;
    ...
    public int state;
    public final SideSheetBehavior<V>.StateSettlingTracker stateSettlingTracker;
    ...
    public SideSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C6765R.styleable.SideSheetBehavior_Layout);
        int i = C6765R.styleable.SideSheetBehavior_Layout_backgroundTint;
        if (typedArrayObtainStyledAttributes.hasValue(i)) {
            this.backgroundTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, i);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C6765R.styleable.SideSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModel = ShapeAppearanceModel.builder(context, attributeSet, 0, DEF_STYLE_RES).build();
        }
        int i2 = C6765R.styleable.SideSheetBehavior_Layout_coplanarSiblingViewId;
        if (typedArrayObtainStyledAttributes.hasValue(i2)) {
            setCoplanarSiblingViewId(typedArrayObtainStyledAttributes.getResourceId(i2, -1));
        }
        createMaterialShapeDrawableIfNeeded(context);
        this.elevation = typedArrayObtainStyledAttributes.getDimension(C6765R.styleable.SideSheetBehavior_Layout_android_elevation, -1.0f);
        setDraggable(typedArrayObtainStyledAttributes.getBoolean(C6765R.styleable.SideSheetBehavior_Layout_behavior_draggable, true));
        typedArrayObtainStyledAttributes.recycle();
        this.maximumVelocity = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
    }

    public final void setSheetEdge(@NonNull V v, int i) {
    ...
    public final void updateMaterialShapeDrawable(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
    ...
    public final void updateSheetVisibility(@NonNull View view) {
    ...
    public final void ensureAccessibilityPaneTitleIsSet(View view) {
        if (ViewCompat.getAccessibilityPaneTitle(view) == null) {
            ViewCompat.setAccessibilityPaneTitle(view, view.getResources().getString(DEFAULT_ACCESSIBILITY_PANE_TITLE));
        }
    }

    public final void maybeAssignCoplanarSiblingViewBasedId(@NonNull CoordinatorLayout coordinatorLayout) {
        int i;
    ...
    public final int calculateCurrentOffset(int i, V v) {
        int i2 = this.state;
        if (i2 == 1 || i2 == 2) {
    ...
    public final boolean shouldInterceptTouchEvent(@NonNull V v) {
    ...
    public final boolean isDraggedFarEnough(@NonNull MotionEvent motionEvent) {
    ...
    public final float calculateDragDistance(float f, float f2) {
    ...
    public final /* synthetic */ void lambda$setState$0(int i) {
    ...
    public final void runAfterLayout(@NonNull V v, Runnable runnable) {
        if (isLayingOut(v)) {
            v.post(runnable);
        } else {
            runnable.run();
    ...
    public final boolean isLayingOut(@NonNull V v) {
    ...
    public final void createMaterialShapeDrawableIfNeeded(@NonNull Context context) {
    ...
    public final void dispatchOnSlide(@NonNull View view, int i) {
    ...
    public final void clearCoplanarSiblingView() {
        WeakReference<View> weakReference = this.coplanarSiblingViewRef;
        if (weakReference != null) {
            weakReference.clear();
        }
    ...
    public final void updateCoplanarSiblingBackProgress() {
        ViewGroup.MarginLayoutParams marginLayoutParams;
        WeakReference<V> weakReference = this.viewRef;
        if (weakReference == null || weakReference.get() == null) {
            return;
    ...
    @Nullable
    public final ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
    ...
    public final /* synthetic */ void lambda$getCoplanarFinishAnimatorUpdateListener$1(ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    public class StateSettlingTracker {
        public final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final /* synthetic */ boolean lambda$createAccessibilityViewCommandForState$2(int i, View view, AccessibilityViewCommand.CommandArguments commandArguments) {
        setState(i);
        return true;
    }
}
