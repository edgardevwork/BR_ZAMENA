...
final class AutoValue_RolloutAssignment extends RolloutAssignment {
    ...
    public /* synthetic */ AutoValue_RolloutAssignment(String str, String str2, String str3, String str4, long j, C77591 c77591) {
    ...
    public String toString() {
        return "RolloutAssignment{rolloutId=" + this.rolloutId + ", variantId=" + this.variantId + ", parameterKey=" + this.parameterKey + ", parameterValue=" + this.parameterValue + ", templateVersion=" + this.templateVersion + WebvttCssParser.RULE_END;
    }
