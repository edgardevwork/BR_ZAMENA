...
public final class zzbc extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", m1069id = 1)
    final int zza;
    ...
    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", m1069id = 3, type = "android.os.IBinder")
    final com.google.android.gms.location.zzbd zzc;

    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", m1069id = 4)
    final PendingIntent zzd;

    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", m1069id = 5, type = "android.os.IBinder")
    final com.google.android.gms.location.zzba zze;

    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", m1069id = 6, type = "android.os.IBinder")
    final zzai zzf;

    @SafeParcelable.Constructor
    public zzbc(@SafeParcelable.Param(m1070id = 1) int i, @Nullable @SafeParcelable.Param(m1070id = 2) zzba zzbaVar, @Nullable @SafeParcelable.Param(m1070id = 3) IBinder iBinder, @Nullable @SafeParcelable.Param(m1070id = 4) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m1070id = 5) IBinder iBinder2, @Nullable @SafeParcelable.Param(m1070id = 6) IBinder iBinder3) {
        this.zza = i;
        this.zzb = zzbaVar;
        zzai zzagVar = null;
