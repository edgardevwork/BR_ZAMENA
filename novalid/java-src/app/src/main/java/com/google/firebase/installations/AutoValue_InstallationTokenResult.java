...
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public /* synthetic */ AutoValue_InstallationTokenResult(String str, long j, long j2, C76901 c76901) {
        this(str, j, j2);
    }
    ...
    public String toString() {
        return "InstallationTokenResult{token=" + this.token + ", tokenExpirationTimestamp=" + this.tokenExpirationTimestamp + ", tokenCreationTimestamp=" + this.tokenCreationTimestamp + WebvttCssParser.RULE_END;
    }
    ...
    public static final class Builder extends InstallationTokenResult.Builder {
        ...
        public /* synthetic */ Builder(InstallationTokenResult installationTokenResult, C76901 c76901) {
