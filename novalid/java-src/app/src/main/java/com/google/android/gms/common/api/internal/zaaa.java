...
final class zaaa implements zaca {
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), client.getSignInIntent(), com.google.android.gms.internal.base.zap.zaa | C2732C.BUFFER_FLAG_FIRST_SAMPLE);
    }
