...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStartTimeMillis", m1069id = 1)
    private final long zza;

    @SafeParcelable.Field(getter = "getEndTimeMillis", m1069id = 2)
    private final long zzb;

    @SafeParcelable.Field(getter = "getStatus", m1069id = 3)
    private final int zzc;

    @SafeParcelable.Field(getter = "getMissingDataDurationMinutes", m1069id = 4)
    private final int zzd;

    @SafeParcelable.Field(getter = "getNinetiethPctConfidence", m1069id = 5)
    private final int zze;

    @ShowFirstParty
    @SafeParcelable.Constructor
    public SleepSegmentEvent(@SafeParcelable.Param(m1070id = 1) long j, @SafeParcelable.Param(m1070id = 2) long j2, @SafeParcelable.Param(m1070id = 3) int i, @SafeParcelable.Param(m1070id = 4) int i2, @SafeParcelable.Param(m1070id = 5) int i3) {
