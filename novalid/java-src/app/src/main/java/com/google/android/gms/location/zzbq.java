...
public final class zzbq extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getGeofenceIds", m1069id = 1)
    private final List<String> zza;

    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m1069id = 2)
    ...
    public zzbq(@Nullable @SafeParcelable.Param(m1070id = 1) List<String> list, @Nullable @SafeParcelable.Param(m1070id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(m1070id = 3) String str) {
