...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final zabx zac(Context context, zabw zabwVar) {
        ...
        intentFilter.addDataScheme(BundleInfo.PACKAGE_TYPE);
    ...
    public final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) throws Resources.NotFoundException {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                style.addAction(C6754R.drawable.common_full_open_on_phone, resources.getString(C6754R.string.common_open_on_phone), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(C6754R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(C6754R.string.common_google_play_services_notification_channel_name);
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(NotificationApiHelperForO$$ExternalSyntheticApiModelOutline4.m28m("com.google.android.gms.availability", string, 4));
    ...
    public final void zaf(Context context) {
        new zad(this, context).sendEmptyMessageDelayed(1, FileBasedLockStrategy.DEFAULT_TIMEOUT);
    }
    ...
    public final boolean zah(@NonNull Context context, @NonNull ConnectionResult connectionResult, int i) throws Resources.NotFoundException {
        ...
        zae(context, connectionResult.getErrorCode(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | C2732C.BUFFER_FLAG_FIRST_SAMPLE));
        return true;
    }
