...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", m1069id = 1)
    private final List<com.google.android.gms.internal.location.zzbe> zza;

    @InitialTrigger
    @SafeParcelable.Field(getter = "getInitialTrigger", m1069id = 2)
    private final int zzb;

    @SafeParcelable.Field(defaultValue = "", getter = "getTag", m1069id = 3)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getContextAttributionTag", m1069id = 4)
    ...
    public GeofencingRequest(@SafeParcelable.Param(m1070id = 1) List<com.google.android.gms.internal.location.zzbe> list, @SafeParcelable.Param(m1070id = 2) @InitialTrigger int i, @SafeParcelable.Param(m1070id = 3) String str, @Nullable @SafeParcelable.Param(m1070id = 4) String str2) {
        this.zza = list;
        this.zzb = i;
        this.zzc = str;
        this.zzd = str2;
