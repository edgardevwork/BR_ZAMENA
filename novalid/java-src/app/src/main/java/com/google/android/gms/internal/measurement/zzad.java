...
public final class zzad {
    private static final ImmutableSet<String> zza = ImmutableSet.m1221of("_syn", "_err", "_el");
    private String zzb;
    private long zzc;
    ...
    public final String toString() {
        return "Event{name='" + this.zzb + "', timestamp=" + this.zzc + ", params=" + String.valueOf(this.zzd) + WebvttCssParser.RULE_END;
    }
