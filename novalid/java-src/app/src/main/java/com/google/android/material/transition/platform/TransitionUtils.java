...
public class TransitionUtils {
    ...
    public static final int PATH_TYPE_ARC = 1;
    public static final int PATH_TYPE_LINEAR = 0;
    ...
    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, m9to = 1.0d) float f3, @FloatRange(from = 0.0d, m9to = 1.0d) float f4, @FloatRange(from = 0.0d, m9to = 1.0d) float f5) {
        return lerp(f, f2, f3, f4, f5, false);
    }

    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, m9to = 1.0d) float f3, @FloatRange(from = 0.0d, m9to = 1.0d) float f4, @FloatRange(from = 0.0d) float f5, boolean z) {
    ...
    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, m9to = 1.0d) float f, @FloatRange(from = 0.0d, m9to = 1.0d) float f2, @FloatRange(from = 0.0d, m9to = 1.0d) float f3) {
        return f3 < f ? i : f3 > f2 ? i2 : (int) lerp(i, i2, (f3 - f) / (f2 - f));
    }

    public static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, final RectF rectF, final RectF rectF2, @FloatRange(from = 0.0d, m9to = 1.0d) final float f, @FloatRange(from = 0.0d, m9to = 1.0d) final float f2, @FloatRange(from = 0.0d, m9to = 1.0d) final float f3) {
    ...
    public static View findAncestorById(View view, @IdRes int i) throws Resources.NotFoundException {
