...
public abstract class CodedInputStream {
    ...
    public /* synthetic */ CodedInputStream(C79131 c79131) {
        this();
    }
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        public /* synthetic */ ArrayDecoder(byte[] bArr, int i, int i2, boolean z, C79131 c79131) {
            this(bArr, i, i2, z);
        }
            ...
            if (i3 != i2) {
                ...
                if (i3 - i4 >= 9) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = i2 + 3;
                        int i8 = (bArr[i5] << Ascii.f787SO) ^ i6;
                        if (i8 >= 0) {
                            i = i8 ^ 16256;
                        } else {
                            int i9 = i2 + 4;
        ...
        public final void skipRawVarint() throws IOException {
        ...
        public final void skipRawVarintFastPath() throws IOException {
            for (int i = 0; i < 10; i++) {
                byte[] bArr = this.buffer;
                int i2 = this.pos;
                this.pos = i2 + 1;
        ...
        public final void skipRawVarintSlowPath() throws IOException {
            for (int i = 0; i < 10; i++) {
                if (readRawByte() >= 0) {
                    return;
                }
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (i2 != i) {
                ...
                if (i2 - i3 >= 9) {
                    ...
                    int i5 = (bArr[i3] << 7) ^ b;
                    if (i5 < 0) {
                        j = i5 ^ JsonParser.MIN_BYTE_I;
                    } else {
                        int i6 = i + 3;
                        int i7 = (bArr[i4] << Ascii.f787SO) ^ i5;
                        if (i7 >= 0) {
                            j = i7 ^ 16256;
                            i4 = i6;
                        } else {
    ...
    public static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        public /* synthetic */ UnsafeDirectNioDecoder(ByteBuffer byteBuffer, boolean z, C79131 c79131) {
            this(byteBuffer, z);
        }
        ...
        public UnsafeDirectNioDecoder(ByteBuffer buffer, boolean immutable) {
            super();
            this.currentLimit = Integer.MAX_VALUE;
            this.buffer = buffer;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:73:0x008c, code lost:
            ...
            if (com.google.protobuf.UnsafeUtil.getByte(r3) < 0) goto L74;
         */
        @Override // com.google.protobuf.CodedInputStream
        /*
        ...
        */
        public int readRawVarint32() throws IOException {
            ...
            if (this.limit != j) {
                ...
                if (this.limit - j2 >= 9) {
                    ...
                    if (i2 < 0) {
                        i = i2 ^ JsonParser.MIN_BYTE_I;
                    } else {
                        long j4 = 3 + j;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j3) << Ascii.f787SO);
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            j3 = 4 + j;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j4) {
                ...
                if (this.limit - j5 >= 9) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j6) << Ascii.f787SO);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                            j6 = j7;
                        } else {
        ...
        public final int bufferPos(long pos) {
            return (int) (pos - this.address);
        }

        public final ByteBuffer slice(long begin, long end) throws IOException {
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        public /* synthetic */ StreamDecoder(InputStream inputStream, int i, C79131 c79131) {
            this(inputStream, i);
        }

        public StreamDecoder(final InputStream input, int bufferSize) {
            super();
            this.currentLimit = Integer.MAX_VALUE;
        ...
        public static int read(InputStream input, byte[] data, int offset, int length) throws IOException {
            try {
        ...
        public static long skip(InputStream input, long length) throws IOException {
            try {
        ...
        public static int available(InputStream input) throws IOException {
            try {
        ...
        public final void refillBuffer(int n) throws IOException {
        ...
        public final boolean tryRefillBuffer(int n) throws IOException {
            int i = this.pos;
        ...
        public final byte[] readRawBytesSlowPath(final int size, boolean ensureNoLeakedReferences) throws IOException {
        ...
        public final byte[] readRawBytesSlowPathOneChunk(final int size) throws IOException {
            if (size == 0) {
                return Internal.EMPTY_BYTE_ARRAY;
            }
            if (size < 0) {
        ...
        public final List<byte[]> readRawBytesSlowPathRemainingChunks(int sizeLeft) throws IOException {
        ...
        public final ByteString readBytesSlowPath(final int size) throws IOException {
            byte[] rawBytesSlowPathOneChunk = readRawBytesSlowPathOneChunk(size);
            if (rawBytesSlowPathOneChunk != null) {
        ...
        public final void skipRawBytesSlowPath(final int size) throws IOException {
            if (size < 0) {
                throw InvalidProtocolBufferException.negativeSize();
            }
            int i = this.totalBytesRetired;
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public boolean enableAliasing;
        public final boolean immutable;
        public final Iterable<ByteBuffer> input;
        ...
        public /* synthetic */ IterableDirectByteBufferDecoder(Iterable iterable, int i, boolean z, C79131 c79131) {
            this(iterable, i, z);
        }

        public IterableDirectByteBufferDecoder(Iterable<ByteBuffer> inputBufs, int size, boolean immutableFlag) {
            super();
            this.currentLimit = Integer.MAX_VALUE;
        ...
        public final void getNextByteBuffer() throws InvalidProtocolBufferException {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = (UnsafeUtil.getByte(j3) << Ascii.f787SO) ^ i2;
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            long j5 = 4 + j;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i < 0) {
                        j = i ^ JsonParser.MIN_BYTE_I;
                    } else {
                        long j7 = 3 + j4;
                        int i2 = (UnsafeUtil.getByte(j6) << Ascii.f787SO) ^ i;
                        if (i2 >= 0) {
                            j = i2 ^ 16256;
                            j6 = j7;
                        } else {
        ...
        public final void readRawBytesTo(byte[] bytes, int offset, final int length) throws IOException {
            if (length < 0 || length > remaining()) {
                if (length > 0) {
                    throw InvalidProtocolBufferException.truncatedMessage();
                }
        ...
        public final ByteBuffer slice(int begin, int end) throws IOException {
