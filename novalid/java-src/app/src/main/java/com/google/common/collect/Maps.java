...
public final class Maps {
    ...
    public enum EntryFunction implements Function<Map.Entry<?, ?>, Object> {
        ...
        /* synthetic */ EntryFunction(C73001 c73001) {
            this();
        }

        /* renamed from: com.google.common.collect.Maps$EntryFunction$1 */
        /* loaded from: classes8.dex */
        public enum C73131 extends EntryFunction {
            @Override // com.google.common.base.Function
            @CheckForNull
            public Object apply(Map.Entry<?, ?> entry) {
                return entry.getKey();
        ...
        /* loaded from: classes8.dex */
        public enum C73142 extends EntryFunction {
            @Override // com.google.common.base.Function
            @CheckForNull
            public Object apply(Map.Entry<?, ?> entry) {
                return entry.getValue();
    ...
    /* loaded from: classes7.dex */
    public class C73001<K, V> extends TransformedIterator<Map.Entry<K, V>, K> {
        public C73001(Iterator backingIterator) {
    ...
    public static <K, V> Iterator<K> keyIterator(Iterator<Map.Entry<K, V>> entryIterator) {
        return new TransformedIterator<Map.Entry<K, V>, K>(entryIterator) { // from class: com.google.common.collect.Maps.1
            public C73001(Iterator entryIterator2) {
    ...
    /* loaded from: classes7.dex */
    public class C73052<K, V> extends TransformedIterator<Map.Entry<K, V>, V> {
        public C73052(Iterator backingIterator) {
            super(backingIterator);
        }
    ...
    public static <K, V> Iterator<V> valueIterator(Iterator<Map.Entry<K, V>> entryIterator) {
        return new TransformedIterator<Map.Entry<K, V>, V>(entryIterator) { // from class: com.google.common.collect.Maps.2
            public C73052(Iterator entryIterator2) {
                super(entryIterator2);
            }
    ...
    public static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        /* renamed from: com.google.common.collect.Maps$AsMapView$1EntrySetImpl */
        /* loaded from: classes8.dex */
    ...
    /* loaded from: classes7.dex */
    public class C73063<K, V> extends TransformedIterator<K, Map.Entry<K, V>> {
        public final /* synthetic */ Function val$function;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C73063(Iterator backingIterator, final Function val$function) {
            super(backingIterator);
        ...
        public /* bridge */ /* synthetic */ Object transform(@ParametricNullness final Object key) {
            return transform((C73063<K, V>) key);
        }
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C73063(Iterator backingIterator, final Function function2) {
                super(backingIterator);
    ...
    /* loaded from: classes8.dex */
    public class C73074<E> extends ForwardingSet<E> {
        public final /* synthetic */ Set val$set;

        public C73074(final Set val$set) {
            val$set = val$set;
        }
    ...
    /* loaded from: classes8.dex */
    public class C73085<E> extends ForwardingSortedSet<E> {
        public final /* synthetic */ SortedSet val$set;

        public C73085(final SortedSet val$set) {
            val$set = val$set;
        }
    ...
    public static <E> SortedSet<E> removeOnlySortedSet(final SortedSet<E> set) {
        return new ForwardingSortedSet<E>() { // from class: com.google.common.collect.Maps.5
            ...
            public C73085(final SortedSet set2) {
                val$set = set2;
            }
    ...
    /* loaded from: classes7.dex */
    public class C73096<E> extends ForwardingNavigableSet<E> {
        public final /* synthetic */ NavigableSet val$set;

        public C73096(final NavigableSet val$set) {
            val$set = val$set;
        }
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> set) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.6
            ...
            public C73096(final NavigableSet set2) {
                val$set = set2;
            }
    ...
    /* loaded from: classes7.dex */
    public class C73107<K, V> extends AbstractMapEntry<K, V> {
        public final /* synthetic */ Map.Entry val$entry;

        public C73107(final Map.Entry val$entry) {
            val$entry = val$entry;
        }
    ...
    public static <K, V> Map.Entry<K, V> unmodifiableEntry(final Map.Entry<? extends K, ? extends V> entry) {
        ...
        return new AbstractMapEntry<K, V>() { // from class: com.google.common.collect.Maps.7
            ...
            public C73107(final Map.Entry entry2) {
                val$entry = entry2;
            }
    ...
    /* loaded from: classes7.dex */
    public class C73118<K, V> extends UnmodifiableIterator<Map.Entry<K, V>> {
        public final /* synthetic */ Iterator val$entryIterator;

        public C73118(final Iterator val$entryIterator) {
    ...
    public static <K, V> UnmodifiableIterator<Map.Entry<K, V>> unmodifiableEntryIterator(final Iterator<Map.Entry<K, V>> entryIterator) {
        return new UnmodifiableIterator<Map.Entry<K, V>>() { // from class: com.google.common.collect.Maps.8
            ...
            public C73118(final Iterator entryIterator2) {
    ...
    public static class UnmodifiableBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        public UnmodifiableBiMap(BiMap<? extends K, ? extends V> delegate, @CheckForNull BiMap<V, K> inverse) {
    ...
    /* loaded from: classes7.dex */
    public class C73129<K, V1, V2> implements EntryTransformer<K, V1, V2> {
        public C73129() {
        }
    ...
    /* loaded from: classes7.dex */
    public class C730110<V1, V2> implements Function<V1, V2> {
        public final /* synthetic */ Object val$key;

        public C730110(final Object val$key) {
            val$key = val$key;
        }
    ...
    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> transformer, @ParametricNullness final K key) {
        ...
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            ...
            public C730110(final Object key2) {
                val$key = key2;
            }
    ...
    /* renamed from: com.google.common.collect.Maps$11 */
    /* loaded from: classes7.dex */
    public class C730211<K, V1, V2> implements Function<Map.Entry<K, V1>, V2> {
        public C730211() {
        }
    ...
    public static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> transformer, final Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.common.collect.Maps.12
            ...
            public C730312(final Map.Entry entry2, final EntryTransformer transformer2) {
                val$entry = entry2;
    ...
    /* loaded from: classes7.dex */
    public class C730312<K, V2> extends AbstractMapEntry<K, V2> {
        public final /* synthetic */ Map.Entry val$entry;
        public final /* synthetic */ EntryTransformer val$transformer;
    ...
    /* loaded from: classes7.dex */
    public class C730413<K, V1, V2> implements Function<Map.Entry<K, V1>, Map.Entry<K, V2>> {
        public C730413() {
        }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @CheckForNull
        public final Map.Entry<K, V2> transformEntry(@CheckForNull Map.Entry<K, V1> entry) {
            if (entry == null) {
                return null;
            }
    ...
    public static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        public class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            public /* synthetic */ EntrySet(FilteredEntryMap filteredEntryMap, C73001 c73001) {
                this();
            }
            ...
            /* loaded from: classes7.dex */
            public class C73161 extends TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>> {
                public C73161(Iterator backingIterator) {
                    super(backingIterator);
                }

                /* renamed from: com.google.common.collect.Maps$FilteredEntryMap$EntrySet$1$1 */
                /* loaded from: classes8.dex */
                public class AnonymousClass1 extends ForwardingMapEntry<K, V> {
                    public final /* synthetic */ Map.Entry val$entry;
    ...
    public static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        public class C73171 extends NavigableKeySet<K, V> {
            public C73171(NavigableMap map) {
                super(map);
            }
        ...
        public NavigableSet<K> navigableKeySet() {
            return new NavigableKeySet<K, V>(this) { // from class: com.google.common.collect.Maps.FilteredEntryNavigableMap.1
                public C73171(NavigableMap this) {
                    super(this);
                }
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        /* loaded from: classes7.dex */
        public class C73151 implements Predicate<Map.Entry<V, K>> {
            public C73151() {
            }
        ...
        public static <K, V> Predicate<Map.Entry<V, K>> inversePredicate(final Predicate<? super Map.Entry<K, V>> forwardPredicate) {
    ...
    public static abstract class IteratorBasedAbstractMap<K, V> extends AbstractMap<K, V> {
        ...
        /* loaded from: classes8.dex */
        public class C73181 extends EntrySet<K, V> {
            public C73181() {
            }
    ...
    public static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        /* renamed from: com.google.common.collect.Maps$DescendingMap$1EntrySetImpl */
        public class C1EntrySetImpl extends EntrySet<K, V> {
            public C1EntrySetImpl() {
            }
    ...
    public static <K extends Comparable<? super K>, V> NavigableMap<K, V> subMap(NavigableMap<K, V> map, Range<K> range) {
        ...
        if (range.hasLowerBound() && range.hasUpperBound()) {
            ...
            return map.subMap(comparableLowerEndpoint, boundTypeLowerBoundType == boundType, range.upperEndpoint(), range.upperBoundType() == boundType);
        }
