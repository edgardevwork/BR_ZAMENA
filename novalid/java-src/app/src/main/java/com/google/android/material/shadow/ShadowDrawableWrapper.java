...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, C6765R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C6765R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C6765R.color.design_fab_shadow_end_color);
    ...
    public final void drawShadow(@NonNull Canvas canvas) {
        int i;
        float f;
        int i2;
        float f2;
    ...
    public final void buildComponents(@NonNull Rect rect) {
