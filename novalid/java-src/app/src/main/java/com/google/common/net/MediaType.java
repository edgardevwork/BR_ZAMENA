...
public final class MediaType {
    ...
    public static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m1185of("charset", Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    public static final MediaType WEBM_AUDIO = createConstant("audio", MatroskaExtractor.DOC_TYPE_WEBM);
    ...
    public static final MediaType WEBM_VIDEO = createConstant("video", MatroskaExtractor.DOC_TYPE_WEBM);
    ...
    public static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m1144on("; ").withKeyValueSeparator(URLEncodedUtils.NAME_VALUE_SEPARATOR);

    public static MediaType createConstant(String type, String subtype) {
        MediaType mediaTypeAddKnownType = addKnownType(new MediaType(type, subtype, ImmutableListMultimap.m1184of()));
    ...
    public static MediaType createConstantUtf8(String type, String subtype) {
        ...
        mediaTypeAddKnownType.parsedCharset = Optional.m1145of(Charsets.UTF_8);
        return mediaTypeAddKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optionalAbsent = Optional.m1145of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String attribute, String value) {
        return withParameters(attribute, ImmutableSet.m1219of(value));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType mediaTypeWithParameter = withParameter("charset", charset.name());
        mediaTypeWithParameter.parsedCharset = Optional.m1145of(charset);
    ...
    /* renamed from: is */
    public boolean m1315is(MediaType mediaTypeRange) {
    ...
    public static MediaType create(String type, String subtype) {
        MediaType mediaTypeCreate = create(type, subtype, ImmutableListMultimap.m1184of());
