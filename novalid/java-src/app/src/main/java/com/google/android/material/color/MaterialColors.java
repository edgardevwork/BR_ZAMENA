...
public class MaterialColors {
    ...
    public static final int CHROMA_NEUTRAL = 6;
    public static final int TONE_ACCENT_CONTAINER_DARK = 30;
    public static final int TONE_ACCENT_CONTAINER_LIGHT = 90;
    public static final int TONE_ACCENT_DARK = 80;
    public static final int TONE_ACCENT_LIGHT = 40;
    public static final int TONE_ON_ACCENT_CONTAINER_DARK = 90;
    public static final int TONE_ON_ACCENT_CONTAINER_LIGHT = 10;
    public static final int TONE_ON_ACCENT_DARK = 20;
    public static final int TONE_ON_ACCENT_LIGHT = 100;
    public static final int TONE_SURFACE_CONTAINER_DARK = 12;
    public static final int TONE_SURFACE_CONTAINER_HIGH_DARK = 17;
    public static final int TONE_SURFACE_CONTAINER_HIGH_LIGHT = 92;
    public static final int TONE_SURFACE_CONTAINER_LIGHT = 94;
    ...
    public static int resolveColor(@NonNull Context context, @NonNull TypedValue typedValue) {
    ...
    public static ColorStateList resolveColorStateList(@NonNull Context context, @NonNull TypedValue typedValue) {
        int i = typedValue.resourceId;
        if (i != 0) {
    ...
    @ColorInt
    public static int layer(@NonNull View view, @AttrRes int i, @AttrRes int i2, @FloatRange(from = 0.0d, m9to = 1.0d) float f) {
        return layer(getColor(view, i), getColor(view, i2), f);
    }

    @ColorInt
    public static int layer(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, m9to = 1.0d) float f) {
    ...
    @ColorInt
    public static int compositeARGBWithAlpha(@ColorInt int i, @IntRange(from = 0, m10to = ScatterMapKt.Sentinel) int i2) {
    ...
    public static int harmonizeWithPrimary(@NonNull Context context, @ColorInt int i) {
        return harmonize(i, getColor(context, C6765R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static boolean isLightTheme(@NonNull Context context) {
        return MaterialAttributes.resolveBoolean(context, C6765R.attr.isLightTheme, true);
    }

    @ColorInt
    public static int getColorRole(@ColorInt int i, @IntRange(from = 0, m10to = 100) int i2) {
    ...
    @ColorInt
    public static int getColorRole(@ColorInt int i, @IntRange(from = 0, m10to = 100) int i2, int i3) {
