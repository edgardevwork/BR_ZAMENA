...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m1352of(eventBus, (Class<EventBus>) EventBus.class, (Class<? super EventBus>[]) new Class[]{Subscriber.class, Publisher.class}));
        arrayList.add(Component.m1352of(this, (Class<ComponentRuntime>) ComponentLoader.class, (Class<? super ComponentRuntime>[]) new Class[0]));
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return OptionalProvider.m1353of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m34m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
