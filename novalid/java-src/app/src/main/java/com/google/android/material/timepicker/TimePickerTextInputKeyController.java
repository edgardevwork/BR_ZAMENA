...
public class TimePickerTextInputKeyController implements TextView.OnEditorActionListener, View.OnKeyListener {
    ...
    public final boolean onMinuteKeyPress(int i, KeyEvent keyEvent, EditText editText) {
    ...
    public final boolean onHourKeyPress(int i, KeyEvent keyEvent, EditText editText) {
    ...
    public final void clearPrefilledText(EditText editText) {
