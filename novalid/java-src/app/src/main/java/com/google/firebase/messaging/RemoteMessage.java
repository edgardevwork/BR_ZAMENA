...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public RemoteMessage(@SafeParcelable.Param(m1070id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    @Deprecated
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f879TO);
    }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            bundle.putString(Constants.MessagePayloadKeys.f879TO, str);
        }
        ...
        @NonNull
        public Builder setTtl(@IntRange(from = 0, m10to = 86400) int i) {
