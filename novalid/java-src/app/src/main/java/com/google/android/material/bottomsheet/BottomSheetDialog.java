...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(@NonNull Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C6765R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C6765R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C6765R.id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C6765R.id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C6765R.id.coordinator);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(C6765R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
            public ViewOnClickListenerC68022() {
            }
        ...
        this.bottomSheet.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.4
            ...
            public ViewOnTouchListenerC68044() {
            }
        });
        return this.container;
    }
    ...
    public class C68011 implements OnApplyWindowInsetsListener {
        public C68011() {
        }
    ...
    public class ViewOnClickListenerC68022 implements View.OnClickListener {
        public ViewOnClickListenerC68022() {
        }
    ...
    /* loaded from: classes6.dex */
    public class C68033 extends AccessibilityDelegateCompat {
        public C68033() {
        }
    ...
    /* loaded from: classes4.dex */
    public class ViewOnTouchListenerC68044 implements View.OnTouchListener {
        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view2, MotionEvent motionEvent) {
            return true;
        }
    ...
    private static int getThemeResId(@NonNull Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C6765R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C6765R.style.Theme_Design_Light_BottomSheetDialog;
    }
    ...
    /* loaded from: classes6.dex */
    public class C68055 extends BottomSheetBehavior.BottomSheetCallback {
        @Override // com.google.android.material.bottomsheet.BottomSheetBehavior.BottomSheetCallback
        public void onSlide(@NonNull View view, float f) {
        }
    ...
    public static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        public /* synthetic */ EdgeToEdgeCallback(View view, WindowInsetsCompat windowInsetsCompat, C68011 c68011) {
            this(view, windowInsetsCompat);
        }

        public EdgeToEdgeCallback(@NonNull View view, @NonNull WindowInsetsCompat windowInsetsCompat) {
