...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public BitmapTeleporter(@SafeParcelable.Param(m1070id = 1) int i, @SafeParcelable.Param(m1070id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(m1070id = 3) int i2) {
        this.zaa = i;
