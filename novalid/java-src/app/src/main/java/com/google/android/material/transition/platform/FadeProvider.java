...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    public static Animator createFadeAnimator(final View view, final float f, final float f2, @FloatRange(from = 0.0d, m9to = 1.0d) final float f3, @FloatRange(from = 0.0d, m9to = 1.0d) final float f4, final float f5) {
