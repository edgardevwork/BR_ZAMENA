...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public final List<Interceptor> m17411deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m17412deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final SSLSocketFactory m17421deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }
    ...
    public final List<ConnectionSpec> m17403deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Protocol> m17414deprecated_protocols() {
        return this.protocols;
    }
    ...
    public static final class Builder {
        ...
        public final Builder m17423addInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m17424addNetworkInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder callTimeout(long j, @NotNull TimeUnit timeUnit) {
            ...
            this.callTimeout = Util.checkDuration(ClientProperties.PROP_TIMEOUT, j, timeUnit);
            return this;
        }
        ...
        public final Builder connectTimeout(long j, @NotNull TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            this.connectTimeout = Util.checkDuration(ClientProperties.PROP_TIMEOUT, j, timeUnit);
            return this;
        }
        ...
        public final Builder readTimeout(long j, @NotNull TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            this.readTimeout = Util.checkDuration(ClientProperties.PROP_TIMEOUT, j, timeUnit);
            return this;
        }
        ...
        public final Builder writeTimeout(long j, @NotNull TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            this.writeTimeout = Util.checkDuration(ClientProperties.PROP_TIMEOUT, j, timeUnit);
            return this;
        }
        ...
        @NotNull
        public final Builder pingInterval(long interval, @NotNull TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            this.pingInterval = Util.checkDuration("interval", interval, timeUnit);
            return this;
        }
    ...
    /* compiled from: OkHttpClient.kt */
    @Metadata(m7104d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, m7105d2 = {"Lokhttp3/OkHttpClient$Companion;", "", "()V", "DEFAULT_CONNECTION_SPECS", "", "Lokhttp3/ConnectionSpec;", "getDEFAULT_CONNECTION_SPECS$okhttp", "()Ljava/util/List;", "DEFAULT_PROTOCOLS", "Lokhttp3/Protocol;", "getDEFAULT_PROTOCOLS$okhttp", "okhttp"}, m7106k = 1, m7107mv = {1, 8, 0}, m7109xi = 48)
    /* loaded from: classes6.dex */
