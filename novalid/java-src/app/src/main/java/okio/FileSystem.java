...
public abstract class FileSystem {
    ...
    @NotNull
    public abstract Sink appendingSink(@NotNull Path path, boolean mustExist) throws IOException;
    ...
    @NotNull
    public abstract FileHandle openReadWrite(@NotNull Path path, boolean mustCreate, boolean mustExist) throws IOException;

    @NotNull
    public abstract Sink sink(@NotNull Path path, boolean mustCreate) throws IOException;
    ...
    public static /* synthetic */ Object m17460write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws Throwable {
        Object objInvoke;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    /* compiled from: FileSystem.kt */
    @Metadata(m7104d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0011\u0010\b\u001a\u00020\u0004*\u00020\tH\u0007¢\u0006\u0002\b\nR\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m7105d2 = {"Lokio/FileSystem$Companion;", "", "()V", "RESOURCES", "Lokio/FileSystem;", "SYSTEM", "SYSTEM_TEMPORARY_DIRECTORY", "Lokio/Path;", "asOkioFileSystem", "Ljava/nio/file/FileSystem;", "get", "okio"}, m7106k = 1, m7107mv = {1, 9, 0}, m7109xi = 48)
    ...
    @JvmName(name = "-read")
    /* renamed from: -read */
    public final <T> T m17461read(@NotNull Path path, @NotNull Function1<? super BufferedSource, ? extends T> readerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(path, "file");
    ...
    @JvmName(name = "-write")
    /* renamed from: -write */
    public final <T> T m17462write(@NotNull Path path, boolean mustCreate, @NotNull Function1<? super BufferedSink, ? extends T> writerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(path, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
        BufferedSink bufferedSinkBuffer = Okio.buffer(sink(path, mustCreate));
        Throwable th = null;
        try {
