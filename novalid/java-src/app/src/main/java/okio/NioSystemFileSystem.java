...
public class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public final FileMetadata metadataOrNull(@NotNull java.nio.file.Path nioPath) throws IOException {
        ...
        try {
            BasicFileAttributes attributes = Files.readAttributes(nioPath, (Class<BasicFileAttributes>) PathTreeWalkKt$$ExternalSyntheticApiModelOutline0.m7151m(), LinkOption.NOFOLLOW_LINKS);
    ...
    public final Long zeroToNull(FileTime fileTime) {
