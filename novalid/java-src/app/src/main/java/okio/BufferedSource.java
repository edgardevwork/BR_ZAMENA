...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    boolean rangeEquals(long j, @NotNull ByteString bytes) throws IOException;

    boolean rangeEquals(long j, @NotNull ByteString bytes, int bytesOffset, int byteCount) throws IOException;

    int read(@NotNull byte[] sink) throws IOException;

    int read(@NotNull byte[] sink, int i, int byteCount) throws IOException;
