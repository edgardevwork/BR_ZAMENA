...
public class Issue implements Serializable {
    ...
    public org.jfrog.build.api.Issue ToBuildIssue() {
        org.jfrog.build.api.Issue issue = new org.jfrog.build.api.Issue();
        issue.setKey(this.key);
        issue.setUrl(this.url);
        issue.setSummary(this.summary);
        issue.setAggregated(this.aggregated);
        return issue;
    }
    ...
    public static Issue ToBuildInfoIssue(org.jfrog.build.api.Issue issue) {
        ...
        issue2.setUrl(issue.getUrl());
        issue2.setSummary(issue.getSummary());
        issue2.setAggregated(issue.isAggregated());
        return issue2;
    }
}
