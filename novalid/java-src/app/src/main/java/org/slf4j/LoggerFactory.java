...
public final class LoggerFactory {
    ...
    public static final void performInitialization() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        bind();
    ...
    public static final void bind() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void postBindCleanUp() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void replayEvents() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void replaySingleEvent(SubstituteLoggingEvent substituteLoggingEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static Set<URL> findPossibleStaticLoggerBinderPathSet() throws IOException {
