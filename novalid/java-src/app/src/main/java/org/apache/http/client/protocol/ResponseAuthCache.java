...
public class ResponseAuthCache implements HttpResponseInterceptor {
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (httpHost != null && authState != null) {
            ...
            if (isCachable(authState)) {
                ...
                int i = C111181.$SwitchMap$org$apache$http$auth$AuthProtocolState[authState.getState().ordinal()];
                if (i == 1) {
        ...
        if (isCachable(authState2)) {
            ...
            int i2 = C111181.$SwitchMap$org$apache$http$auth$AuthProtocolState[authState2.getState().ordinal()];
            if (i2 == 1) {
    ...
    public static /* synthetic */ class C111181 {
    ...
    public final boolean isCachable(AuthState authState) {
    ...
    public final void cache(AuthCache authCache, HttpHost httpHost, AuthScheme authScheme) {
        if (this.log.isDebugEnabled()) {
    ...
    public final void uncache(AuthCache authCache, HttpHost httpHost, AuthScheme authScheme) {
        if (this.log.isDebugEnabled()) {
