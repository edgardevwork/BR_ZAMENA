...
public class StringUtils {
    ...
    /* renamed from: CR */
    public static final String f9902CR = "\r";
    public static final String EMPTY = "";
    public static final int INDEX_NOT_FOUND = -1;

    /* renamed from: LF */
    public static final String f9903LF = "\n";
    ...
    */
    ...
    public static boolean containsAny(ToBooleanBiFunction<CharSequence, CharSequence> toBooleanBiFunction, CharSequence charSequence, CharSequence... charSequenceArr) {
    ...
    */
    ...
    public static StringJoiner newStringJoiner(char c) {
