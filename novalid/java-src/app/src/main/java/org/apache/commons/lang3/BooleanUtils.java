...
public class BooleanUtils {
    ...
    /* renamed from: NO */
    public static final String f9898NO = "no";
    public static final String OFF = "off";

    /* renamed from: ON */
    public static final String f9899ON = "on";
    ...
    /* renamed from: or */
    public static boolean m7343or(boolean... zArr) {
        ObjectUtils.requireNonEmpty(zArr, "array");
        for (boolean z : zArr) {
            if (z) {
                return true;
    ...
    /* renamed from: or */
    public static Boolean m7342or(Boolean... boolArr) {
        ObjectUtils.requireNonEmpty(boolArr, "array");
        try {
            return m7343or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
        } catch (NullPointerException unused) {
            throw new IllegalArgumentException("The array must not contain any null elements");
        }
    }
