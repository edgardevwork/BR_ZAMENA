...
public class ArrayUtils {
    ...
    public static Object add(Object obj, int i, Object obj2, Class<?> cls) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        if (obj == null) {
            if (i != 0) {
    ...
    public static Object copyArrayGrow1(Object obj, Class<?> cls) throws NegativeArraySizeException {
        if (obj != null) {
            int length = Array.getLength(obj);
    ...
    public static Object remove(Object obj, int i) throws NegativeArraySizeException {
