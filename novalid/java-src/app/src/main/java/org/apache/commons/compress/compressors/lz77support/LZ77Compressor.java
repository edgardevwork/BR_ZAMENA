...
public class LZ77Compressor {
    ...
    public int insertHash;
    public int lookahead;
    public int matchStart = -1;
    public int missedInserts;
    ...
    public final int nextHash(int i, byte b) {
    ...
    public final void doCompress(byte[] bArr, int i, int i2) throws IOException {
    ...
    public final void slide() throws IOException {
        int windowSize = this.params.getWindowSize();
        int i = this.blockStart;
    ...
    public final int insertString(int i) {
    ...
    public final int longestMatchForNextPosition(int i) {
    ...
    public final void insertStringsInMatch(int i) {
    ...
    public final void catchUpMissedInserts() {
        while (true) {
    ...
    public final void flushBackReference(int i) throws IOException {
        this.callback.accept(new BackReference(this.currentPosition - this.matchStart, i));
    }

    public final void flushLiteralBlock() throws IOException {
    ...
    public final int longestMatch(int i) {
