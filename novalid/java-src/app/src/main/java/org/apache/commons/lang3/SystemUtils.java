...
public class SystemUtils {
    ...
    static {
        ...
        JAVA_VENDOR_URL = getSystemProperty(LoggerFactory.JAVA_VENDOR_PROPERTY);
        ...
        IS_JAVA_1_4 = getJavaVersionMatches(SVG.VERSION);
        IS_JAVA_1_5 = getJavaVersionMatches(YouTubePlayerBridge.RATE_1_5);
        ...
        IS_JAVA_13 = getJavaVersionMatches(WebSocketContentKt.WEBSOCKET_VERSION);
