...
public class Digest {
    ...
    public final void println(String str, byte[] bArr) {
        println(str, bArr, null);
    }

    public final void println(String str, byte[] bArr, String str2) {
        String str3;
        ...
        if (str2 != null) {
            str3 = GlideException.IndentedAppendable.INDENT + str2;
        } else {
            str3 = "";
        }
        sb.append(str3);
    ...
    public final void run(String[] strArr) throws IOException {
    ...
    public final void run(String str, MessageDigest messageDigest) throws IOException {
    ...
    public final void run(String str, MessageDigest messageDigest, File[] fileArr) throws IOException {
    ...
    public final void run(String str, String str2) throws IOException {
