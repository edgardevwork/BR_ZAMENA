...
import org.apache.commons.p059io.comparator.NameFileComparator;
...
public class FileAlterationObserver implements Serializable {
    ...
    public final void checkAndNotify(FileEntry fileEntry, FileEntry[] fileEntryArr, File[] fileArr) {
    ...
    public final FileEntry createFileEntry(FileEntry fileEntry, File file) {
    ...
    public final FileEntry[] doListFiles(File file, FileEntry fileEntry) {
    ...
    public final void doCreate(FileEntry fileEntry) {
    ...
    public final void doMatch(FileEntry fileEntry, File file) {
    ...
    public final void doDelete(FileEntry fileEntry) {
        for (FileAlterationListener fileAlterationListener : this.listeners) {
            if (fileEntry.isDirectory()) {
