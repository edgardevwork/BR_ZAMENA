...
public class DurationFormatUtils {
    ...
    /* renamed from: H */
    public static final String f9908H = "H";
    public static final String ISO_EXTENDED_FORMAT_PATTERN = "'P'yyyy'Y'M'M'd'DT'H'H'm'M's.SSS'S'";

    /* renamed from: M */
    public static final String f9909M = "M";

    /* renamed from: S */
    public static final String f9910S = "S";

    /* renamed from: d */
    public static final String f9911d = "d";

    /* renamed from: m */
    public static final String f9912m = "m";

    /* renamed from: s */
    public static final String f9913s = "s";

    /* renamed from: y */
    public static final String f9914y = "y";
    ...
    public static String formatDuration(long j, String str, boolean z) {
        ...
        if (Token.containsTokenWithValue(tokenArrLexx, f9908H)) {
            long j9 = j2 / 3600000;
            j2 -= 3600000 * j9;
            j4 = j9;
        } else {
