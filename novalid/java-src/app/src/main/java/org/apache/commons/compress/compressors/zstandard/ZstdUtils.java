...
public class ZstdUtils {
    ...
    public static final byte[] SKIPPABLE_FRAME_MAGIC = {42, TarConstants.LF_MULTIVOLUME, 24};
    public static volatile CachedAvailability cachedZstdAvailability = CachedAvailability.DONT_CACHE;
    ...
    public static boolean internalIsZstdCompressionAvailable() throws ClassNotFoundException {
        try {
