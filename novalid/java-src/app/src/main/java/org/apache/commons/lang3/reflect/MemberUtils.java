...
public abstract class MemberUtils {
    ...
    public static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m7357of(constructor), Executable.m7357of(constructor2), clsArr);
    }

    public static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m7358of(method), Executable.m7358of(method2), clsArr);
    }
    ...
    public static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m7358of(method), clsArr);
    }

    public static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m7357of(constructor), clsArr);
    }
    ...
    public static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m7358of(Method method) {
            return new Executable(method);
        }

        /* renamed from: of */
        public static Executable m7357of(Constructor<?> constructor) {
