...
public interface Interceptor {
    ...
    public interface Chain {
        ...
        @ExperimentalCoilApi
        @NotNull
        Chain withRequest(@NotNull ImageRequest request);
