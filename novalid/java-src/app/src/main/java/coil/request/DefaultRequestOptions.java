...
public final class DefaultRequestOptions {
    ...
    @NotNull
    public final DefaultRequestOptions copy(@NotNull CoroutineDispatcher interceptorDispatcher, @NotNull CoroutineDispatcher fetcherDispatcher, @NotNull CoroutineDispatcher decoderDispatcher, @NotNull CoroutineDispatcher transformationDispatcher, @NotNull Transition.Factory transitionFactory, @NotNull Precision precision, @NotNull Bitmap.Config bitmapConfig, boolean allowHardware, boolean allowRgb565, @Nullable Drawable placeholder, @Nullable Drawable error, @Nullable Drawable drawable, @NotNull CachePolicy memoryCachePolicy, @NotNull CachePolicy diskCachePolicy, @NotNull CachePolicy networkCachePolicy) {
        return new DefaultRequestOptions(interceptorDispatcher, fetcherDispatcher, decoderDispatcher, transformationDispatcher, transitionFactory, precision, bitmapConfig, allowHardware, allowRgb565, placeholder, error, drawable, memoryCachePolicy, diskCachePolicy, networkCachePolicy);
    }
